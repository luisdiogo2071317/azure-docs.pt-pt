---
title: Descrição do Serviço de Aplicações | Microsoft Docs
description: Conteúdo de ajuda da descrição geral do Serviço de Aplicações no portal do Azure
...
Saiba como implementar a sua primeira aplicação na cloud com o Serviço de Aplicações para Aplicações Web:
...
Saiba como implementar, gerir e monitorizar aplicações Web seguras no Azure.
...
- Criar uma aplicação com:
  ...
  - [Python com PostgreSQL](/app-service/app-service-web-tutorial-python-postgresql)
