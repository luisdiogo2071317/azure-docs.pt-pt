...
3. **Utilize uma conta de armazenamento separada para cada VM num Conjunto de Disponibilidade.** Não partilhe Contas de armazenamento com várias VMs no mesmo Conjunto de Disponibilidade. É aceitável para as VMs em diferentes conjuntos de disponibilidade para partilhar contas de armazenamento se forem seguidos acima melhores práticas ![não gerido discos FDs](./media/virtual-machines-common-manage-availability/md-fd.png)
