...
1. No portal do Azure, visite a página **Grupo de recursos**. 
   ...
   ![Selecione o grupo de recursos a eliminar na página da aplicação de função.](./media/functions-quickstart-cleanup/functions-app-delete-resource-group.png)
