...
### <a name="register-an-application-in-your-azure-active-directory"></a>Registar uma aplicação no Azure Active Directory
...
Depois de criar o Cofre de chaves, precisamos de adicionar uma chave para o Cofre de chaves, esta chave será refered quando criamos uma chave assimétrica criar mais tarde no SQL Server.
