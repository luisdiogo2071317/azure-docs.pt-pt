A Shell de nuvem, criar um plano de serviço de aplicações no grupo de recursos com o [criar plano de serviço aplicacional az](/cli/azure/appservice/plan?view=azure-cli-latest#az_appservice_plan_create) comando.
