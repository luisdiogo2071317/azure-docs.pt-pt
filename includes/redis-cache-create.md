Para criar uma cache, sessão pela primeira vez para o [portal do Azure](https://portal.azure.com)e clique em **crie um recurso** > **bases de dados** > **a Cache de Redis** .
...
No **nova Cache de Redis**, especifique a configuração pretendida para a cache.
...
* Para **Subscrição**, selecione a subscrição do Azure que pretende utilizar para a cache. Se a sua conta tiver apenas uma subscrição, é selecionado automaticamente e o **subscrição** não for apresentado o menu pendente.
