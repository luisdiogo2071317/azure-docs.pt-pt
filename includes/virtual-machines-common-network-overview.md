...
| [Azure PowerShell](../articles/virtual-machines/windows/multiple-nics.md) | Uso [New-AzNetworkInterface](https://docs.microsoft.com/powershell/module/azurerm.network/new-aznetworkinterface) com o **- PublicIpAddressId** parâmetro para fornecer o identificador do endereço IP público que criou anteriormente. |
...
| [Azure PowerShell](../articles/virtual-network/virtual-network-deploy-static-pip-arm-ps.md) | Utilizar [New-AzPublicIpAddress](https://docs.microsoft.com/powershell/module/azurerm.network/new-azpublicipaddress) com o **- AllocationMethod** parâmetro como dinâmico ou estático. |
...
| [Azure PowerShell](../articles/virtual-network/quick-create-powershell.md) | Utilizar [New-AzVirtualNetworkSubnetConfig](https://docs.microsoft.com/powershell/module/azurerm.network/New-AzVirtualNetworkSubnetConfig) e [New-AzVirtualNetwork](https://docs.microsoft.com/powershell/module/azurerm.network/New-AzVirtualNetwork) para criar uma sub-rede e uma VNet. Também pode utilizar [Add-AzVirtualNetworkSubnetConfig](https://docs.microsoft.com/powershell/module/azurerm.network/add-azvirtualnetworksubnetconfig) para adicionar uma sub-rede para uma VNet já existente. |
...
| [Azure PowerShell](../articles/virtual-network/tutorial-filter-network-traffic.md) | Uso [New-AzNetworkSecurityRuleConfig](https://docs.microsoft.com/powershell/module/azurerm.network/New-AzNetworkSecurityRuleConfig) e forneça as informações necessárias da regra. Uso [New-AzNetworkSecurityGroup](https://docs.microsoft.com/powershell/module/azurerm.network/New-AzNetworkSecurityGroup) para criar o NSG. Uso [Set-AzVirtualNetworkSubnetConfig](https://docs.microsoft.com/powershell/module/azurerm.network/Set-AzVirtualNetworkSubnetConfig) para configurar o NSG da sub-rede. Uso [Set-AzVirtualNetwork](https://docs.microsoft.com/powershell/module/azurerm.network/set-azvirtualnetwork) para adicionar o NSG à VNet. |
...
| [Azure PowerShell](../articles/load-balancer/load-balancer-get-started-internet-arm-ps.md) | Para fornecer o identificador do endereço IP público que criou anteriormente, utilize [New-AzLoadBalancerFrontendIpConfig](https://docs.microsoft.com/powershell/module/azurerm.network/New-AzLoadBalancerFrontendIpConfig) com o **- PublicIpAddress** parâmetro. Uso [New-AzLoadBalancerBackendAddressPoolConfig](https://docs.microsoft.com/powershell/module/azurerm.network/New-AzLoadBalancerBackendAddressPoolConfig) para criar a configuração do conjunto de endereços de back-end. Uso [New-AzLoadBalancerInboundNatRuleConfig](https://docs.microsoft.com/powershell/module/azurerm.network/New-AzLoadBalancerInboundNatRuleConfig) para criar regras NAT de entrada associadas com a configuração de IP Front-end que criou. Uso [New-AzLoadBalancerProbeConfig](https://docs.microsoft.com/powershell/module/azurerm.network/New-AzLoadBalancerProbeConfig) para criar as sondas de que precisa. Uso [New-AzLoadBalancerRuleConfig](https://docs.microsoft.com/powershell/module/azurerm.network/New-AzLoadBalancerRuleConfig) para criar a configuração de Balanceador de carga. Uso [New-AzLoadBalancer](https://docs.microsoft.com/powershell/module/azurerm.network/new-azloadbalancer) para criar o Balanceador de carga.|
