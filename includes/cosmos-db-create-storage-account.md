...
Também pode criar uma conta de armazenamento do Azure, utilizando [Azure PowerShell](../articles/storage/common/storage-powershell-guide-full.md) ou [CLI do Azure](../articles/storage/common/storage-azure-cli.md).
