...
- Inícios rápidos
    ...
    |[Utilizar o Visual Studio](../articles/azure-resource-manager/vs-azure-tools-resource-groups-deployment-projects-create-deploy.md)|Utilize o Visual Studio para criar, editar e implementar modelos.|
