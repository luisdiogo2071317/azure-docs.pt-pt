...
1. Utilize as credenciais da conta Microsoft para iniciar sessão para o [Portal do Microsoft Azure Government](https://portal.azure.us/).
...
3. No painel **Gestor de Dispositivos do StorSimple**, siga os seguintes passos:
   ...
   4. Forneça uma **Localização** para o serviço. Localização do pacote refere-se para a região geográfica onde pretende implementar o dispositivo. Selecione **Iowa do Governo dos E.u.a.** ou **Virgina do Governo dos E.u.a**.
