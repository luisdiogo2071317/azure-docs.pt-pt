...
ms.locfileid: "36943424"
---
# <a name="sign-in-users-and-call-the-microsoft-graph-api-from-an-android-app"></a>Os utilizadores a iniciar sessão e chamar a Microsoft Graph API a partir de uma aplicação Android
