...
2. Quando estiver pronto para testar a aplicação, utilize uma conta do Microsoft Azure Active Directory (conta escolar ou profissional) ou uma conta Microsoft (live.com, outlook.com) para iniciar sessão. 
...
Depois de iniciar sessão, deverá ver os resultados que são devolvidos pela chamada para a Microsoft Graph API. A chamada para a Microsoft Graph API **-me** endpoint devolve o utilizador perfil https://graph.microsoft.com/v1.0/me. Para obter uma lista de pontos finais de Microsoft Graph comuns, consulte [a documentação de programador do Microsoft Graph API](https://developer.microsoft.com/graph/docs#common-microsoft-graph-queries).
