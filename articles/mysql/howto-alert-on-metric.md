...
ms.locfileid: "35265188"
---
# <a name="use-the-azure-portal-to-set-up-alerts-on-metrics-for-azure-database-for-mysql"></a>Utilizar o portal do Azure para configurar alertas nas métricas da base de dados do Azure para MySQL 

Este artigo mostra como configurar a base de dados do Azure para os alertas de MySQL no portal do Azure. Pode receber um alerta com base nas métricas para os serviços do Azure de monitorização.
...
1. No [portal do Azure](https://portal.azure.com/), selecione a base de dados do Azure para o servidor de MySQL que pretende monitorizar.

2. Sob o **monitorização** secção da barra lateral, selecione **regras de alerta** conforme mostrado:

   ![Selecione as regras de alertas](./media/howto-alert-on-metric/1-alert-rules.png)
...
4. O **Adicionar regra** página abre-se conforme mostrado abaixo.  Preencha as informações necessárias:
   ...
   | Subscrição | Este campo é pré-preenchida com a subscrição que aloja a base de dados do Azure para MySQL. |
   | Grupo de recursos | Este campo é pré-preenchida com o grupo de recursos da sua base de dados do Azure para MySQL. |
   | Recurso | Este campo é pré-preenchida com o nome da base de dados do Azure para MySQL. |
