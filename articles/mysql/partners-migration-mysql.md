---
title: Base de dados do Azure para parceiros de migração de MySQL | Microsoft Docs
description: Apresenta uma lista de parceiros de migração de terceiros com soluções que suportam a base de dados do Azure para MySQL.
services: mysql
author: HJToland3
ms.author: jtoland
manager: craigg
...
ms.locfileid: "36304564"
---
# <a name="azure-database-for-mysql-migration-partners"></a>Base de dados do Azure para parceiros de migração de MySQL
Para suportar amplamente a base de dados do Azure para a solução de MySQL, escolha a partir de uma ampla variedade de ferramentas e parceiros líder da indústria. Este artigo realça empresas da Microsoft com soluções de migração que suporta a base de dados do Azure para MySQL.
