...
> Observe que os ficheiros do service.yaml são processados com o idioma inglês.  Por exemplo, se precisar de utilizar um separador decimal, utilize um ponto em vez de uma vírgula.
