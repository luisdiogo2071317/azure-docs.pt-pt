...
ms.locfileid: "29693362"
---
# <a name="backup-and-restore-in-azure-database-for-postgresql"></a>Cópia de segurança e restauro da base de dados do Azure para PostgreSQL
...
Na base de dados do Azure para PostgreSQL, efetuar um restauro cria um novo servidor de cópias de segurança do servidor original.
