...
> [!IMPORTANT]
> O **Arquivo de Consultas**, o **Query Performance Insight** e as **Recomendações de Desempenho** estão em Pré-visualização Pública num número limitado de regiões.
