---
title: Resolver problemas de ligação à base de dados do Azure para PostgreSQL | Documentos da Microsoft
description: Saiba como resolver problemas de ligação à base de dados do Azure para PostgreSQL.
