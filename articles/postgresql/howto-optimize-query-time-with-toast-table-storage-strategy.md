...
Reveja a seguinte documentação de PostgreSQL: [Capítulo 68, armazenamento físico do banco de dados](https://www.postgresql.org/docs/current/storage-toast.html) 