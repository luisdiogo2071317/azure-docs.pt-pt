---
title: Início Rápido para aprender a utilizar a Cache de Redis do Azure com o Java | Microsoft Docs
description: Neste início rápido, vai criar uma nova aplicação de Java que utiliza a Cache de Redis do Azure
...
Este artigo mostra como começar a utilizar a Cache de Redis do Azure com o cliente [Jedis](https://github.com/xetorthio/jedis) da Cache de Redis para Java.
...
Este código mostra como ligar a uma instância da Cache de Redis do Azure através do nome do anfitrião da cache e de variáveis de ambiente da chave. O código também armazena e obtém um valor de cadeia na cache. Os comandos `PING` e `CLIENT LIST` também são executados. 
