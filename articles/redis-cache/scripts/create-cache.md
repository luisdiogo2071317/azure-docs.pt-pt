---
title: CLI do Azure Script de exemplo - criar uma Cache de Redis do Azure | Microsoft Docs
description: CLI do Azure Script de exemplo - criar uma Cache de Redis do Azure
...
ms.locfileid: "29849400"
---
# <a name="create-an-azure-redis-cache"></a>Criar uma Cache de Redis do Azure

Neste cenário, irá aprender a criar uma Cache de Redis do Azure.
...
Este script utiliza os seguintes comandos para criar um grupo de recursos e uma cache de redis. Cada comando na tabela liga à documentação específica do comando.
