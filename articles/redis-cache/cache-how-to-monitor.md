...
| Chaves Excluídas |O número de itens expulsos da cache durante o intervalo especificado de relatórios devido ao `maxmemory` limite. Isto mapeia para `evicted_keys` do comando Redis informações. |
