...
Este artigo contém a versão de lançamento de notas do Explorador de armazenamento do Azure 0.9.5 (pré-visualização), bem como as notas de versão para versões anteriores.
