...
1. Se a Data Lake Store é selecionada como uma saída no portal do Azure, será solicitado para autorizar a utilização do Data Lake Store existente ou para pedir acesso para o Data Lake Store.
