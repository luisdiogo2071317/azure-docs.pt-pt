...
1. No portal do Azure, clique em **crie um recurso** > **armazenamento** > **conta de armazenamento**.
...
8. No **carregar blob** painel, carregue o **sampleinput.csv** ficheiro que transferiu anteriormente. Para **Blob tipo**, selecione **BLOBs de blocos** e defina o tamanho do bloco para 4 MB, que é suficiente para este tutorial.
...
2. Clique em **crie um recurso** > **Internet das coisas** > **tarefa do Stream Analytics**. 
...
1. Depois da tarefa foi criada, em **tarefa topologia** no painel de tarefas, clique o **entradas** opção.    

2. No **entradas** painel, clique em **Adicionar entrada de fluxo** >**armazenamento de BLOBs**

3. Preencha o **Blob Storage** painel com estes valores:

   
   |Campo  |Valor  |
   |---------|---------|
   |**Alias de entrada** | Utilize o nome `datainput` e selecione **selecione do blob storage a partir da sua subscrição**       |
...
1. Em **tarefa topologia** no painel de tarefas, clique o **saídas** opção.  

2. No **saídas** painel, clique em **adicionar** >**armazenamento de BLOBs**e, em seguida, adicione uma saída com o alias `datamloutput`. 
...
2. Navegue para o painel de tarefas > **funções** > **+ adicionar** > **AzureML**

3. Preencha o **função do Azure Machine Learning** painel com estes valores:

   |Campo  |Valor  |
   |---------|---------|
   | **Alias de função** | Utilize o nome `sentiment` e selecione **definições da função de fornecer o Azure Machine Learning manualmente** que lhe oferece uma opção para introduzir o URL e a chave.      |
