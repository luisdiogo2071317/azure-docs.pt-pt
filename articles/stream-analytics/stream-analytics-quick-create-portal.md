...
5. Na página **Serviço Blob**, selecione **Contentor**, forneça um **Nome** para o contentor, como *container1* e altere o **Nível de acesso público** para Blob (acesso de leitura anónimo apenas para blobs) > selecione **OK**.  
