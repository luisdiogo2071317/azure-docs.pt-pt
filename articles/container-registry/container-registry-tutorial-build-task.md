...
Por predefinição, o comando `az acr build-task run` transmite a saída de registo para a consola quando executar o comando. Aqui, o resultado mostra que a compilação **eastus2** foi colocada em fila e compilada.
