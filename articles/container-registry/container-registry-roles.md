...
| / Permissões da função       | [Gestor de recursos de acesso](#access-resource-manage)| [Criar/eliminar registo](#create/delete-registry) | [Enviar imagem](#push-image) | [Imagem de extração](#pull-image) | [Alterar as políticas](#change-polices) |   [Imagens de início de sessão](#sign-images)  |
| ---------| --------- | --------- | --------- | --------- | --------- | --------- |
