---
title: Criar um Balanceador de Carga Standard público - CLI do Azure | Microsoft Docs
...
---
# <a name="create-a-standard-load-balancer-to-load-balance-vms-using-azure-cli-20"></a>Criar um Balanceador de Carga Standard para fazer o balanceamento de carga das VMs com a CLI do Azure 2.0
