...
Azure [limites de serviço para funcionamento em rede](https://docs.microsoft.com/azure/azure-subscription-service-limits#networking-limits) aplicam-se por região por subscrição. 
