...
1. <a name="step6-1"></a>Em **definições**, selecione **as regras de balanceamento de carga**. No painel seguinte, perto da parte superior, selecione **adicionar**. 
