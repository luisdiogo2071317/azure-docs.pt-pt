---
title: Utilizar sondas de estado de funcionamento do Balanceador de carga para proteger o seu serviço | Documentos da Microsoft
...
-  SDK, PowerShell não suportam HTTPS sondas neste momento.
