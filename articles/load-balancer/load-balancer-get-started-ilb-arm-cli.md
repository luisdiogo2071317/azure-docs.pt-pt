---
title: Criar um Balanceador de Carga Básico interno – CLI do Azure | Microsoft Docs
description: Saiba como criar um balanceador de carga interno com a CLI do Azure
