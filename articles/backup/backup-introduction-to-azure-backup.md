...
As VMs de Armazenamento Premium podem ser restauradas para o Armazenamento Premium ou para o Armazenamento Standard. Restaurar um ponto de recuperação de uma VM do Premium Storage novamente para o Premium Storage é o processo normal de restauro. No entanto, pode ser rentável restaurar um ponto de recuperação de uma VM do Armazenamento Premium para o Armazenamento Standard. Este tipo de restauro pode ser utilizado se precisar de um subconjunto de ficheiros da VM.
