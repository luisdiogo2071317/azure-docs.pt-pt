---
title: Cópia de segurança do Azure - cópia de segurança Offline para o DPM e o servidor de cópia de segurança do Azure | Microsoft Docs
...
---
# <a name="offline-backup-workflow-for-dpm-and-azure-backup-server"></a>Fluxo de trabalho de cópia de segurança offline para o DPM e o servidor de cópia de segurança do Azure
...
> [!NOTE]
> O processo de cópia de segurança Offline para o agente de serviços de recuperação do Azure (MARS) da Microsoft é diferente do System Center DPM e o servidor de cópia de segurança do Azure. Para obter informações sobre como utilizar a cópia de segurança Offline com o agente MARS, consulte [neste artigo](backup-azure-backup-import-export.md). Cópia de segurança offline não é suportada para cópias de segurança do Estado do sistema feitas com o agente de cópia de segurança do Azure. 
>
