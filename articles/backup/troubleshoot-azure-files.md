---
title: "Resolução de Problemas da Cópia de Segurança de Ficheiros do Azure"
description: "Este artigo apresenta informações sobre a resolução de problemas que ocorrem ao proteger os Ficheiros do Azure (partilhas de ficheiros) no Azure."
services: backup
ms.service: backup
...
| Não é possível eliminar o cofre dos Serviços de Recuperação após desproteger uma Partilha de ficheiros. | No portal do Azure, abra **Infraestrutura de Cópia de Segurança** > **Contas de armazenamento** e clique em **Anular o Registo** para remover a conta de armazenamento do cofre dos Serviços de Recuperação.|
