...
### <a name="why-cant-i-protect-file-shares-connected-to-a-sync-group-in-azure-file-sync-br"></a>Por que motivo não posso proteger as Partilhas de Ficheiros ligadas a um Grupo de Sincronização no Azure File Sync? <br/>
A proteção das partilhas de ficheiros do Azure ligadas a grupos de sincronização encontra-se em pré-visualização limitada. Envie uma mensagem para [AskAzureBackupTeam@microsoft.com](email:askazurebackupteam@microsoft.com) com o ID da Subscrição para solicitar o acesso. 
...
A cópia de segurança para partilhas de ficheiros do Azure não suporta Contas de Armazenamento que têm Redes Virtuais ativadas. Desative as Redes Virtuais nas Contas de Armazenamento para permitir cópias de segurança bem-sucedidas. 
...
Quando uma partilha de ficheiros do Azure é eliminada, é-lhe apresentada a lista de cópias de segurança que também serão eliminadas e é-lhe pedida uma confirmação. Não é possível restaurar uma partilha de ficheiros do Azure eliminada.
