...
* Cópia de segurança fornecida [permissões para aceder a um cofre de chaves](#provide-permissions-to-backup) que contém chaves e segredos para encriptados VMs.
