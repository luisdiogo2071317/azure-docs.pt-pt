...
| AlertOccurenceDate |Date |Data quando o alerta foi criado |
...
| Campo | Tipo de Dados | Descrição |
| --- | --- | --- |
| Date |Date |Data seleccionada para filtrar dados |
...
| MonthDate | Date |Datas no mês quando termina o mês, selecionado para filtrar dados |
...
| Week (Semana) |Texto |Semana selecionada para filtrar dados, semana começa no Domingo e termina no Sábado |
| WeekDate |Date |Data da semana quando termina semana, selecionado para filtrar dados |
...
| YearDate |Date |Datas no ano quando termina o ano, selecionado para filtrar dados |
...
| JobStartDate |Date |Data quando iniciar a tarefa em execução |
...
| LastUpdatedDate |Date |Data quando linha selecionada foi atualizada pela última vez |
