...
Antes de continuar, certifique-se de que tem [instalado e preparar o servidor de cópia de segurança do Azure](backup-mabs-install-azure-stack.md) proteger cargas de trabalho.
...
Consulte o [cópia de segurança do SQL Server em Azure pilha](backup-mabs-sql-azure-stack.md) artigo.
