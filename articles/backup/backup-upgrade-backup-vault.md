...
- **Recursos para ajudar a proteger os dados da cópia de segurança aprimorados**: com serviços de recuperação, cópia de segurança do Azure fornece capacidades de segurança para proteger cópias de segurança na cloud. Estas funcionalidades de segurança, certifique-se que pode proteger as suas cópias de segurança e recuperar com segurança os dados de cópias de segurança na cloud, mesmo se os servidores de produção e cópia de segurança sejam comprometidos. [Saiba mais](backup-azure-security-feature.md)
