...
Para ativar o Azure PowerShell para consultar o Azure Resource Graph, tem de adicionar o módulo. Este módulo pode ser utilizado com o Windows PowerShell instalado localmente e o PowerShell Core, bem como a [imagem do Docker do Azure PowerShell](https://hub.docker.com/r/azuresdk/azure-powershell/).
...
- PowerShellGet. Se não estiver ainda instalado ou atualizado, siga [estas instruções](/powershell/gallery/installing-psget).
...
1. Confirme que o módulo foi importado e se é a versão correta (0.2.0):
...
1. Confirme que o módulo foi importado e se é a versão correta (0.1.0-pré-visualização):
...
Agora que o módulo Azure PowerShell foi adicionado ao seu ambiente escolhido, é altura de experimentar uma consulta simples do Resource Graph. A consulta devolverá os cinco primeiros recursos do Azure com o **Nome** e **Tipo de Recurso** de cada recurso.
