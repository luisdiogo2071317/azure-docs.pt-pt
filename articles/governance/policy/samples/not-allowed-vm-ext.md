---
title: Exemplo do Azure Policy – Tipos de extensões de VM não permitidos
description: Esta política de exemplo proíbe a utilização de extensões especificadas.
