---
title: Exemplo do Azure Policy – múltiplos padrões de nome
description: Esta política de exemplo requer que o recurso corresponda a um dos padrões de nome disponibilizado.
...
ms.locfileid: "46975960"
---
# <a name="allow-multiple-name-patterns"></a>Permitir múltiplos padrões de nome

Permita que um dos muitos padrões de nomes seja utilizado para recursos. Especifica os padrões de nome permitidos na regra de política.
