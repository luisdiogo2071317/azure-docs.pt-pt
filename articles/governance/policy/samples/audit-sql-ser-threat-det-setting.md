---
title: Exemplo do Azure Policy – Auditar a definição de deteção de ameaças do nível do servidor
description: Esta política de exemplo faz uma auditoria às políticas de alerta de segurança da base de dados SQL se as políticas não estiverem definidas para o estado especificado.
