---
title: Exemplo do Azure Policy – Auditar se a extensão não existir
description: Esta política de exemplo faz uma auditoria se uma extensão não estiver implementada numa máquina virtual.
