---
title: Exemplo do Azure Policy – SKUs de gateways de rede virtual permitidos
description: Esta política de exemplo exige que os gateways de rede virtual utilizem um tipo de SKU e gateway aprovados.
