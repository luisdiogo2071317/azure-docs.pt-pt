---
title: Exemplo do Azure Policy – Tipos de recursos permitidos
description: Este exemplo de política garante que apenas os tipos de recursos aprovados são implementados.
