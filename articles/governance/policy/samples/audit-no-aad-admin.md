...
description: Esta definição de política de exemplo audita quando não existe nenhum administrador do Azure Active Directory atribuído para o SQL server.
...
ms.locfileid: "56339656"
---
# <a name="sample---audit-no-azure-active-directory-administrator"></a>Exemplo - nenhum administrador do Azure Active Directory de auditoria
