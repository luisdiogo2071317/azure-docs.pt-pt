---
title: Exemplo - Certifique-se a encriptação de ficheiros de armazenamento
description: Esta definição de política de exemplo requer que se a encriptação de ficheiros está ativada para contas de armazenamento.
...
ms.locfileid: "56339690"
---
# <a name="sample---ensure-storage-file-encryption"></a>Exemplo - Certifique-se a encriptação de ficheiros de armazenamento
