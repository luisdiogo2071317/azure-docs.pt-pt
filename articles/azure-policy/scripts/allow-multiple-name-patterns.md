---
title: Exemplo de json do Azure Policy – Múltiplos padrões de nome | Microsoft Docs
description: Esta política de exemplo de json requer que o recurso corresponda a um dos padrões de nome fornecido.
