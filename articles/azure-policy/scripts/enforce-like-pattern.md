---
title: Exemplo de json do Azure Policy – Impor padrão like | Microsoft Docs
description: Esta política de exemplo de json requer que os recursos cumpram o padrão like para convenções de nomenclatura.
