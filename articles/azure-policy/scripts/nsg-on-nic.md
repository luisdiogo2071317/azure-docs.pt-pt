---
title: Exemplo de json do Azure Policy – NSG x em cada NIC | Microsoft Docs
description: Esta polícia de exemplo de json requer a utilização de um grupo de segurança de rede específico em cada interface de rede virtual.
