---
title: Exemplo de json do Azure Policy – Auditar a definição de auditoria do nível do SQL Server | Microsoft Docs
description: Esta política de exemplo de json faz uma auditoria das definições de auditoria do SQL Server se essas definições não corresponderem a uma definição especificada.
