---
title: Exemplo de json do Azure Policy – Extensões de VM não permitidas | Microsoft Docs
description: Esta política de exemplo de json proíbe a utilização de extensões especificadas.
...
ms.locfileid: "34602089"
---
# <a name="not-allowed-vm-extensions"></a>Extensões de VM não permitidas
