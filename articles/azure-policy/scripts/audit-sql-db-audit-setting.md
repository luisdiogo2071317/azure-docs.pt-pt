---
title: Exemplo de json do Azure Policy – Auditar a definição de auditoria do nível de BD SQL| Microsoft Docs
description: Esta política de exemplo de json faz uma auditoria das definições de auditoria da base de dados SQL se essas definições não corresponderem a uma definição especificada.
...
ms.locfileid: "32154795"
---
# <a name="audit-sql-db-level-audit-setting"></a>Auditar a definição de auditoria do nível de BD SQL

Esta política faz uma auditoria das definições de auditoria da base de dados SQL se essas definições não corresponderem a uma definição especificada. Especifica um valor que indica se as definições de auditoria devem estar ativadas ou desativadas.
