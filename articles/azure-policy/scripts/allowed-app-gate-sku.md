---
title: Exemplo de json do Azure Policy – SKUs de gateways de aplicação permitidos | Microsoft Docs
description: Esta política de exemplo de json requer que os gateways de aplicação utilizem um SKU aprovado.
