...
description: Esta política requer que sejam implementadas apenas imagens personalizadas aprovadas no seu ambiente.
...
Neste parâmetro de exemplo, apenas o _ContosoStdImage_ no grupo de recursos _YourResourceGroup_ ou a versão da imagem de Maio de 2018 do Windows Server 2016 Datacenter localizado em "EUA Central" será permitida.
...
[![Implementar no Azure](../media/deploy/deploybutton.png)](https://portal.azure.com/?#blade/Microsoft_Azure_Policy/CreatePolicyDefinitionBlade/uri/https%3A%2F%2Fraw.githubusercontent.com%2FAzure%2Fazure-policy%2Fmaster%2Fsamples%2FCompute%2Fallowed-custom-images%2Fazurepolicy.json)
[![Implementar no Azure Gov](../media/deploy/deployGovbutton.png)](https://portal.azure.us/?#blade/Microsoft_Azure_Policy/CreatePolicyDefinitionBlade/uri/https%3A%2F%2Fraw.githubusercontent.com%2FAzure%2Fazure-policy%2Fmaster%2Fsamples%2FCompute%2Fallowed-custom-images%2Fazurepolicy.json)
...
| [Get-AzureRmResourceGroup](/powershell/module/azurerm.resources/get-azurermresourcegroup) | Obtém um grupo de recursos único. |
| [New-AzureRmPolicyAssignment](/powershell/module/azurerm.resources/new-azurermpolicyassignment) | Cria uma nova atribuição do Azure Policy. Neste exemplo, damos uma definição, mas também pode tomar iniciativa. |
| [Remove-AzureRmPolicyAssignment](/powershell/module/azurerm.resources/remove-azurermpolicyassignment) | Remove uma atribuição do Azure Policy existente. |
| [Remove-AzureRmPolicyDefinition](/powershell/module/azurerm.resources/remove-azurermpolicydefinition) | Remove uma definição do Azure Policy existente. |
...
- Reveja os [exemplos do Azure Policy](../json-samples.md) adicionais
- Reveja a [estrutura de definição do Azure Policy](../policy-definition.md)
- Veja os exemplos do Azure Policy para Máquinas Virtuais em [Aplicar políticas a VMs do Windows](../../virtual-machines/windows/policy.md)