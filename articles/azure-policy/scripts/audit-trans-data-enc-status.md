---
title: Exemplo de json do Azure Policy – Auditar o estado de encriptação de dados transparente | Microsoft Docs
description: Esta política de exemplo de json faz uma auditoria se a encriptação de dados transparente da base de dados SQL não tiver ativada.
...
ms.locfileid: "34602283"
---
# <a name="audit-transparent-data-encryption-status"></a>Auditar o estado de encriptação de dados transparente

Esta política faz uma auditoria se a encriptação de dados transparente da base de dados SQL não tiver ativada.
