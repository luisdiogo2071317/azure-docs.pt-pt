---
title: Exemplo de json do Azure Policy – Requerer a encriptação de ficheiros de armazenamento | Microsoft Docs
description: Esta política de exemplo de json requer que a conta de armazenamento utilize a encriptação de blobs.
