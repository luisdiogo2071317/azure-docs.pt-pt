---
title: Exemplo de json do Azure Policy – Permitir uma imagem de VM personalizada de um grupo de recursos | Microsoft Docs
description: Esta política de exemplo de json requer que as imagens personalizadas sejam provenientes de um grupo de recursos aprovado.
...
Esta política de exemplo de json requer que as imagens personalizadas sejam provenientes de um grupo de recursos aprovado. Especifica o nome do grupo de recursos aprovado.
...
Pode ver exemplos de modelos do Azure Policy adicionais na documentação do Azure Policy
