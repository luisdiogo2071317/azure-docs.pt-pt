---
title: Exemplo de json do Azure Policy – Tipos de recursos permitidos | Microsoft Docs
description: Esta política de exemplo de json assegura que apenas os tipos de recursos aprovados são implementados.
