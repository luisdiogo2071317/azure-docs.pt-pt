---
title: Exemplo de json do Azure Policy – Auditar a encriptação de dados transparente da Base de Dados SQL | Microsoft Docs
description: Esta política de exemplo de json fará uma auditoria se a base de dados SQL não tiver a encriptação de dados transparente ativada.
