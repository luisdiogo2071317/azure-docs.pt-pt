---
title: Exemplo de jason do Azure Policy – Negar o benefício de utilização híbrida | Microsoft Docs
description: Esta política de exemplo de json proíbe a utilização do Benefício de Utilização Híbrida do Azure (AHUB).
