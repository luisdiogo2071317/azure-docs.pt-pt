---
title: Exemplo de json do Azure Policy – Aplicar etiqueta e o respetivo valor predefinido | Microsoft Docs
description: Esta política de exemplo de json acrescenta um nome de etiqueta e um valor especificado, se essa etiqueta não for fornecida.
