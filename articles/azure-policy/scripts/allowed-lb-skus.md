---
title: Exemplo de json do Azure Policy – SKUs de balanceadores de carga permitidos | Microsoft Docs
description: Esta política de exemplo de json requer que os balanceadores de carga utilizem um SKU aprovado.
