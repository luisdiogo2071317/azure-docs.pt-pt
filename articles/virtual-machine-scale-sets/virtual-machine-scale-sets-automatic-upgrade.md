...
O exemplo seguinte utiliza a CLI do Azure (2.0.47 ou posterior) para configurar as atualizações automáticas para o conjunto nomeado de dimensionamento *myVMSS* no grupo de recursos com o nome *myResourceGroup*:
...
```
Suporte para configurar esta propriedade através do PowerShell do Azure será lançado em breve.
...
O exemplo seguinte utiliza a CLI do Azure (2.0.47 ou posterior) para verificar o estado para o conjunto nomeado de dimensionamento *myVMSS* no grupo de recursos com o nome *myResourceGroup*:
