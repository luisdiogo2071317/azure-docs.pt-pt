---
title: Exemplos da CLI 2.0 do Azure | Microsoft Docs
...
ms.locfileid: "30246394"
---
# <a name="azure-cli-20-samples-for-virtual-machine-scale-sets"></a>Exemplos da CLI 2.0 do Azure para conjuntos de dimensionamento de máquinas virtuais

A tabela seguinte inclui ligações para scripts bash criados com a CLI 2.0 do Azure.
...
| [Criar um conjunto de dimensionamento com redundância de zona](scripts/cli-sample-zone-redundant-scale-set.md?toc=%2fcli%2fazure%2ftoc.json) | Cria um dimensionamento de máquina virtual em várias Zonas de Disponibilidade. |
| | |