...
ms.locfileid: "55982238"
---
# <a name="create-a-single-zone-virtual-machine-scale-set-with-the-azure-cli"></a>Criar um máquina virtual de zona única conjunto de dimensionamento com a CLI do Azure
