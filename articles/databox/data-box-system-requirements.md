...
Seu centro de dados tem de ter a rede de alta velocidade. Recomendamos vivamente que tem pelo menos uma ligação de 10 GbE. Se não estiver disponível uma ligação de GbE 10, uma ligação de dados 1 GbE pode ser usada para copiar dados, mas as velocidades de cópia são afetadas.
