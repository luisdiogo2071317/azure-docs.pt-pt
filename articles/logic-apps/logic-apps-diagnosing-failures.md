...
description: Compreender como e por que não obedeçam a aplicações lógicas
services: logic-apps
documentationcenter: ''
author: jeffhollan
manager: jeconnoc
...
---
# <a name="troubleshoot-and-diagnose-logic-app-failures"></a>Solucionar problemas e diagnosticar falhas de aplicação lógica
