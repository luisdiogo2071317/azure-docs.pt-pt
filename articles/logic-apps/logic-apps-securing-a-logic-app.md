...
1. No portal do Azure, abra a aplicação lógica que pretende adicionar restrições de endereço IP
2. Clique em de **configuração de controlo de acesso** item de menu em **definições**
3. Especifique a lista de intervalos de endereços IP para acesso ao conteúdo
