...
description: Como utilizar o Decodificador ou codificador de ficheiro de arquivo no Enterprise Integration Pack nas suas aplicações lógicas
services: logic-apps
