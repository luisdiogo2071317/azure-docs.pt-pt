...
| isTechnicalAcknowledgmentExpected | Booleano | Indica se a confirmação técnica está configurada no X12 contrato. (Obrigatório) |
| isFunctionalAcknowledgmentExpected | Booleano | Indica se a confirmação funcional está configurada no X12 contrato. (Obrigatório) |
| needAk2LoopForValidMessages | Booleano | Indica se o ciclo de AK2 é necessário para uma mensagem válida. (Obrigatório) |
...
| statusCode | Booleano | Transação definida código de estado de confirmação. (Obrigatório) |
