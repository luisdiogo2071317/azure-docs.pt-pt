...
* [O que é o acesso a aplicações e início de sessão único com o Azure Active Directory?](../active-directory/manage-apps/what-is-single-sign-on.md)
...
A abordagem da Microsoft para identidade abrange no local e a cloud, criação de uma única identidade de utilizador para autenticação e autorização para todos os recursos, independentemente da localização.
