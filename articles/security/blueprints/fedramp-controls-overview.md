...
| [MP](fedramp-media-protection-controls.md ) | Proteção de suporte de dados |
...
| [PL](fedramp-planning-controls.md ) | Planeamento |
| [RA](fedramp-risk-assessment-controls.md ) | Avaliação de riscos |
| [CA](fedramp-security-assessment-authorization-controls.md ) | Avaliação de segurança e autorização |
| [SC](fedramp-system-communications-protection-controls.md ) | Proteção de comunicações e de sistema |
| [SI](fedramp-system-information-integrity-controls.md ) | Sistema e informações de integridade |
