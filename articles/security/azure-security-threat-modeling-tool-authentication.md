...
| **Tecnologias aplicáveis** | Genérico, o .NET Framework 3 |
| **Atributos**              | Tipo de credencial de cliente - None |
| **Referências**              | [MSDN](https://msdn.microsoft.com/library/ff648500.aspx), [Reforçamos](https://vulncat.hpefod.com/en/detail?id=desc.semantic.dotnet.wcf_misconfiguration_anonymous_transport_client) |
