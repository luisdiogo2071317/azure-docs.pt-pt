...
3. Introduza o `Connect-AzureRmAccount` comando. Na janela do início de sessão, introduza as informações de credenciais para a subscrição que irá utilizar para este tutorial.
