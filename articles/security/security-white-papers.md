...
|[As funções do Azure e segurança da plataforma sem servidor](https://gallery.technet.microsoft.com/Azure-Functions-and-c6449f8d/file/202175/1/Microsoft%20Serverless%20Platform.pdf)|Este documento técnico transferível abrange os benefícios da informática sem servidor ao fornecer considerações de segurança e atenuações no contexto do Azure. | 
