...
## <a name="list-all-azure-cache-for-rediss-within-your-subscription-or-resource-group"></a>Lista de todo o Cache do Azure para Rediss dentro da sua subscrição ou grupo de recursos
Para listar todos os Azure Cache para Rediss dentro da sua subscrição ou grupo de recursos, utilize o seguinte comando:
