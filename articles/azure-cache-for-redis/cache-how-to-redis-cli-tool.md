...
Se quiser executar a ferramenta da linha de comandos em outra plataforma, Baixe o Cache do Azure para Redis a partir da [ http://redis.io/download ](https://redis.io/download).
