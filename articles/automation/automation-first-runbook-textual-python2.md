...
3. Atribua ao runbook o nome *MyFirstRunbook-Python*.
4. Neste caso, vai criar um [Python runbook](automation-runbook-types.md#python-runbooks) , por isso, selecione **Python 2** para **tipo de Runbook**.
