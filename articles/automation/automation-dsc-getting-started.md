...
Criar uma simples [configuração DSC](/powershell/dsc/configurations) que garante a presença ou ausência de **servidor Web** Windows funcionalidade (IIS), dependendo de como pode designar nós.
...
1. No **conta de automatização** página, selecione **configurações de DSC** em **gestão de configuração**.
1. No **configurações de DSC** página, clique em **+ adicionar uma configuração**.
1. No **importar a configuração** página, navegue para o `TestConfig.ps1` ficheiros no seu computador.
...
1. No lado esquerdo, clique em **todos os recursos** e, em seguida, o nome da sua conta de automatização.
1. No **conta de automatização** página, selecione **configurações de DSC** em **gestão de configuração**.
1. No **configurações de DSC** página, clique em **TestConfig** (este é o nome da configuração que importou no procedimento anterior).
1. No **TestConfig configuração** página, clique em **origem de configuração de vista**.
...
1. No **conta de automatização** página, clique em **configurações de DSC** em **gestão de configuração**.
1. No **configurações de DSC** página, clique em **TestConfig** (o nome da configuração importado anteriormente).
1. Em **tarefas de compilação**, selecione a tarefa de compilação que pretende visualizar. A **tarefa de compilação** página se abre, com a etiqueta com a data em que a tarefa de compilação foi iniciada.
...
1. No **conta de automatização** painel, clique em **configurações de nó DSC**.
...
1. Inicie sessão no [portal do Azure](https://portal.azure.com).
1. No lado esquerdo, clique em **todos os recursos** e, em seguida, o nome da sua conta de automatização.
1. No **conta de automatização** página, clique em **nós de DSC** em **gestão de configuração**.
1. No **nós de DSC** página, clique em **adicionar a VM do Azure**.
...
1. Na página de máquinas virtuais, selecione a VM. **Adicionar VMs do Azure** página, clique em **selecionar máquinas virtuais para carregar**.
1. Clique em **Ligar**.
...
1. No **adicionar VMs do Azure** painel, clique em **criar**.
