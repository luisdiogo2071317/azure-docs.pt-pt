...
1.  Ative a solução "Worker híbrido de automatização" no Azure. Isto pode ser feito ao:
   ...
   1. Adicionar o **automatização de trabalho híbrida** solução à sua subscrição utilizando o procedimento em [soluções de gestão de análise de registos de adicionar a sua área de trabalho](https://docs.microsoft.com/en-us/azure/log-analytics/log-analytics-add-solutions).
