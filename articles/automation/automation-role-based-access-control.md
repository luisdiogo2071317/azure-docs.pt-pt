...
> [!NOTE]
> Não defina a função de operador de automatização, a menos que pretende conceder um operador a capacidade de gerir as tarefas de todos os runbooks na conta.
