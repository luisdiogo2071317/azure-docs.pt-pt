...
A atividade seguinte, Connect-AzureRmAccount, adiciona autenticada conta Run as para utilização no runbook.<br>
![Conjunto de parâmetros de ligação-AzureRmAccount](media/automation-graphical-authoring-intro/authenticate-conn-to-azure-parameter-set.png)<br>
...
Dados criados por qualquer atividade que não tem uma ligação de saída são o [saída do runbook](http://msdn.microsoft.com/library/azure/dn879148.aspx). O resultado é guardado com a tarefa de runbook e está disponível para um runbook principal quando o runbook é utilizado como elemento subordinado.
