...
Testamos e publicamos o runbook, mas até ao momento, não faz nada de útil. Pretende que efetue a gestão de recursos do Azure. Será possível fazê-lo embora, a menos que tenha seja autenticado utilizando as credenciais referidas na [pré-requisitos](#prerequisites). Pode fazê-lo com o **Add-AzureRMAccount** cmdlet.
