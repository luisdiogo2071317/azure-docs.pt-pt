...
4. Clique com o botão direito do rato no cmdlet para inserir e selecione **adicionar à tela**. Se o cmdlet tem mais do que um parâmetro definido, em seguida, o conjunto padrão será adicionado. Também pode expandir o cmdlet para selecionar um conjunto de parâmetros diferentes.
...
4. Clique com o botão direito do rato no elemento para inserir e selecione **adicionar à tela**. Para [recursos de variável](automation-variables.md), selecione **adicionar "Obter variável" à tela** ou **adicionar "Definir variável" à tela** dependendo se pretende obter ou definir a variável.
...
Comandos de exemplo seguintes mostram como substituir o conteúdo existente de um runbook com o conteúdo de um ficheiro de script. Tenha em atenção que este é o mesmo procedimento de exemplo como na [para importar um runbook a partir de um ficheiro de script com o Windows PowerShell](automation-creating-importing-runbook.md).
