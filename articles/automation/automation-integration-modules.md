...
Se tiver implementado o Service Management Automation e criado pacotes de módulos de integração para os runbooks de automatização, este deverá ter um aspeto familiar. 
