...
Com baseada em funções controlo de acesso (RBAC), é possível definir acesso para utilizadores, grupos e principais de serviço através da atribuição de funções num determinado âmbito. Este artigo descreve como gerir o acesso com o Azure PowerShell.
...
![Captura de ecrã do RBAC PowerShell-Get AzureRmRoleDefinition-](./media/role-assignments-powershell/1-get-azure-rm-role-definition1.png)
...
![Captura de ecrã do RBAC PowerShell-Get AzureRmRoleDefinition para uma função específica-](./media/role-assignments-powershell/1-get-azure-rm-role-definition2.png)
...
![Captura de ecrã do RBAC PowerShell-Get AzureRmRoleAssignment para um grupo de recursos-](./media/role-assignments-powershell/4-get-azure-rm-role-assignment1.png)
...
![Captura de ecrã do RBAC PowerShell-Get AzureRmRoleAssignment para um utilizador-](./media/role-assignments-powershell/4-get-azure-rm-role-assignment2.png)
...
![Captura de ecrã do RBAC PowerShell - novo AzureRmRoleAssignment-](./media/role-assignments-powershell/2-new-azure-rm-role-assignment2.png)
...
![Captura de ecrã do RBAC PowerShell - novo AzureRmRoleAssignment-](./media/role-assignments-powershell/2-new-azure-rm-role-assignment3.png)
...
![Captura de ecrã do RBAC PowerShell - novo AzureRmRoleAssignment-](./media/role-assignments-powershell/2-new-azure-rm-role-assignment4.png)
...
![Captura de ecrã do RBAC PowerShell-Remove AzureRmRoleAssignment-](./media/role-assignments-powershell/3-remove-azure-rm-role-assignment.png)
...
Quando utilizar o PowerShell para criar uma função personalizada, pode começar do zero ou utilize um do [funções incorporadas](built-in-roles.md) como um ponto de partida. O exemplo nesta secção começa com uma função incorporada e, em seguida, customizes-lo com mais privilégios. Editar os atributos para adicionar o *ações*, *notActions*, ou *âmbitos* que pretende e, em seguida, guarde as alterações como uma nova função.
...
![Captura de ecrã do RBAC PowerShell-Get AzureRmRoleDefinition-](./media/role-assignments-powershell/2-new-azurermroledefinition.png)
...
![Captura de ecrã do RBAC PowerShell - Set-AzureRmRoleDefinition-](./media/role-assignments-powershell/3-set-azurermroledefinition-1.png)
...
![Captura de ecrã do RBAC PowerShell - Set-AzureRmRoleDefinition-](./media/role-assignments-powershell/3-set-azurermroledefinition-2.png)
...
![Captura de ecrã do RBAC PowerShell - Remove-AzureRmRoleDefinition-](./media/role-assignments-powershell/4-remove-azurermroledefinition.png)
...
![Captura de ecrã do RBAC PowerShell-Get AzureRmRoleDefinition-](./media/role-assignments-powershell/5-get-azurermroledefinition-1.png)
...
![Captura de ecrã do RBAC PowerShell-Get AzureRmRoleDefinition-](./media/role-assignments-powershell/5-get-azurermroledefinition2.png)
