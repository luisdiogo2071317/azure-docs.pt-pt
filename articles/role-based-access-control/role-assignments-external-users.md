...
![captura de ecrã da função personalizada importada no portal do Azure](./media/role-assignments-external-users/18.png)

![captura de ecrã de atribuição de função importada personalizada ao utilizador no mesmo diretório](./media/role-assignments-external-users/19.png)

![captura de ecrã de permissões de função importada personalizada](./media/role-assignments-external-users/20.png)

Os utilizadores com esta função personalizada, agora podem criar novos pedidos de suporte.

![captura de ecrã da função personalizada criar pedidos de suporte](./media/role-assignments-external-users/21.png)
...
![captura de ecrã da função personalizada não é possível criar VMs](./media/role-assignments-external-users/22.png)

![captura de ecrã da função personalizada não é possível criar o novo RGs](./media/role-assignments-external-users/23.png)
...
![Captura de ecrã portal do Azure de função personalizada que criou com a CLI 1.0](./media/role-assignments-external-users/26.png)
