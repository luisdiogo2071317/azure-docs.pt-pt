...
|||
|---|---|
| [Relação entre inquilinos do Azure AD e subscrições](rbac-and-directory-admin-roles.md) | Saiba mais sobre como do Azure AD é a origem de fidedigna dos utilizadores e grupos para uma subscrição do Azure. |
| [Controlo de acesso baseado em funções (RBAC)](overview.md) | Oferece gestão de acesso detalhada através de funções atribuídas a utilizadores, grupos ou principais de serviço. |
...
| [Identidade de serviço geridas (MSI)](../active-directory/pp/msi-overview.md) | Fornecer recursos do Azure como máquinas virtuais às suas próprias identidades, para que não tem de colocar as credenciais no seu código. |
