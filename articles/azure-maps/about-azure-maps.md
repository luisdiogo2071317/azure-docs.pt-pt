...
| Fase de desenvolvimento  | O Azure Maps está otimizado para a fase inicial de testes e desenvolvimento de uma Prova de Conceito | É preciso um SLA de nível empresarial para um ambiente de produção |
