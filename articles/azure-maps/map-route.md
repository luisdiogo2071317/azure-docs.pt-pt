...
Existem duas formas de fazer isso, é uma forma consultando o [API de rota do Azure Maps](https://docs.microsoft.com/rest/api/maps/route/getroutedirections) através de um serviço de módulo e o outro está fazendo uma [XMLHttpRequest](https://xhr.spec.whatwg.org/) para a API. Ambos são abordadas abaixo.

## <a name="querying-the-route-via-service-module"></a>Consultar a rota através do módulo de serviço
...
## <a name="querying-the-route-via-xmlhttprequest"></a>Consultar a rota via XMLHttpRequest
