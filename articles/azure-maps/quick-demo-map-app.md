...
5. Mova o rato sobre a lista de endereços/localizações apresentados abaixo da caixa de pesquisa e repare como o pin correspondente no mapa faz aparecer informações sobre essa localização. Por motivos de privacidade das empresas privadas, são apresentados nomes e endereços fictícios.
