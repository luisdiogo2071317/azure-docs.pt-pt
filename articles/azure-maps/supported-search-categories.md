---
title: Categorias de pesquisa do Azure Maps | Documentos da Microsoft
description: Saiba mais sobre as categorias de pesquisa no Azure Maps
author: sataneja
ms.author: sataneja
ms.date: 05/14/2018
ms.topic: conceptual
...
Ao efetuar uma [pesquisa de categoria](https://docs.microsoft.com/rest/api/maps/search/getsearchpoicategory) para pontos de interesse, há mais uma centena de categorias suportadas. Segue-se uma lista dos códigos de categoria para nomes de categoria com suporte. Códigos de categoria são gerados para categorias de nível superior. Todas as sub-categorias de partilhar o mesmo código de categoria. Tenha em atenção que esta lista de categorias está sujeitas a alterações com as novas versões de dados.

<br/>

| **Código de categoria** | **Categorias de correspondência de código** |
| --- | --- |
| ACESSO\_GATEWAY | acesso de companhia aérea, o Portão de segurança, o acesso de estação, o gateway de acesso |
| ADMINISTRATIVAS\_DIVISÃO | província, divisão administrativa da ordem de quarto, divisão administrativa da primeira, histórico terceira ordem divisão administrativa, posto de trabalho de uma divisão administrativa quarto ordem, posto de trabalho de uma divisão administrativa de segunda ordem, dependente de política entidade, preenchida lugar, de usuários de uma divisão administrativa de terceira ordem, locais preenchidas, divisão administrativa de segunda ordem, posto de trabalho de uma ordem de primeiro administrativa divisão, divisão administrativa, preenchido localidade, região histórico, histórico site, histórico lugar preenchida, liquidação israelita Adota, histórico divisão administrativa de ordem de quarta, quinta-order divisão administrativa, histórico divisão administrativa de primeira, terceira ordem divisão administrativa histórico políticos entidade, divisão administrativa histórico, posto de trabalho do Governo de uma entidade política, histórico divisão administrativa de segunda ordem, capital de uma entidade de política |
| ADVENTURE\_DESPORTO\_NA LOCALIZAÇÃO | na localização de desportos Adventure |
| AGRICULTURA | horticulture, produtor primário, agricultura, farm, village de farm, farmstead, homestead, grazing área, comum, o recurso de aquaculture, farms de servidores, área de pesca, dairy, campo (s) |
| AEROPORTO | autoridade privada, militar autoridade, heliport, aeroporto fechado, médio, grande aeroporto, aeroporto pequeno, airfield, seaplane base, autoridade pública, porta de balão, aeroporto |
| INGRESSO\_PARK | arcade de entretenimento, local de entretenimento, entretenimento park |
| AUTOMÓVEL\_DEALER | ATV/snowmobile, barco, barramento, motociclo, camião, van, veículos recreational, carro, dealer automóvel |
| BANCÁRIA | banco, bancos, bank(s) |
| PRAIA | praia, praias |
| CRIAÇÃO DE\_PONTO | criar (ponto) |
| NEGÓCIOS\_PARK | parque de negócios, industrial área |
| CAFE\_PUB | cybercafé, casa de chá, café, cybercafé, café, café, garden microbrewery/cerveja, pub, café/pub, café/pub |
| ACAMPAR\_ZERO | site de caravan Recreational, acampar zero |
| CARRO\_WASH | carro wash |
| PAGAMENTO À VISTA\_FORNECEDOR | automático caixas eletrônicos, o fornecedor de pagamento à vista |
| CASINO | casino |
...
| DEPARTAMENTO\_STORE | arquivo de departamento |
| DOUTOR | praticante, especialista, o doutor |
| ELECTRIC\_VEÍCULO\_ESTAÇÃO | estação de veículos Electric |
| EMBASSY | embassy |
| EMERGÊNCIA\_MÉDICOS\_SERVIÇO | serviço de médico de emergência |
| ENTRETENIMENTO | entretenimento |
| EXCHANGE | Gold exchange, câmbio de moedas, bolsa de valores, exchange |
| SALÃO DE EXIBIÇÃO\_CONVENÇÃO\_CENTER | Centro salão de exibição |
| FERRY\_TERMINAL | ferry, ferry terminal |
| FIRE\_ESTAÇÃO\_BRIGADE | estação de fogo/brigade |
| FRONTIER\_CRUZAR | cruzamento de frontier |
| COMBUSTÍVEL\_INSTALAÇÕES | instalações de combustível |
| GEOGRÁFICA\_FUNCIONALIDADE | Baía, cove, pan, Localidade, ridge, frequente/mineral springs, bem, reservatórios, marsh/pântano/vlei, quarry, cruzamento de rio, valley, pico das regiões montanhosas, Kingman, Dunas, lagoa, sem formatação/fixa, rapids, cabo, patamar, oasis, porto, cave, rocks, funcionalidade geográfica, promontory(-ies), Ilhas, headland, pier, crater lake, cliff(s), hill, gobi, portage, glacier(s), gully, geyser, coral reef(s), lacuna, longa distância, jetty, ghat, buraco, crater lakes, o campo de gás, islet, crater(s), cove(s), grassland, gravel área, zona fratura, de integridade, gorge(s), ilha, headwaters, desligar-se de silício, hills, hot spring(s), furrow, anabranch |
| GOLFE\_CURSO | curso de golfe |
| GOVERNO\_OFFICE | Ordenar 5 área de área de ordem 8, área de ordem 9, área de encomenda 2 área ordem 7, área de ordem 3, supra national, área de ordem 4, solicite 6 área, government office, recurso diplomatic, estabelecimento de administração pública dos Estados Unidos, office de Governo local, consultarei casa, consultarei post |
| ESTADO DE FUNCIONAMENTO\_CUIDADO\_SERVIÇO | banco de sangue, serviço de pessoal, instalações de cuidados de saúde pessoais, unidade ambulance, serviço dos cuidados de saúde, leprosarium, sanatorium, hospital, medical center, clínica |
| HELIPAD\_HELICOPTER\_DE DESTINO | helipad/helicopter de destino |
| FERIADO\_ALUGUEL | bungalow, cottage, chalet, villa, apartment, aluguel de feriado |
| HOSPITAL\_POLYCLINIC | hospital especial, de chinês medicina, hospital para mulheres crianças, geral, hospital/polyclinic |
| HOTEL\_HOTEL | cabins lodges, convidado de café da manhã usado como plataforma hospeda, hotel, os campos de rest, hotel, recurso, hostel, hotel/hotel, resthouse, hammock(s), casa de convidado |
| ICE\_PATINANDO\_RINK | ICE patinando rink |
| IMPORTANTE\_TOURIST\_ATTRACTION | criação de, observatory, arch, túnel, escultura, tower, ponte, planetarium, mausoleum/grave, monumentos, buraco de água, da atração natural, da atração de tourist importante, promenade, pirâmides, pagoda, castle, palace, hermitage, pirâmide, fort, porta de casa de país , dam, lighthouse, graves |
| INDUSTRIAL\_MODULARES | Foundry, depot de combustível, criando industrial, fábrica |
| QUANDO QUISER\_CENTER | boliche, snooker, billiard de agrupamento, a entrego clubes, dança studio escola, sauna, ajustamos solarium, center como quiser, spa |
| BIBLIOTECA | biblioteca |
| FABRICO\_INSTALAÇÕES | instalação de fabrico |
| MARINA | yacht basin, marina |
| MERCADO | supermarkets hypermarkets, agricultores, mercado público, informal, |
| SUPORTE DE DADOS\_INSTALAÇÕES | recurso de multimédia |
...
| COMPRAS\_CENTER | Centro comercial, o Centro de compras |
...
| TRÁFEGO\_SERVIÇO\_CENTER | departamento de controle de tráfego, o Centro de atendimento de tráfego |
| TRÁFEGO\_INÍCIO DE SESSÃO | início de sessão de tráfego |
| INÍCIO\_SISTEMA | Adventure veículo, show de rock sobe, de seqüestro de Tróia, bicicletas de montanha, caminhar, sistema de início |
| TRANSPORTE\_VEÍCULO DE AUTORIDADE\_REGISTO | registo de autoridade/veículos de transporte |
| CAMIÃO\_PARAR | camião stop |
| VETERINARIAN | recurso Veterinary, veterinarian |
| ÁGUA\_DESPORTO | desporto de água |
