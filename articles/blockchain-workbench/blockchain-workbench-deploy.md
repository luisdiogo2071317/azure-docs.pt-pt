...
2. Gere um GUID. Pode gerar um GUID utilizando o comando PowerShell [guid]:: NewGuid () ou o cmdlet New-GUID. Outra opção consiste em utilizar um Web site gerador GUID.
