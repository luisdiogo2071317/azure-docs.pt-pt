---
title: Blockchain Workbench mensagens integração descrição geral do Azure
...
ms.locfileid: "34607605"
---
# <a name="azure-blockchain-workbench-messaging-integration"></a>Azure Blockchain Workbench, integração de mensagens
...
### <a name="consuming-event-grid-events-with-azure-functions"></a>Consumo de grelha de eventos de eventos com as funções do Azure
...
### <a name="consuming-event-grid-events-with-logic-apps"></a>Consumo de grelha de eventos de eventos com as Logic Apps
...
Consoante o **OperationName**, as mensagens de notificação de ter um dos seguintes tipos de mensagem.
...
| ChainIdentifier | Endereço do utilizador que foi criado na rede blockchain. Ethereum, isto seria o utilizador **na cadeia** endereço. |
...
## <a name="classes-used-by-message-types"></a>Classes utilizadas pelos tipos de mensagem
