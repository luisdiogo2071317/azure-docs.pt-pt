...
## [Cenários de DNS privado](private-dns-scenarios.md)
## [Métricas e alertas de DNS](dns-alerts-metrics.md)
...
### [CLI do Azure](private-dns-getstarted-cli.md)
...
# Referência
## [Exemplos de código](https://azure.microsoft.com/resources/samples/?service=dns)
