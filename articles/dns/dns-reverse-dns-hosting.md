...
Este artigo orienta-o pelos passos para criar sua primeira zona DNS de pesquisa inversa e registar com o portal do Azure, o Azure PowerShell, a CLI 1.0 do Azure ou a CLI 2.0 do Azure.
