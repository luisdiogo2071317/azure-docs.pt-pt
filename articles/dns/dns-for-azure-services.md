...
| Gestor de Tráfego |Nome público |Só pode criar um CNAME que mapeia para o nome de trafficmanager.net atribuído ao perfil do Traffic Manager. Para obter mais informações, consulte [funciona como o Gestor de tráfego](../traffic-manager/traffic-manager-overview.md#traffic-manager-example). |
