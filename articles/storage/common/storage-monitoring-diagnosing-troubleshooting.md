...
* **ConditionNotMet** (não modificados 304), por exemplo a partir de uma operação condicional, tais como quando um cliente envia um **ETag** valor e um HTTP **If-None-Match** cabeçalho para pedir uma imagem apenas se tiver foi atualizado desde a última operação.
