...
Primeiro, crie uma conta de armazenamento, se ainda não tiver um. Para obter mais informações, consulte [criar uma conta de armazenamento](storage-quickstart-create-account.md).
