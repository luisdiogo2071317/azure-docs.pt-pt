...
## <a name="creating-the-export-job"></a>Criar a tarefa de exportação
 Para criar a tarefa de exportação, chamar o [colocar tarefa](/rest/api/storageimportexport/jobs#Jobs_CreateOrUpdate) operação. Terá de fornecer as seguintes informações:
