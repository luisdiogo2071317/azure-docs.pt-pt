...
2. Abra o Visual Studio e crie uma aplicação em branco (nativo portátil): **ficheiro > novo > projeto > Multiplataforma > App(Native Portable) em branco**.
