...
![Opções de criação rápida personalizada de criação de hdinsight](media/data-lake-storage-quickstart-create-connect-hdi-cluster/hdinsight-creation-options.png)
...
Embora uma instalação local do Hadoop utiliza o Hadoop Distributed File System (HDFS) para o armazenamento no cluster, na cloud é usar pontos de extremidade de armazenamento ligados ao cluster. Utilizam clusters do HDInsight [geração 2 de armazenamento do Data Lake](data-lake-storage-abfs-driver.md) ou [Blobs no armazenamento do Azure](../../hdinsight/hdinsight-hadoop-use-blob-storage.md). Utilizar o armazenamento do Azure ou o armazenamento do Data Lake, significa que pode eliminar em segurança os clusters do HDInsight utilizados para o cálculo ao mesmo tempo retendo os dados.
...
| Storm |Nó nimbus (2), servidor de supervisor (1 +), o nó do ZooKeeper (3) |![Nós de cluster do HDInsight Storm](media/data-lake-storage-quickstart-create-connect-hdi-cluster/hdinsight-storm-cluster-type-setup.png) |
| Spark |Nó principal (2), o nó de trabalho (1 +), nós ZooKeeper (3) (gratuito para o tamanho da VM de ZooKeeper A1) |![Nós de cluster do HDInsight Spark](media/data-lake-storage-quickstart-create-connect-hdi-cluster/hdinsight-spark-cluster-type-setup.png) |
