...
Disponibilidade para eventos de armazenamento está associada ao Event Grid [disponibilidade](../../event-grid/overview.md) e ficará disponível noutras regiões como o Event Grid. Dê uma olhada [eventos de armazenamento de BLOBs de rota para um personalizado da web endpoint - CLI](storage-blob-event-quickstart.md) ou [eventos de armazenamento de BLOBs de rota para um personalizado da web endpoint - PowerShell](storage-blob-event-quickstart-powershell.md) um exemplo rápido. 
