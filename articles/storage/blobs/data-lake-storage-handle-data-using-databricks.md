...
> * Crie uma conta de armazenamento de Blobs do Azure e um contentor no mesmo. Consulte [início rápido: Criar uma conta de armazenamento de Blobs do Azure](storage-quickstart-blobs-portal.md).
