...
Crie uma aplicação Ruby. Para obter instruções, consulte [Ruby na aplicação Rails Web numa VM do Azure](https://docs.microsoft.com/azure/app-service/containers/quickstart-ruby)
