---
title: "Adicionar as aplicações de lógica de conector de pesquisa do Bing | Microsoft Docs"
description: "Descrição geral do conector de pesquisa do Bing com parâmetros de REST API"
services: 
suite: 
documentationcenter: 
...
Ver todos os acionadores e ações definidas no swagger e consulte também os limites no [detalhes do conector](/connectors/bingsearch/).
