...
---
# <a name="frequently-asked-questions-for-iot-suite-remote-monitoring-preconfigured-solution"></a>Perguntas mais frequentes sobre a solução pré-configurada de monitorização remota do IoT Suite
