...
Se ainda não implementado simulação de dispositivo ainda, deve efetuar o [implementar simulação de dispositivo do Azure IoT](iot-suite-device-simulation-deploy.md) tutorial.
