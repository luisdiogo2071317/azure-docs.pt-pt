---
title: Ligar um Raspberry Pi com C com telemetria simulada do Azure IoT Suite | Documentos da Microsoft
description: Utilize o Microsoft Azure IoT Starter Kit para o Raspberry Pi 3 e Suite IoT do Azure. Utilizar C para ligar o seu Raspberry Pi a solução de monitorização remota, enviar telemetria simulada para a cloud e responder a métodos invocados a partir do dashboard da solução.
services: ''
suite: iot-suite
documentationcenter: ''
author: dominicbetts
...
ms.locfileid: "38635613"
---
# <a name="connect-your-raspberry-pi-3-to-the-remote-monitoring-solution-and-send-simulated-telemetry-using-c"></a>Ligar o seu Raspberry Pi 3 a solução de monitorização remota e enviar telemetria simulada com C
