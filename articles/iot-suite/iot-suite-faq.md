...
Consulte também o [específicos de fábrica ligado FAQ](iot-suite-faq-cf.md) e [FAQ de específicos de monitorização remota](iot-suite-faq-rm-v2.md) .
...
* [Explore as capacidades do acelerador de solução de monitorização remota](iot-suite-remote-monitoring-explore.md)
