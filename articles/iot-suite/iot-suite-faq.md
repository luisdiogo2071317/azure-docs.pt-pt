...
### <a name="what-sdks-can-i-use-to-develop-device-clients-for-the-preconfigured-solutions"></a>Os SDKs pode utilizar para desenvolver clientes de dispositivo para as soluções pré-configuradas
