...
1. Implementar um **básico** instância do acelerador de solução utilizando o **pcs** CLI. Anote o nome da sua implementação e as credenciais fornecidas para a máquina virtual. Para obter mais informações, consulte [implementar utilizando a CLI](iot-suite-remote-monitoring-deploy-cli.md).
...
![Esquema do painel de alteração](media/iot-suite-remote-monitoring-customize/layout.png)
...
![Gráfico de telemetria que mostra um dia](media/iot-suite-remote-monitoring-customize/telemetry-period.png)
...
![Aviso KPI](media/iot-suite-remote-monitoring-customize/new-kpi.png)
...
Para obter mais informações concetuais sobre o acelerador de solução de monitorização remota, consulte [arquitetura de monitorização remota](iot-suite-remote-monitoring-sample-walkthrough.md)

Para obter mais informações sobre como personalizar a solução de monitorização remota, consulte [personalizar e volte a implementar um microsserviço](iot-suite-microservices-example.md)
