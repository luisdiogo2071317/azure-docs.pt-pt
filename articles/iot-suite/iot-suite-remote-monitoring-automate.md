...
![Página de regras e ações](media/iot-suite-remote-monitoring-automate/rulesactions_v2.png)
...
![Ver detalhes da regra](media/iot-suite-remote-monitoring-automate/rulesactionsdetail_v2.png)

Para desativar, ativar ou eliminar uma ou mais regras, selecione várias regras na lista:

![Selecione várias regras](media/iot-suite-remote-monitoring-automate/rulesactionsmultiselect_v2.png)
...
![Criar regra de mult](media/iot-suite-remote-monitoring-automate/rulesactionsnewrule_mult_v2.png)
...
| Nível de Serverity  | Crítico                              |

Para adicionar a segunda condição, clique em "+ Adicionar condição".

![Criar a condição 2](media/iot-suite-remote-monitoring-automate/rulesactionsnewrule_mult_cond2_v2.png)
