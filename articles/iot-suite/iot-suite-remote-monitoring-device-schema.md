...
Para saber mais sobre o ficheiro de JavaScript que implementa o comportamento do dispositivo, consulte [compreender o comportamento de modelo do dispositivo](iot-suite-remote-monitoring-device-behavior.md).
...
Agora que aprendeu sobre o esquema JSON, o passo seguinte sugerido é saber como [implementa o comportamento do seu dispositivo simulado](iot-suite-remote-monitoring-device-behavior.md).
