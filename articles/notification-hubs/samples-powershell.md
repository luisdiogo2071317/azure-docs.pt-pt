...
| |  |
|---|---|
|[Criar um hub de notificação](scripts/create-notification-hub-powershell.md?toc=%2fpowershell%2fmodule%2ftoc.json)| Este script do PowerShell cria um hub de notificação de exemplo. |
