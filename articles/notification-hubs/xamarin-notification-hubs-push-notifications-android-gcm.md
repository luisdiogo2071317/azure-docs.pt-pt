...
## <a name="create-xamarinandroid-app-and-connect-it-to-notification-hub"></a>Criar uma aplicação Xamarin.Android e ligá-la ao hub de notificação
