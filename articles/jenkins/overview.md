...
Monitorizar e gerir a sua implementação do Azure Jenkins utilizando [Log Analytics](/azure/log-analytics/log-analytics-overview) e [CLI do Azure](/cli/azure).
