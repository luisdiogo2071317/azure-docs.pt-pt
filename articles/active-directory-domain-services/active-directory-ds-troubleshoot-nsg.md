...
> [!NOTE]
> Esta predefinição NSG não bloquear acesso para a porta utilizada para proteger o LDAP. Para bloquear o acesso de LDAP seguro através da internet, consulte [neste artigo](active-directory-ds-troubleshoot-ldaps.md).
>
