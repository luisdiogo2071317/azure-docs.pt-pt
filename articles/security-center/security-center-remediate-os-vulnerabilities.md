...
* Para mensagens de blogue acerca da segurança do Azure e de conformidade, veja [blogue de segurança do Azure](http://blogs.msdn.com/b/azuresecurity/).
