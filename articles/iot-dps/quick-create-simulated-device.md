...
---
# <a name="create-and-provision-a-simulated-device-using-iot-hub-device-provisioning-services"></a>Criar e aprovisionar um dispositivo simulado com os Serviços de Aprovisionamento de Dispositivos no Hub IoT
