---
title: Criar e registar a conta de editor | Documentos da Microsoft
...
## <a name="1-create-a-microsoft-account"></a>1. Criar uma conta Microsoft
Para iniciar o processo de publicação, terá de criar uma conta Microsoft. Esta conta vai ser utilizada para registar para ambos os **Microsoft Developer Center** e **Portal de publicação do Azure**. Deve ter apenas uma conta Microsoft para as ofertas do Azure Marketplace. Não deve ser específico para serviços ou ofertas.
...
> [!WARNING]
> Gostam de palavras **"Azure"** e **"Microsoft"** não são suportadas para o registo da conta Microsoft. Evite utilizar essas palavras para concluir a criação da conta e o processo de registo.
>
>
...
> [!NOTE]
> Traga a sua própria licença (BYOL) só é suportada para máquinas virtuais e é considerada uma **gratuita** oferta.
>
>
...
2. Aceda a [ http://dev.windows.com/registration?accountprogram=azure ](http://dev.windows.com/registration?accountprogram=azure) para registrar-se como um vendedor no Centro de desenvolvimento. Leia a observação importante a seguir antes de continuar.
   ...
   >
    ...
    ![desenho][img-signin]
3. Conclua o assistente "Ajude-na proteger a sua conta", que vai verificar se a sua identidade através do endereço de e-mail ou número de telefone.

    ![desenho][img-verify]
4. Na secção de "Informações de conta de registo", selecione seu **país/região da conta** no menu pendente.
...
5. Selecione o "tipo de conta" como **empresa** e, em seguida, clique nas **próxima** botão.
   ...
   > [!IMPORTANT]
   > Para compreender melhor os tipos de conta e que é melhor para escolher, exibir página [taxas, tipos e localizações de conta](https://msdn.microsoft.com/library/windows/apps/jj863494.aspx)
   >
   >
...
6. Introduza o **nome a apresentar do publicador**, normalmente, o nome da sua empresa.
   ...
   > [!TIP]
   > O nome a apresentar publicador introduzido no Centro de desenvolvimento não é apresentado no Azure Marketplace, assim que a sua oferta vai listada. Mas isso deve ser preenchido para concluir o processo de registo.
   >
   >
7. Introduza o **informações de contacto** para a verificação da conta.
   ...
   >
   >
8. Introduza as informações de contacto para o **aprovador da empresa**. Aprovador da empresa é a pessoa que pode verificar que está autorizado a criar uma conta no Centro de desenvolvimento em nome da sua organização. Clique em **próxima** mover para o **"Secção de pagamento"** quando tiver terminado.
...
Se preferir atualizar suas informações fiscais e bancárias mais tarde, pode aceder à secção 3, [registar a sua conta no portal de publicação](#3-register-your-account-in-the-publishing-portal)e volte mais tarde, utilizando ligações no Portal de publicação do Azure.

### <a name="add-tax-and-banking-information"></a>Adicionar fiscais e bancárias informações
 Se pretender publicar ofertas comerciais para compra, terá também de adicionar fiscais e informações de imposto sobre vendas e enviá-lo para a validação no Centro de programadores. Se o que irá publicar ofertas gratuitas apenas (ou ofertas BYOL), não é necessário adicionar esta informação. Pode adicioná-lo mais tarde, mas demora algum tempo para validar as informações de imposto. Se sabe que oferecerá comerciais ofertas de compra, recomendamos que adicioná-lo assim que possível.
...
2. Clique em **conta de dividendos** no menu à esquerda, sob **escolher método de pagamento** clique **conta bancária** ou **PayPal**.
...
2. Clique em **imposto sobre vendas perfil** no menu à esquerda.
3. Sobre o **configurar o seu formulário de imposto sobre** página, selecione o país ou região onde tenha residência permanente e, em seguida, selecione o país ou região onde mantém cidadania primária. Clique em **Seguinte**.
4. Introduza os detalhes de imposto e, em seguida, clique em **seguinte**.

> [!WARNING]
> Não será capaz de emitir para produção sua comercial oferece sem concluir as informações fiscais e de conta bancária na sua conta do Microsoft Developer Center.
>
>
...
O [portal de publicação](http://publish.windowsazure.com) é utilizado para publicar e gerir a sua offer(s).
...
> [!TIP]
> As políticas de participação estão descritas no [Web site do Azure](https://azure.microsoft.com/support/legal/marketplace/participation-policies/).
>
>
...
**Partindo do princípio que é o administrador,** indicada abaixo estão os passos para adicionar um coadministrador.

> [!NOTE]
> **Para os novos utilizadores,** antes de adicionar um coadministrador na publicação portal, certifique-se de que criou, pelo menos, um aplicativo na publicação portal. Isto é necessário como o **os PUBLICADORES** separador aparecer apenas depois de criar pelo menos uma aplicação na publicação portal.
>
>
