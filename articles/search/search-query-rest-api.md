...
description: Comandos HTTP e o código da REST API para builidng uma consulta de pesquisa no Azure Search. Adicione parâmetros de pesquisa para filtrar e ordenar os resultados da pesquisa.
author: brjohnstmsft
manager: jlembicz
ms.author: brjohnst
services: search
