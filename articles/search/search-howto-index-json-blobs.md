...
Para uma matriz JSON, o pedido de indexador utiliza o `jsonArray` analisador. Estes são apenas dois requisitos específicos de matriz para indexar JSON blobs.
