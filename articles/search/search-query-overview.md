...
| [Postman ou outra ferramenta de teste de HTTP](search-fiddler.md) | Explica como configurar um cabeçalho de pedido HTTP e corpo para enviar consultas para o Azure Search.  |
