...
Assim que a CLI do Azure 1.0 estiver instalado, [ligá-lo com a sua subscrição do Azure](/cli/azure/authenticate-azure-cli) e execute o **azure** comandos a partir da sua interface de linha de comandos (Bash, Terminal, linha de comandos e assim sucessivamente) para trabalhar com os recursos do Azure.
...
Agora, está pronto! Para aceder a todos os os comandos da CLI para trabalhar com os seus próprios recursos, [ligar a sua subscrição do Azure a partir da CLI do Azure](/cli/azure/authenticate-azure-cli).
