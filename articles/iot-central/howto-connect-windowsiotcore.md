...
Para configurar um dispositivo de Windows IoT Core, siga o guia passo a passo em [configurar um dispositivo de Windows IoT Core] (https://github.com/Microsoft/microsoft-iot-central-firmware/tree/master/WindowsIoT#setup-a-physical-device).
