...
Exemplo de TIs mostra-lhe como adicionar uma ação para uma regra. Isso mostra como adicionar a ação de e-mail, mas também pode adicionar outras ações:
