...
Para obter mais informações sobre os dispositivos de IoT disponíveis, confira do setor maior [catálogo de dispositivos certificada for IoT](https://catalog.azureiotsolutions.com/alldevices).
