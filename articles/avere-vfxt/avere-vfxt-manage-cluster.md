...
Se tiver criado um grupo de recursos especificamente para hospedar o cluster, pode destruir todos os recursos relacionados para o cluster com a destruição do grupo de recursos. 
