---
title: Application Insights para resolver problemas de políticas personalizadas no Azure Active Directory B2C | Microsoft Docs
description: como a configuração do Application Insights para rastrear a execução de políticas personalizadas.
