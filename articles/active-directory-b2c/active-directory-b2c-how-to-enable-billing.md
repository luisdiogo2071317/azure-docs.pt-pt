---
title: Como ligar uma subscrição do Azure ao Azure Active Directory B2C | Microsoft Docs
...
Clique em de **crie um recurso** botão. No campo **Procurar no Marketplace**, escreva `B2C`.
