...
1. Clique no botão **Iniciar Sessão** para se inscrever como utilizador da aplicação de ambiente de trabalho. Esta opção utiliza a política **B2C_1_SiUpIn** definida num passo anterior.
