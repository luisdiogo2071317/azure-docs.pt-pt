---
title: Tipos de Aplicações no Azure Active Directory B2C | Microsoft Docs
...
<!-- TODO: Need a page for libraries to link to --> Estes passos podem diferir ligeiramente com base no tipo de aplicação que quer criar.
...
Para ver este cenário na ação, experimente um dos exemplos de início de sessão do código de aplicação web na nossa [Secção de introdução](active-directory-b2c-overview.md).
