---
title: Proteger a sua serviços RESTful utilizando a autenticação básica HTTP no Azure Active Directory B2C | Microsoft Docs
description: Proteja as trocas de afirmações de REST API personalizadas no seu Azure AD B2C, utilizando a autenticação básica de HTTP.
