...
1. Para **URL de início de sessão**, introduza o URL seguinte, onde `yourtenant` é substituída pelo nome do inquilino do Azure AD B2C (`fabrikamb2c`):
