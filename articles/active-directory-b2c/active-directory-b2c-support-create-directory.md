...
* Se o inquilino do Azure AD B2C aparecem na sua lista de inquilinos e verá a seguinte mensagem de erro, eliminar o inquilino e criá-la novamente:
    ...
    "Não foi possível concluir a criação do inquilino B2C 'contosob2c'. Visite esta [link](http://go.microsoft.com/fwlink/?LinkID=624192&clcid=0x409) para obter mais orientações. "
