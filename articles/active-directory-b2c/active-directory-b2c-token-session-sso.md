---
title: Token, a sessão e a configuração do início de sessão único no Azure Active Directory B2C | Microsoft Docs
description: Token, a sessão e a configuração de início de sessão único no Azure Active Directory B2C.
