---
title: Proteger uma API web utilizando Node.js no Azure Active Directory B2C | Microsoft Docs
description: Como criar uma API que aceita tokens a partir de um inquilino do B2C da web de Node.js.
