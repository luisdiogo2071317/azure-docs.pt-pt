...
## [Ler a partir de um Key Vault - .NET](quick-create-net.md)
## [Ler a partir de um Key Vault - Node.js](quick-create-node.md)
# Tutoriais
...
## Node.js
### [Gestão do Cofre](https://docs.microsoft.com/javascript/api/azure-arm-keyvault/)
### [Biblioteca do Cliente do Cofre](https://docs.microsoft.com/javascript/api/azure-keyvault/)
## Programar
