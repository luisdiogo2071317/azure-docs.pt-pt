...
## <a name="best-practice-encrypt-data"></a>Melhor prática: encriptar dados 

Encriptação 's uma parte importante de práticas de segurança do Azure. Garantir que a encriptação está ativada em todos os níveis de ajuda a impedir que partes não autorizadas de obter acesso a dados confidenciais, incluindo os dados em trânsito e em inatividade. 

### <a name="encryption-for-iaas"></a>Encriptação para IaaS

- **VMs**: para VMs que pode utilizar o Azure Disk Encryption para encriptar os discos da VM de IaaS de Linux e Windows.
...
- **Armazenamento**: proteger os dados rest armazenados no armazenamento do Azure.
...
- **Sempre encriptado**: utilizar o assistente encriptado sempre no SQL Server Management Studio para proteger dados em repouso.
...
- **Encriptação de dados transparente (TDE)**: proteger a base de dados do SQL do Azure com a encriptação em tempo real e a desencriptação da base de dados, cópias de segurança associadas e ficheiros de registo de transação em repouso.
...
## <a name="best-practice-secure-web-apps"></a>Melhor prática: proteger aplicações web
...
- **O Azure Key Vault**: hoje os desenvolvedores de aplicativos web são passos para garantir que informações confidenciais não estão a fuga destes ficheiros. Métodos para proteger as informações é extraí-lo a partir dos ficheiros e colocá-la num Azure Key Vault.
...
- **Ambiente de serviço de aplicações**: Se precisar de uma aplicação migrar proteção extra, pode considerar a inclusão de um ambiente de serviço de aplicações e uma Firewall de aplicações Web para proteger os recursos de aplicação.
...
## <a name="best-practice-review-subscriptions-and-resource-permissions"></a>Melhor prática: Reveja as subscrições e permissões de recursos
...
## <a name="best-practice-review-audit-and-security-logs"></a>Melhor prática: rever os registos de auditoria e segurança
...
## <a name="best-practice-evaluate-other-security-features"></a>Melhor prática: avaliar a outros recursos de segurança
...
## <a name="best-practice-understand-resource-access-permissions"></a>Melhor prática: compreender as permissões de acesso de recursos 
...
## <a name="best-practice-tag-resources-effectively"></a>Melhor prática: Etiquetar recursos com eficiência
...
## <a name="best-practice-implement-blueprints"></a>Melhor prática: implementar planos gráficos
...
## <a name="best-practice-deploy-azure-policy"></a>Melhor prática: implementar a política do Azure
...
- **O Azure Site Recovery**: orquestra a replicação de VMs do Azure num site primário para uma região secundária. Quando ocorrem falhas, efetuar a ativação pós-falha da região primária para o secundário e os utilizadores podem continuar a aceder às aplicações. Quando as coisas estão de volta ao normal, reativação pós-falha para a região primária.
...
- **Replicação geográfica activa**: implementar a georreplicação ativa para recuperação após desastre rápida se ocorrer uma falha do datacenter, ou não é possível estabelecer uma ligação para uma base de dados primária.
...
## <a name="best-practice-enable-diagnostic-logging"></a>Melhor prática: Ativar o registo de diagnóstico
...
## <a name="best-practice-set-up-alerts-and-playbooks"></a>Melhor prática: configurar alertas e playbooks
...
## <a name="best-practice-use-the-azure-dashboard"></a>Melhor prática: Utilize o dashboard do Azure
...
## <a name="best-practice-understand-support-plans"></a>Melhor prática: compreender o suporte de planos
