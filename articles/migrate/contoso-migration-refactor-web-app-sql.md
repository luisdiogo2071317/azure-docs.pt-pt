...
18. Na **selecionar um ficheiro ou pasta**, eles localizar o **SmartHotel.Registration.Wcf.zip** ficheiro que foi criar durante a compilação e clique em **guardar**.
