---
title: Atualizações de terminologia de Monitor do Azure | Documentos da Microsoft
description: Descreve as alterações de terminologia recentes feitas aos serviços de monitorização do Azure.
author: bwren
manager: carmonm
editor: tysonn
