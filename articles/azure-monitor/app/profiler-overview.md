...
* [Aplicações do Service Fabric](profiler-servicefabric.md ?toc=/azure/azure-monitor/toc.json)
* [Máquinas virtuais e Scalesets VM](profiler-vm.md?toc=/azure/azure-monitor/toc.json)

Se tiver ativado o Profiler, mas não estão a ver rastreios, verifique nossos [guia de resolução de problemas.](profiler-troubleshooting.md ?toc=/azure/azure-monitor/toc.json)
