...
* [Monitorização de uma aplicação já em execução](../../azure-monitor/app/monitor-performance-live-website-now.md#troubleshoot)
...
* [Aplicação de ambiente de trabalho do Windows](../../azure-monitor/app/windows-desktop.md)
