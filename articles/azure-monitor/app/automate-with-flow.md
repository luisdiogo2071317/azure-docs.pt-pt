...
2. Clique em **criar um fluxo do zero**.
...
1. Na **frequência** caixa, selecione **dia**e, no **intervalo** , digite **1**.
    ...
    ![Caixa de diálogo de Acionador do Microsoft Flow](./media/automate-with-flow/flow1.png)
...
1. Clique em **pré-visualização de consulta do Azure Application Insights - Analytics visualizar**.
    ...
    ![Execute a janela de consulta do Analytics](./media/automate-with-flow/flow2.png)
...
![ID da aplicação no portal do Azure](./media/automate-with-flow/appid.png) 

- Forneça um nome para a sua ligação, juntamente com a chave de API e o ID da aplicação.

    ![Janela de ligação do Microsoft Flow](./media/automate-with-flow/flow3.png)
...
1. Clique em **Office 365 Outlook - enviar um e-mail**.
    ...
    ![Janela de seleção do Outlook do Office 365](./media/automate-with-flow/flow2b.png)
...
1. Na **enviar um e-mail** janela, efetue o seguinte procedimento:
   ...
   d. Clique em **Mostrar opções avançadas**.
    ...
    ![Configuração do Outlook do Office 365](./media/automate-with-flow/flow5.png)
...
1. No menu de conteúdo dinâmico, efetue o seguinte:
    ...
    ![Janela de configuração de e-mail do Office 365](./media/automate-with-flow/flow7.png)
...
- Na **nome do fluxo** caixa, adicione um nome para o fluxo e, em seguida, clique em **criar fluxo**.
    ...
    ![Janela de criação de fluxos](./media/automate-with-flow/flow8.png)
