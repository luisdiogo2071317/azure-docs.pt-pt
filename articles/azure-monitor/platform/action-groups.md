...
Para receber atualizações sobre as alterações a estes endereços IP, recomendamos que configure uma [alerta de estado de funcionamento do serviço](./../../monitoring-and-diagnostics/monitoring-service-notifications.md) que monitoriza para notificações informativas sobre o serviço de grupos de ação.
