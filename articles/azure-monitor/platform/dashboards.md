...
![Dashboard de exemplo](./media/dashboards/oms-dashboards-example-dash.png)
...
* [Aplicação móvel do OMS da Microsoft Store](https://www.windowsphone.com/store/app/operational-insights/4823b935-83ce-466c-82bb-bd0a3f58d865)
* [Aplicação móvel do OMS pelo Apple iTunes](https://itunes.apple.com/app/microsoft-operations-management/id1042424859?mt=8)

![dashboard móvel](./media/dashboards/oms-search-mobile.png)
...
![Descrição geral](./media/dashboards/oms-dashboards-overview.png)
...
![Pictóricos](./media/dashboards/oms-dashboards-pictorial01.png)
...
![Adicionar mosaicos 1](./media/dashboards/oms-dashboards-pictorial02.png)

Quando clica no **plus** símbolo, um novo mosaico é apresentada na vista do Dashboard de My.

![Adicionar mosaicos 2](./media/dashboards/oms-dashboards-pictorial03.png)
...
![Editar mosaico](./media/dashboards/oms-dashboards-pictorial04.png)

![Editar mosaico](./media/dashboards/oms-dashboards-pictorial05.png)
...
![Organizar o seu Dashboard](./media/dashboards/oms-dashboards-organize.png)
