...
1. Navegue para **registo de atividades** utilizando o menu no lado esquerdo do portal.
    ...
    ![Navegue até ao registo de atividades no portal](./media/activity-logs-overview/activity-logs-portal-navigate-v2.png)
