---
title: Auditoria e receber notificações sobre ações importantes efetuadas na sua subscrição do Azure
...
2. Na secção **Registo de Atividades**, clique na lista pendente **Grupo de Recursos** e selecione **myResourceGroup**. Altere a lista pendente **Período de Tempo** para **Última 1 hora**. Clique em **Aplicar**.
    ...
    ![Filtrar o Registo de Atividades](./media/quick-audit-notify-action-subscription/browse-activity-log.png)
...
![Ver o resumo de eventos no Registo de Atividades](./media/quick-audit-notify-action-subscription/activity-log-summary.png)
...
![Ver os detalhes do evento no Registo de Atividades](./media/quick-audit-notify-action-subscription/activity-log-json.png)
...
6. Em **Ações**, adicione uma ou mais ações ao indicar um **Nome** para a ação, o **Tipo de ação** (por exemplo, e-mail, SMS ou webhook) e os **Detalhes** para esse tipo de ação específico (por exemplo, um URL do webhook, endereço de e-mail ou número SMS).
...
> [!NOTE]
> Demora cerca de 5 minutos para que um alerta de Registo de Atividades fique totalmente ativado. Os novos eventos ocorridos antes de o alerta de Registo de Atividades ficar totalmente ativado não geram notificações.
>
>
...
> [Arquivamento dos dados de monitorização](./../../monitoring-and-diagnostics/monitor-tutorial-archive-monitoring-data.md)
