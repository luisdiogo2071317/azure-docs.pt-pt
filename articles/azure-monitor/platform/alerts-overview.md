...
![Página de todos os alertas](media/alerts-overview/all-alerts-page.png)
...
Para obter mais informações, consulte [alertas clássico](./../../azure-monitor/platform/alerts-classic.overview.md)
