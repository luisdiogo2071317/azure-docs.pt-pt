...
![ALT "ID de recurso apresentado no painel de propriedades no portal do Azure"](./media/rest-api-walkthrough/resourceid_azure_portal.png)
...
* Ver os [suportado métricas com o Azure Monitor](metrics-supported.md).
