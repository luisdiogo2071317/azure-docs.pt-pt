...
Configurar registos de eventos do Windows a partir do [menu de dados nas definições do Log Analytics](agent-data-sources.md#configuring-data-sources).
