---
title: Criar um gateway de aplicação com o URL com base no caminho regras de encaminhamento - Azure PowerShell | Documentos da Microsoft
description: Saiba como criar URL baseado no caminho regras de encaminhamento para um aplicativo máquina virtual e gateway de conjunto de dimensionamento com o Azure PowerShell.
...
Utilize [New-AzureRmApplicationGatewayIPConfiguration](/powershell/module/azurerm.network/new-azurermapplicationgatewayipconfiguration) para associar *myAGSubnet* que criou anteriormente ao gateway de aplicação. Atribuir a *myAGPublicIPAddress* para o gateway de aplicação com [New-AzureRmApplicationGatewayFrontendIPConfig](/powershell/module/azurerm.network/new-azurermapplicationgatewayfrontendipconfig).
...
Os mapas de caminho de URL asseguram que são encaminhados URLs específicos para conjuntos de back-end específicos. Pode criar mapas de caminho de URL com o nome *imagePathRule* e *videoPathRule* usando [New-AzureRmApplicationGatewayPathRuleConfig](/powershell/module/azurerm.network/new-azurermapplicationgatewaypathruleconfig) e [ Adicionar-AzureRmApplicationGatewayUrlPathMapConfig](/powershell/module/azurerm.network/add-azurermapplicationgatewayurlpathmapconfig).
...
A regra de encaminhamento associa o mapa do URL ao serviço de escuta que criou. Pode adicionar a regra com o nome **rule2* usando [Add-AzureRmApplicationGatewayRequestRoutingRule](/powershell/module/azurerm.network/add-azurermapplicationgatewayrequestroutingrule).
