...
ms.locfileid: "32769544"
---
# <a name="restrict-web-traffic-with-a-web-application-firewall-using-azure-powershell"></a>Restringir o tráfego da Web com uma firewall de aplicações Web com o Azure PowerShell
...
- *Configurações de IP e porta de front-end* - associa a sub-rede que criou anteriormente ao gateway de aplicação e atribui uma porta que vai ser utilizada para aceder ao mesmo.
- *Conjunto predefinido*  - todos os gateways de aplicação precisam de ter, pelo menos, um conjunto de back-end de servidores.
