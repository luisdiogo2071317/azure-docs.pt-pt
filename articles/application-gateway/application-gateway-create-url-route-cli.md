...
Na sua shell atual, crie um ficheiro denominado customConfig.json e cole a seguinte configuração. Pode utilizar qualquer editor de que pretende criar o ficheiro na Shell de nuvem.  Introduza `sensible-editor cloudConfig.json` para ver uma lista de editores disponíveis para criar o ficheiro.
