...
Neste exemplo, criará duas novas regras e eliminar a regra predefinida que foi criada.  Pode adicionar a regra com [az network application-gateway rule create](/cli/azure/application-gateway#az-network_application_gateway_rule_create).
