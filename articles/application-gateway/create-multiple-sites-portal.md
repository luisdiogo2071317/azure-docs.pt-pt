---
title: Criar um gateway de aplicação que aloja vários web sites - portal do Azure | Microsoft Docs
description: Saiba como criar um gateway de aplicação que aloja vários web sites no portal do Azure.
...
![Exemplo de encaminhamento de vários site](./media/create-multiple-sites-portal/scenario.png)
...
3. Introduza estes valores para o gateway de aplicação:
    ...
    ![Criar o novo gateway de aplicação](./media/create-multiple-sites-portal/application-gateway-create.png)
...
1. Abra a shell interativa e certifique-se de que está definido como **PowerShell**.
    ...
    ![Instalar a extensão personalizado](./media/create-multiple-sites-portal/application-gateway-extension.png)
...
4. Selecione *contosoPool* para o conjunto de back-end.
    ...
    ![Criar uma regra de caminho](./media/create-multiple-sites-portal/application-gateway-multisite-rule.png)
...
1. Introduza o nome de domínio na barra de endereço do seu browser. Tal como http://www.contoso.com.
    ...
    ![Testar o site da contoso no gateway de aplicação](./media/create-multiple-sites-portal/application-gateway-iistest.png)

2. Altere o endereço para o outro domínio e deverá ver algo semelhante ao seguinte exemplo:

    ![Testar o site da fabrikam no gateway de aplicação](./media/create-multiple-sites-portal/application-gateway-iistest2.png)
