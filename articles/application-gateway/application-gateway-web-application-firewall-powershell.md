...
Um serviço de escuta é obrigatório para ativar o gateway de aplicação encaminhar o tráfego adequadamente para os conjuntos de endereços de back-end. Neste exemplo, pode criar um serviço de escuta básico que escuta o tráfego do URL de raiz. 
...
### <a name="create-the-application-gateway-with-the-waf"></a>Criar o gateway de aplicação com o WAF

Agora que criou os recursos de suporte necessários, especifique os parâmetros para o gateway de aplicação com [New-AzureRmApplicationGatewaySku](/powershell/module/azurerm.network/new-azurermapplicationgatewaysku). Especifique a configuração de WAF utilizando [New-AzureRmApplicationGatewayWebApplicationFirewallConfiguration](/powershell/module/azurerm.network/new-azurermapplicationgatewaywebapplicationfirewallconfiguration). E, em seguida, criar o gateway de aplicação com o nome *myAppGateway* utilizando [New-AzureRmApplicationGateway](/powershell/module/azurerm.network/new-azurermapplicationgateway).
...
Criar uma conta de armazenamento com o nome *myagstore1* utilizando [New-AzureRmStorageAccount](/powershell/module/azurerm.storage/new-azurermstorageaccount).
...
Configurar diagnósticos para registar dados para o ApplicationGatewayAccessLog, ApplicationGatewayPerformanceLog, e ApplicationGatewayFirewallLog registos através da [Set-AzureRmDiagnosticSetting](/powershell/module/azurerm.insights/set-azurermdiagnosticsetting).
...
![URL de base de teste no gateway de aplicação](./media/application-gateway-web-application-firewall-powershell/application-gateway-iistest.png)
