...
Pode cconfigure redirecionamento para o serviço de escuta com [adicionar AzureRmApplicationGatewayRedirectConfiguration](/powershell/module/azurerm.network/add-azurermapplicationgatewayredirectconfiguration). 
...
![Testar o site da contoso no gateway de aplicação](./media/redirect-internal-site-powershell/application-gateway-iistest.png)
