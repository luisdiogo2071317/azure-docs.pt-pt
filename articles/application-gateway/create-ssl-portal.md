...
Pode utilizar o portal do Azure para criar um [gateway de aplicação](overview.md) com um certificado para a terminação de SSL, que utiliza máquinas virtuais para servidores back-end.
