...
> [!NOTE]
> As novas funcionalidades descritas neste artigo são disponíveis na pré-visualização apenas nos seguintes tipos de cluster: Hadoop, Spark e consulta interativo.
