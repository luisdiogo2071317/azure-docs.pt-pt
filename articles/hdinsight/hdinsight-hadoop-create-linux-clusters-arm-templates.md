...
- Clássico do Azure CLI: Veja [modelos de exportar o Azure Resource Manager com CLI clássica do Azure](../azure-resource-manager/resource-manager-export-template-cli.md).
