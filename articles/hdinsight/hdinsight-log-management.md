...
Pode aproveitar essas informações de nível superior do portal do Azure.  Em alternativa, pode utilizar a CLI do Azure para obter informações sobre os clusters do HDInsight:
