...
7. Clique em de **desligar** botão que os registos de submissão não são apresentados no painel esquerdo. No entanto, se ainda está em execução no back-end.
