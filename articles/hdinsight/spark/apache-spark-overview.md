...
| --- | --- |
| Criação fácil |Pode criar um cluster do Spark novo no HDInsight em apenas alguns minutos com o portal do Azure, o Azure PowerShell ou o SDK .NET do HDInsight. Consulte [introdução ao cluster do Apache Spark no HDInsight](apache-spark-jupyter-spark-sql.md) |
...
- Spark Machine Learning
    ...
    [Tutorial: Prever temperaturas de construção com dados de AVAC](apache-spark-ipython-notebook-machine-learning.md) [Tutorial: Prever resultados de inspeções alimentares](apache-spark-machine-learning-mllib-ipython.md)    
