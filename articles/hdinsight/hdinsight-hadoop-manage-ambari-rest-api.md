...
> [!NOTE]  
> Embora a maioria dos exemplos neste documento utiliza `ConvertFrom-Json` para apresentar elementos do documento de resposta, o exemplo de configuração de atualização Ambari utiliza jq. Jq é utilizado neste exemplo, para construir um novo modelo de documento de resposta JSON.
