...
Neste artigo, aprendeu a visualizar dados do HDInsight com o Power BI.  Para obter mais informações sobre a visualização de dados, consulte os artigos seguintes:
