...
Twitter permite-lhe obter os dados para cada tweet como um documento de JavaScript Object Notation (JSON) através de uma API REST. [OAuth](http://oauth.net) é necessária para a autenticação para a API.
