...
* **ORC/Parquet**: mais adequada para o desempenho.
...
Pode ler mais sobre o formato ORC no [manual de linguagem de ramo de registo do Apache](https://cwiki.apache.org/confluence/display/Hive/LanguageManual+ORC).
