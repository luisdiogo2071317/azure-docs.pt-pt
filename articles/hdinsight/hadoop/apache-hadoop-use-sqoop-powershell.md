...
* Um cluster do Apache Hadoop no HDInsight. Para obter mais informações, consulte [criar o cluster e a base de dados SQL](hdinsight-use-sqoop.md#create-cluster-and-sql-database).
