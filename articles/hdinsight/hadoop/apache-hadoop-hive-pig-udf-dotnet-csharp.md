...
Saiba como utilizar c# definidas pelo utilizador Udfs (funções) com o Apache Hive e Pig no HDInsight.
...
* __HDInsight baseado em Linux__ clusters com [Mono (https://mono-project.com) ](https://mono-project.com) para executar aplicações de .NET. Versão mono 4.2.1 está incluída com o HDInsight versão 3.6.
    ...
    Para obter mais informações sobre a Mono compatibilidade com versões do .NET Framework, consulte [Mono compatibility](http://www.mono-project.com/docs/about-mono/compatibility/).
...
1. Abra o Visual Studio e crie uma solução. Para o tipo de projeto, selecione **aplicação de consola (.NET Framework)** e dê o nome do novo projeto **HiveCSharp**.
    ...
    > [!IMPORTANT]
    > Selecione __.NET Framework 4.5__ se estiver a utilizar um cluster do HDInsight baseado em Linux. Para obter mais informações sobre a Mono compatibilidade com versões do .NET Framework, consulte [Mono compatibility](http://www.mono-project.com/docs/about-mono/compatibility/).
...
2. Substitua os conteúdos do **Program.cs** ficheiro com o código a seguir:
    ...
    Esse código analisa as linhas enviadas a partir do Pig e reformata linhas que começam com `java.lang.Exception`.
...
6. Para carregar os ficheiros de .exe, utilize um dos seguintes métodos:
    ...
    * Se utilizar __do Azure Data Lake Store__, uma área vazia na listagem de ficheiros com o botão direito e, em seguida, selecione __carregar__. Por fim, selecione o **HiveCSharp.exe** do ficheiro e clique em **aberto**.
...
## <a name="run-a-pig-job"></a>Executar uma tarefa Pig
...
Neste documento, aprendeu como utilizar uma aplicação .NET Framework a partir do Hive e Pig no HDInsight. Se gostaria de saber como utilizar Python com Hive e Pig, veja [utilizar Python com Hive e Pig no HDInsight](python-udf-hdinsight.md).
