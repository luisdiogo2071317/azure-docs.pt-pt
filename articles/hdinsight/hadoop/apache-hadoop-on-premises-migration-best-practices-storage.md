...
> [!Note]
> Para versões mais antigas das distribuições de Hadoop no local que não têm o certificado de "wasbs", eles precisam ser importados para o arquivo de confiança de Java.
