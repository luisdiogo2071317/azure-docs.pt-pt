...
Para obter mais informações, consulte [utilizar o Oozie com o Hadoop para definir e executar um fluxo de trabalho no HDInsight](../hdinsight-use-oozie-linux-mac.md) para uma descrição profunda que mostra como utilizar o Oozie para um pipeline de ponto a ponto da unidade, consulte [Operacionalizar o Pipeline de dados](../hdinsight-operationalize-data-pipeline.md). 
