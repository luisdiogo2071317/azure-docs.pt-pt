...
* `Invoke-AzureRmHDInsightHiveJob`: Utilizado para executar declarações HiveQL. Este cmdlet blocos a consulta estiver concluída, em seguida, devolve os resultados.
* `Use-AzureRmHDInsightCluster`: Define o cluster atual para o `Invoke-AzureRmHDInsightHiveJob` comando.
