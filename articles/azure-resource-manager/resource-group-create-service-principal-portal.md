...
1. Selecione **Azure Active Directory**.
   ...
   ![Selecione o azure active directory](./media/resource-group-create-service-principal-portal/select-active-directory.png)
...
Acabou de criar a aplicação de Azure Active Directory e o principal de serviço.
...
1. Navegue para o nível de âmbito que pretende atribuir a aplicação. Por exemplo, para atribuir uma função no âmbito da subscrição, selecione **todos os serviços** e **subscrições**.
   ...
   ![Selecionar subscrição](./media/resource-group-create-service-principal-portal/select-subscription.png)
...
1. Selecione a função que pretende atribuir à aplicação. Para permitir que o aplicativo execute ações como **reinicie**, **iniciar** e **parar** instâncias, selecionadas o **contribuinte** função. Por predefinição, as aplicações do Azure Active Directory não são apresentadas nas opções disponíveis. Para localizar seu aplicativo, procure o nome e selecioná-lo.
...
1. Selecione **definições**.
   ...
   ![Selecionar definições](./media/resource-group-create-service-principal-portal/select-settings.png)

1. Selecione **Chaves**.

   ![Selecione chaves](./media/resource-group-create-service-principal-portal/select-keys.png)
...
1. Selecione **Azure Active Directory**.
   ...
   ![Selecione Azure Active Directory](./media/resource-group-create-service-principal-portal/select-active-directory.png)

1. Observe que a sua função. Se tiver o **utilizador** função, deve certificar-se de que não-administradores podem registar aplicações.
