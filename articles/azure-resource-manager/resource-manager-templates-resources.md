...
Alguns tipos de recursos, que pode querer nome, mas seus nomes não têm de ser exclusivo. Para estes tipos de recursos, pode fornecer um nome que identifica o contexto de recursos e o tipo de recurso.
