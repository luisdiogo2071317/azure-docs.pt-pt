...
# Inícios rápidos
## [Criar modelos - portal](resource-manager-quickstart-create-templates-use-the-portal.md)
## [Criar modelos - VS Code](resource-manager-quickstart-create-templates-use-visual-studio-code.md)
## [Criar modelos - Visual Studio](vs-azure-tools-resource-groups-deployment-projects-create-deploy.md)

# Conceitos
## [Fornecedores e tipos de recursos](resource-manager-supported-services.md)
## [Grupos de Gestão](management-groups-overview.md)
## [Governação de subscrições](/azure/architecture/cloud-adoption-guide/subscription-governance?toc=%2fazure%2fazure-resource-manager%2ftoc.json)
## [Modelos para a consistência de cloud](templates-cloud-consistency.md)
...
### [Criar subscrições EA](programmatically-create-subscription.md)
### [Conceder acesso para criar subscrições de EA](grant-access-to-create-subscription.md)
...
### [Resolver erros de implementação](resource-manager-common-deployment-errors.md)
...
## [Gerir dados pessoais](resource-manager-personal-data.md)
