...
Para passar parâmetros inline, forneça os nomes de parâmetro com o `New-AzureRmResourceGroupDeployment` comando. Por exemplo, para passar uma cadeia de caracteres e a matriz a um modelo, utilize:
