...
O Azure Batch fornece capacidades de composição à escala da cloud num modelo de faturação de pagamento por utilização. O serviço Batch Rendering suporta Autodesk Maya, 3ds Max, Arnold e V-Ray. Este tutorial mostra-lhe os passos para compor uma pequena cena com o Batch, através da Interface de Linha de Comandos do Azure. Saiba como:
