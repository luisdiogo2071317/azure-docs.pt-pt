...
| Comando | Notas |
|---|---|
| [az role assignment create](/cli/azure/role#az-role-assignment-create) | Crie uma nova atribuição de função para um utilizador, grupo ou principal de serviço. |
