...
|Distribuição de mercado|Suportadas<br>Licenciamento de BYOL|Suportadas<br>Licenciamento de BYOL|
...
5. Os portais do Azure Stack e as ferramentas (Visual Studio) precisam de tokens de atualização. Estas devem ser configuradas por depender de confiança. Abra uma sessão elevada do Windows PowerShell e execute o seguinte comando:
