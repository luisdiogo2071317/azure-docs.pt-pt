...
Estamos a compreender de que a privacidade e segurança das informações dos nossos clientes é importante. Iremos efetuou uma abordagem abrangente e thoughtful a privacidade do cliente e a proteção de dados de clientes com a pilha do Azure. Os administradores de TI tem controlos para personalizar funcionalidades e definições de privacidade em qualquer altura. É claro nosso compromisso para transparência e fidedignidade:
...
- * * Compatibilidade dados, o que ajuda a fornece conhecimento sobre quais os fornecedores de recursos são instaladas num sistema e a máquina virtual e identifica potenciais problemas de compatibilidade.
...
Desativar a telemetria de pilha de Azure e Windows desativa a telemetria do SQL Server. Para obter informações adicionais sobre as implicações das definições de telemetria do Windows Server, referenciar a [Windows telemetria documento](https://aka.ms/winservtelemetry).
