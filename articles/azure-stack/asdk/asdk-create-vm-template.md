...
> [!IMPORTANT]
> A imagem de VM com Ubuntu (Ubuntu Server 16.04 LTS neste exemplo) já ter sido [adicionadas para o mercado de pilha do Azure](asdk-marketplace-item.md) antes de iniciar estes passos.
...
> [Saiba mais sobre tarefas de avaliação avançadas](asdk-advanced-eval.md)