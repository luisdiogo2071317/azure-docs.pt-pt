...
description: Neste tutorial, instale o ASDK utilizando os scripts de instalador.
...
---
# <a name="tutorial-deploy-the-asdk-using-the-installer"></a>Tutorial: implementar o ASDK utilizando o instalador
Neste tutorial, pode implementar o Azure pilha Development Kit (ASDK) num ambiente de não produção. 
...
> [!div class="checklist"]
> * Transferir e extraia o pacote de implementação
> * Preparar o computador de anfitrião do kit de desenvolvimento 
> * Instalar o ASDK no computador anfitrião
> * Efetuar configurações de pós-implementação
> * Registar com o Azure
...
Depois de preparar o computador de anfitrião do kit de desenvolvimento, a ASDK pode ser implementado na imagem do CloudBuilder.vhdx. O ASDK pode ser implementado com uma interface gráfica (GUI) fornecida ao descarregar e executar o script de PowerShell asdk installer.ps1 ou completamente a partir de [a linha de comandos](asdk-deploy-powershell.md). 

> [!NOTE]
> Opcionalmente, após o computador anfitrião ter arrancado para o CloudBuilder.vhdx, pode configurar [definições de telemetria de pilha do Azure](asdk-telemetry.md#set-telemetry-level-in-the-windows-registry) *antes* o ASDK a instalar.
...
**[Tarefas de implementação POST ASDK](asdk-post-deploy.md)**
