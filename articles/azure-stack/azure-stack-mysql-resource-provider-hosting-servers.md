...
3. Selecione **recursos administrativos** > **MySQL alojar servidores** > **+ adicionar**. Esta ação abre o **adicionar um servidor de hospedagem do MySQL** caixa de diálogo, mostrada na captura de ecrã seguinte.
