...
Utilize a linha de comandos para implementar modelos Azure Resource Manager para o Azure Stack Development Kit. Modelos Azure Resource Manager implementar e aprovisionar todos os recursos para a sua aplicação numa operação única e coordenada.
...
Este comando implementa o modelo para o grupo de recursos **cliRG** na localização predefinida da Azure Stack POC.
