...
5. Para implementar uma aplicação de exemplo, visite a página de documentação oficial do Kubernetes e ignorar a secção "Criar o Cluster Minikube" como já tiver criado um acima. Ir para a secção "Criar a sua aplicação node. js" em https://kubernetes.io/docs/tutorials/stateless-application/hello-minikube/.
