...
Este artigo apresenta os tamanhos de máquina virtual (VM) que são suportados pela pilha de Azure. 


## <a name="general-purpose"></a>Fins gerais

### <a name="basic-a"></a>Básico A
|Tamanho - Size\Name |vCPU     |Memória | Tamanho máximo do disco temporário | Débito do disco de SO máxima: (IOPS) | Débito de armazenamento temporário de Max (IOPS) | Débito de disco de dados máxima (IOPS) |
|-----------------|-----|---------|---------|-----|------|-----------|
|**A0\Basic_A0**  |1    |768 MB   | 20 GB   |300  | 300  |1 / 1x300  |
|**A1\Basic_A1**  |1    |1,75 GB  | 40 GB   |300  | 300  |2 / 2x300  |
|**A2\Basic_A2**  |2    |3,5 GB   | 60 GB   |300  | 300  |4 / 4, 300  |
