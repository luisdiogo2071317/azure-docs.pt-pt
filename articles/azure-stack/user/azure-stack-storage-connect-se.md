...
6. No **editar** menu, aponte para **certificados SSL**e, em seguida, selecione **importar certificados**. Utilize a caixa de diálogo do selecionador de ficheiros para encontrar e abrir o certificado que foi exportado no passo anterior.
    ...
    Depois de importar o certificado, é-lhe pedido que reinicie o Explorador de armazenamento.
...
Utilize os seguintes passos para ligar o Explorador de armazenamento para uma subscrição de pilha do Azure.
...
5. Selecione **Ligar**.
6. Depois da conta de armazenamento é anexada com êxito, a conta de armazenamento é apresentada com (**externo, outros**) acrescentado ao respetivo nome.
