...
>[!NOTE]
>Discos criada e gerida pelo Azure são denominados [discos geridos pelo](https://docs.microsoft.com/azure/virtual-machines/windows/managed-disks-overview).
