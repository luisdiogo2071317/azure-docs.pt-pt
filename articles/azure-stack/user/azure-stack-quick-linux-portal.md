...
6. Sobre o **configurações** página, mantenha as predefinições e clique em **OK**.
...
![Página de boas-vindas do servidor de web do NGINX](media/azure-stack-quick-linux-portal/linux-04.PNG)
