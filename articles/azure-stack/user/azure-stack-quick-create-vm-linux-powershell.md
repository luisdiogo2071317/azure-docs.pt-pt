...
Quando lhe for pedido, inicie sessão como **azureuser**. Se utilizou uma frase de acesso quando criou as chaves SSH, terá de fornecer a frase de acesso.
