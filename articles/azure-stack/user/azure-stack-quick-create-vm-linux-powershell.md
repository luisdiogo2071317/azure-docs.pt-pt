...
## <a name="quick-create-virtual-machine---full-script"></a>Rápida criar máquina - script completa

> [!NOTE]
> É maior ou menor o código acima, intercalado, mas com uma palavra-passe em vez de SSH a chave de autenticação.
