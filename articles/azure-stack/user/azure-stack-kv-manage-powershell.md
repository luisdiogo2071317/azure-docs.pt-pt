...
ms.locfileid: "34075770"
---
# <a name="manage-key-vault-in-azure-stack-using-powershell"></a>Gerir o Cofre de chaves na pilha do Azure com o PowerShell

*Aplica-se a: Azure pilha integrado sistemas e Kit de desenvolvimento de pilha do Azure*

Pode gerir o Cofre de chaves na pilha do Azure com o PowerShell. Saiba como utilizar cmdlets do PowerShell do Cofre de chave para:
...
>[!NOTE]
>Descibed de cmdlets do PowerShell do Cofre de chave neste artigo são fornecidos no SDK do Azure PowerShell.
...
O resultado deste comando mostra as propriedades do Cofre de chaves que criou. Quando acede a uma aplicação neste cofre, tem de utilizar o **cofre do URI** propriedade, o que é "https://vault01.vault.local.azurestack.external" neste exemplo.

### <a name="active-directory-federation-services-ad-fs-deployment"></a>Implementação de serviços de Federação do Directory (AD FS) ativa
