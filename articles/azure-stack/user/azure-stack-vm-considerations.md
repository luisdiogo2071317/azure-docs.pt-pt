...
| Armazenamento de máquina virtual | Suporta [discos geridos.](../../virtual-machines/windows/managed-disks-overview.md) | Discos geridos ainda não são suportados no Azure Stack. |
