...
<!-- 2332636 - IS -->  
- Quando utilizar o AD FS para o seu sistema de identidade do Azure Stack e a atualização para esta versão do Azure Stack, o proprietário de predefinição da subscrição do fornecedor de padrão é reposto incorporada **CloudAdmin** utilizador.  
...
<!-- 2096388 IS --> 
- Não é possível utilizar o portal de administração ao atualizar as regras para um grupo de segurança de rede.
...
<!-- IS, ASDK --> 
- Caracteres especiais, incluindo espaços e períodos, não são suportadas no **família** ou **escalão** nomes ao criar um SKU para os fornecedores de recursos do SQL e o MySQL.
