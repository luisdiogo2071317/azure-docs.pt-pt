...
Para obter mais informações, consulte [início rápido: utilizar a validação como um portal de serviço para agendar o seu primeiro teste](azure-stack-vaas-schedule-test-pass.md).
