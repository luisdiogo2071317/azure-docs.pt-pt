...
- [Implementar o agente local](azure-stack-vaas-local-agent.md) (obrigatório)
- [Validação como um conceito de principais de serviço](azure-stack-vaas-key-concepts.md) (obrigatório)
