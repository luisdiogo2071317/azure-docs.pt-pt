...
1. Confirme que tem o Azure PowerShell instalada e configurada. Caso contrário, utilize as instruções seguintes: 
   * Para instalar a versão mais recente do Azure PowerShell e associá-lo a sua subscrição do Azure, veja [como instalar e configurar o Azure PowerShell](http://azure.microsoft.com/documentation/articles/powershell-install-configure/).
...
Para obter mais informações, consulte [documentação do Azure Stack do PowerShell.](https://docs.microsoft.com/powershell/module/azurerm.azurestackstorage)
