...
Em ambientes de produção, teste a conectividade de rede da estação de trabalho de um operador não é totalmente indicativa de conectividade disponível para o Azure Stack. Rede de VIP pública o carimbo de Azure Stack tem conectividade para o tráfego LDAP efetuar a integração de identidade.
