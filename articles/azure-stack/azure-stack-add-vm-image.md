...
2. Inicie sessão no Azure pilha como operador. No menu, selecione **mais serviços**. Em seguida, selecione **computação** > **imagens da VM** > **adicionar**.
...
3. Abra o PowerShell com uma linha de comandos elevada e execute:
  ...
  - **OSUri**  
    ...
    Para obter mais informações, consulte a referência do PowerShell para o [adicionar AzsPlatformimage](https://docs.microsoft.com/powershell/module/azs.compute.admin/add-azsplatformimage) cmdlet e os [New-DataDiskObject](https://docs.microsoft.com/powershell/module/Azs.Compute.Admin/New-DataDiskObject) cmdlet.
...
3. Abra o PowerShell com uma linha de comandos elevada e execute:
  ...
  - **Versão**  
    ...
    Para obter mais informações sobre o cmdlet Remove-AzsPlatformImage, consulte o PowerShell Microsoft [documentação do módulo de operador de pilha do Azure](https://docs.microsoft.com/powershell/module/).
