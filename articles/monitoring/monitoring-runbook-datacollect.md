...
![Módulo de OMSIngestionAPI](media/monitoring-runbook-datacollect/OMSIngestionAPI.png)
...
![Editar o runbook](media/monitoring-runbook-datacollect/edit-runbook.png)
...
![Runbook de teste](media/monitoring-runbook-datacollect/test-runbook.png)
...
Depois do runbook foi concluída em teste, e verificado que a saída foi recebida com êxito, pode verificar os registos foram criados com uma [pesquisa de registos no Log Analytics](../log-analytics/log-analytics-log-searches.md).
...
![Publicar o runbook](media/monitoring-runbook-datacollect/publish-runbook.png)
...
![Registo e rastreio](media/monitoring-runbook-datacollect/logging.png)
...
![Agendar runbook](media/monitoring-runbook-datacollect/schedule-runbook.png)
...
![Tarefas](media/monitoring-runbook-datacollect/jobs.png)
...
5. Desloque-se para baixo para localizar uma entrada semelhante à imagem abaixo.<br>![Verboso](media/monitoring-runbook-datacollect/verbose.png)
