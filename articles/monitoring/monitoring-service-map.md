...
3. Na página de resultados de pesquisa do marketplace, selecione **mapa de serviço** da lista.<br><br> ![Selecione a solução mapa de serviço dos resultados da pesquisa do Azure Marketplace](./media/monitoring-service-map/marketplace-search-results.png)<br>
4. Sobre o **mapa de serviço** painel de descrição geral, reveja os detalhes da solução e, em seguida, clique em **criar** para iniciar o processo de inclusão para a área de trabalho do Log Analytics.<br><br> ![Integrar a solução mapa de serviço](./media/monitoring-service-map/service-map-onboard.png).
...
![Descrição geral de mapa de serviço](media/monitoring-service-map/service-map-overview.png)
...
![Separador de grupos](media/monitoring-service-map/machine-groups-tab.png)

Em seguida, selecione o nome do grupo para ver o mapa para esse grupo de máquina.
![Grupo de máquinas](media/monitoring-service-map/machine-group.png) as máquinas que pertencem ao grupo são descritas em branco no mapa.
...
![Filtro de grupo](media/monitoring-service-map/machine-groups-filter.png)
...
![Grupo de máquina filtrado processos](media/monitoring-service-map/machine-groups-filtered.png)
...
![Remover máquina de grupo](media/monitoring-service-map/machine-groups-remove.png)
...
![Menu de grupo do computador](media/monitoring-service-map/machine-groups-menu.png)
...
![Ligações com falhas](media/monitoring-service-map/failed-connections.png)
...
![Painel de resumo de máquina](media/monitoring-service-map/machine-summary.png)
...
![Painel de eventos do registo de máquina](media/monitoring-service-map/log-events.png)
...
![Painel do serviço de atendimento de máquina](media/monitoring-service-map/service-desk.png)
...
![Painel de controlo de alterações de máquina](media/monitoring-service-map/change-tracking.png)
...
![Painel de desempenho da máquina](media/monitoring-service-map/machine-performance.png)
...
Dados de inventário de computador e o processo de mapa de serviço estão disponíveis para [pesquisa](../log-analytics/log-analytics-log-searches.md) no Log Analytics. Pode aplicar esses dados para cenários que incluem planos de migração, análise de capacidade, deteção e resolução de problemas de desempenho a pedido.
...
Saiba mais sobre [pesquisas de registos](../log-analytics/log-analytics-log-searches.md) no Log Analytics para obter os dados recolhidos pelo mapa de serviço.


## <a name="troubleshooting"></a>Resolução de problemas
Consulte a [secção do documento de mapa de serviço de configuração de resolução de problemas]( monitoring-service-map-configure.md#troubleshooting).
