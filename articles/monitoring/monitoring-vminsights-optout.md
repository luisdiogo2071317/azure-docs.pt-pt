...
Se antes de integração do Azure Monitor para as VMs, não tivesse [recolher os contadores de desempenho ativados](monitoring-vminsights-onboard.md?toc=/azure/azure-monitor/toc.json#performance-counters-enabled) para o Windows ou baseado em Linux VMs na sua área de trabalho, terá de desativar essas regras, seguindo os passos descritos [aqui](../log-analytics/log-analytics-data-sources-performance-counters.md?toc=/azure/azure-monitor/toc.json#configuring-performance-counters) para Windows e Linux.
