...
Para obter mais informações sobre o desempenho do que os contadores estão ativados, consulte a nossa [inclusão](monitoring-vminsights-onboard.md) artigo.
...
Se optar por utilizar o método baseado em script, essas etapas são abordadas os [inclusão](monitoring-vminsights-onboard.md) artigo. 
...
Se não vir dados de desempenho na tabela de disco ou em alguns dos gráficos de desempenho, em seguida, os contadores de desempenho não podem ser configurados na área de trabalho. Para resolver, execute o seguinte [script do PowerShell](monitoring-vminsights-onboard.md#enable-with-powershell).
