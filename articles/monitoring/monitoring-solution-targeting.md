...
- Solução filtragem apenas se aplica a soluções fornecidas pela Microsoft.  Não é aplicável a soluções [criado por si ou parceiros](monitoring-solutions-creating.md).
