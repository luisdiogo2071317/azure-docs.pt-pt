...
- Nesta versão, o serviço está disponível apenas em determinadas regiões nos EUA, UE e Ásia-Pacífico. Para obter mais informações, aceda a [disponibilidade das regiões](#data-box-gateway-overview#region-availability). A conta de armazenamento deve ser fisicamente mais próxima da região em que o dispositivo implementado (pode ser diferente da geo de serviço).
