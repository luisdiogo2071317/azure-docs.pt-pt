...
ms.locfileid: "56109746"
---
# <a name="tutorial-provision-azure-data-box-gateway-in-hyper-v-preview"></a>Tutorial: Gateway de caixa de dados do Azure de aprovisionamento no Hyper-V (pré-visualização)
