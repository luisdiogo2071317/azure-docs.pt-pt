...
Por fim, na adição da secção `nodeTypes` da configuração, adicione uma nova secção para mapear as portas efémeras que o Windows irá utilizar.  O ficheiro de configuração deve ser semelhante ao seguinte:
