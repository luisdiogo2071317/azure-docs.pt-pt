...
Utilize a carga de réplica primária como carga média da partição.
|Atributo|Valor|
|---|---|
...
## <a name="centralsecretservicereplicatorendpoint-element"></a>Elemento de CentralSecretServiceReplicatorEndpoint
|Atributo|Valor|
|---|---|
|tipo|[InternalEndpointType](service-fabric-service-model-schema-complex-types.md#internalendpointtype-complextype)|
|conteúdo|0 elemento (s), atributos de 0|
...
Especifica as informações de um certificado que será exposta ao contentor.
...
O padrão administrador função certificado de cliente utilizado para proteger a comunicação de servidor cliente.
...
## <a name="configpackage-element-type-configpackagedescriptiontype"></a>Elemento de ConfigPackage (tipo ConfigPackageDescriptionType) 
...
|conteúdo|0 elemento (s), atributos de 0|
|definido|localmente na [ConfigPackagePoliciesType complexType](service-fabric-service-model-schema-complex-types.md#configpackagepoliciestype-complextype)|
|nome|ConfigPackage|
|minOccurs|0|
|maxOccurs|não vinculado|
...
## <a name="configpackage-element-type-configpackagetype"></a>Elemento de ConfigPackage (tipo ConfigPackageType) 
Declara uma pasta, com o nome do atributo de nome, und PackageRoot que contém um arquivo Settings XML. Este ficheiro contém seções de definições de par chave-valor, de definidas pelo utilizador que o processo pode ler voltar no tempo de execução. Durante uma atualização, se apenas a versão de ConfigPackage foi alterada, em seguida, o processo em execução não for reiniciado. Em vez disso, um retorno de chamada notifica o processo que as definições de configuração foram alterados para que possa ser recarregadas dinamicamente.
...
## <a name="configpackagepolicies-element"></a>Elemento de ConfigPackagePolicies
Pacotes de configuração de ser montado no interior do contentor.
...
Aviso! Não utilizar o redirecionamento de consola num aplicativo de produção, utilize apenas para desenvolvimento local e depuração. Redireciona saída da consola do script de arranque para um ficheiro de saída na pasta denominada "log" no nó de cluster em que a aplicação é implementada e executar.
...
Define o número de redirecionamento da consola ficheiros de saída a manter.  Tem de ser um número inteiro positivo, o valor predefinido é "2".
|Atributo|Valor|
|---|---|
...
Defina o tamanho máximo de um ficheiro de saída de redirecionamento de consola.  Tem de ser um número inteiro positivo maior do que 128KB, o valor predefinido é "20480".
|Atributo|Valor|
|---|---|
...
## <a name="containerlabel-element"></a>Elemento de ContainerLabel
Etiquetas para contentores na chave do formulário = valor.
...
## <a name="containernetworkpolicy-element"></a>Elemento de ContainerNetworkPolicy
Descreve as políticas de rede do contentor para o pacote de serviço.
...
|conteúdo|0 elemento (s), atributos de 0|
|definido|localmente na [NetworkPoliciesType complexType](service-fabric-service-model-schema-complex-types.md#networkpoliciestype-complextype)|
...
Declara uma pasta, com o nome do atributo de nome, em PackageRoot que contém ficheiros de dados estáticos para ser consumida pelo processo em tempo de execução. Service Fabric serão reciclar todos os EXEs e DLLHOSTs especificados nos pacotes de anfitrião e suporte quando nenhum dos pacotes de dados listados no manifesto do serviço sejam atualizados.
...
|---|---|
|tipo|complexType anónimo|
|conteúdo|6 elemento (s), atributos de 2|
...
Especifica as políticas de configuração para monta.
|Atributo|Valor|
|---|---|
|nome|ConfigPackagePolicies|
|tipo|[ConfigPackagePoliciesType](service-fabric-service-model-schema-complex-types.md#configpackagepoliciestype-complextype)|
...
O ponto final, declarados no manifesto do serviço, para substituir.
...
## <a name="endpointbinding-element"></a>Elemento de EndpointBinding
Especifica um ponto final que deve ser exposto na rede de contentor.
...
|conteúdo|0 elemento (s), atributos de 0|
|definido|localmente na [ContainerNetworkPolicyType complexType](service-fabric-service-model-schema-complex-types.md#containernetworkpolicytype-complextype)|
...
O ponto de serviço para substituir.
...
## <a name="environmentvariable-element-type-environmentvariableoverridetype"></a>Elemento de EnvironmentVariable (tipo EnvironmentVariableOverrideType) 
...
|conteúdo|0 elemento (s), atributos de 0|
|definido|localmente na [EnvironmentOverridesType complexType](service-fabric-service-model-schema-complex-types.md#environmentoverridestype-complextype)|
...
## <a name="environmentvariable-element-type-environmentvariabletype"></a>Elemento de EnvironmentVariable (tipo EnvironmentVariableType) 
Variável de ambiente.
...
|conteúdo|0 elemento (s), atributos de 0|
|definido|localmente na [EnvironmentVariablesType complexType](service-fabric-service-model-schema-complex-types.md#environmentvariablestype-complextype)|
|nome|Em EnvironmentVariable|
|minOccurs|0|
|maxOccurs|não vinculado|
...
## <a name="eventstoreservicereplicatorendpoint-element"></a>Elemento de EventStoreServiceReplicatorEndpoint
|Atributo|Valor|
|---|---|
|tipo|[InternalEndpointType](service-fabric-service-model-schema-complex-types.md#internalendpointtype-complextype)|
|conteúdo|0 elemento (s), atributos de 0|
...
## <a name="gatewayresourcemanagerreplicatorendpoint-element"></a>Elemento de GatewayResourceManagerReplicatorEndpoint
|Atributo|Valor|
|---|---|
|tipo|[InternalEndpointType](service-fabric-service-model-schema-complex-types.md#internalendpointtype-complextype)|
|conteúdo|0 elemento (s), atributos de 0|
...
Declara um conjunto de grupos como segurança principais, que podem ser referenciados nas políticas. Os grupos são úteis se existirem vários utilizadores para os pontos de entrada de serviço diferentes e que precisam para tem determinados privilégios comuns que estão disponíveis no nível de grupo.
...
Os nomes de imagens correspondente ao SO criar número a ser iniciado.
...
## <a name="label-element"></a>Elemento da etiqueta
Especifica as etiquetas para o contentor.
...
## <a name="networkpolicies-element"></a>Elemento de NetworkPolicies
Especifica diretivas de rede, incluindo políticas de rede do contentor.
...
Indica se um pacote de código, configuração ou dados deve ser partilhado entre instâncias de serviço do mesmo tipo de serviço.
...
Especifica o recurso de ponto final a vincular a porta do contentor exposta.

|Atributo|Valor|
|---|---|
|tipo|[PortBindingType](service-fabric-service-model-schema-complex-types.md#portbindingtype-complextype)|
|conteúdo|0 elemento (s), atributos de 0|
|definido|localmente na [ServicePackageContainerPolicyType complexType](service-fabric-service-model-schema-complex-types.md#servicepackagecontainerpolicytype-complextype), [ContainerHostPoliciesType complexType](service-fabric-service-model-schema-complex-types.md#containerhostpoliciestype-complextype)|
|nome|PortBinding|
|minOccurs|0|
|maxOccurs|não vinculado|
...
Especifica os limites de recursos para um codepackage.
...
Especifica as substituições de recurso para pontos de extremidade declarados em recursos do manifesto do serviço.
...
ServicePackageActivationMode a ser utilizado ao criar o serviço. Valores permitidos são 'SharedProcess' e 'ExclusiveProcess'. Com o modo de SharedProcess, réplicas ou instâncias de partição (ões) diferentes do serviço irão partilhar mesmo ativação do pacote de serviço num nó. Com o modo de ExclusiveProcess, cada réplica ou de uma instância do serviço terá sua própria ativação dedicada do pacote de serviço.
|Atributo|Valor|
|---|---|
...
## <a name="servicefabricruntimeaccesspolicy-element"></a>Elemento de ServiceFabricRuntimeAccessPolicy
Especifica políticas que determinam como o tempo de execução do service fabric é exposto para as réplicas.
...
## <a name="servicepackagecontainerpolicy-element"></a>Elemento de ServicePackageContainerPolicy
|Atributo|Valor|
|---|---|
...
Especifica o tipo de conta: Utilizador_local, Utilizador_do_domínio, NetworkService, LocalService, ManagedServiceAccount ou LocalSystem.  A predefinição é Utilizador_local. São criadas contas de utilizador local nas máquinas em que a aplicação é implementada. Por predefinição, estas contas não têm os mesmos nomes que os especificados aqui. Em vez disso, eles são gerados dinamicamente e tem palavras-passe aleatórias. Tipos de conta de sistema local suportados são Utilizador_local, NetworkService, LocalService e LocalSystem. Contas de domínio são suportadas em implementações do Windows Server onde o Azure Active Directory está disponível.
|Atributo|Valor|
|---|---|
|nome|AccountType|
|Utilização|opcional|
...
O padrão utilizador função certificado de cliente utilizado para proteger a comunicação de servidor cliente.
