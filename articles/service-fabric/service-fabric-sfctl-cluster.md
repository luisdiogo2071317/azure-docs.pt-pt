...
| --replica-set-check-timeout | Tempo limite de verificação medido em segundos de conjunto de réplicas de atualização. |
...
Reverter a atualização de código ou configuração de um cluster do Service Fabric.
