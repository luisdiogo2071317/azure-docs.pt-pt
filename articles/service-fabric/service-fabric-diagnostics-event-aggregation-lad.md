...
1. Para saber mais detalhadamente que eventos deve examinar durante a resolução de problemas, consulte [LTTng documentação](http://lttng.org/docs) e [utilizando LAD](https://docs.microsoft.com/en-us/azure/virtual-machines/extensions/diagnostics-linux).
