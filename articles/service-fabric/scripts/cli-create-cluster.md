...
| Comando | Notas |
|---|---|
| [Criar cluster de sf AZ](https://docs.microsoft.com/cli/azure/sf/cluster?view=azure-cli-latest#az_sf_cluster_create) | Cria um novo cluster de Service Fabric.  |
