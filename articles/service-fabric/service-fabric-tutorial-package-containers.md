...
Para ligar à aplicação em execução, abra um browser e aceda ao url do cluster, como, por exemplo, http://containertestcluster.eastus.cloudapp.azure.com:80. Deverá ver a aplicação Voting na IU da Web.
