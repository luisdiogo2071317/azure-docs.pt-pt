...
Em alternativa, se tiver uma subscrição do Azure, siga os passos no [criar um cluster do Service Fabric com o Azure Resource Manager](service-fabric-cluster-creation-via-arm.md).
