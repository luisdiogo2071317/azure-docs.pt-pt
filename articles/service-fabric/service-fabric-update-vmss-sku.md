...
Desative instâncias VM de conjunto com a intenção de remover o nó de dimensionamento de máquina virtual antigo. Esta operação pode demorar muito tempo a concluir. Pode desativar ao mesmo tempo e irá ser em fila de espera. Aguarde até que todos os nós estão desativados. 
...
Remova o conjunto de dimensionamento concluída. Aguarde até que o estado de aprovisionamento do conjunto de dimensionamento é concluída com êxito 
