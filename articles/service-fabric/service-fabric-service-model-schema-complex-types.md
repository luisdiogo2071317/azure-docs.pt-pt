...
Este atributo é apenas para utilização interna.
|Atributo|Valor|
|---|---|
|nome|IsActivator|
|tipo|xs:Boolean|
...
Nome da seção do Settings ConfigPackage.
|Atributo|Valor|
|---|---|
|nome|SectionName|
|Utilização|obrigatório|

#### <a name="mountpoint"></a>Ponto de montagem
|Atributo|Valor|
|---|---|
...
|Atributo|Valor|
|---|---|
|conteúdo|10 elemento (s), atributos de 8|
|definido|globalmente|
...
Utilize as credenciais do repositório de padrão especificadas no clusterManifest.xml em vez das credenciais especificadas na marca "RepositoryCredentials" dentro do applicationmanifest. XML.
...
Utilize a autenticação de token MSI (ou um ponto final especificado personalizado) para obter um token utilizado para autenticação.
...
Modo de isolamento para o contentor. Valores válidos são o padrão, o processo ou o Hyper-v (apenas suportado para contentores do windows).
|Atributo|Valor|
|---|---|
|nome|Isolamento|
|Utilização|opcional|
...
Sinalizador que indica se a remoção de contentores ocorrerá automaticamente (true) ou não (false), se o contentor é eliminado.  Se false SF remova manualmente os contentores.
|Atributo|Valor|
|---|---|
|nome|AutoRemove|
|Utilização|opcional|
...
NetworkType. Atualmente suportados são "Aberto" e "Em ambiente isolado".
|Atributo|Valor|
|---|---|
|nome|NetworkType|
|Utilização|obrigatório|
...
O nome do ponto de extremidade, que tem de ser declarado na seção de recursos do manifesto do serviço.
|Atributo|Valor|
|---|---|
|nome|EndpointRef|

## <a name="containernetworkpolicytype-complextype"></a>ContainerNetworkPolicyType complexType
Descreve a associação entre um pacote de serviço e uma rede de contentor e, opcionalmente, a associação entre pontos finais do pacote de serviço e a rede de contentor.
...
O nome da rede de contentor (maiúsculas de minúsculas). Tem de ser o nome de uma rede do contentor já criou ou reservado nomes incluindo "Aberto" ou "NAT".
|Atributo|Valor|
|---|---|
|nome|NetworkRef|
|Utilização|obrigatório|
...
|Atributo|Valor|
|---|---|
|conteúdo|4 elemento (s), 10 atributos|
|definido|globalmente|
...
#### <a name="name"></a>Nome
O nome do ponto de extremidade para substituir. Uma cadeia de caracteres.
|Atributo|Valor|
|---|---|
|nome|Nome|
|Utilização|obrigatório|
...
#### <a name="port"></a>Porta
O número de porta para o ponto final. Substitui o valor no manifesto do serviço.
|Atributo|Valor|
|---|---|
|nome|Porta|
|tipo|xs:String|
...
O protocolo para o ponto final. Substitui o valor no manifesto do serviço. Pontos finais HTTPS também tem de ter um EndpointCertificate e um EndpointBindingPolicy declarados no manifesto do aplicativo. O protocolo não é possível alterar mais tarde numa atualização da aplicação. 
|Atributo|Valor|
|---|---|
|nome|Protocolo|
|tipo|xs:String|
...
#### <a name="type"></a>Tipo
O tipo do ponto de extremidade. Substitui o valor no manifesto do serviço. Pontos finais de entrada são utilizados para expor a porta ao lado de fora, pontos finais internos são usados para comunicação intra-aplicativo.
|Atributo|Valor|
|---|---|
|nome|Tipo|
|tipo|xs:String|
...
O esquema URI. Substitui o valor no manifesto do serviço. Por exemplo, "http", "https" ou "ftp".
|Atributo|Valor|
|---|---|
|nome|uriScheme|
|Utilização|opcional|
...
#### <a name="protocol"></a>Protocolo
O protocolo para o ponto final: http, https, tcp ou udp. Pontos finais HTTPS também tem de ter um EndpointCertificate e um EndpointBindingPolicy declarados no manifesto do aplicativo. O protocolo não é possível alterar mais tarde numa atualização da aplicação. 
|Atributo|Valor|
|---|---|
|nome|Protocolo|
|Utilização|opcional|
...
|Atributo|Valor|
|---|---|
|conteúdo|21 de elemento (s), atributos de 0|
|definido|globalmente|
...
Descreve as políticas de rede, incluindo políticas de rede do contentor para o pacote de serviço.
...
#### <a name="passwordencrypted"></a>PasswordEncrypted
Especifica se a palavra-passe é texto encriptado ou simples. Este atributo é preterido. Utilize o atributo 'Type' para indicar a palavra-passe encriptada.
|Atributo|Valor|
|---|---|
|nome|PasswordEncrypted|
|tipo|xs:Boolean|
...
|Atributo|Valor|
|---|---|
|conteúdo|0 elemento (s), atributos de 12|
|definido|globalmente|
...
Quota de disco para contentores.  Tem de ser um número inteiro positivo.
|Atributo|Valor|
|---|---|
|nome|DiskQuotaInMB|
|tipo|xs:String|
...
Limites de memória do kernel em bytes.  Tem de ser um número inteiro positivo.  Tenha em atenção que esta é específico do Linux e docker no windows emite um erro se isto estiver definido.
|Atributo|Valor|
|---|---|
...
Tamanho da/desenvolvimento/shm em bytes. Se for omitido, o sistema usa 64MB.  Tem de ser um número inteiro positivo.  Tenha em atenção de que foi Linux específico, no entanto, terá de docker não erro se especificado.  Ela simplesmente é ignorada.
|Atributo|Valor|
|---|---|
|nome|ShmSizeInMB|
|tipo|xs:String|
...
Os direitos para conceder: Leitura, alteração ou completo. A predefinição é de leitura.
|Atributo|Valor|
|---|---|
|nome|GrantRights|
...
O tipo de recurso, definido na secção de recursos do manifesto do serviço. O ponto final ou certificado.
|Atributo|Valor|
|---|---|
|nome|ResourceType|
|Utilização|opcional|
...
Indica se as informações específicas de tempo de execução de recursos de infraestrutura devem ser expostas para os pacotes de código no pacote de serviço.
|Atributo|Valor|
|---|---|
...
Indica se replicado do Service Fabric blockstore deve ser utilizado para fornecer o volume para contentores no pacote de serviço.
|Atributo|Valor|
|---|---|
...
|Atributo|Valor|
|---|---|
|conteúdo|11 elemento (s), atributos de 0|
|definido|globalmente|
...
#### <a name="isolation"></a>Isolamento
Modo de isolamento para o contentor. Valores válidos são "predefinição", "processo" ou "Hyper-v".
|Atributo|Valor|
|---|---|
|nome|Isolamento|
|Utilização|opcional|
...
|Atributo|Valor|
|---|---|
|conteúdo|11 elemento (s), atributos de 4|
|definido|globalmente|
...
Especifica a percentagem máxima de tolerado dos serviços de mau estado de funcionamento antes do aplicativo é considerado em mau estado de funcionamento. Percentagem de predefinição: 0.
|Atributo|Valor|
|---|---|
...
Especifica a percentagem de tolerado máxima de partições de mau estado de funcionamento antes de um serviço é considerado em mau estado de funcionamento. Percentagem de predefinição: 0.
|Atributo|Valor|
|---|---|
...
Especifica a percentagem máxima de tolerado das réplicas de mau estado de funcionamento antes de uma partição é considerada em mau estado de funcionamento. Percentagem de predefinição: 0.
|Atributo|Valor|
|---|---|
