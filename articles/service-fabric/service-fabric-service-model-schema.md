...
# <a name="service-model-xml-schema-documentation"></a>Documentação de esquema XML de modelo de serviço
Este artigo documentos o ficheiro de esquema ServiceFabricServiceModel.xsd instalado com o SDK de Service Fabric.  Por predefinição, o ficheiro de esquema está instalado o *C:\Program Files\Microsoft SDKs\Service Fabric\schemas\ServiceFabricServiceModel.xsd*.

## <a name="namespace-bindings"></a>Enlaces de espaço de nomes
|Prefixo|URI de espaço de nomes|
|---|---|
|Xs|http://www.w3.org/2001/XMLSchema|
|Nenhuma|http://schemas.microsoft.com/2011/01/fabric|

## <a name="component-summary"></a>Resumo de componente 
Os seguintes componentes são definidos no http://schemas.microsoft.com/2011/01/fabric ServiceFabricServiceModel.xsd de espaço de nomes:
- [293 elementos](service-fabric-service-model-schema-elements.md)
...
- [3 grupos de elemento](service-fabric-service-model-schema-element-groups.md)
