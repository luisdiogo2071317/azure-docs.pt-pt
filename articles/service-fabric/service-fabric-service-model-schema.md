...
# <a name="servicefabricservicemodelxsd-schema-documentation"></a>ServiceFabricServiceModel.xsd schema documentation
...
|content|0 ou mais elementos, atributos 0|
|nome|Aplicação|
...
|content|0 ou mais elementos, atributos de 2|
...
|---|---|
|tipo|complexType anónimo|
|content|1 ou mais elementos, atributos 0|
|nome|Blackbird|
...
|---|---|
|tipo|complexType anónimo|
|content|2 elementos, atributos 0|
|nome|Certificados|
|minOccurs|0|
...
|---|---|
|tipo|complexType anónimo|
|content|2 elementos, 1 atributos|
...
|---|---|
|tipo|complexType anónimo|
|content|0 ou mais elementos, 1 atributos|
...
|---|---|
|tipo|complexType anónimo|
|content|3 ou mais elementos, atributos 0|
|nome|Destinos|
|minOccurs|0|
...
|---|---|
|tipo|complexType anónimo|
|content|5 elementos, atributos de 2|
...
|---|---|
|tipo|complexType anónimo|
|content|3 ou mais elementos, atributos de 2|
...
|---|---|
|tipo|complexType anónimo|
|content|2 elementos, atributos de 2|
...
|---|---|
|tipo|complexType anónimo|
|content|4 ou mais elementos, atributos 0|
...
|---|---|
|tipo|complexType anónimo|
|content|1 ou mais elementos, atributos de 2|
|nome|EvictionPolicy|
...
|---|---|
|tipo|complexType anónimo|
|content|6 elementos, atributos 0|
|nome|Infraestrutura|
...
|---|---|
|tipo|complexType anónimo|
|content|0 ou mais elementos, 6 atributos|
|nome|NTLMAuthenticationPolicy|
|minOccurs|0|
...
|---|---|
|tipo|complexType anónimo|
|content|6 elementos, 1 atributos|
|nome|NodeType|
|maxOccurs|unbounded|
...
|---|---|
|tipo|complexType anónimo|
|content|0 ou mais elementos, 4 atributos|
|nome|Parâmetro|
|minOccurs|0|
|maxOccurs|unbounded|
...
|---|---|
|tipo|complexType anónimo|
|content|1 ou mais elementos, 4 atributos|
...
|---|---|
|tipo|complexType anónimo|
|content|1 ou mais elementos, 1 atributos|
|nome|Section|
|maxOccurs|unbounded|
...
|---|---|
|tipo|complexType anónimo|
|content|5 elementos, atributos 0|
...
|---|---|
|tipo|complexType anónimo|
|content|0 ou mais elementos, 3 atributos|
...
|---|---|
|tipo|complexType anónimo|
|content|4 ou mais elementos, 1 atributos|
...
|---|---|
|tipo|complexType anónimo|
|content|9 elementos, atributos 0|
...
|---|---|
|tipo|complexType anónimo|
|content|4 ou mais elementos, 3 atributos|
...
|---|---|
|tipo|complexType anónimo|
|content|3 ou mais elementos, 1 atributos|
...
|---|---|
|tipo|complexType anónimo|
|content|0 ou mais elementos, 8 atributos|
...
|---|---|
|tipo|complexType anónimo|
|content|9 elementos, 5 atributos|
...
|---|---|
|tipo|complexType anónimo|
|content|3 ou mais elementos, 10 atributos|
...
|---|---|
|tipo|complexType anónimo|
|content|0 ou mais elementos, 5 atributos|
...
|---|---|
|tipo|complexType anónimo|
|content|18 elementos, atributos 0|
...
|---|---|
|tipo|complexType anónimo|
|content|0 ou mais elementos, 9 atributos|
...
|---|---|
|tipo|complexType anónimo|
|content|4 ou mais elementos, atributos de 2|
...
|---|---|
|tipo|complexType anónimo|
|content|7 elementos, atributos 0|
...
|---|---|
|tipo|complexType anónimo|
|content|7 elementos, 1 atributos|
...
|---|---|
|tipo|complexType anónimo|
|content|8 elementos, 4 atributos|
...
|---|---|
|tipo|complexType anónimo|
|content|0 ou mais elementos, 11 atributos|
