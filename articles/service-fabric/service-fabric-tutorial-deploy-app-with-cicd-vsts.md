...
Selecione **Git do Azure DevOps** como origem, Projeto de **Voto**, Repositório de **Voto** e ramo Predefinido **mestre** ou manual e compilações programadas.  Em seguida, clique em **Continuar**.
