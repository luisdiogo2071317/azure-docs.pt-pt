...
Esta é a segunda parte de um tutorial e orienta-o ao longo da configuração do Log Analytics para monitorizar os seus contentores do Windows orquestrados no Service Fabric.
...
Desta forma, é encaminhado para a Área de Trabalho do OMS, onde pode ver as suas soluções, criar dashboards personalizados e configurar o agente do OMS. 
