...
* Instalar o [do Azure Powershell versão 4.1 ou superior do módulo](https://docs.microsoft.com/powershell/azure/install-azurerm-ps) ou [CLI do Azure](/cli/azure/install-azure-cli).
