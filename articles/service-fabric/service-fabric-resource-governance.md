...
> [!IMPORTANT]  A especificação de governação de recursos com parâmetros de aplicação está disponível a partir com a versão 6.1 do Service Fabric.<br> 
>
