...
6. Quando terminar, pode parar e limpar o contentor com este comando:
 ...
 * Aplicações de contentor não não possível implementar atualmente para este cluster local
