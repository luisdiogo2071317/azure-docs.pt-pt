...
8. Guarde o token gerado. Utilizar o token mais tarde.
9. Feche o GitHub.   
...
1. Aceda à home page da sua coleção de equipa (por exemplo, https://contoso-web-team.visualstudio.com)e, em seguida, selecione o seu projeto.
