...
1. Navegue para o URL de registo que recebeu do professor/educator. 

    ![Criar um laboratório de sala de aula](../media/tutorial-connect-vm-in-classroom-lab/access-labs.png)
