...
---
# <a name="an-introduction-to-azure-lab-services-formerly-azure-devtest-labs"></a>Uma introdução ao Azure Lab Services (anteriormente Azure DevTest Labs)
