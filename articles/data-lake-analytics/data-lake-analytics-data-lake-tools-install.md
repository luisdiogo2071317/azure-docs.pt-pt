...
Transfira e instale as Ferramentas do Azure Data Lake para Visual Studio [a partir do centro de transferências](https://aka.ms/adltoolsvs). Após a instalação, tenha em atenção que:
