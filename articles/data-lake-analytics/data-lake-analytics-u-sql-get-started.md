...
* Para obter informações detalhadas sobre o **sintaxe de linguagem U-SQL**, consulte a [referência de linguagem U-SQL](https://go.microsoft.com/fwlink/p/?LinkId=691348).
