---
title: Usar um projeto de banco de dados U-SQL para desenvolver uma base de dados U-SQL para o Azure Data Lake | Documentos da Microsoft
...
Saiba mais sobre [como criar um projeto de banco de dados U-SQL com o MSBuild linha de comandos e um Visual Studio Team Services tarefa de compilação](data-lake-analytics-cicd-overview.md).
