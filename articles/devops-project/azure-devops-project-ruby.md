...
Configure a integração contínua (CI) e a entrega contínua (CD) da sua aplicação Ruby on Rails com o **Projeto de DevOps do Azure**.  O Projeto de DevOps do Azure simplifica a configuração inicial de uma compilação dos Serviços DevOps do Azure e pipeline de versão.
...
Para saber mais sobre como modificar os pipelines de compilação e versão para satisfazer as necessidades da sua equipa, veja este tutorial:
