...
Determinar se determinados tráfego é permitido no orr fora da sua VM, visitando [Certifique-se de fluxo de verificação de IP](diagnose-vm-network-traffic-filtering-problem.md)
