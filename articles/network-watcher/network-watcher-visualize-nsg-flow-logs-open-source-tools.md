...
1. A pilha elástica da versão 5.0 e superior requer Java 8. Execute o comando `java -version` para verificar a sua versão. Se não tiver java instalar, se não tiver instalado de java, consulte a documentação sobre o [Azure-suppored JDKs](https://aka.ms/azure-jdks).
