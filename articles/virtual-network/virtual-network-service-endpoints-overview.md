...
- **[Cofre de chaves do Azure](.../key-vault/key-vault-overview-vnet-service-endpoints)**: Disponível em geral em todas as regiões de cloud pública do Azure.
