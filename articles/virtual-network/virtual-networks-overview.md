...
- Criar a primeira rede virtual e implementar algumas máquinas virtuais para a mesma, seguindo os passos no [criar a primeira rede virtual](quick-create-portal.md).
