...
description: Saiba como atribuir vários endereços IP a uma máquina virtual com o PowerShell | Gestor de recursos.
...
2. Inicie sessão na sua conta com o `Connect-AzureRmAccount` comando.
