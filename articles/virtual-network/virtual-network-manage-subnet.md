...
|Ferramenta|Comando|
|---|---|
|CLI do Azure|[az network vnet subnet create](/cli/azure/network/vnet/subnet?toc=%2fazure%2fvirtual-network%2ftoc.json#az_network_vnet_subnet_create)|
...
|Ferramenta|Comando|
|---|---|
|CLI do Azure|[atualização de sub-rede da vnet de rede de AZ](/cli/azure/network/vnet?toc=%2fazure%2fvirtual-network%2ftoc.json#az_network_vnet_update)|
...
Para criar uma máquina virtual numa sub-rede, consulte [criar uma rede virtual e implementar as VMs na sub-rede](quick-create-portal.md#create-virtual-machines).
