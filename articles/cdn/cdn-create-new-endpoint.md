...
Este artigo descreve como ativar a Rede de Entrega de Conteúdos (CDN) do Azure através da criação de um novo perfil e ponto final da CDN.

> [!IMPORTANT]
> Para uma introdução à CDN e uma lista das funcionalidades, veja [Descrição Geral da CDN](cdn-overview.md).
> 
> 
