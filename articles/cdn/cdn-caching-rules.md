...
> [!NOTE] 
> Os ficheiros que estão em cache antes de uma alteração de regra mantêm a respetiva definição de duração de cache de origem. Para repor o respetivas durações de cache, tem de [remover o ficheiro](cdn-purge-endpoint.md). 
>
...
> - Para **CDN do Azure Standard da Verizon** perfis, propagação normalmente conclui em 10 minutos.  
>
