...
Se a operação for concluída com êxito, `result` contém o [ETag](https://en.wikipedia.org/wiki/HTTP_ETag) do registo inserido e `response` contém as informações sobre a operação.
