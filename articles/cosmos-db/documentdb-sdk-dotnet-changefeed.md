...
* Compatível com [SQL .NET SDK](documentdb-sdk-dotnet.md) versões 1.17.0 e superior.
* Compatível com [SQL .NET Core SDK](documentdb-sdk-dotnet-core.md) versões 1.5.1 e superior.
...
* Compatível com [SQL .NET SDK](documentdb-sdk-dotnet.md) versões 1.13.2 e superior.
...
* GA SDK
* Compatível com [SQL .NET SDK](documentdb-sdk-dotnet.md) versões 1.14.1 e abaixo.
