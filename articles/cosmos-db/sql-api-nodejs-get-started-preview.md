...
* Pretende um exemplo de Node.js mais complexo? Consulte [Build a Node.js web application using Azure Cosmos DB](sql-api-nodejs-application-preview.md) (Criar uma aplicação Web Node.js com o Azure Cosmos DB).
