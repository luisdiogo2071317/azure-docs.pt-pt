...
1. Copie e cole o código abaixo para definir o ID da base de dados e o ID do contentor. Estes IDs vão permitir ao cliente do Azure Cosmos DB encontrar a base de dados e o contentor corretos.
   ...
   Uma base de dados pode ser criado utilizando o [createIfNotExists](/javascript/api/%40azure/cosmos/databases) ou [criar](/javascript/api/%40azure/cosmos/databases) função do **bases de dados** classe. As bases de dados são os contentores lógicos dos itens particionados em contentores. 
