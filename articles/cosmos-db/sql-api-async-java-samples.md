---
title: 'Azure Cosmos DB: Exemplos Async Java para a API do SQL | Microsoft Docs'
...
Estão incluídas as mais recentes aplicações de exemplo que executam operações CRUD e outras operações comuns em recursos do Azure Cosmos DB no repositório do GitHub [azure-comsosdb-java](https://github.com/Azure/azure-cosmosdb-java). Este artigo fornece:
