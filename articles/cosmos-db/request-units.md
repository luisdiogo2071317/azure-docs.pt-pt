...
Para saber mais sobre como definir e obter débito utilizando o portal do Azure e o SDK do, consulte:

* [Definir e obter débito do BD Azure Cosmos](set-throughput.md)
