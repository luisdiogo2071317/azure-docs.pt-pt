---
title: Criar uma aplicação Java com o SDK de Async Java do Azure Cosmos DB | Microsoft Docs
...
## <a id="Run"></a>Passo 9: Executar a sua aplicação de consola Java em conjunto!
