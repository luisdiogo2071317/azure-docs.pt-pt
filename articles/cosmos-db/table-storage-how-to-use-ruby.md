---
title: Como utilizar o Armazenamento de Tabelas do Azure e a API de Tabela do Azure Cosmos com Ruby | Microsoft Docs
...
* **update_entity():** atualiza uma entidade existente ao substitui-la.
* **merge_entity():** atualiza uma entidade existente ao intercalar novos valores de propriedade na entidade existente.
...
* **insert_or_replace_entity():** atualiza uma entidade existente ao intercalar novos valores de propriedade na entidade existente. Se não existir uma entidade, será inserida uma nova.
