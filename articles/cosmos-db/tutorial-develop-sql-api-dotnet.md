...
Este método faz uma chamada de API REST para o Azure Cosmos DB e o serviço aprovisiona um número de partições com base no débito pedido. Pode alterar o débito de uma coleção ou conjunto de coleções se tiver de aumentar o seu desempenho com o SDK ou o [portal do Azure](set-throughput.md).
