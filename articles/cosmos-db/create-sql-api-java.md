...
2. Agora, adicione um documento à coleção com a seguinte estrutura e clique em **Guardar**. Utilize o botão **Copiar** na caixa de código para copiar o json para a sua área de transferência.
