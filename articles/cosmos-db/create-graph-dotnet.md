...
ms.locfileid: "53407682"
---
# <a name="azure-cosmos-db-build-a-net-framework-or-core-application-using-the-gremlin-api"></a>o Azure Cosmos DB: Criar uma aplicação de .NET Framework ou Core com a API do Gremlin
