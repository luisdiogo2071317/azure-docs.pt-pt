...
ms.locfileid: "54039526"
---
# <a name="quickstart-build-a-cassandra-app-with-java-and-azure-cosmos-db"></a>Início rápido: Criar uma aplicação do Cassandra com o Java e o Azure Cosmos DB
