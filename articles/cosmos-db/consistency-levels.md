...
description: Azure Cosmos DB tem cinco níveis de consistência para o ajudar a equilibrar a consistência eventual, disponibilidade e as compensações de latência.
