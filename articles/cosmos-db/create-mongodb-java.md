...
Vamos fazer uma breve revisão do que está a acontecer à aplicação. Abra o ficheiro `Program.java` e verá que estas linhas de código criam os recursos do Azure Cosmos DB. 
