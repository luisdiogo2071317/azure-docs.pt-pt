...
---
# <a name="azure-cosmos-db-create-a-graph-database-using-python-and-the-azure-portal"></a>o Azure Cosmos DB: Criar uma base de dados com Python e o portal do Azure
