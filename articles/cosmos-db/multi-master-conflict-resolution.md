...
|---------|---------|---------|
|API DE SQL    | .NET    |[Azure-cosmos DB-dotnet/exemplos/MultiMaster /](https://github.com/Azure/azure-cosmosdb-dotnet/tree/master/samples/MultiMaster)  |
...
|API DE SQL    | Java    |[Azure-cosmos DB-java-exemplos/src/main](https://github.com/Azure/azure-cosmosdb-java/tree/master/examples/src/main)  |
...
|API do Gremlin | .NET | [Azure-cosmos-DB-gremlin-DotNet-multi-master](https://github.com/Azure-Samples/azure-cosmos-db-gremlin-dotnet-multi-master)|
