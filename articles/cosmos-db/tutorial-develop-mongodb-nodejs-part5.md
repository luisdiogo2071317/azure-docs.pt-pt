...
Este tutorial com várias partes demonstra como criar uma nova aplicação do Node.js com Express, Angular e ligá-la à sua conta da [API do MongoDB do Azure Cosmos DB](mongodb-introduction.md).
