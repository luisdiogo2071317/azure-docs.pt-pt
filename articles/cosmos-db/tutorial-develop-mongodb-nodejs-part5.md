...
3. Agora, vamos passar para o browser. Abra as Ferramentas do programador e o separador Rede e navegue para http://localhost:3000, onde está a nossa aplicação.
