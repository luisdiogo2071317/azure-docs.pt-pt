---
title: Programação de JavaScript do lado do servidor para o Azure Cosmos DB
...
E o exemplo seguinte mostra como criar uma função definida pelo utilizador (UDF) e utilizá-lo num [consulta SQL](how-to-sql-query.md).
