...
ms.locfileid: "54038607"
---
# <a name="quickstart-build-a-table-api-app-with-net-and-azure-cosmos-db"></a>Início rápido: Criar uma aplicação de API com .NET e o Azure Cosmos DB tabela 
