...
ms.locfileid: "54032640"
---
# <a name="azure-cosmos-db-create-a-cassandra-api-account-using-azure-cli"></a>o Azure Cosmos DB: Criar uma conta de API de Cassandra através da CLI do Azure
