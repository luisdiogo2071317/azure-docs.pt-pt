...
| [az cosmosdb list-keys](https://docs.microsoft.com/cli/azure/cosmosdb#az-cosmosdb-list-keys) | Cria um servidor lógico que aloja a Base de Dados SQL. |
