...
description: Saiba mais sobre a recuperação de dados, ativação pós-falha e a georreplicação de planet escala bases de dados global do Azure Cosmos DB, um serviço de base de dados globalmente distribuída, o modelo de estiverem a utilizar.
services: cosmos-db
author: SnehaGunda
manager: kfile
...
### <a id="ComprehensiveSLAs"></a>SLAs abrangentes (para além de elevada disponibilidade)
