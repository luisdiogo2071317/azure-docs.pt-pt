...
Terá também de [Python SDK](sql-api-sdk-python.md). 
   ...
   > [!NOTE]
   > Cada amostra é autónomo, configura-se automaticamente e limpa após a próprio. Como tal, os exemplos emitir várias chamadas para [document_client. CreateCollection](http://azure.github.io/azure-documentdb-python/api/pydocumentdb.document_client.html). Cada vez que isto é feito a sua subscrição é faturado por uma hora de utilização pela camada de desempenho da coleção que está a ser criada. 
   > 
   > 
