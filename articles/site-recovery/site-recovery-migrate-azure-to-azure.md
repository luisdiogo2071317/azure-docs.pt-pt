...
* O Azure tem dois modelos de implementação diferentes para criar e trabalhar com recursos: o Azure Resource Manager e clássico. O portal do Azure suporta ambos os modelos de implementação. Os passos básicos para migração são os mesmos se estiver a configurar a recuperação de Site no Gestor de recursos ou em clássico. 
...
2. [Ativar a replicação](site-recovery-azure-to-azure.md) para as VMs que pretende migrar e escolha o Azure como origem. Atualmente, a replicação nativa de VMs do Azure através de discos geridos não são suportadas. Pode utilizar a opção "Físico para o Azure" na [neste documento](site-recovery-vmware-to-azure.md) migrar VMs com discos geridos.
