...
2. Introduza um nome para a conta do armazenamento. Nestes tutoriais, vamos utilizar o nome **awsmigrated2017**. O nome tem de ser exclusivo no Azure e ter entre 3 e 24 carateres compostos apenas por números e letras minúsculas.
...
1. No [portal do Azure](https://portal.azure.com), clique em **Nova** > **Rede** >
   **Rede virtual**
