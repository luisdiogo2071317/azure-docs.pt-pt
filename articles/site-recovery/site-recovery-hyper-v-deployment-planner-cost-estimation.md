...
description: "Este artigo descreve os detalhes da estimativa de custos do relatório gerado utilizando o planeador de implementações do Azure Site Recovery para o cenário de Hyper-V para o Azure."
...
O relatório do Planeador de Implementações fornece o resumo da estimativa de custos em folhas de [Recomendações](site-recovery-hyper-v-deployment-planner-analyze-report.md#recommendations) e a análise detalhada de custos na folha Estimativa de Custos. Inclui a análise detalhada de custos por VM. 
...
Saiba mais sobre como proteger [VMs de Hyper-V para o Azure com o Azure Site Recovery](https://docs.microsoft.com/en-us/azure/site-recovery/tutorial-hyper-v-to-azure).
