---
title: "Detalhes de estimativa de custos do Planeador de Implementações do Azure Site Recovery de Hyper-V para o Azure | Microsoft Docs"
description: "Este artigo descreve os detalhes da estimativa de custos de um relatório gerado através do Planeador de Implementações do Azure Site Recovery para o cenário de Hyper-V para o Azure."
...
O relatório do Planeador de Implementações do Azure Site Recovery fornece o resumo da estimativa de custos nas folhas [Recomendações](site-recovery-hyper-v-deployment-planner-analyze-report.md#recommendations) e a análise detalhada de custos na folha Estimativa de Custos. Inclui a análise detalhada de custos por VM. 
...
![Detalhes da estimativa de custos](media/site-recovery-hyper-v-deployment-planner-cost-estimation/cost-estimation1-h2a.png)
...
![Análise detalhada de custos](media/site-recovery-hyper-v-deployment-planner-cost-estimation/detailed-cost-analysis-h2a.png)
...
Saiba mais sobre como proteger [VMs de Hyper-V para o Azure com o Site Recovery](https://docs.microsoft.com/azure/site-recovery/tutorial-hyper-v-to-azure).
