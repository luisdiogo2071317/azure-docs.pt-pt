---
title: Matriz de suporte para replicação de Hyper-V para o Azure | Documentos da Microsoft
description: Resume os requisitos para a replicação de Hyper-V para o Azure com o Azure Site Recovery e componentes suportados
