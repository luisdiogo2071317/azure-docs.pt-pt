...
![Resumo no local](media/site-recovery-hyper-v-deployment-planner-analyze-report/on-premises-summary-h2a.png)
...
![Required Azure storage accounts (Contas de armazenamento do Azure necessárias)](media/site-recovery-hyper-v-deployment-planner-analyze-report/required-storage-accounts-h2a.png)
...
![Required number of Azure cores (Número de núcleos do Azure necessários)](media/site-recovery-hyper-v-deployment-planner-analyze-report/required-number-of-azure-cores-h2a.png)
...
![Requisito de armazenamento no local e frequência de cópias](media/site-recovery-hyper-v-deployment-planner-analyze-report/on-premises-storage-and-copy-frequency-h2a.png)
...
![Resumo da estimativa de custos](media/site-recovery-hyper-v-deployment-planner-analyze-report/cost-estimation-summary-h2a.png)
...
![Colocação do armazenamento de VMs](media/site-recovery-hyper-v-deployment-planner-analyze-report/vm-storage-placement-h2a.png)
...
![Detalhes da criação de batches de IR](media/site-recovery-hyper-v-deployment-planner-analyze-report/ir-batching-for-rpo-h2a.png)

![Detalhes da criação de batches de IR adicionais](media/site-recovery-hyper-v-deployment-planner-analyze-report/ir-batching-for-rpo2-h2a.png)
