...
Este artigo mostra-lhe como configurar a recuperação de desastres para um site secundário, para VMs de Hyper-V no local geridas em nuvens do System Center Virtual Machine Manager (VMM). Neste artigo, saiba como:
