...
2. Preparar servidores Hyper-V ou [VMware](tutorial-prepare-on-premises-vmware.md) no local.

Antes de começar, é útil rever as arquiteturas do [VMware](concepts-vmware-to-azure-architecture.md) ou [Hyper-V](concepts-hyper-v-to-azure-architecture.md) para a recuperação após desastre.
...
- [Configure](tutorial-physical-to-azure.md#set-up-the-source-environment) o ambiente de origem dos servidores físicos.
...
- [Configure uma política de replicação](tutorial-vmware-to-azure.md#create-a-replication-policy) para as VMs VMware.
- [Configure uma política de replicação](tutorial-physical-to-azure.md#create-a-replication-policy) para os servidores físicos.
...
- [Ative a replicação](tutorial-vmware-to-azure.md#enable-replication) para as VMs VMware.
- [Ative a replicação](tutorial-physical-to-azure.md#enable-replication) para os servidores físicos.
- [Ative a replicação](hyper-v-azure-tutorial.md#enable-replication) para as VMs de Hyper-V.
...
> [Configure a recuperação após desastre](site-recovery-azure-to-azure-after-migration.md) para as VMs do Azure após a migração a partir de um site no local.
