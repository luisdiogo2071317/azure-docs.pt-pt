...
Este início rápido descreve como replicar uma VM do Azure numa região diferente do Azure. A replicação do Azure para o Azure está atualmente em pré-visualização
