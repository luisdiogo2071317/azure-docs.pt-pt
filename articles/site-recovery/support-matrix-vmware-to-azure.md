...
Pontos Finais de Serviço de Rede Virtual<br/><br/> (Firewalls de armazenamento do azure e as VNETs) | Não
...
Convidados/servidor disco > 1 TB | Sim<br/><br/>Até 4095 GB
...
Pontos Finais de Serviço de Rede Virtual<br/><br/> Firewalls de armazenamento do Azure e as VNETs configuradas na conta de armazenamento de cache/armazenamento de destino (utilizada para armazenar dados de replicação) | Não
...
**Tamanho do VHD do disco de dados** | Até 4095 GB | Verificação de pré-requisitos falha se não suportado
...
**Nome da VM** | 1 - 63 carateres.<br/><br/> Limitado a letras, números e hífenes.<br/><br/> O nome do computador tem de começar e terminar com uma letra ou número. | Atualize o valor nas propriedades da máquina no Site Recovery.
