...
Para obter mais informações, consulte o [documentação peering](../virtual-network/virtual-network-create-peering.md#register) e [preços](https://azure.microsoft.com/en-us/pricing/details/virtual-network/).
