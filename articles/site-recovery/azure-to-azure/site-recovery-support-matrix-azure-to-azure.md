...
>[!NOTE]
>
> - Replicar máquinas virtuais do Azure a partir de uma subscrição para outro para cenários de recuperação após desastre não é suportada.
> - Azure migrar máquinas virtuais entre subscrições não é suportada.
> - Azure migrar máquinas virtuais na mesma região não é suportada.
> - Migrar máquinas virtuais do Azure do modelo de implementação clássica para o recurso de modelo de implementação manager não é suportado.
...
- Começar a proteger as cargas de trabalho por [replicar as VMs do Azure](azure-to-azure-quickstart.md)
