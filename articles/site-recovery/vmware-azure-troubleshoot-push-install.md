...
Este artigo descreve como resolver erros comuns que poderá enfrentam quando tentar instalar o serviço de mobilidade do Azure Site Recovery no servidor de origem para ativar a proteção.
...
[Saiba como](vmware-azure-tutorial.md) para configurar a recuperação após desastre para as VMs de VMware.