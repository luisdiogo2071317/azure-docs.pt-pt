...
3.  No Assistente de migração de dados, no **opções** ecrã, selecione **seguinte**.
4.  No **selecione origens** no ecrã o **ligar a um servidor** , forneça os detalhes de ligação ao SQL Server e, em seguida, selecione **Connect**.
5.  No **adicionar origens** caixa de diálogo, selecione **AdventureWorks2012**, selecione **adicionar**e, em seguida, selecione **iniciar avaliação**.
...
6.  Reveja os resultados da avaliação para problemas de bloqueio de migração e problemas de paridade da funcionalidade selecionando as opções específicas.
...
3.  Em **migração âmbito**, selecione **apenas o esquema**.
...
5.  No Assistente de migração de dados, especifique os detalhes de ligação de origem para o SQL Server, selecione **Connect**e, em seguida, selecione o **AdventureWorks2012** base de dados.
...
6.  Selecione **seguinte**, em **ligar ao servidor de destino**, especifique os detalhes de ligação de destino para a base de dados SQL do Azure, selecione **Connect**e, em seguida, selecione o **AdventureWorksAzure** base de dados previamente tinha sido aprovisionadas na base de dados SQL do Azure.
...
7.  Selecione **seguinte** para avançar para o **selecionar objetos** ecrã, onde pode especificar os objetos de esquema no **AdventureWorks2012** base de dados que têm de ser implementada no Azure Base de dados do SQL Server.
...
8.  Selecione **script SQL gerar** para criar os scripts de SQL e, em seguida, reveja os scripts de eventuais erros.

    ![Script de esquema](media\tutorial-sql-server-to-azure-sql\dma-schema-script.png)

9.  Selecione **implementar esquema** para implementar o esquema SQL Database do Azure e, em seguida, depois de implementar o esquema, verifique o servidor de destino para qualquer anomalias.
...
1. No **origem detalhes** ecrã, especifique os detalhes de ligação para a instância do SQL Server de origem.
...
3.  No **mapa para bases de dados de destino** ecrã, mapear a origem e a base de dados de destino para migração.
    ...
    ![Mapa para as bases de dados de destino](media\tutorial-sql-server-to-azure-sql\dms-map-targets-activity1.png)
...
6. Expanda o **opção de validação** secção para visualizar o **escolher a opção de validação** ecrã, especifique se pretende validar as bases de dados migrados para **comparação de esquema**, **Consistência dos dados**, e **consultar correcção**.
...
1. No ecrã de atividade de migração, selecione **atualizar** para atualizar a apresentação até o **estado** da migração é apresentado como **concluído**.
...
3. Certifique-se as bases de dados de destino no servidor da SQL Database do Azure de destino.
