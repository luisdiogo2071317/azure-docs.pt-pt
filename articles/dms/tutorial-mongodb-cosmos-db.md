...
Neste tutorial, migra os **Wingtips** conjunto de dados MongoDB alojada numa máquina Virtual para a API do MongoDB do Cosmos DB ao utilizar o serviço de migração de base de dados do Azure. Se não tiver uma origem de MongoDB já configurar, consulte o artigo [instalar e configurar o MongoDB numa VM do Windows no Azure](https://docs.microsoft.com/azure/virtual-machines/windows/install-mongodb).
...
- Depois de concluir a migração, pode verificar a sua conta do Cosmos DB MongoDB API para verificar se todas as coleções foram migradas com êxito.
