...
Este artigo mostra-lhe como obter determinadas informações de versão sobre o sistema operacional ou software no [serviço de aplicações](app-service-web-overview.md). 
