...
3. Clique em **adicionar uma aplicação**, em seguida, escreva um nome de aplicação e, em **criar**.
...
## <a name="secrets"> </a>Adicionar informações de Account Microsoft à sua aplicação de serviço de aplicações
