...
O servidor do Rails tem de estar em execução para a aplicação funcionar. Mude para o diretório `hello-world` e utilize o comando `rails server` para iniciar o servidor.
