...
No Cloud Shell, execute o seguinte comando da CLI do Azure, para permitir o acesso à base de dados a partir de todos os endereços IP. 
> [!Note]
> Não é aconselhado a deixar todas as portas abertas para a base de dados ou para criar sua base de dados com acesso à internet.  Ver outros [Artigos sobre segurança do Azure](https://docs.microsoft.com/azure/security/) para proteger corretamente a nova base de dados para utilização em produção.  
