...
As definições de dimensionamento levam apenas alguns segundos para aplicar e afetam todas as aplicações no seu [plano do App Service](../app-service/overview-hosting-plans.md).
