...
* Configura [agendador do Azure](https://docs.microsoft.com/azure/scheduler/) tarefas de WebJobs que estejam agendados para execução em alturas específicas. (Isto não é necessária para WebJobs contínuos.)
