...
| [`az webapp deployment user set`](/cli/azure/webapp/deployment/user?view=azure-cli-latest#az_webapp_deployment_user_set) | Define as credenciais de implementação de nível de conta para o Serviço de Aplicações. |
