---
title: "Exemplo de Script do CLI do Azure - criar uma aplicação web e implementar os ficheiros com FTP | Microsoft Docs"
description: "Exemplo de Script do CLI do Azure - criar uma aplicação web e implementar os ficheiros com FTP"
...
---
# <a name="create-a-web-app-and-deploy-files-with-ftp"></a>Criar uma aplicação web e implementar os ficheiros com FTP

Este script de exemplo cria uma aplicação web no App Service com os respetivos recursos relacionados e, em seguida, implementa uma página HTML estática a utilizar FTP. Para o carregamento FTP, o script utiliza [cURL](https://en.wikipedia.org/wiki/CURL) como exemplo. Pode utilizar qualquer ferramenta FTP para carregar os ficheiros.
...
| [`az webapp deployment list-publishing-profiles`](/cli/azure/webapp/deployment?view=azure-cli-latest#az_webapp_deployment_list_publishing_profiles) | Obter os detalhes para perfis de implementação de aplicação web disponíveis. |
