...
| [`az webapp config ssl bind`](/cli/azure/webapp/config/ssl?view=azure-cli-latest#az_webapp_config_ssl_bind) | Vincular um certificado SSL carregado para uma aplicação Web. |
