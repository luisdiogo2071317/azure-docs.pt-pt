---
title: "Exemplo de Script CLI do Azure - monitorizar uma aplicação web com os registos do servidor web | Microsoft Docs"
description: "Exemplo de Script CLI do Azure - monitorizar uma aplicação web com os registos do servidor web"
services: appservice
...
Este script de exemplo cria um grupo de recursos, o plano do app service e a aplicação web e configura a aplicação web para ativar registos do servidor web. Em seguida, transfere os ficheiros de registo para revisão.
...
| [`az webapp log config`](/cli/azure/webapp/log?view=azure-cli-latest#az_webapp_log_config) | Configura os registos de persistir de uma aplicação web do Azure. |
