...
Para saber mais sobre a sintaxe JSON e propriedades de recursos de serviços de aplicações, veja [tipos de recursos Microsoft. Web](/azure/templates/microsoft.web/allversions).
