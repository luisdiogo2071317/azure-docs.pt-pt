...
> [Add a Content Delivery Network (CDN) to an Azure App Service](../cdn/app-service-web-tutorial-content-delivery-network.md) (Adicionar uma Rede de Entrega de Conteúdos (CDN) ao Serviço de Aplicações do Azure)
