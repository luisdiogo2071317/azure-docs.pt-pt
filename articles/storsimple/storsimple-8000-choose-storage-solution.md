...
Este documento fornece uma descrição geral das opções para transferência de dados no local para o Azure, comparando: Edge de caixa de dados vs. Azure File Sync vs. Série StorSimple 8000.
