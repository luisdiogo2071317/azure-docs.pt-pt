...
+ Um Active Directory [PowerApps conta](https://docs.microsoft.com/en-us/powerapps/maker/signup-for-powerapps) com o início de sessão mesmo as credenciais de início como a sua conta do Azure. 
