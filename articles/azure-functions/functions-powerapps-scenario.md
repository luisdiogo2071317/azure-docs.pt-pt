...
+ Um ativo [conta do PowerApps](https://docs.microsoft.com/powerapps/maker/signup-for-powerapps) com o mesmo sinal em credenciais da sua conta do Azure. 
