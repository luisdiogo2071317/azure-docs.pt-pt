...
* Uma conta do Armazenamento do Azure. Para criar uma conta de armazenamento, veja [criar uma conta de armazenamento](../storage/common/storage-quickstart-create-account.md).
