...
2. Selecione o modelo **WebHook Genérico - C#**. Escreva um nome para a função de C# e, em seguida, selecione **Criar**.

     ![Crie uma função acionada por um webhook genérico no portal do Azure](./media/functions-create-generic-webhook-triggered-function/functions-create-generic-webhook-trigger.png) 
