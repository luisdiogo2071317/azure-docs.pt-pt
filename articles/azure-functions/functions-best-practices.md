...
[Funções duráveis](durable-functions-overview.md) e [Azure Logic Apps](../logic-apps/logic-apps-what-are-logic-apps.md) incorporada para gerir transições de estado e a comunicação entre várias funções.
