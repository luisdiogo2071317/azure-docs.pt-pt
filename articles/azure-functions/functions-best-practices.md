...
Este artigo fornece orientações para melhorar o desempenho e confiabilidade de seus [sem servidor](https://azure.microsoft.com/overview/serverless-computing/) aplicações de funções. 
