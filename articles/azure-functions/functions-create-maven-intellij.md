...
Este artigo mostra-lhe como criar uma [sem servidor](https://azure.microsoft.com/solutions/serverless/) projeto de função com o IntelliJ IDEA e o Apache Maven, testar e depurá-lo no seu computador a partir do IDE e implementá-la para as funções do Azure. 
