...
* Siga as instruções em "Instalar o Azure funções principais ferramentas" em [código e teste das funções do Azure localmente](https://docs.microsoft.com/en-us/azure/azure-functions/functions-run-local)
