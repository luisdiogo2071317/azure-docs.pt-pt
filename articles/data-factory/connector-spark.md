...
|:--- |:--- |:--- |
| tipo | A propriedade de tipo tem de ser definida como: **Spark** | Sim |
...
| Propriedade | Descrição | Necessário |
|:--- |:--- |:--- |
| tipo | A propriedade de tipo do conjunto de dados deve ser definida como: **SparkObject** | Sim |
