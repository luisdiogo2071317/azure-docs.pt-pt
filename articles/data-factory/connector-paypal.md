...
Para copiar dados de PayPal, defina a propriedade de tipo de conjunto de dados para **PayPalObject**. Não existe nenhuma propriedade de tipo específicas adicional neste tipo de conjunto de dados.
