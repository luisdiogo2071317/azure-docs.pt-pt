...
1. Depois de iniciar sessão no [portal do Azure](https://portal.azure.com/), clique em **Mais serviços**, pesquise com uma palavra-chave, como `data fa`, e selecione **Fábricas de dados**.
