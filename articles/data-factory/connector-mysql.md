...
Especificamente, este conector de MySQL suporta MySQL **versão 5.1 e acima**.
...
|:--- |:--- |:--- |
| tipo | A propriedade de tipo tem de ser definida como: **MySql** | Sim |
