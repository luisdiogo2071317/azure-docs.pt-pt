...
| --- | --- | --- |
| tipo |A propriedade de tipo deve ser definida como: **OnPremisesTeradata** |Sim |
...
### <a name="json-example-copy-data-from-teradata-to-azure-blob"></a>Exemplo de JSON: copiar dados do Teradata para BLOBs do Azure
