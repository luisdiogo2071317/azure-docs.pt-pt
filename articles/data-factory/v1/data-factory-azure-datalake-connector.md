...
> [!NOTE]
> Este artigo aplica-se a versão 1 do Data Factory. Se estiver a utilizar a versão atual do serviço Data Factory, consulte o artigo [conector do Azure Data Lake Store no V2](../connector-azure-data-lake-store.md).
