...
2. Certifique-se de conceder, pelo menos, "**leitor**" função ao utilizador ou principal de serviço na conta do data lake. Eis como torná-lo:

    1. Aceda ao Portal do Azure -> a sua conta do Data Lake Store
    2. Clique em "Access Control (IAM)" no painel do Store de Lake dados
    3. Clique em "Adicionar" no painel de "acesso controlo (IAM)"
    4. Definir "Função" como "Leitor de" e selecione o utilizador ou o principal de serviço a que utilizar para a cópia para conceder acesso

3. Se não pretender conceder a função "Leitor de" para o utilizador ou principal de serviço, é alernative [especificar explicitamente um local de execução](data-factory-data-movement-activities.md#global) na cópia activitywith a localização do seu Store de Lake de dados. Exemplo:
