...
> [!NOTE]
> Este artigo aplica-se a versão 1 do Data Factory. Se estiver a utilizar a versão atual do serviço Data Factory, consulte o artigo [conector da SQL Database do Azure na V2](../connector-azure-sql-database.md).
