---
title: Receber eventos através de Go - Event Hubs do Azure | Documentos da Microsoft
description: Este artigo fornece um passo a passo para criar uma aplicação Go que recebe eventos de Hubs de eventos do Azure.
services: event-hubs
