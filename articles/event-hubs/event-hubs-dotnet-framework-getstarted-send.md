---
title: Enviar eventos com o .NET Framework - Event Hubs do Azure | Documentos da Microsoft
description: Este artigo fornece um passo a passo para criar uma aplicação .NET Fraemwork para enviar eventos para Hubs de eventos do Azure.
services: event-hubs
documentationcenter: ''
...
2. Clique no separador **Procurar** e, em seguida, procure `WindowsAzure.ServiceBus`. Clique em **Instalar** e aceite os termos de utilização. 
    ...
    ![Instalar o pacote NuGet do Service Bus](./media/event-hubs-dotnet-framework-getstarted-send/create-sender-csharp2.png)
