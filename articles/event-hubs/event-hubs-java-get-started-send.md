...
> [!NOTE]
> Pode transferir este guia de introdução como uma amostra a partir do [GitHub](https://github.com/Azure/azure-event-hubs/tree/master/samples/Java/Basic/SimpleSend), substitua `EventHubConnectionString` e `EventHubName` cadeias de caracteres com os seus valores de hub de eventos, e executá-lo. Em alternativa, pode seguir os passos neste tutorial para criar o seu próprio.
...
Neste início rápido, enviou mensagens para um hub de eventos com Java. Para saber como receber eventos de um hub de eventos com o .NET Framework, consulte [receber eventos do hub de eventos - Java](event-hubs-java-get-started-receive-eph.md).
