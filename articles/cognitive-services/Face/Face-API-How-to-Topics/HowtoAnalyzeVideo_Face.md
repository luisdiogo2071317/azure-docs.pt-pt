---
title: Análise de vídeo em tempo real com a API de rostos em | Microsoft Docs
titleSuffix: Microsoft Cognitive Services
description: Utilize a API de rostos em serviços cognitivos para executar uma análise de quase em tempo real sobre Jumbo obtidos a partir de um fluxo de vídeo em direto.
