...
Para ajudar a explorar ainda mais a API de letra, este tutorial fornece um exemplo de GUI. Para executá-la, instale primeiro [wxPython](https://wxpython.org/pages/downloads/) , em seguida, execute os comandos abaixo.
