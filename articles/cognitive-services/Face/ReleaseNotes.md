...
* Funcionalidade de instantâneo foi adicionada para suportar a migração de dados entre subscrições: [Instantâneo](https://docs.microsoft.com/en-us/rest/api/cognitiveservices/face/snapshot).
