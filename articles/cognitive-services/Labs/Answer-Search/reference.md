...
|Object|Descrição|  
|------------|-----------------|  
|[WebPage]|Principal ao nível objeto JSON que contém os atributos de pré-visualização.|  
|[Fact]|Principal ao nível objeto JSON que contém os fatos.| 
