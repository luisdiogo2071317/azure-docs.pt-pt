...
|----|----|----|----|
| String | eq | Correspondência exata da cadeia de caracteres | é igual a |
| String | starts_with | Correspondência de prefixo de cadeia de caracteres | starts_with |
