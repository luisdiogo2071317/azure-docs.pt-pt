---
title: Início rápido de Java para os serviços do Azure cognitivos, Microsoft tradutor voz API | Microsoft Docs
...
ms.locfileid: "35352201"
---
# <a name="quickstart-for-microsoft-translator-speech-api-with-java"></a>Início rápido para reconhecimento de voz do Microsoft tradutor API com Java 
<a name="HOLTop"></a>
...
Terá do [javax.websocket-api-1.1.jar](http://central.maven.org/maven2/javax/websocket/javax.websocket-api/1.1/) e [tyrus autónomo-cliente 1.9.jar](http://repo1.maven.org/maven2/org/glassfish/tyrus/bundles/tyrus-standalone-client/1.9/) ficheiros.
