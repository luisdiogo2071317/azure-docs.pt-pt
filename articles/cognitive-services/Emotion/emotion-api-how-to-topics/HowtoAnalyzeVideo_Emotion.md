---
title: Análise de vídeo em tempo real com a API de emoções | Microsoft Docs
description: Utilize a API de emoções serviços cognitivos para executar uma análise de quase em tempo real sobre Jumbo obtidos a partir de um fluxo de vídeo em direto.
