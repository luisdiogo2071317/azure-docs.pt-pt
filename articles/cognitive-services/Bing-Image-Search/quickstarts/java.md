---
title: 'Início rápido: Consultas de pesquisa de envio com a API REST para a API de pesquisa de imagens do Bing e o Java'
description: Neste início rápido, envia consultas de pesquisa para a API de pesquisa do Bing para obter uma lista de imagens relevantes com Java.
...
ms.locfileid: "41987535"
---
# <a name="quickstart-send-search-queries-using-the-rest-api-and-java"></a>Início rápido: Consultas de pesquisa de envio utilizar a REST API e o Java
...
3. Adicione o código fornecido num arquivo chamado `BingImageSearch.java`.
