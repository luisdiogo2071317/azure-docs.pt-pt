---
title: Chamada e resposta - guia de introdução de Java para serviços do Azure cognitivos, API de pesquisa do Bing imagem | Microsoft Docs
...
ms.locfileid: "35354560"
---
# <a name="call-and-response-your-first-bing-image-search-query-in-java"></a>Chamada e resposta: a primeira consulta de pesquisa do Bing imagem em Java
...
3. Adicione o código fornecido num ficheiro denominado `BingImageSearch.java`.
