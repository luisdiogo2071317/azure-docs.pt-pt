---
title: Chamada e resposta - guia de introdução do Ruby para serviços do Azure cognitivos, API de pesquisa do Bing imagem | Microsoft Docs
...
ms.locfileid: "35354482"
---
# <a name="call-and-response-your-first-bing-image-search-query-in-ruby"></a>Chamada e resposta: a primeira consulta de pesquisa do Bing imagem numa Ruby
...
Este artigo inclui uma aplicação de consola simples que executa uma consulta de API de pesquisa do Bing imagem e apresenta os resultados da pesquisa em bruto devolvido, que estão no formato JSON. Enquanto esta aplicação é escrita em Ruby, a API é um serviço RESTful Web compatível com qualquer linguagem de programação que pode efetuar pedidos HTTP e analisar JSON. 

## <a name="prerequisites"></a>Pré-requisitos

Terá de [Ruby 2.4 ou posterior](https://www.ruby-lang.org/en/downloads/) para executar o código de exemplo.
