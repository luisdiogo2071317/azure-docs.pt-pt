...
|<a name="query" />q|Termo de pesquisa do usuário.|Cadeia|Não|  
...
|Name|Value|Type|  
|----------|-----------|----------|  
|_type|Dica de tipo, que pode ser definida como um dos seguintes:<br /><br /><ul><li>Hotel</li><li>LocalBusiness<br /></li><li>Restaurante</ul><li>|Cadeia|  
