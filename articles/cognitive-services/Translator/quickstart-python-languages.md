---
title: 'Início Rápido: obter lista de idiomas suportados, Python - API de Texto do Microsoft Translator'
...
ms.locfileid: "50246563"
---
# <a name="quickstart-use-the-translator-text-api-to-get-a-list-of-supported-languages-using-python"></a>Início Rápido: utilizar a API de Texto do Microsoft Translator para obter uma lista de idiomas suportados com o Python
...
Atualmente, está disponível um ponto final para Tradução de Texto e está definido como `base_url`. `path` define a rota `languages` e identifica que queremos utilizar a versão 3 da API.
