---
title: Tradução de Texto obter o comprimento de frases com C# | Microsoft Docs
titleSuffix: Microsoft Cognitive Services
description: Neste início rápido, pode encontrar o comprimento de frases no texto através da API de Texto do Microsoft Translator com C# nos Serviços Cognitivos.
...
ms.locfileid: "43770623"
---
# <a name="quickstart-get-sentence-lengths-with-c35"></a>Início rápido: Obter o comprimento de frases com C&#35;

Neste início rápido, pode encontrar o comprimento de frases do texto através da API de Texto do Microsoft Translator.
