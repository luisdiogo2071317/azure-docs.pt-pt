...
| Parâmetro | Descrição |
|:---|:---|
| Cabeçalho de autorização | **Necessário** cabeçalho HTTP utilizado para identificar a aplicação. Utilizar chave: "Autorização" e valor: "Bearer" + "" + o token de acesso. Para obter detalhes, vá aqui.|
