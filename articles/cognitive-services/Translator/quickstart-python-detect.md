---
title: 'Início Rápido: identificar o idioma do texto, Python – API de Texto do Microsoft Translator'
...
ms.locfileid: "49644920"
---
# <a name="quickstart-identify-language-from-text-with-the-translator-text-rest-api-python"></a>Início Rápido: identificar o idioma do texto com a API de Texto do Microsoft Translator (Python)
