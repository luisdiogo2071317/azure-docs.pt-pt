---
title: Escolher a capacidade para a sua implementação do QnA Maker - serviços cognitivos da Microsoft | Documentos da Microsoft
titleSuffix: Azure
...
3.  Informações da aplicação (opcionais, para armazenar chatlogs e telemetria)

Antes de criar o serviço QnA Maker, deve decidir que camadas dos serviços acima é adequada para si. 
