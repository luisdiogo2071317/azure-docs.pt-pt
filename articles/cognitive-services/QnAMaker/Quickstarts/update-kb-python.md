---
title: Guia de introdução sobre como atualizar uma Base de Dados de Conhecimento em Python – Serviços Cognitivos do Azure | Microsoft Docs
...
Se ainda não tiver uma base de dados de conhecimento, pode criar uma de exemplo para utilizar neste guia de introdução: [Criar uma nova base de dados de conhecimento](create-new-kb-python.md).
