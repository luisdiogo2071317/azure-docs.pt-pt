---
title: Visite o início rápido para Maker de QnA Microsoft API (V4) - serviços cognitivos do Azure | Microsoft Docs
...
ms.locfileid: "36301296"
---
# <a name="quickstart-for-microsoft-qna-maker-api-with-go"></a>Início rápido para Maker de QnA Microsoft API com aceda 
<a name="HOLTop"></a>

Este artigo mostra como utilizar o [Microsoft Maker de QnA API](../Overview/overview.md) com aceda ao fazer o seguinte.
...
Terá de [aceda 1.10.1](https://golang.org/dl/) para executar este código.
...
1. Crie um novo projeto de aceda no seu IDE favorito.
