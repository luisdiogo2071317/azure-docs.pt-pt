...
Para obter ajuda com o Visual Studio e o Python: [Work with Python in Visual Studio on Windows](https://docs.microsoft.com/en-us/visualstudio/python/overview-of-python-tools-for-visual-studio) (Trabalhar com o Python no Visual Studio em Windows).
...
3. Substitua o valor `subscriptionKey` pela sua chave de subscrição válida.
