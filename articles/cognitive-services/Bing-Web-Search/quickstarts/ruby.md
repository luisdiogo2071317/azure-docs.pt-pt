...
description: Neste guia de início rápido, irá aprender a fazer a primeira chamada à API de Pesquisa na Web do Bing através do Ruby e receber uma resposta JSON.
...
ms.locfileid: "46127062"
---
# <a name="quickstart-use-ruby-to-call-the-bing-web-search-api"></a>Guia de Início Rápido: Utilizar o Ruby para chamar a API de Pesquisa na Web do Bing  
