---
title: Aplicação de Web de página única de pesquisa na Web Bing (código de origem) | Microsoft Docs
description: Código de origem para o tutorial que mostra como utilizar a API de pesquisa do Bing Web numa aplicação Web de página única.
