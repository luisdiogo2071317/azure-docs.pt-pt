---
title: Conteúdo externo e da Comunidade para a API de análise de texto
titleSuffix: Azure Cognitive Services
description: Blogs do parceiro, vídeos do youtube, treinamento do Microsoft Cognitive Services API análise de texto no Azure.
...
# <a name="external--community-content-for-the-text-analytics-cognitive-service"></a>Conteúdo externo e da Comunidade para o serviço cognitivos de análise de texto
 ...
 Ligações neste artigo levá-lo para o conteúdo da web úteis desenvolvido e produzidos pelos parceiros e aos profissionais de experiência de usar a API de análise de texto.
...
+ [Lógica de aplicação para detetar sentimentos e extrair expressões-chave no seu texto](https://www.youtube.com/watch?v=jVN9NObAzgk)

+ [Análise de sentimentos com o Power BI e os serviços cognitivos da Microsoft](https://www.youtube.com/watch?v=gJ1j3N7Y75k)

+ [Análise de texto extrair expressões-chave com o Power BI e os serviços cognitivos da Microsoft](https://www.youtube.com/watch?v=R_-1TB2BF14)

## <a name="next-steps"></a>Passos Seguintes

Está à procura de informações sobre um recurso ou casos de utilização que não abordamos? Considere solicitar ou de voto para o mesmo [UserVoice](https://cognitive.uservoice.com/forums/555922-text-analytics). 
