---
title: Idiomas suportados na API de análise de texto
titleSuffix: Azure Cognitive Services
description: Lista de disponibilidade geral e o idioma de pré-visualização de suporte para operações de API de análise de texto. Aplica-se a análise de sentimentos, extração de expressões-chave e deteção de idioma.
...
ms.locfileid: "45603248"
---
# <a name="supported-languages-in-the-text-analytics-cognitive-service"></a>Idiomas suportados no serviço cognitivos de análise de texto
