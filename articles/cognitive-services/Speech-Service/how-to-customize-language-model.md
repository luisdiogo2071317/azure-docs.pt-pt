...
description: Aprenda a criar um modelo de linguagem com o Serviço de Voz - Serviços Cognitivos da Microsoft.
...
Veja a lista completa de [linguagens suportadas](supported-languages.md) para os modelos de linguagem **Conversão de Voz em Texto** personalizados.
