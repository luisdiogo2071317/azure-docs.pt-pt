...
Terá de obter primeiro uma [chave de subscrição do Azure](https://azure.microsoft.com/try/cognitive-services/) e, em seguida, irá precisar de consultar o [transcrição API do Batch](batch-transcription.md) documentação.
