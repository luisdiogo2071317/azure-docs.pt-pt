...
description: >
  Mostra várias formas de reconhecer a conversão de voz (de ficheiro, do microfone, com um modelo personalizado, continuamente ou da) com o SDK de voz para Java.
