...
O formulário falado tem de estar em minúsculas, que pode forçar durante a importação. Além disso, tem de fornecer verificações no importador de dados. Nenhum separador no formulário falado ou o formulário de apresentação é permitida. No entanto, existem poderá ser mais proibido carateres no formulário de apresentação (por exemplo, ~ e ^).
