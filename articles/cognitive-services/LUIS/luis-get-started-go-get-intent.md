---
title: Guia de Início Rápido da linguagem Go – prever a intenção – LUIS
...
3. Execute a aplicação do Go a partir da linha de comandos ao introduzir o seguinte texto na linha de comandos: 
