---
title: Tutorial para aprender a chamar uma aplicação Language Understanding (LUIS) com Python | Microsoft Docs
...
ms.locfileid: "36264589"
---
# <a name="tutorial-call-a-luis-endpoint-using-python"></a>Tutorial: Chamar um ponto final do LUIS com Python
...
1. Copie um dos fragmentos de código seguinte:
...
2. Substitua o valor do campo `Ocp-Apim-Subscription-Key` pela sua chave de subscrição do LUIS.

3. Execute o script. Apresenta o mesmo JSON que viu anteriormente na janela do browser.
<!-- 
