...
Após adicionar, editar, eliminar ou desativar uma lista de frase [treinar e testar a aplicação](interactive-test.md) novamente para ver se melhora o desempenho.
