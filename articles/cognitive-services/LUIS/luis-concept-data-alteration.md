...
|--|--|
|`spellCheck`|boolean|
|`bing-spell-check-subscription-key`|[API V7 de verificação do ortográfica do Bing](https://azure.microsoft.com/services/cognitive-services/spell-check/) chave de subscrição|
