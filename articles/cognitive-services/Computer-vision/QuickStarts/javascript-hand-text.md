...
description: Neste início rápido, irá extrair texto manuscrito de uma imagem através da Imagem Digitalizada com JavaScript nos Serviços Cognitivos.
...
1. Copie o seguinte e guarde-o num ficheiro como `handwriting.html`.
...
O JSON devolve uma resposta de êxito. Os resultados devolvidos de escrita manual incluem texto, caixa delimitadora para regiões, linhas e palavras.
