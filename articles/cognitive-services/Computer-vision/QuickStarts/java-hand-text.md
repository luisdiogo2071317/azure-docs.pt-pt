...
description: Neste início rápido, irá extrair texto manuscrito de uma imagem através da Imagem Digitalizada com Java nos Serviços Cognitivos.
...
Uma resposta bem-sucedida é devolvida no JSON. Os resultados do reconhecimento de escrita manual incluem o texto detetado e as caixas delimitadoras para regiões, linhas e palavras.

O programa deve produzir um resultado semelhante ao seguinte JSON:
