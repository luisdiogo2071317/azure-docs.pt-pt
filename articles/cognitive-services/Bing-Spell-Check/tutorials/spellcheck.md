...
Neste tutorial, vamos compilar uma página Web que permite que os utilizadores consultem a API de Verificação de Ortografia do Bing.
...
## <a name="add-html-header"></a>Adicionar o cabeçalho HTML
...
A função bingSpellCheck é chamada sempre que o utilizador introduz texto no campo de formulário HTML.
Utiliza dois parâmetros: o conteúdo do campo do formulário HTML e a chave de API de Verificação de Ortografia do Bing.
...
Crie um formulário HTML com um campo de texto. Processe o evento **onsubmit** e chame a função bingSpellCheck, passando o conteúdo do campo de texto e a chave de API de Verificação de Ortografia do Bing.
