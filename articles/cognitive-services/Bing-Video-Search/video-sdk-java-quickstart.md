...
Instale as dependências de SDK de Pesquisa de Vídeos do Bing com o Maven, Gradle ou outro sistema de gestão de dependências. O ficheiro POM do Maven requer a declaração:
```
  <dependencies>
    <dependency>
