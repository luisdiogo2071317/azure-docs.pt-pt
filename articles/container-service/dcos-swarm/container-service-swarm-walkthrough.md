---
title: "Guia de início rápido – Cluster Azure Docker Swarm para Linux"
...
Crie um cluster Docker Swarm no Azure Container Service com o comando [az acs create](/cli/azure/acs#az_acs_create). 
