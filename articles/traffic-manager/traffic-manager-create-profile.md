...
4. No **perfil do Gestor de tráfego criar**, concluída, da seguinte forma:
...
2. No **perfil do Traffic Manager**, no **definições** secção, clique em **pontos finais**.
3. Clique em **Adicionar**.
4. Conclua os seguintes:
    ...
    4. Para **recurso de destino**, clique em **escolher um serviço de aplicações** para mostrar a listagem das aplicações Web na mesma subscrição. No **recursos**, escolha o serviço de aplicações que pretende adicionar como o primeiro ponto final.
...
6.  Quando a adição de ambos os pontos finais estiver concluída, são apresentados no **perfil do Traffic Manager** juntamente com o respetivo estado de monitorização como **Online**.
...
Quando já não é necessário, elimine o grupo de recursos e o perfil do Gestor de tráfego que criou. Para tal, selecione o grupo de recursos do **perfil do Traffic Manager** e clique em **eliminar**.
