...
description: Criar um servidor de base de dados do Azure SQL e a base de dados no portal do Azure e a consulta.
...
Uma base de dados SQL do Azure tem um conjunto definido de [recursos de computação e armazenamento](sql-database-service-tiers-dtu.md). Criar a base de dados num [servidor de base de dados SQL](sql-database-features.md) dentro de um [grupo de recursos do Azure](../azure-resource-manager/resource-group-overview.md).
