...
Deteção de ameaças do SQL Deteta atividades anómalas que invulgares e potencialmente prejudiciais tenta aceder ou explorar bases de dados numa instância de gerida de base de dados no Azure SQL (pré-visualização).
