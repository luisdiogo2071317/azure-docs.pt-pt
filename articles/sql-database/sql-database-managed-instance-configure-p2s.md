...
ms.locfileid: "47163006"
---
# <a name="configure-a-point-to-site-connection-to-connect-to-an-azure-sql-database-managed-instance-from-on-premises-computer"></a>Configurar uma ligação de ponto a site para ligar a uma instância de gerida de base de dados do Azure SQL a partir do computador no local
...
5. Havigate para a pasta de WindowsAmd64 e abra o **VpnClientSetupAmd64.exe** ficheiro.
