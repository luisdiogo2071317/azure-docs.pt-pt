...
2. Aceda a **crie um recurso** > **bases de dados** > **base de dados SQL**.
...
1. Abra o SQL Server Management Studio. (Aceda a **Connect** > **motor de base de dados** para abrir o **ligar ao servidor** janela se não estiver aberto.)
