...
O serviço de deteção de ameaças é cobrado 15$ / mês para todas as bases de dados por servidor lógico ou a instância gerida, com os primeiros 30 dias sem encargos.
...
Deteção de ameaças da base de dados SQL integra seus alertas no [Centro de segurança do Azure](https://azure.microsoft.com/services/security-center/). Um mosaicos dinâmicos de deteção de ameaças SQL na base de dados e os painéis da ATP do SQL no portal do Azure rastrear o status de ameaças ativas.
