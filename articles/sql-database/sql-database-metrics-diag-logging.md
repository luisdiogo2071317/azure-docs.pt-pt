...
Leia sobre como [alterar as definições de diagnóstico ao através da API de REST do Azure Monitor](https://docs.microsoft.com/en-us/rest/api/monitor/diagnosticsettings). 
