...
* As três aplicações de inquilino de exemplo são implementadas. Para implementar estas aplicações em menos de cinco minutos, veja [implementar e explorar o padrão de aplicativo da Wingtip Tickets SaaS autónomo](https://docs.microsoft.com/azure/sql-database/saas-standaloneapp-get-started-deploy).
...
Pode explorar como o catálogo é usado para oferecer suporte a vários cenários entre inquilinos a utilizar a versão da base de dados por inquilino dos [aplicação Wingtip Tickets SaaS](https://docs.microsoft.com/azure/sql-database/saas-dbpertenant-wingtip-app-overview).  
