...
| SIZE_BASED_CLEANUP_MODE |Especifica se a limpeza de dados automática ocorre quando o limite se aproxima do tamanho dos dados Store de consulta |AUTOMÁTICA |Imposta para todas as bases de dados |
| QUERY_CAPTURE_MODE |Especifica se a todas as consultas ou apenas um subconjunto de consultas são controladas |AUTOMÁTICA |Imposta para todas as bases de dados |
