...
ms.locfileid: "50912973"
---
# <a name="quickstart-azure-sql-database-use-visual-studio-code-to-connect-and-query-data"></a>Início Rápido: Base de Dados SQL do Azure: utilize o Visual Studio Code para ligar e consultar dados
...
Para macOS, tem de instalar o OpenSSL que é um pré-requisito do .Net Core que essa extensão do mssql utiliza. Abra o terminal e introduza os comandos seguintes para instalar **brew**, **OpenSSL**. 
...
Utilize o seguinte código para eliminar o produto novo que foi adicionado anteriormente com uma declaração Transact-SQL [ELIMINAR](https://docs.microsoft.com/sql/t-sql/statements/delete-transact-sql).
