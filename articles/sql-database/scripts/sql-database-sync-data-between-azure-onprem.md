---
title: Exemplo do PowerShell - Sincronizar entre a Base de Dados SQL e o SQL Server no local | Microsoft Docs
...
| [Get-AzureRmSqlSyncSchema](https://docs.microsoft.com/powershell/module/azurerm.sql/Get-AzureRmSqlSyncSchema?view=azurermps-6.8.1) |  Obtém as informações de esquema da base de dados |
...
-   Atualizar o esquema de sincronização
    ...
    -   Com o PowerShell - [utilize o PowerShell para atualizar o esquema de sincronização num grupo de sincronização existente](sql-database-sync-update-schema.md)
