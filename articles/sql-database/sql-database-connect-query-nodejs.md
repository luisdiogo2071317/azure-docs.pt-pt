...
ms.locfileid: "38561116"
---
# <a name="use-nodejs-to-query-an-azure-sql-database"></a>Utilizar o Node.js para consultar uma base de dados SQL do Azure

Este início rápido demonstra como utilizar o [Node.js](https://nodejs.org/en/) para criar um programa para ligar a uma base de dados SQL do Azure e como utilizar instruções Transact-SQL para consultar dados.
