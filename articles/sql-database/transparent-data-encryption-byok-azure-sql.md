...
### <a name="guidelines-for-configuring-the-tde-protector-asymmetric-key-stored-in-azure-key-vault"></a>Diretrizes para configurar o Protetor de TDE (chave assimétrica) armazenados no Azure Key Vault
