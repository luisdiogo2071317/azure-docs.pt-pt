...
- Mais informações: [Segurança da base de dados SQL: Gerir a segurança de acesso e o início de sessão da base de dados](sql-database-manage-logins.md).
...
- Mais informações: [Mensagens de erro para os programas de cliente de base de dados SQL](sql-database-develop-error-messages.md).
