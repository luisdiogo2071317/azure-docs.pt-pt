...
ms.locfileid: "48867113"
---
# <a name="an-overview-ahd-azure-sql-database-security-capabilities"></a>Capacidades de segurança uma visão geral ahd SQL Database do Azure
