...
description: O Azure Cost Management é uma solução de gestão de custos multiclouds que o ajuda a utilizar o Azure e outros recursos da cloud.
...
Para ver um vídeo introdutório, veja [Introduction to Azure Cost Management (Introdução ao Azure Cost Management)](https://youtu.be/NWIRny6Wpsk).
