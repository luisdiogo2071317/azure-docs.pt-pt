---
title: Adicionar um certificado para o arquivo de ACs de Java
...
Pode utilizar keytool para adicionar o certificado de AC antes de zipping o JDK e adicioná-lo ao seu projeto do Azure **approot** pasta, ou foi possível executar uma tarefa de arranque do Azure que utiliza keytool para adicionar o certificado. (Este exemplo assume que está a adicionar um certificado de AC antes de zipping o JDK). Além disso, é utilizado um certificado de AC específico no exemplo, mas os passos para obter um certificado de AC diferente e importá-la para o arquivo de cacerts seriam semelhantes.
...
3. Importe o certificado através do seguinte comando:
    ...
    Se lhe for pedido para confiar um certificado com uma impressão digital de MD5 de 67:CB:9 D: C0:13:24:8A:82:9B:B2:17:1E:D1:1B:EC:D4, responder, escrevendo **y**.
