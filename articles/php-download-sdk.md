...
1. [Instalar o Git][install-git]. No Windows, também terá de adicionar o executável de Git para a variável de ambiente PATH.

2. Crie um ficheiro denominado **Composer** na raiz do projeto e adicione o seguinte código:
...
4. Abra uma linha de comandos e execute este na raiz do projeto
...
Para obter mais informações, consulte o [Centro para programadores do PHP](https://azure.microsoft.com/develop/php/).
