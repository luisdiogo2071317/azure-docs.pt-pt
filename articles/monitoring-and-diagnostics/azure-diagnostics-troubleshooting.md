...
ms.locfileid: "46952584"
---
# <a name="azure-diagnostics-troubleshooting"></a>Resolução de problemas de diagnóstico do Azure
Este artigo descreve as informações de resolução de problemas que são relevantes para a utilização de diagnóstico do Azure. Para obter mais informações sobre o diagnóstico do Azure, consulte [descrição geral de diagnóstico do Azure](azure-diagnostics.md).
...
- **Contadores de desempenho**: Abra o perfmon e verificar o contador.
...
| -11 |O agente convidado não foi possível criar o processo responsável por iniciar e monitorizar o agente de monitorização.<p><p>Solução: Verifique se os recursos de sistema suficientes disponíveis para novos processos de iniciar.<p> |
...
| -102 |O processo de plug-in é não é possível inicializar em si.<p><p>Solução: Verifique se os recursos de sistema suficientes disponíveis para novos processos de iniciar. |
| -103 |O processo de plug-in é não é possível inicializar em si. Especificamente, não consegue criar o objeto logger.<p><p>Solução: Verifique se os recursos de sistema suficientes disponíveis para novos processos de iniciar. |
...
| -111 |Não é possível iniciar o agente de monitorização.<p><p>Solução: Verifique se os recursos de sistema suficientes disponíveis. |
| -112 |Erro geral |
...
**Atenuação:** instalar o .NET 4.5 ou posterior no seu computador.
