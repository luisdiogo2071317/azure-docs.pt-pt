...
3. Introduza as informações da aplicação lógica mostradas na imagem seguinte.  Utilize a localização predefinida. Marque a opção **Afixar ao Dashboard**.  Quando terminar, clique em **Criar**. 
