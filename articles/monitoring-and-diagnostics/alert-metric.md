...
4. Se o recurso selecionado tem métricas, pode criar alertas, **sinais disponíveis** na parte inferior direita irá incluir as métricas. Pode ver a lista completa dos tipos de recurso suportados para alertas de métricas desta [artigo](monitoring-near-real-time-metric-alerts.md#metrics-and-dimensions-supported)
...
## <a name="view-and-manage-metric-alert-rules-using-azure-portal"></a>Ver e gerir regras de alerta de métrica com portal do Azure
...
- [Criar alertas de métricas utilizando modelos do Azure Resource Manager](monitoring-enable-alerts-using-template.md).
- [Compreender a forma como o trabalho de alertas de métrica](alert-metric-overview.md).
- [Compreender o esquema de hook de web para alertas de métricas](monitoring-near-real-time-metric-alerts.md#payload-schema)