---
title: Como a acionar ações complexas com alertas de monitorização do Azure e os grupos de ações | Microsoft Docs
...
7.  Selecione **payload de exemplo de utilização para gerar o esquema**.
