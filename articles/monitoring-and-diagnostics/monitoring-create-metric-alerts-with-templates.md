...
## <a name="resource-manager-template-for-metric-alert-that-monitors-multiple-resources"></a>Modelo do Resource Manager para o alerta de métrica que monitoriza vários recursos

A seção anterior descreveu os modelos do Azure Resource Manager de exemplo para criar alertas de métricas que monitorize um único recurso. Monitor do Azure agora suporta a monitorização de vários recursos com uma regra de alerta de métrica única. Esta funcionalidade de pré-visualização está atualmente disponível apenas através de modelos Azure Resource Manager e a REST API e só é suportada para máquinas virtuais. Suporte do portal para criar e editar dessas regras estará disponível brevemente.
...
### <a name="all-virtual-machines-in-one-or-more-resource-groups"></a>Todas as máquinas virtuais num ou mais grupos de recursos

Este modelo irá criar uma regra de alerta de métrica que monitoriza a percentagem de CPU para todas as máquinas virtuais (numa região do Azure) num ou mais grupos de recursos.

Guarde o json abaixo como all-vms-em-resource-group.json com o objetivo deste passo a passo.
...
Guarde e modificar o json abaixo como all-vms-no-resource-group.parameters.json para efeitos destas instruções.
...
### <a name="all-virtual-machines-in-a-subscription"></a>Todas as máquinas virtuais numa subscrição

Este modelo irá criar uma regra de alerta de métrica que monitoriza a percentagem de CPU para todas as máquinas virtuais (numa região do Azure) numa subscrição.

Guarde o json abaixo como all-vms-em-subscription.json com o objetivo deste passo a passo.
...
Pode utilizar o modelo acima com o ficheiro de parâmetros abaixo.
Guarde e modificar o json abaixo como all-vms-em-subscription.parameters.json para efeitos destas instruções.
...
Este modelo irá criar uma regra de alerta de métrica que monitoriza a percentagem de CPU para obter uma lista de máquinas virtuais (numa região do Azure) numa subscrição.

Guarde o json abaixo como lista de vms.json com o objetivo deste passo a passo.
...
Pode utilizar o modelo acima com o ficheiro de parâmetros abaixo.
Guarde e modificar o json abaixo como lista de vms.parameters.json para efeitos destas instruções.
...
* Leia mais sobre [alertas no Azure](monitoring-overview-alerts.md)
* Saiba como [criar um grupo de ação com modelos do Resource Manager](monitoring-create-action-group-with-resource-manager-template.md)
