...
* Todas as falhas de dimensionamento automático são registadas no registo de atividade. Em seguida, pode configurar uma [alerta de registo de atividade](./monitoring-activity-log-alerts.md) para que pode ser notificado por e-mail, SMS ou webhooks sempre que houver uma falha de dimensionamento automático.
