...
ms.locfileid: "51233971"
---
# <a name="alerts-with-dynamic-thresholds-in-azure-monitor-limited-public-preview"></a>Alertas com limiares dinâmicos no Azure Monitor (pré-visualização pública limitada)
...
6. Definições de lógica de alerta adicional:
   ...
   - Sensibilidade de alerta:
    ...
    ![Definições de lógica de alerta](./media/monitoring-alerts-dynamic-thresholds/00007.png)
...
- P: se a métrica lentamente altera ao longo do tempo, isto irá acionar um alerta com limiares dinâmicos?
...
- P: posso configurar limiares dinâmicos através de uma API?
