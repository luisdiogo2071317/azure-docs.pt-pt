...
| Relatórios do Active Directory | Eventos | Azure Active Directory | <ul><li>**REST API:** [graph API do Azure Active Directory](../active-directory/active-directory-reporting-api-getting-started.md)</li></ul> |
...
- Saiba mais sobre [métricas do Azure Monitor](monitoring-overview-metrics.md)
