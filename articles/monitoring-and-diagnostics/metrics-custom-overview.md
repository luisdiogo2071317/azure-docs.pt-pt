...
- Instale a extensão do Windows Azure Diagnostics (WAD) no seu [VM do Azure](metrics-store-custom-guestos-resource-manager-vm.md), [conjunto de dimensionamento de máquina virtual](metrics-store-custom-guestos-resource-manager-vmss.md), [VM clássica](metrics-store-custom-guestos-classic-vm.md), ou [clássico de serviços Cloud](metrics-store-custom-guestos-classic-cloud-service.md) e enviar os contadores de desempenho para o Azure Monitor. 
- Instalar o [InfluxData Telegraf agente](metrics-store-custom-linux-telegraf.md) na sua VM Linux do Azure e as métricas de envio utilizando o Azure Monitor de saída do plug-in.
- Enviar métricas personalizadas [diretamente para a API de REST do Azure Monitor](metrics-store-custom-rest-api.md), `https://<azureregion>.monitoring.azure.com/<AzureResourceID>/metrics`.
...
* **Min**: O mínimo observou o valor de todos os exemplos e medições durante o minuto.
* **Máx.**: O máximo valor de todos os exemplos e medidas foi observada durante o minuto.
...
Utilize métricas personalizadas dos serviços de diferentes: 
 - [Máquinas Virtuais](metrics-store-custom-guestos-resource-manager-vm.md)
 - [Conjunto de dimensionamento de máquina virtual](metrics-store-custom-guestos-resource-manager-vmss.md)
 - [Máquinas virtuais do Azure (clássico)](metrics-store-custom-guestos-classic-vm.md)
 - [Máquina Virtual Linux utilizando o agente de Telegraf](metrics-store-custom-linux-telegraf.md)
 - [API REST](metrics-store-custom-rest-api.md)
 - [Serviços Cloud clássico](metrics-store-custom-guestos-classic-cloud-service.md)
