...
[Adicionar um utilizador a um grupo] (# add-user-to-group) | `N / A` | : Heavy_check_mark:
[Remover um utilizador de um grupo] (# remove-user-from-group) | `N / A` | : Heavy_check_mark:
<a name="broadcast"> </a>
