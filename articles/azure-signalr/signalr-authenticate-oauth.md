---
title: Tutorial para a autenticação de clientes do serviço Azure SignalR
...
Neste tutorial, vai aprender a implementar a sua própria autenticação e a integrá-la no Microsoft Azure SignalR Service.
