...
+ Certifique-se de que existe uma Aplicação API na sua subscrição. Para obter mais informações, veja [Documentação sobre o Serviço de Aplicações][https://docs.microsoft.com/azure/app-service/]
