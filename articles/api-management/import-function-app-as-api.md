...
+ Certifique-se de que existe uma Function App na sua subscrição. Para obter mais informações, veja [Criar uma Function App](../azure-functions/functions-create-first-azure-function.md#create-a-function-app).
