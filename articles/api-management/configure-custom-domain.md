...
> [!WARNING]
> Os clientes que pretenderem utilizar a afixação de certificado para melhorar a segurança das respetivas aplicações tem de utilizar um nome de domínio personalizado > e o certificado que eles geridos, não o certificado predefinido. Clientes que afixar o certificado predefinido em vez disso, será > tendo uma dependência de disco rígida nas propriedades do certificado que não controlam, que não é uma prática recomendada.
