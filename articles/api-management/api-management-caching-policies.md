...
|variar pelo programador|Definido como `true` para respostas de cache por chave de programador.|Sim||  
|variar-por-programador-groups|Definido como `true` para respostas de cache por função de utilizador.|Sim||  
