...
* Uma subscrição do Azure. Para obter mais informações sobre a obtenção de uma subscrição, consulte [opções de compra][purchase options], [ofertas de membros][member offers], ou [livre conta][free account].
