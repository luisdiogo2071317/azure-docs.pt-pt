...
> [!NOTE]
> O escalão básico do Service Bus não suporta a sessões. Os escalões standard e premium suportam sessões. Para obter mais informações, consulte [preços do Service Bus](/pricing/details/service-bus/).
