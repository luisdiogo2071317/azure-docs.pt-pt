...
Para a sintaxe JSON e propriedades, consulte [espaços de nomes](/azure/templates/microsoft.servicebus/namespaces) e [filas](/azure/templates/microsoft.servicebus/namespaces/queues).
