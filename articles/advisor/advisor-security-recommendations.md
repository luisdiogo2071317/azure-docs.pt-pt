...
Para mais informações sobre as recomendações de segurança, consulte [gerir recomendações de segurança no Centro de segurança do Azure](https://azure.microsoft.com/documentation/articles/security-center-recommendations/).
