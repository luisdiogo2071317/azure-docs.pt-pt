...
Para obter mais informações sobre as recomendações de serviços de aplicações, consulte [melhores práticas para o App Service do Azure](https://azure.microsoft.com/documentation/articles/app-service-best-practices/).
