...
* [Implementar o acelerador de solução de monitorização remota](iot-accelerators-remote-monitoring-deploy.md).
...
1. No portal do Azure, clique em de **nuvem Shell** botão.
    ...
    ![Ícone de início do portal](./media/iot-accelerators-integrate-data-lake/portal-launch-icon.png)
...
1. Clique em **crie um recurso**, selecione de Internet das coisas no Marketplace e clique em **tarefa do Stream Analytics**.
    ...
    ![Nova tarefa de Stream Analytics](./media/iot-accelerators-integrate-data-lake/new-stream-analytics-job.png)
...
1. Clique em **adicionar a entrada de fluxo** e selecione **IoT Hub** da lista pendente.
    ...
    ![Adicionar a entrada](./media/iot-accelerators-integrate-data-lake/stream-analytics-add-input.png)
...
1. Na página Descrição geral, clique em **saídas**.
    ...
    ![Adicione o arquivo Data Lake](./media/iot-accelerators-integrate-data-lake/stream-analytics-overview-2.png)
...
1. Clique em **autorizar**.
    ...
    ![Autorizar o Stream Analytics para o arquivo Data Lake](./media/iot-accelerators-integrate-data-lake/stream-analytics-out-authorize.png)
...
1. No Explorador de dados, desagregar o **/ de transmissão em fluxo** pasta. Verá pastas criadas com o formato dd/MM/DD/HH.
    ...
    ![Explore os dados de transmissão em fluxo](./media/iot-accelerators-integrate-data-lake/data-lake-store-data-explorer.png)

    Irá ver ficheiros json com um ficheiro por hora.

    ![Explore os dados de transmissão em fluxo](./media/iot-accelerators-integrate-data-lake/data-lake-store-file-preview.png)
