...
* [Criar um novo dispositivo simulado](iot-accelerators-device-simulation-create-simulated-device.md) coloca tudo isso e mostra-lhe como implementar um novo tipo de dispositivo simulado à sua solução.
