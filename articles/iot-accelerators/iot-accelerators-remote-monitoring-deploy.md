...
1. Clique em **Tente agora** no **monitorização remota** mosaico.
    ...
    ![Escolha a monitorização remota](./media/iot-accelerators-remote-monitoring-deploy/remotemonitoring.png)
...
1. Clique em **Criar Solução** para iniciar o processo de aprovisionamento. Este processo normalmente demora vários minutos a executar:
    ...
    ![Detalhes de solução de monitorização remotos](./media/iot-accelerators-remote-monitoring-deploy/createform.png)
