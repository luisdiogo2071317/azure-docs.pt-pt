---
title: Implementar e executar uma solução de simulação de dispositivo no Azure | Microsoft Docs
...
Para saber como utilizar o Hub IoT existente numa simulação, consulte o guia de procedimentos:
