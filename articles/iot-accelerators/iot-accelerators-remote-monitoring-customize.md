...
1. Utilizar o portal do Azure ou o [az CLI](https://docs.microsoft.com/cli/azure/install-azure-cli?view=azure-cli-latest) para ativar o acesso SSH à máquina virtual que aloja os microsserviços na sua solução. Por exemplo:
    ...
    Só deverá ativar o acesso SSH durante o desenvolvimento e teste. Se ativar o SSH, [deve desabilitá-la novamente logo que possível](../security/azure-security-network-security-best-practices.md#disable-rdpssh-access-to-azure-virtual-machines).
...
* [Os microsserviços de configuração para soluções de IoT do Azure (.NET)](https://github.com/Azure/pcs-ui-config-dotnet/)
* [Os microsserviços de configuração para soluções de IoT do Azure (Java)](https://github.com/Azure/pcs-ui-config-java/)
