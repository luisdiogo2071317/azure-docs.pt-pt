...
Pode ver informações sobre o acelerador de soluções de Fábrica Ligada no painel apresentado. Selecione **Dashboard de soluções** para ver o acelerador de soluções de Fábrica Ligada:
