---
title: 'IoT DevKit para a cloud: ligar IoT DevKit AZ3166 para acelerador de solução de IoT de monitorização remota | Documentos da Microsoft'
...
Pode alterar o ID de dispositivo no IoT Hub ao seguir [este guia](https://microsoft.github.io/azure-iot-developer-kit/docs/customize-device-id/).
