...
ms.locfileid: "38972918"
---
# <a name="quickstart-deploy-a-cloud-based-solution-to-run-a-predictive-maintenance-analysis-on-my-connected-devices"></a>Início Rápido: Implementar uma solução baseada na cloud para executar uma análise de manutenção preditiva nos meus dispositivos ligados

Este início rápido mostra como implementar o acelerador de soluções de Manutenção Preditiva de IoT do Azure para utilizar como uma solução de manutenção preditiva baseada na cloud para os seus dispositivos IoT. Depois de implementar o acelerador de soluções, utilize a página **Dashboard** da solução para executar uma simulação com dados de motores de aeronaves.
...
Na página **Criar Manutenção Preditiva**, introduza um **Nome da solução** exclusivo para o seu acelerador de soluções de Manutenção Preditiva.
...
Quando a implementação da sua subscrição do Azure estiver concluída, pode iniciar sessão no dashboard do acelerador de soluções de Manutenção Preditiva.
...
Para saber mais sobre o acelerador de soluções, veja o artigo.
