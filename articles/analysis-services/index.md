---
title: Documentação do Azure Analysis Services - Tutoriais, Referência da API
...
<ul class="panelContent cardsW">
    ...
                    <div class="cardText">
                        <h3>REST</h3>
                        <p><a href="/rest/api/analysisservices/">Referência da API REST</a></p>
                    </div>
                </div>
            </div>
        </div>
