...
2. Utilize [identidade de vm az atribuir](/cli/azure/vm/identity/#az_vm_identity_assign) com o `identity assign` comando para adicionar um MSI para uma VM existente:
