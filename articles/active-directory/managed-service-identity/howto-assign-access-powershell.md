...
Depois de ativar MSI um recurso do Azure, [como uma VM do Azure](qs-configure-powershell-windows-vm.md):

1. Inicie sessão no Azure com o `Connect-AzureRmAccount` cmdlet. Utilize uma conta que está associada à subscrição do Azure na qual configurou o MSI:
...
- Para ativar o MSI numa VM do Azure, consulte [configurar um Azure VM geridos serviço de identidade (MSI) com o PowerShell](qs-configure-powershell-windows-vm.md).
