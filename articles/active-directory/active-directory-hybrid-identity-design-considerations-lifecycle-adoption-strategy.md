...
Nesta tarefa, vai definir a estratégia de gestão de identidade para a sua solução de identidade híbrida cumprir os requisitos de negócios que definiu nas [determinar as tarefas de gestão de identidade híbrida](active-directory-hybrid-identity-design-considerations-hybrid-id-management-tasks.md).
...
> [!NOTE]
> Para obter mais informações, consulte [integrar as identidades no local com o Azure Active Directory](active-directory-aadconnect.md).
> 
> 
