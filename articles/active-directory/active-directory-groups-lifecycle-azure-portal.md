...
Os seguintes cmdlets pode ser utilizados para configurar a política mais detalhadamente. Para obter mais informatin, consulte [PowerShell documentação](https://docs.microsoft.com/powershell/module/azuread/?view=azureadps-2.0-preview&branch=master#groups).
