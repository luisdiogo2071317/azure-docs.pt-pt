...
- Utilize o Azure Monitor com os Hubs de Eventos para transmitir os registos para o seu sistema SIEM. Primeiro, [transmita os registos para um hub de eventos](quickstart-azure-monitor-stream-logs-to-event-hub.md) e, em seguida [configure a ferramenta SIEM](quickstart-azure-monitor-stream-logs-to-event-hub.md#access-data-from-your-event-hub) com o hub de eventos configurado. 
