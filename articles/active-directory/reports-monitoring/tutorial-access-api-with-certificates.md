...
1. Primeiro, certifique-se de que concluiu o [pré-requisitos para aceder ao Azure Active Directory reporting API](howto-configure-prerequisites-for-reporting-api.md). 

2. Baixe e instale o Azure AD Powershell V2, seguir as instruções em [Azure Active Directory do PowerShell (https://github.com/Azure/azure-docs-powershell-azuread/blob/master/docs-conceptual/azureadps-2.0/install-adv2.md)
...
2. Em seguida, siga os passos para [registar o certificado com o Azure AD](https://docs.microsoft.com/azure/active-directory/develop/active-directory-certificate-credentials#register-your-certificate-with-azure-ad) para a aplicação. 
