...
Com os relatórios de segurança no Azure Active Directory (Azure AD), pode obter informações sobre a probabilidade de contas de utilizador comprometidas no seu ambiente. Um utilizador sinalizado para risco é um indicador de uma conta de utilizador que pode ter sido comprometida.
...
Para obter informações, veja [Relatório de segurança de Utilizadores sinalizados para risco no portal do Azure Active Directory](concept-user-at-risk.md).
