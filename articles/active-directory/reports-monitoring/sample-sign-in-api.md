...
* [Registos de auditoria](overview-reports.md#activity-reports) para obter mais informações concetuais
* Veja a [Introdução à API de relatórios do Azure Active Directory](concept-reporting-api.md) para obter mais informações sobre a API de relatórios.


## <a name="prerequisites"></a>Pré-requisitos
Antes de poder utilizar os exemplos deste artigo, precisa de concluir os [pré-requisitos para aceder à API dos relatórios do Azure AD](howto-configure-prerequisites-for-reporting-api.md).  
...
* Se pretender ver uma descrição geral completa da utilização da API de relatórios do Azure Active Directory, veja [Introdução à API de relatórios do Azure Active Directory](concept-reporting-api.md).
* Se gostaria de saber mais sobre os relatórios do Azure Active Directory, veja o [Guia dos Relatórios do Azure Active Directory](overview-reports.md).  
