---
title: 'Tutorial: Integração do Azure Active Directory com JIRA SAML SSO pela Microsoft | Microsoft Docs'
description: Saiba como configurar o início de sessão entre o Azure Active Directory e JIRA SAML SSO pela Microsoft.
...
ms.locfileid: "34698701"
---
# <a name="tutorial-azure-active-directory-integration-with-jira-saml-sso-by-microsoft"></a>Tutorial: Integração do Azure Active Directory com JIRA SAML SSO pela Microsoft

Neste tutorial, irá aprender integrar JIRA SAML SSO pelo Microsoft Azure Active Directory (Azure AD).

Integrar JIRA SAML SSO pela Microsoft com o Azure AD fornece as seguintes vantagens:

- Pode controlar no Azure AD que tenha acesso ao JIRA SAML SSO pela Microsoft.
- Pode permitir aos utilizadores automaticamente obter com sessão iniciada para JIRA SAML SSO pela Microsoft (Single Sign-On) com as respetivas contas do Azure AD.
...
Para configurar a integração do Azure AD com JIRA SAML SSO pela Microsoft, terá dos seguintes itens:

- Uma subscrição do Azure AD
- JIRA núcleos e Software 6.0 para 7.8 ou JIRA 3.0 de secretária de serviço para 3.2 devem instalado e configurado numa versão do Windows de 64 bits
...
Para configurar a integração de JIRA SAML SSO pela Microsoft com o Azure AD, tem de adicionar JIRA SAML SSO pela Microsoft da Galeria à sua lista de aplicações SaaS geridas.
...
4. Na caixa de pesquisa, escreva **JIRA SAML SSO pela Microsoft**, selecione **JIRA SAML SSO pela Microsoft** partir do painel de resultados, em seguida, clique em **adicionar** botão para adicionar a aplicação.

    ![JIRA SAML SSO pela Microsoft na lista de resultados](.\media\active-directory-saas-msaadssojira-tutorial\tutorial_singlesign-onforjira_addfromgallery.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurar e testar o Azure AD-início de sessão único

Nesta secção, configure e teste do Azure AD-início de sessão único com JIRA SAML SSO pela Microsoft baseada-se um utilizador de teste chamado "Britta Simon".

Para início de sessão trabalhar, do Azure AD tem de saber o que o utilizador homólogo em JIRA SAML SSO pela Microsoft é um utilizador no Azure AD. Por outras palavras, uma relação de ligação entre um utilizador do Azure AD e o utilizador relacionado no JIRA SAML SSO pela Microsoft tem de ser estabelecida.

Para configurar e testar o Azure AD-início de sessão único com JIRA SAML SSO pela Microsoft, tem de concluir os blocos modulares seguintes:

1. **[Configurar o Azure AD Single Sign-On](#configure-azure-ad-single-sign-on)**  - para permitir aos utilizadores utilizar esta funcionalidade.
2. **[Criar um utilizador de teste do Azure AD](#create-an-azure-ad-test-user)**  - para testar o Azure AD-início de sessão único com Britta Simon.
3. **[Criar um JIRA SAML SSO pelo utilizador de teste do Microsoft](#create-a-jira-saml-sso-by-microsoft-test-user)**  - para ter um homólogo de Britta Simon JIRA SAML SSO pela Microsoft que está ligada a representação do Azure AD do utilizador.
4. **[Atribua o utilizador de teste do Azure AD](#assign-the-azure-ad-test-user)**  - para ativar Britta Simon utilizar o Azure AD-início de sessão único.
5. **[Teste o início de sessão único](#test-single-sign-on)**  - para verificar se a configuração funciona.

### <a name="configure-azure-ad-single-sign-on"></a>Configurar o Azure AD-início de sessão único

Nesta secção, ativar o Azure AD início de sessão no portal do Azure e configurar o início de sessão único na sua JIRA SAML SSO aplicações da Microsoft.

**Para configurar o Azure AD-início de sessão único com JIRA SAML SSO pela Microsoft, execute os seguintes passos:**

1. No portal do Azure, no **JIRA SAML SSO pela Microsoft** página de integração de aplicações, clique em **de sessão único-**.
...
3. No **JIRA SAML SSO ao Microsoft Domain e URLs** secção, execute os seguintes passos:
    ...
    ![JIRA SAML SSO pelo Microsoft Domain e URLs único início de sessão informações](.\media\active-directory-saas-msaadssojira-tutorial\tutorial_singlesign-onforjira_url.png)
...
4. No **certificado de assinatura de SAML** secção, clique no botão Copiar para copiar **Url de metadados de Federação de aplicação** e cole-o bloco de notas.
    ...
    ![Configurar o início de sessão único](./media/active-directory-saas-msaadssojira-tutorial/tutorial_metadataurl.png)
...
10. Execute os seguintes passos na página de configuração:
    ...
    b. Copiar o **identificador, o URL de resposta e o URL de início de sessão** valores e cole-os no **identificador, o URL de resposta e o URL de início de sessão** caixas de texto em respetivamente **JIRA SAML SSO ao Microsoft Domain e URLs** secção no portal do Azure.
...
### <a name="create-a-jira-saml-sso-by-microsoft-test-user"></a>Criar um JIRA SAML SSO pelo utilizador de teste da Microsoft

Para permitir que os utilizadores do Azure AD iniciar sessão no servidor no local JIRA, estes têm de ser aprovisionados para JIRA SAML SSO pela Microsoft. JIRA SAML SSO pela Microsoft, o aprovisionamento é uma tarefa manual.
...
Nesta secção, vai ativar Britta Simon utilizar o Azure-início de sessão único, concedendo acesso para JIRA SAML SSO pela Microsoft.

![Atribuir a função de utilizador][200] 

**Para atribuir Britta Simon a JIRA SAML SSO pela Microsoft, execute os seguintes passos:**
...
2. Na lista de aplicações, selecione **JIRA SAML SSO pela Microsoft**.
    ...
    ![O JIRA SAML SSO através da ligação da Microsoft na lista de aplicações](.\media\active-directory-saas-msaadssojira-tutorial\tutorial_singlesign-onforjira_app.png)
...
Ao clicar o JIRA SAML SSO pelo mosaico da Microsoft no painel de acesso, deve obter automaticamente com sessão iniciada para sua JIRA SAML SSO por aplicações da Microsoft.
