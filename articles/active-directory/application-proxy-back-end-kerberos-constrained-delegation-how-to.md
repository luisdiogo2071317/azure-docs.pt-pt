...
-   Implementação do Proxy de aplicações do Azure AD por [introdução ao Proxy de aplicações](manage-apps/application-proxy-enable.md) e acesso geral para aplicativos não KCD funcionar conforme esperado.
...
-   [Resolver problemas do Proxy de aplicações e mensagens de erro](manage-apps/application-proxy-troubleshoot.md)

-   [Erros de Kerberos e os sintomas](manage-apps/application-proxy-troubleshoot.md#kerberos-errors)

-   [Trabalhar com o SSO no local e na cloud identidades não são idênticas](manage-apps/application-proxy-configure-single-sign-on-with-kcd.md#working-with-different-on-premises-and-cloud-identities)
