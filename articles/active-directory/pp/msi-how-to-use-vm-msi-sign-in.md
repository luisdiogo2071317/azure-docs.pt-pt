...
Este artigo fornece exemplos de script da CLI para início de sessão através de um utilizador atribuído principal de serviço do MSI e orientações tópicos importantes, tais como o processamento de erros.
