...
* [Palavra-passe início de sessão único](manage-apps/what-is-single-sign-on.md#password-based-single-sign-on)
...
* Uso [atribuição baseada em grupo](users-groups-roles/groups-saasapps.md) e selecione a opção para introduzir uma credencial partilhada
