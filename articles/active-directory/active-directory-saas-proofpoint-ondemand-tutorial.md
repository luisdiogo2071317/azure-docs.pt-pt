...
4. Na caixa de pesquisa, escreva **Proofpoint a pedido**, selecione **Proofpoint a pedido** partir do painel de resultados, em seguida, clique em **adicionar** botão para adicionar a aplicação.

    ![Proofpoint a pedido na lista de resultados](./media/active-directory-saas-proofpoint-ondemand-tutorial/tutorial_proofpointondemand_addfromgallery.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurar e testar o Azure AD-início de sessão único

Nesta secção, configure e teste do Azure AD-início de sessão único com Proofpoint a pedido com base num utilizador de teste chamado "Britta Simon".
...
No Proofpoint a pedido, atribua o valor do **nome de utilizador** no Azure AD como o valor a **Username** para estabelecer a relação de ligação.
...
3. **[Criar um Proofpoint no utilizador de teste a pedido](#create-a-proofpoint-on-demand-test-user)**  - para ter um homólogo de Britta Simon Proofpoint a pedido que está ligada a representação do Azure AD do utilizador.
...
2. No **de sessão único-** caixa de diálogo, selecione **modo** como **baseados em SAML início de sessão** para ativar o início de sessão único.
    ...
    ![Caixa de diálogo de início de sessão único](./media/active-directory-saas-proofpoint-ondemand-tutorial/tutorial_proofpointondemand_samlbase.png)

3. No **Proofpoint no domínio a pedido e URLs** secção, execute os seguintes passos:

    ![Proofpoint no domínio a pedido e URLs único início de sessão informações](./media/active-directory-saas-proofpoint-ondemand-tutorial/tutorial_proofpointondemand_url.png)

    a. No **URL de início de sessão** caixa de texto, escreva um URL a utilizar o padrão do seguinte: `https://<hostname>.pphosted.com/ppssamlsp_hostname`
    ...
    > [!NOTE] 
    > Estes valores não estiverem reais. Atualize estes valores com o identificador de real, a URL de resposta e o URL de início de sessão. Contacte [Proofpoint na equipa de suporte de cliente a pedido](https://www.proofpoint.com/us/support-services) para obter estes valores.
...
5. No **certificado de assinatura de SAML** secção, clique em **Certificate(Base64)** e, em seguida, guarde o ficheiro de certificado no seu computador.
    ...
    ![A hiperligação de transferência do certificado](./media/active-directory-saas-proofpoint-ondemand-tutorial/tutorial_proofpointondemand_certificate.png) 

6. Clique em **guardar** botão.

    ![Configurar botão único início de sessão guardar](./media/active-directory-saas-proofpoint-ondemand-tutorial/tutorial_general_400.png)
    
7. No **Proofpoint na configuração de pedido** secção, clique em **configurar Proofpoint a pedido** para abrir **configurar início de sessão** janela. Copiar o **Sign-Out URL, o ID de entidade de SAML e o único início de sessão no URL do serviço SAML** do **secção de referência rápida.**

    ![Proofpoint na configuração de pedido](./media/active-directory-saas-proofpoint-ondemand-tutorial/tutorial_proofpointondemand_configure.png) 

8. Para configurar o início de sessão único em **Proofpoint a pedido** lado, terá de enviar o transferido **Certificate(Base64)**, **Sign-Out URL, o ID de entidade de SAML e o único início de sessão no URL do serviço SAML** para [Proofpoint na equipa de suporte do pedido](https://www.proofpoint.com/us/support-services). Se definir esta definição para que a ligação de SAML SSO corretamente em ambos os lados.
...
1. No portal do Azure, no painel esquerdo, clique em de **do Azure Active Directory** botão.
    ...
    ![O botão do Azure Active Directory](./media/active-directory-saas-proofpoint-ondemand-tutorial/create_aaduser_01.png)

2. Para apresentar a lista de utilizadores, aceda a **utilizadores e grupos**e, em seguida, clique em **todos os utilizadores**.

    !["Os utilizadores e grupos" e "Todos os utilizadores" ligações](./media/active-directory-saas-proofpoint-ondemand-tutorial/create_aaduser_02.png)

3. Para abrir o **utilizador** caixa de diálogo, clique em **adicionar** na parte superior do **todos os utilizadores** caixa de diálogo.

    ![O botão de adição](./media/active-directory-saas-proofpoint-ondemand-tutorial/create_aaduser_03.png)

4. No **utilizador** diálogo caixa, execute os seguintes passos:

    ![A caixa de diálogo de utilizador](./media/active-directory-saas-proofpoint-ondemand-tutorial/create_aaduser_04.png)
...
2. Na lista de aplicações, selecione **Proofpoint a pedido**.
    ...
    ![Proofpoint na ligação a pedido na lista de aplicações](./media/active-directory-saas-proofpoint-ondemand-tutorial/tutorial_proofpointondemand_app.png)  
...
Ao clicar Proofpoint no mosaico a pedido no painel de acesso, deve obter automaticamente com sessão iniciada para sua Proofpoint na aplicação a pedido.
