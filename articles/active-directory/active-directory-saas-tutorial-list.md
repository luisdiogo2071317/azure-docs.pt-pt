...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-10000ftplans-tutorial.png)| [Planos 10,000ft](active-directory-saas-10000ftplans-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-23video-tutorial.png)| [Vídeo 23](active-directory-saas-23video-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-8x8virtualoffice-tutorial.png)| [Office Virtual 8 x 8](active-directory-saas-8x8virtualoffice-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-absorblms-tutorial.png)| [Absorver LMS](active-directory-saas-absorblms-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-adaptivesuite-tutorial.png)| [Suite adaptável](active-directory-saas-adaptivesuite-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-adobe-creative-cloud-tutorial.png)| [Nuvem criativos Adobe](active-directory-saas-adobe-creative-cloud-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-adobeexperiencemanager-tutorial.png)| [Gestor de experiência de Adobe](active-directory-saas-adobeexperiencemanager-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-adobe-echosign-tutorial.png)| [Adobe início de sessão](active-directory-saas-adobe-echosign-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-alcumus-info-tutorial.png)| [Informações de Alcumus Exchange](active-directory-saas-alcumus-info-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-apexportal-tutorial.png)| [Portal de vértice](active-directory-saas-apexportal-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-asana-tutorial.png)| [Asana](active-directory-saas-asana-tutorial.md)|[Asana - aprovisionamento de utilizadores](active-directory-saas-asana-provisioning-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-asccontracts-tutorial.png)| [Contratos ASC](active-directory-saas-asccontracts-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-atlassian-cloud-tutorial.png)| [Nuvem Atlassian](active-directory-saas-atlassian-cloud-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-atomiclearning-tutorial.png)| [Learning atómico](active-directory-saas-atomiclearning-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-attendancemanagementservices-tutorial.png)| [Serviços de gestão de assistência](active-directory-saas-attendancemanagementservices-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-autotaskworkplace-tutorial.png)| [Área de trabalho Autotask](active-directory-saas-autotaskworkplace-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-bambubysproutsocial-tutorial.png)| [Bambu por Sprout Social](active-directory-saas-bambubysproutsocial-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-bcinthecloud-tutorial.png)| [BC na nuvem](active-directory-saas-bcinthecloud-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-birst-tutorial.png)| [Análise de negócio seja ágil Birst](active-directory-saas-birst-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-blackboard-learn-tutorial.png)| [Saiba blackboard](active-directory-saas-blackboard-learn-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-blackboard-learn-shibboleth-tutorial.png)| [Saiba blackboard - Shibboleth](active-directory-saas-blackboard-learn-shibboleth-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-bluejeans-tutorial.png)| [BlueJeans](active-directory-saas-bluejeans-tutorial.md)|[BlueJeans - aprovisionamento de utilizadores](active-directory-saas-bluejeans-provisioning-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-box-tutorial.png)| [Box](active-directory-saas-box-tutorial.md)|[Caixa - aprovisionamento de utilizadores](active-directory-saas-box-userprovisioning-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-brightspace-desire2learn-tutorial.png)| [Brightspace por Desire2Learn](active-directory-saas-brightspace-desire2learn-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-canvas-lms-tutorial.png)| [Lms tela](active-directory-saas-canvas-lms-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-capriza-tutorial.png)| [Plataforma de Capriza](active-directory-saas-capriza-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-carlsonwagonlit-tutorial.png)| [Carlson Wagonlit levar](active-directory-saas-carlsonwagonlit-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-central-desktop-tutorial.png)| [Ambiente de trabalho central](active-directory-saas-central-desktop-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-cernercentral-tutorial.png)| [Cerner Central](active-directory-saas-cernercentral-tutorial.md)|[Centro de Cerner - aprovisionamento de utilizadores](active-directory-saas-cernercentral-provisioning-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-certify-tutorial.png)| [Certificar](active-directory-saas-certify-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-cezannehrsoftware-tutorial.png)| [Software Cezanne HR](active-directory-saas-cezannehrsoftware-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-clarizen-tutorial.png)| [Clarizen](active-directory-saas-clarizen-tutorial.md)| [Clarizen - aprovisionamento de utilizadores]( active-directory-saas-clarizen-provisioning-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-clearreview-tutorial.png)| [Limpar revisão](active-directory-saas-clearreview-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-newsignature-tutorial.png)| [Portal de gestão de nuvem do Microsoft Azure](active-directory-saas-newsignature-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-collaborativeinnovation-tutorial.png)| [Colaboração inovação](active-directory-saas-collaborativeinnovation-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-complianceelf-tutorial.png)| [Conformidade ELF](active-directory-saas-complianceelf-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-concur-tutorial.png)| [Concur](active-directory-saas-concur-tutorial.md)|[Concur - aprovisionamento de utilizadores](active-directory-saas-concur-provisioning-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-confluencemicrosoft-tutorial.png)| [Confluence SAML SSO pela Microsoft](active-directory-saas-confluencemicrosoft-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-cornerstone-ondemand-tutorial.png)| [Pilares OnDemand](active-directory-saas-cornerstone-ondemand-tutorial.md)|[Pilares OnDemand - aprovisionamento de utilizadores](active-directory-saas-successcenter-provisioning-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-cs-stars-tutorial.png)| [CS estrelas](active-directory-saas-cs-stars-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-direct-tutorial.png)| [Direto](active-directory-saas-direct-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-directions-microsoft-tutorial.png)| [Instruções da Microsoft](active-directory-saas-directions-microsoft-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-docusign-tutorial.png)| [DocuSign](active-directory-saas-docusign-tutorial.md)|[DocuSign - aprovisionamento de utilizadores](active-directory-saas-docusign-provisioning-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-dome9arc-tutorial.png)| [Dome9 arco](active-directory-saas-dome9arc-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-dowjones-factiva-tutorial.png)| [Utenção Jones Factiva](active-directory-saas-dowjones-factiva-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-dropboxforbusiness-tutorial.png)| [Dropbox para empresas](active-directory-saas-dropboxforbusiness-tutorial.md)|[Dropbox para empresas - aprovisionamento de utilizadores](  active-directory-saas-dropboxforbusiness-provisioning-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-encompass-tutorial.png)| [Abranger](active-directory-saas-encompass-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-fidelitynetbenefits-tutorial.png)| [Fidelidade NetBenefits](active-directory-saas-fidelitynetbenefits-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-firmplay-tutorial.png)| [FirmPlay - empregado Advocacy para Recruiting](active-directory-saas-firmplay-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-five9-tutorial.png)| [Five9 Plus adaptador (CTI, agentes contacte Center)](active-directory-saas-five9-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-flatter-files-tutorial.png)| [Ficheiros flatter](active-directory-saas-flatter-files-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-github-tutorial.png)| [GitHub](active-directory-saas-github-tutorial.md)|[GitHub - aprovisionamento de utilizadores](active-directory-saas-github-provisioning-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-google-apps-tutorial.png)| [Google Apps](active-directory-saas-google-apps-tutorial.md)|[Aplicações do Google - aprovisionamento de utilizadores](active-directory-saas-google-apps-provisioning-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-citrix-gotomeeting-tutorial.png)| [GoToMeeting](active-directory-saas-citrix-gotomeeting-tutorial.md)|[GoToMeeting - aprovisionamento de utilizadores](active-directory-saas-citrixgotomeeting-provisioning-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-helpscout-tutorial.png)| [Scout de ajuda](active-directory-saas-helpscout-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-hostedgraphite-tutorial.png)| [Graphite alojada](active-directory-saas-hostedgraphite-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-hr2day-tutorial.png)| [HR2day por Merces](active-directory-saas-hr2day-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-icertisicm-tutorial.png)| [Plataforma de gestão Icertis contrato](active-directory-saas-icertisicm-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-imagerelay-tutorial.png)| [Reencaminhamento de imagem](active-directory-saas-imagerelay-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-imageworks-tutorial.png)| [FUNCIONA DA IMAGEM](active-directory-saas-imageworks-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-impacriskmanager-tutorial.png)| [Gestor de risco IMPAC](active-directory-saas-impacriskmanager-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-inforretailinformationmanagement-tutorial.png)| [Revenda de infor â informações de gestão](active-directory-saas-inforretailinformationmanagement-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-insidertrack-tutorial.png)| [Controlar internas](active-directory-saas-insidertrack-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-jitbit-helpdesk-tutorial.png)| [Suporte técnico de Jitbit](active-directory-saas-jitbit-helpdesk-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-jive-tutorial.png)| [Jive](active-directory-saas-jive-tutorial.md)|[Jive - aprovisionamento de utilizadores](active-directory-saas-jive-provisioning-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-kantegassoforbamboo-tutorial.png)| [Kantega SSO para Bamboo](active-directory-saas-kantegassoforbamboo-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-kantegassoforbitbucket-tutorial.png)| [Kantega SSO para Bitbucket](active-directory-saas-kantegassoforbitbucket-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-kantegassoforconfluence-tutorial.png)| [Kantega SSO para Confluence](active-directory-saas-kantegassoforconfluence-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-kantegassoforfisheyecrucible-tutorial.png)| [Kantega SSO para FishEye/Crucible](active-directory-saas-kantegassoforfisheyecrucible-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-kantegassoforjira-tutorial.png)| [Kantega SSO para JIRA](active-directory-saas-kantegassoforjira-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-keeperpasswordmanager-tutorial.png)| [Gestor de palavras-passe keeper & Digital Cofre](active-directory-saas-keeperpasswordmanager-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-knowbe4-tutorial.png)| [Formação de deteção de segurança KnowBe4](active-directory-saas-knowbe4-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-landgorilla-tutorial.png)| [Telefone Gorilla cliente](active-directory-saas-landgorilla-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-learning-at-work-tutorial.png)| [Learning no trabalho](active-directory-saas-learning-at-work-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-learningseatlms-tutorial.png)| [Learning posto LMS](active-directory-saas-learningseatlms-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-lifesize-cloud-tutorial.png)| [Nuvem Lifesize](active-directory-saas-lifesize-cloud-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-worksmobile-tutorial.png)| [FUNCIONA DE LINHA](active-directory-saas-worksmobile-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-linkedinelevate-tutorial.png)| [LinkedIn Elevate](active-directory-saas-linkedinelevate-tutorial.md)|[Elevar o LinkedIn - utilizador de aprovisionamento](active-directory-saas-linkedinelevate-provisioning-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-linkedinlearning-tutorial.png)| [LinkedIn Learning](active-directory-saas-linkedinlearning-tutorial.md)|[LinkedIn Learning - aprovisionamento de utilizadores](active-directory-saas-linkedinlearning-provisioning-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-linkedinsalesnavigator-tutorial.png)| [LinkedIn navegador de vendas](active-directory-saas-linkedinsalesnavigator-tutorial.md)|[Navegador de vendas LinkedIn - aprovisionamento de utilizadores](active-directory-saas-linkedinsalesnavigator-provisioning-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-lucidchart-tutorial.png)| [Lucidchart](active-directory-saas-lucidchart-tutorial.md)|[Lucidchart - aprovisionamento de utilizadores](active-directory-saas-lucidchart-provisioning-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-m-files-tutorial.png)| [M-ficheiros](active-directory-saas-m-files-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-menlosecurity-tutorial.png)| [Segurança Menlo](active-directory-saas-menlosecurity-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-jiramicrosoft-tutorial.png)| [Microsoft Azure Active Directory-início de sessão único para JIRA](active-directory-saas-jiramicrosoft-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-mimecast-admin-console-tutorial.png)| [Consola de administração de Mimecast](active-directory-saas-mimecast-admin-console-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-mimecast-personal-portal-tutorial.png)| [Portal de Mimecast pessoal](active-directory-saas-mimecast-personal-portal-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-mobilexpense-tutorial.png)| [Xpense móvel](active-directory-saas-mobilexpense-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-moveittransfer-tutorial.png)| [Transferência de MOVEit - a integração do Azure AD](active-directory-saas-moveittransfer-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-moxiengage-tutorial.png)| [Moxi levar a cabo](active-directory-saas-moxiengage-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-neotalogicstudio-tutorial.png)| [Lógica de Neota Studio](active-directory-saas-neotalogicstudio-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-netsuite-tutorial.png)| [Netsuite](active-directory-saas-netsuite-tutorial.md)|[Netsuite - aprovisionamento de utilizadores](active-directory-saas-netsuite-provisioning-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-onetrust-tutorial.png)| [Software de gestão da privacidade de OneTrust](active-directory-saas-onetrust-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-pacific-timesheet-tutorial.png)| [Timesheet Pacífico](active-directory-saas-pacific-timesheet-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-paloaltoadmin-tutorial.png)| [Redes da Palo Alto - UI de Admin](active-directory-saas-paloaltoadmin-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-paloaltonetworks-aperture-tutorial.png)| [Redes da Palo Alto - Aperture](active-directory-saas-paloaltonetworks-aperture-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-paloaltonetworks-captiveportal-tutorial.png)| [Redes da Palo Alto - Captive Portal](active-directory-saas-paloaltonetworks-captiveportal-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-paloaltoglobalprotect-tutorial.png)| [Redes da Palo Alto - GlobalProtect](active-directory-saas-paloaltoglobalprotect-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-pegasystems-tutorial.png)| [Pega sistemas](active-directory-saas-pegasystems-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-perceptionunitedstates-tutorial.png)| [Perceção dos Estados Unidos (não UltiPro)](active-directory-saas-perceptionunitedstates-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-pingboard-tutorial.png)| [Pingboard](active-directory-saas-pingboard-tutorial.md)|[Pingboard - aprovisionamento de utilizadores](active-directory-saas-pingboard-provisioning-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-predictix-assortment-planning-tutorial.png)| [Planeamento de Assortment Predictix](active-directory-saas-predictix-assortment-planning-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-predictixordering-tutorial.png)| [Predictix ordenação](active-directory-saas-predictixordering-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-predictixpricereporting-tutorial.png)| [Preços de Predictix Reporting Services](active-directory-saas-predictixpricereporting-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-proofpoint-ondemand-tutorial.png)| [Proofpoint a pedido](active-directory-saas-proofpoint-ondemand-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-qliksense-enterprise-tutorial.png)| [Qlik sentido Enterprise](active-directory-saas-qliksense-enterprise-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-questetra-bpm-suite-tutorial.png)| [Questetra BPM Suite](active-directory-saas-questetra-bpm-suite-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-redbrickhealth-tutorial.png)| [Estado de funcionamento redBrick](active-directory-saas-redbrickhealth-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-replicon-tutorial.png)| [Replicon](active-directory-saas-replicon-tutorial.md)|[Replicon - aprovisionamento de utilizadores](active-directory-saas-replicon-provisioning-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-reward-gateway-tutorial.png)| [Gateway de reward](active-directory-saas-reward-gateway-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-salesforce-tutorial.png)| [Salesforce](active-directory-saas-salesforce-tutorial.md)|[Salesforce - aprovisionamento de utilizadores](active-directory-saas-salesforce-provisioning-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-salesforce-sandbox-tutorial.png)| [Salesforce Sandbox](active-directory-saas-salesforce-sandbox-tutorial.md)|[Salesforce Sandbox - aprovisionamento de utilizadores](active-directory-saas-salesforce-sandbox-provisioning-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-samanage-tutorial.png)| [Samanage](active-directory-saas-samanage-tutorial.md)|[Samanage - aprovisionamento de utilizadores](active-directory-saas-samanage-provisioning-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-bamboo-tutorial.png)| [SAML SSO para Bamboo pela resolução GmbH](active-directory-saas-bamboo-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-bitbucket-tutorial.png)| [SAML SSO para Bitbucket pela resolução GmbH](active-directory-saas-bitbucket-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-samlssoconfluence-tutorial.png)| [SAML SSO para Confluence pela resolução GmbH](active-directory-saas-samlssoconfluence-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-samlssojira-tutorial.png)| [SAML SSO para Jira pela resolução GmbH](active-directory-saas-samlssojira-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-sapbusinessbydesign-tutorial.png)| [SAP ByDesign de negócio](active-directory-saas-sapbusinessbydesign-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-sapboc-tutorial.png)| [Nuvem de objeto do SAP Business](active-directory-saas-sapboc-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-sap-customer-cloud-tutorial.png)| [Nuvem SAP para o cliente](active-directory-saas-sap-customer-cloud-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-sap-hana-cloud-platform-tutorial.png)| [Plataforma de nuvem do SAP](active-directory-saas-sap-hana-cloud-platform-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-sap-hana-cloud-platform-identity-authentication-tutorial.png)| [Autenticação de identidade da plataforma de nuvem SAP](active-directory-saas-sap-hana-cloud-platform-identity-authentication-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-sciquest-spend-director-tutorial.png)| [SciQuest gastam Director](active-directory-saas-sciquest-spend-director-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-sd-elements-tutorial.png)| [Elementos de SD](active-directory-saas-sd-elements-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-securedeliver-tutorial.png)| [ENTREGAR SEGURA](active-directory-saas-securedeliver-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-sensoscientific-tutorial.png)| [Sistema de monitorização de temperatura de sem fios de SensoScientific](active-directory-saas-sensoscientific-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-servicenow-tutorial.png)| [ServiceNow](active-directory-saas-servicenow-tutorial.md)|[ServiceNow - aprovisionamento de utilizadores](active-directory-saas-servicenow-provisioning-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-shmoopforschools-tutorial.png)| [Shmoop para escolas](active-directory-saas-shmoopforschools-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-slack-tutorial.png)| [Slack](active-directory-saas-slack-tutorial.md)|[Slack - aprovisionamento de utilizadores](active-directory-saas-slack-provisioning-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-smallimprovements-tutorial.png)| [Melhoramentos pequenos](active-directory-saas-smallimprovements-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-soonr-tutorial.png)| [Área de trabalho Soonr](active-directory-saas-soonr-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-splunkenterpriseandsplunkcloud-tutorial.png)| [Splunk Enterprise e Splunk nuvem](active-directory-saas-splunkenterpriseandsplunkcloud-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-springerlink-tutorial.png)| [Ligação springer](active-directory-saas-springerlink-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-symantec-tutorial.png)| [Serviço Web da Symantec de segurança (WSS)](active-directory-saas-symantec-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-tyeexpress-tutorial.png)| [T & rápida i](active-directory-saas-tyeexpress-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-tableauserver-tutorial.png)| [Servidor tableau](active-directory-saas-tableauserver-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-tangoe-tutorial.png)| [Comando Tangoe Premium Mobile](active-directory-saas-tangoe-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-thefundingportal-tutorial.png)| [O Portal Funding](active-directory-saas-thefundingportal-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-thousandeyes-tutorial.png)| [ThousandEyes](active-directory-saas-thousandeyes-tutorial.md)|[ThousandEyes - aprovisionamento de utilizadores](active-directory-saas-thousandeyes-provisioning-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-tigertext-tutorial.png)| [Messenger segura TigerText](active-directory-saas-tigertext-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-topdesk-public-tutorial.png)| [TOPdesk - público](active-directory-saas-topdesk-public-tutorial.md)|
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-topdesk-secure-tutorial.png)| [TOPdesk - segura](active-directory-saas-topdesk-secure-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-wizergosproductivitysoftware-tutorial.png)| [Software de produtividade Wizergos](active-directory-saas-wizergosproductivitysoftware-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-workday-tutorial.png)| [Workday](active-directory-saas-workday-tutorial.md)|[Workday - Tutorial de entrada](active-directory-saas-workday-inbound-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-yonyx-tutorial.png)| [Guias de interativa Yonyx](active-directory-saas-yonyx-tutorial.md)|
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-zendesk-tutorial.png)| [Zendesk](active-directory-saas-zendesk-tutorial.md)|[Zendesk - aprovisionamento de utilizadores](active-directory-saas-zendesk-provisioning-tutorial.md)
...
| ![logo](./media/active-directory-saas-tutorial-list/active-directory-saas-zscalerprivateaccessadministrator-tutorial.png)| [Administrador de acesso do Zscaler privada](active-directory-saas-zscalerprivateaccessadministrator-tutorial.md)|
