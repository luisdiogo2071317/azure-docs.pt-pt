...
- **[Introdução à gestão de dispositivos no Azure Active Directory](device-management-introduction.md)**  -este artigo dá-lhe uma descrição geral das várias opções, terá de os dispositivos sob controle organizacional. 
