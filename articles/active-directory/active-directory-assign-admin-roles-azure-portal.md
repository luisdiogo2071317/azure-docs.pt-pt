...
Para saber como atribuir funções administrativas a um utilizador no Azure Active Directory, veja [atribuir um utilizador a funções de administrador no Azure Active Directory](active-directory-users-assign-role-azure-portal.md).
...
* **[Leitores de diretório](#directory-readers)**: Esta é uma função legada que está a ser atribuída às aplicações que não suportam a [consentimento Framework](active-directory-integrating-applications.md). Não deve ser atribuído a quaisquer utilizadores.
...
* **[Gravadores de diretórios](#directory-writers)**: Esta é uma função legada que está a ser atribuída às aplicações que não suportam a [consentimento Framework](active-directory-integrating-applications.md). Não deve ser atribuído a quaisquer utilizadores.
