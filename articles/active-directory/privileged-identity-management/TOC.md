...
## [Fluxos de trabalho de Aprovação do Privileged Identity Management](azure-ad-pim-approval-workflow.md)
...
### [Expandir ou renovar funções](pim-resource-roles-renew-extend.md)
### [Aprovar pedidos](pim-resource-roles-approval-workflow.md)
### [Configurar alertas](pim-resource-roles-configure-alerts.md)
### [Requerer MFA](pim-resource-roles-require-mfa.md)
...
### [Terminar uma revisão de acesso](pim-resource-roles-complete-access-review.md)
