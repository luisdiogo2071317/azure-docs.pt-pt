...
Com o Azure AD Privileged Identity Management (PIM), pode configurar funções para exigir a aprovação para a ativação e escolher um ou vários utilizadores ou grupos como aprovadores delegados. Siga os passos neste artigo para aprovar ou recusar pedidos para funções de recursos do Azure.
