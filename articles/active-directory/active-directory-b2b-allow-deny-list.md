...
- Para obter informações sobre o acesso condicional e de colaboração B2B, consulte [acesso condicional para os utilizadores de colaboração do B2B](active-directory-b2b-mfa-instructions.md).
