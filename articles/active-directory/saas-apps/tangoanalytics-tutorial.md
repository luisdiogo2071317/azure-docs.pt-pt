...
1. Na caixa de pesquisa, escreva **Tango Analytics**.

    ![Criar um utilizador de teste do Azure AD](./media/tangoanalytics-tutorial/tutorial_tangoanalytics_search.png)

1. No painel de resultados, selecione **Tango Analytics**e, em seguida, clique em **Add** botão para adicionar a aplicação.
...
1. **[Criar um utilizador de teste de análise de Tango](#creating-a-tango-analytics-test-user)**  - para ter um equivalente da Eduarda Almeida no Analytics Tango que está ligado à representação de utilizador do Azure AD.
...
1. Sobre o **Tango Analytics domínio e URLs** secção, execute os seguintes passos:
...
1. Para configurar o início de sessão único num **Tango Analytics** lado, terá de enviar o transferido **XML de metadados** para [equipa de suporte de análise de Tango](mailto:support@tangoanalytics.com). Se definir esta definição para que a ligação de SAML SSO definidas corretamente em ambos os lados.
...
1. Na lista de aplicações, selecione **Tango Analytics**.
