...
4. Na caixa de pesquisa, escreva **Carlson Wagonlit levar**, selecione **Carlson Wagonlit levar** partir do painel de resultados, em seguida, clique em **adicionar** botão para adicionar a aplicação.
    ...
    ![Carlson Wagonlit levar na lista de resultados](./media/carlsonwagonlit-tutorial/tutorial_carlsonwagonlittravel_addfromgallery.png)
...
3. No **Carlson Wagonlit levar domínio e os URLs** secção, execute os seguintes passos:
    ...
    ![Carlson Wagonlit levar domínio e os URLs únicos de informações de início de sessão](./media/carlsonwagonlit-tutorial/tutorial_carlsonwagonlittravel_url.png)

    No **identificador** caixa de texto, digite o valor: `cwt-stage`

4. No **certificado de assinatura de SAML** secção, clique em **XML de metadados** e, em seguida, guarde o ficheiro de metadados no seu computador.

    ![A hiperligação de transferência do certificado](./media/carlsonwagonlit-tutorial/tutorial_carlsonwagonlittravel_certificate.png) 

5. Clique em **guardar** botão.

    ![Configurar botão único início de sessão guardar](./media/carlsonwagonlit-tutorial/tutorial_general_400.png)
...
2. Para apresentar a lista de utilizadores, aceda a **utilizadores e grupos**e, em seguida, clique em **todos os utilizadores**.
    ...
    !["Os utilizadores e grupos" e "Todos os utilizadores" ligações](./media/carlsonwagonlit-tutorial/create_aaduser_02.png)

3. Para abrir o **utilizador** caixa de diálogo, clique em **adicionar** na parte superior do **todos os utilizadores** caixa de diálogo.

    ![O botão de adição](./media/carlsonwagonlit-tutorial/create_aaduser_03.png)
...
2. Na lista de aplicações, selecione **Carlson Wagonlit levar**.
    ...
    ![A ligação de Carlson Wagonlit levar na lista de aplicações](./media/carlsonwagonlit-tutorial/tutorial_carlsonwagonlittravel_app.png)  
