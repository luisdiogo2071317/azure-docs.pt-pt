---
title: 'Tutorial: Integração do Azure Active Directory com Encompass | Documentos da Microsoft'
...
3. **[Criar um utilizador de teste Encompass](#create-a-encompass-test-user)**  - para ter um equivalente da Eduarda Almeida na Encompass que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **abranger o domínio e URLs** secção, execute os seguintes passos:
    ...
    > [!NOTE] 
    > Estes valores não são reais. Atualize estes valores com o identificador real e o URL de resposta. Contacte [equipa de suporte de Encompass](http://www.voxmobile.com/contact/) obter esses valores.
...
6. Sobre o **abranger configuração** secção, clique em **configurar abranger** para abrir **configurar início de sessão** janela. Cópia a **URL de fim de sessão e SAML único início de sessão no URL do serviço** partir o **secção de referência rápida.**

    ![Abranger a configuração](./media/encompass-tutorial/tutorial_encompass_configure.png) 

7. Para configurar o início de sessão único num **Encompass** lado, terá de enviar o transferido **Certificate(Base64), o URL de fim de sessão e o SAML único início de sessão no URL do serviço** para [Encompass a equipa de suporte](http://www.voxmobile.com/contact/). Se definir esta definição para que a ligação de SAML SSO definidas corretamente em ambos os lados.
...
Nesta secção, vai criar um usuário chamado Eduarda Almeida no Encompass. Trabalhar com [equipa de suporte de Encompass](http://www.voxmobile.com/contact/) para adicionar os utilizadores na plataforma Encompass. Os utilizadores tem de ser criados e ativados antes de utilizar o início de sessão único. 
