...
4. Na caixa de pesquisa, escreva **Encompass**, selecione **Encompass** partir do painel de resultados, em seguida, clique em **adicionar** botão para adicionar a aplicação.
    ...
    ![Abranger na lista de resultados](./media/encompass-tutorial/tutorial_encompass_addfromgallery.png)
...
3. No **abranger domínios e URLs** secção, execute os seguintes passos:
    ...
    ![Abranger URLs e de domínio único início de sessão informações](./media/encompass-tutorial/tutorial_encompass_url.png)
...
4. No **certificado de assinatura de SAML** secção, clique em **Certificate(Base64)** e, em seguida, guarde o ficheiro de certificado no seu computador.
    ...
    ![A hiperligação de transferência do certificado](./media/encompass-tutorial/tutorial_encompass_certificate.png) 

5. Clique em **guardar** botão.

    ![Configurar botão único início de sessão guardar](./media/encompass-tutorial/tutorial_general_400.png)
...
2. Para apresentar a lista de utilizadores, aceda a **utilizadores e grupos**e, em seguida, clique em **todos os utilizadores**.
    ...
    !["Os utilizadores e grupos" e "Todos os utilizadores" ligações](./media/encompass-tutorial/create_aaduser_02.png)

3. Para abrir o **utilizador** caixa de diálogo, clique em **adicionar** na parte superior do **todos os utilizadores** caixa de diálogo.

    ![O botão de adição](./media/encompass-tutorial/create_aaduser_03.png)
