...
![Efetuar a elevação LinkedIn aprovisionamento](./media/linkedinelevate-provisioning-tutorial/linkedin_elevate1.PNG)
...
![Efetuar a elevação LinkedIn aprovisionamento](./media/linkedinelevate-provisioning-tutorial/linkedin_elevate2.PNG)
...
![Efetuar a elevação LinkedIn aprovisionamento](./media/linkedinelevate-provisioning-tutorial/linkedin_elevate3.PNG)
...
![Efetuar a elevação LinkedIn aprovisionamento](./media/linkedinelevate-provisioning-tutorial/linkedin_elevate4.PNG)
