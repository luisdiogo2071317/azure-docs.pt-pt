...
4. Na caixa de pesquisa, escreva **Moxi envolver**.

    ![Criar um utilizador de teste do Azure AD](./media/moxiengage-tutorial/tutorial_moxiengage_search.png)

5. No painel de resultados, selecione **Moxi envolver**e, em seguida, clique em **Add** botão para adicionar a aplicação.
...
3. **[Criar um utilizador de teste Moxi envolver](#creating-a-moxi-engage-test-user)**  - para ter um equivalente da Eduarda Almeida na Moxi interagir com que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **domínio de interagir com Moxi e URLs** secção, execute os seguintes passos:
...
6. Para configurar o início de sessão único num **Moxi envolver** lado, terá de enviar o transferido **XML de metadados** para [Moxi envolver a equipa de suporte](mailto:support@moxiworks.com). Se definir esta definição para que a ligação de SAML SSO definidas corretamente em ambos os lados.
...
2. Na lista de aplicações, selecione **Moxi envolver**.
