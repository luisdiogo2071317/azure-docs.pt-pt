...
4. Na caixa de pesquisa, escreva **Fuse**, selecione **Fuse** partir do painel de resultados, em seguida, clique em **adicionar** botão para adicionar a aplicação.
    ...
    ![Fuse na lista de resultados](./media/fuse-tutorial/tutorial_fuse_addfromgallery.png)
...
3. No **Fuse domínios e URLs** secção, execute os seguintes passos:
    ...
    ![Fuse URLs e de domínio único início de sessão informações](./media/fuse-tutorial/tutorial_fuse_url.png)
...
4. No **certificado de assinatura de SAML** secção, clique em **certificado (bruto)** e, em seguida, guarde o ficheiro de certificado no seu computador.
    ...
    ![A hiperligação de transferência do certificado](./media/fuse-tutorial/tutorial_fuse_certificate.png) 

5. Clique em **guardar** botão.

    ![Configurar botão único início de sessão guardar](./media/fuse-tutorial/tutorial_general_400.png)
...
2. Para apresentar a lista de utilizadores, aceda a **utilizadores e grupos**e, em seguida, clique em **todos os utilizadores**.
    ...
    !["Os utilizadores e grupos" e "Todos os utilizadores" ligações](./media/fuse-tutorial/create_aaduser_02.png)

3. Para abrir o **utilizador** caixa de diálogo, clique em **adicionar** na parte superior do **todos os utilizadores** caixa de diálogo.

    ![O botão de adição](./media/fuse-tutorial/create_aaduser_03.png)
...
2. Na lista de aplicações, selecione **Fuse**.
    ...
    ![A ligação de Fuse na lista de aplicações](./media/fuse-tutorial/tutorial_fuse_app.png)  
