---
title: 'Tutorial: Integração do Azure Active Directory com o Studio de lógica de Neota | Documentos da Microsoft'
...
ms.locfileid: "39046248"
---
# <a name="tutorial-azure-active-directory-integration-with-neota-logic-studio"></a>Tutorial: Integração do Azure Active Directory com o Studio de lógica de Neota
...
5. No painel de resultados, selecione **Neota lógica Studio**e, em seguida, clique em **Add** botão para adicionar a aplicação.
...
3. **[Criar um utilizador de teste do Studio de lógica de Neota](#creating-a-neota-logic-studio-test-user)**  - para ter um equivalente da Eduarda Almeida no Neota lógica Studio que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **Neota lógica Studio domínio e URLs** secção, execute os seguintes passos:
...
6. Para obter SSO configurado para a sua aplicação, contacte [suporte Neota lógica Studio](https://www.neotalogic.com/contact-us/) da Equipe e fornecê-los com transferido **XML de metadados** ficheiro.
...
Nesta secção, vai criar um usuário chamado Eduarda Almeida no Neota lógica Studio. trabalhar com [equipa de suporte de cliente do Neota lógica Studio](https://www.neotalogic.com/contact-us/) para adicionar os utilizadores na plataforma Neota lógica Studio. Os utilizadores tem de ser criados e ativados antes de utilizar o início de sessão único. 
