...
1. Na caixa de pesquisa, escreva **determinados administrador SSO**, selecione **determinados SSO de administrador** no painel de resultados, em seguida, clique em **Add** botão para adicionar a aplicação.
...
1. **[Criar um utilizador de teste de determinados administrador SSO](#create-a-certain-admin-sso-test-user)**  - para ter um equivalente da Eduarda Almeida em determinados SSO de administrador que está ligado à representação de utilizador do Azure AD.
...
1. Sobre o **determinados domínio de SSO de administrador e URLs** secção, execute os seguintes passos:
...
1. Na **determinados configuração de SSO de administrador** secção, clique em **configurar SSO de administrador determinados** para abrir **configurar início de sessão** janela. Cópia a **URL de fim de sessão, o ID de entidade de SAML e o SAML único início de sessão no URL do serviço** partir o **secção de referência rápida.**
...
1. Na lista de aplicações, selecione **determinados administrador SSO**.
