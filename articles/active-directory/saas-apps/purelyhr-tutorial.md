---
title: 'Tutorial: Integração do Active Directory do Azure com PurelyHR | Documentos da Microsoft'
...
1. Verifique **Mostrar definições de URL avançadas**, se desejar configurar a aplicação na **SP** iniciada pelo modo:
    ...
    > [!NOTE]
    > Estes valores não são o real. Atualize estes valores com o URL de resposta e o URL de início de sessão real. Contacte [equipa de suporte de cliente PurelyHR](https://support.purelyhr.com/) obter esses valores. 
