...
4. Na caixa de pesquisa, escreva **TrackVia**, selecione **TrackVia** no painel de resultados, em seguida, clique em **Add** botão para adicionar a aplicação.
...
3. **[Criar um utilizador de teste TrackVia](#create-a-trackvia-test-user)**  - para ter um equivalente da Eduarda Almeida na TrackVia que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **TrackVia domínio e URLs** secção, execute os seguintes passos, se desejar configurar a aplicação no **IDP** iniciada pelo modo:
...
7. Sobre o **TrackVia configuração** secção, clique em **configurar TrackVia** para abrir **configurar início de sessão** janela. Cópia a **ID de entidade de SAML** partir o **secção de referência rápida.**

    ![Configuração de TrackVia](./media/trackvia-tutorial/tutorial_trackvia_configure.png)
    
8. Na janela de browser diferente, inicie sessão site da sua empresa TrackVia como um administrador.
