...
1. Na caixa de pesquisa, escreva **LaunchDarkly**, selecione **LaunchDarkly** no painel de resultados, em seguida, clique em **Add** botão para adicionar a aplicação.
...
1. **[Criar um utilizador de teste LaunchDarkly](#create-a-launchdarkly-test-user)**  - para ter um equivalente da Eduarda Almeida na LaunchDarkly que está ligado à representação de utilizador do Azure AD.
...
1. Sobre o **LaunchDarkly domínio e URLs** secção, execute os seguintes passos, se desejar configurar a aplicação no **IDP** iniciada pelo modo:
...
1. Sobre o **LaunchDarkly configuração** secção, clique em **configurar LaunchDarkly** para abrir **configurar início de sessão** janela. Cópia a **único URL de início de sessão no serviço** partir o **secção de referência rápida.**
...
1. Selecione **definições de conta** do painel de navegação à esquerda.

    ![Configuração de LaunchDarkly](./media/launchdarkly-tutorial/configure1.png)

1. Clique em **segurança** separador.

    ![Configuração de LaunchDarkly](./media/launchdarkly-tutorial/configure2.png)

1. Clique em **HABILITAR SSO** e, em seguida **Editar configuração de SAML**.

    ![Configuração de LaunchDarkly](./media/launchdarkly-tutorial/configure3.png)

1. Sobre o **editar sua configuração SAML** secção, execute os seguintes passos:
