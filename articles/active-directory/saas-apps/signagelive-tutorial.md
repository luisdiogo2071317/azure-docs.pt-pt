---
title: 'Tutorial: Integração do Active Directory do Azure com Signagelive | Documentos da Microsoft'
description: Saiba como configurar o início de sessão único entre o Azure Active Directory e Signagelive.
...
Neste tutorial, saiba como integrar Signagelive com o Azure Active Directory (Azure AD).
...
2. Na lista de aplicações, selecione **Signagelive**.
    ...
    ![A ligação de Signagelive na lista de aplicações](common/all-applications.png)
