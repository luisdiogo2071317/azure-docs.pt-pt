...
4. Na caixa de pesquisa, escreva **Reviewsnap**, selecione **Reviewsnap** no painel de resultados, em seguida, clique em **Add** botão para adicionar a aplicação.
...
3. **[Criar um utilizador de teste Reviewsnap](#create-a-reviewsnap-test-user)**  - para ter um equivalente da Eduarda Almeida na Reviewsnap que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **Reviewsnap domínio e URLs** secção, execute os seguintes passos, se desejar configurar a aplicação no **IDP** iniciada pelo modo:
...
7. Sobre o **Reviewsnap configuração** secção, clique em **configurar Reviewsnap** para abrir **configurar início de sessão** janela. Cópia a **URL de fim de sessão, o ID de entidade de SAML e o SAML único início de sessão no URL do serviço** partir o **secção de referência rápida.**
