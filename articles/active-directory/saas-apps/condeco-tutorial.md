...
5. No painel de resultados, selecione **Condeco**e, em seguida, clique em **Add** botão para adicionar a aplicação.
...
3. **[Criar um utilizador de teste Condeco](#creating-a-condeco-test-user)**  - para ter um equivalente da Eduarda Almeida na Condeco que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **Condeco domínio e URLs** secção, execute os seguintes passos:
...
6. Para configurar o início de sessão único num **Condeco** lado, terá de enviar o transferido **XML de metadados** para [equipa de suporte de Condeco](mailTo:supportna@condecosoftware.com). Se definir esta definição para que a ligação de SAML SSO definidas corretamente em ambos os lados.
