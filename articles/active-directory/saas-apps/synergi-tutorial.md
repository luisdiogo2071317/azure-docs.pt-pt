---
title: 'Tutorial: Integração do Azure Active Directory com Synergi | Documentos da Microsoft'
...
4. Na caixa de pesquisa, escreva **Synergi**, selecione **Synergi** no painel de resultados, em seguida, clique em **Add** botão para adicionar a aplicação.
...
3. **[Criar um utilizador de teste Synergi](#create-a-synergi-test-user)**  - para ter um equivalente da Eduarda Almeida na Synergi que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **Synergi domínio e URLs** secção, execute os seguintes passos:
...
6. Sobre o **Synergi configuração** secção, clique em **configurar Synergi** para abrir **configurar início de sessão** janela. Copiar o **URL de fim de sessão e o ID de entidade de SAML** partir o **secção de referência rápida.**

    ![Configuração de Synergi](./media/synergi-tutorial/tutorial_synergi_configure.png) 

7. Para configurar o início de sessão único num **Synergi** lado, terá de enviar o transferido **Certificate(Base64), o URL de fim de sessão e o ID de entidade de SAML** para [equipa de suporte de Synergi](https://www.irmsecurity.com/contact/).
