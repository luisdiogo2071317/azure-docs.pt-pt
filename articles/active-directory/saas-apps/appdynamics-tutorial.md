---
title: 'Tutorial: Integração do Active Directory do Azure com o AppDynamics | Documentos da Microsoft'
...
ms.locfileid: "54812272"
---
# <a name="tutorial-azure-active-directory-integration-with-appdynamics"></a>Tutorial: Integração do Active Directory do Azure com o AppDynamics
...
* Pode permitir que os utilizadores ser automaticamente sessão iniciada para AppDynamics (Single Sign-On) com as suas contas do Azure AD.
...
* AppDynamics único início de sessão na subscrição ativada

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, configure e teste do Azure AD início de sessão único num ambiente de teste.

* Oferece suporte a AppDynamics **SP** iniciada SSO

* Oferece suporte a AppDynamics **Just In Time** aprovisionamento de utilizadores
...
4. Na caixa de pesquisa, escreva **AppDynamics**, selecione **AppDynamics** no painel de resultados, em seguida, clique em **Add** botão para adicionar a aplicação.

     ![AppDynamics na lista de resultados](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurar e testar o Azure AD início de sessão único

Nesta secção, configure e teste do Azure AD início de sessão único com o AppDynamics com base num utilizador de teste **Eduarda Almeida**.
Para o início de sessão único funcionar, uma relação de ligação entre um utilizador do Azure AD e o utilizador relacionado no AppDynamics deve ser estabelecido.
...
2. **[Configurar o AppDynamics Single Sign-On](#configure-appdynamics-single-sign-on)**  - para configurar as definições de início de sessão único no lado do aplicativo.
3. **[Criar um utilizador de teste do Azure AD](#create-an-azure-ad-test-user)**  - para testar o Azure AD início de sessão único com Eduarda Almeida.
4. **[Atribua o utilizador de teste do Azure AD](#assign-the-azure-ad-test-user)**  - para ativar a Eduarda Almeida utilizar o Azure AD início de sessão único.
5. **[Criar utilizador de teste do AppDynamics](#create-appdynamics-test-user)**  - para ter um equivalente da Eduarda Almeida na AppDynamics que está ligado à representação de utilizador do Azure AD.
...
1. Na [portal do Azure](https://portal.azure.com/), na **AppDynamics** página de integração de aplicações, selecione **início de sessão único**.
...
4. Sobre o **configuração básica de SAML** secção, execute os seguintes passos:
    ...
    ![AppDynamics domínio e URLs únicas início de sessão em informações](common/sp-identifier.png)

    a. Na **iniciar sessão no URL** caixa de texto, escreva um URL com o seguinte padrão: `https://<companyname>.saas.appdynamics.com?accountName=<companyname>`

    b. Na **identificador (ID de entidade)** caixa de texto, escreva um URL com o seguinte padrão: `https://<companyname>.saas.appdynamics.com/controller`

    > [!NOTE]
    > Estes valores não são reais. Atualize estes valores com o início de sessão real URL e o identificador. Contacte [equipa de suporte de cliente do AppDynamics](https://www.appdynamics.com/support/) obter esses valores. Também pode consultar os padrões mostrados a **configuração básica de SAML** secção no portal do Azure.
...
6. Sobre o **configurar o AppDynamics** secção, copie os URLs apropriados de acordo com seus requisitos.
...
### <a name="configure-appdynamics-single-sign-on"></a>Configurar o AppDynamics Single Sign-On
...
1. No portal do Azure, selecione **aplicações empresariais**, selecione **todos os aplicativos**, em seguida, selecione **AppDynamics**.

    ![Painel de aplicações empresariais](common/enterprise-applications.png)

2. Na lista de aplicativos, escreva e selecione **AppDynamics**.

    ![A ligação do AppDynamics na lista de aplicações](common/all-applications.png)
...
### <a name="create-appdynamics-test-user"></a>Criar utilizador de teste do AppDynamics
...
Quando clica no mosaico do AppDynamics no painel de acesso, deve ser automaticamente sessão iniciada no AppDynamics para o qual configura o SSO. Para obter mais informações sobre o painel de acesso, consulte [introdução ao painel de acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
