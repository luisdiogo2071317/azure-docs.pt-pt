...
4. Na caixa de pesquisa, escreva **Zoom**, selecione **Zoom** partir do painel de resultados, em seguida, clique em **adicionar** botão para adicionar a aplicação.
    ...
    ![Ampliar a lista de resultados](./media/zoom-tutorial/tutorial_zoom_addfromgallery.png)
...
3. No **domínio Zoom e URLs** secção, execute os seguintes passos:
    ...
    ![Domínio de zoom e os URLs únicos de informações de início de sessão](./media/zoom-tutorial/tutorial_zoom_url.png)
...
6. No **certificado de assinatura de SAML** secção, clique em **certificado (Base64)** e, em seguida, guarde o ficheiro de certificado no seu computador.
    ...
    ![A hiperligação de transferência do certificado](./media/zoom-tutorial/tutorial_zoom_certificate.png)

7. Clique em **guardar** botão.

    ![Configurar botão único início de sessão guardar](./media/zoom-tutorial/tutorial_general_400.png)
...
10. Clique em de **Single Sign-On** separador.
    ...
    ![Separador de início de sessão único](./media/zoom-tutorial/IC784700.png "de sessão único-")
...
12. Na secção de Single Sign-On, execute os seguintes passos:
    ...
    ![Único início de sessão na secção](./media/zoom-tutorial/IC784701.png "de sessão único-")
...
2. Para apresentar a lista de utilizadores, aceda a **utilizadores e grupos**e, em seguida, clique em **todos os utilizadores**.
    ...
    !["Os utilizadores e grupos" e "Todos os utilizadores" ligações](./media/zoom-tutorial/create_aaduser_02.png)

3. Para abrir o **utilizador** caixa de diálogo, clique em **adicionar** na parte superior do **todos os utilizadores** caixa de diálogo.

    ![O botão de adição](./media/zoom-tutorial/create_aaduser_03.png)
