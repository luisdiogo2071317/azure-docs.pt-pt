...
1. Na caixa de pesquisa, escreva **DATABASICS**, selecione **DATABASICS** no painel de resultados, em seguida, clique em **Add** botão para adicionar a aplicação.
...
1. **[Criar um utilizador de teste DATABASICS](#create-a-databasics-test-user)**  - para ter um equivalente da Eduarda Almeida na DATABASICS que está ligado à representação de utilizador do Azure AD.
...
1. Sobre o **DATABASICS domínio e URLs** secção, execute os seguintes passos:
...
1. Para configurar o início de sessão único no lado do DATABASICS, preencha o formulário com o URL abaixo. Depois de submeter o formulário, o [equipa de suporte de cliente DATABASICS](https://www.data-basics.com/support/) irá contactá-lo.
...
1. Na lista de aplicações, selecione **DATABASICS**.
