---
title: 'Tutorial: Integração do Azure Active Directory com a cópia de segurança de ponto final de Autotask | Documentos da Microsoft'
...
- Pode permitir que os utilizadores automaticamente obter com sessão iniciada a cópia de segurança de ponto final de Autotask (Single Sign-On) com as suas contas do Azure AD.
...
- Uma cópia de segurança de ponto final de Autotask logon único habilitado subscrição
...
Nesta secção, configure e teste do Azure AD início de sessão único com cópia de segurança do ponto final de Autotask com base num utilizador de teste chamado "Eduarda Almeida".

Para o início de sessão único funcione, o Azure AD precisa saber qual é o utilizador equivalente na cópia de segurança de ponto final de Autotask a um utilizador no Azure AD. Em outras palavras, uma relação de ligação entre um utilizador do Azure AD e o utilizador relacionado na cópia de segurança de ponto final de Autotask deve ser estabelecido.
...
Nesta secção, pode ativar o Azure AD início de sessão único no portal do Azure e configurar início de sessão único na sua aplicação de cópia de segurança de ponto final de Autotask.
...
1. No portal do Azure, sobre o **cópia de segurança de ponto final de Autotask** página de integração de aplicação, clique em **início de sessão único**.
...
**Para atribuir a Eduarda Almeida a cópia de segurança de ponto final de Autotask, execute os seguintes passos:**
...
Quando clica no mosaico de cópia de segurança de ponto final de Autotask no painel de acesso, deve obter automaticamente com sessão iniciada para a sua aplicação de cópia de segurança de ponto final de Autotask.
