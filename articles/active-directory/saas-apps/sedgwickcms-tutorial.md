...
4. Na caixa de pesquisa, escreva **Sedgwick CMS**, selecione **Sedgwick CMS** no painel de resultados, em seguida, clique em **Add** botão para adicionar a aplicação.
...
3. **[Criar um utilizador de teste de Sedgwick CMS](#create-a-sedgwick-cms-test-user)**  - para ter um equivalente da Eduarda Almeida no CMS Sedgwick que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **Sedgwick CMS domínio e URLs** secção, execute os seguintes passos:
...
6. Para configurar o início de sessão único num **Sedgwick CMS** lado, terá de enviar o transferido **XML de metadados** para [equipa de suporte de Sedgwick CMS](https://www.sedgwick.com/contact/Pages/contactform.aspx). Se definir esta definição para que a ligação de SAML SSO definidas corretamente em ambos os lados.
