---
title: 'Tutorial: Integração do Azure Active Directory com as redes de Skyhigh | Documentos da Microsoft'
...
ms.locfileid: "39041947"
---
# <a name="tutorial-azure-active-directory-integration-with-skyhigh-networks"></a>Tutorial: Integração do Azure Active Directory com as redes de Skyhigh
...
4. Na caixa de pesquisa, escreva **redes Skyhigh**, selecione **Skyhigh redes** no painel de resultados, em seguida, clique em **Add** botão para adicionar a aplicação.
...
3. **[Criar um utilizador de teste de redes de Skyhigh](#create-a-skyhigh-networks-test-user)**  - para ter um equivalente da Eduarda Almeida em redes de Skyhigh que está ligada à representação de utilizador do Azure AD.
...
3. Sobre o **Skyhigh redes de domínio e URLs** secção, execute os seguintes passos, se desejar configurar a aplicação no **IDP** iniciada pelo modo:
...
7. Na **configuração de redes de Skyhigh** secção, clique em **configurar redes de Skyhigh** para abrir **configurar início de sessão** janela. Cópia a **URL de fim de sessão, o ID de entidade de SAML e o SAML único início de sessão no URL do serviço** partir o **secção de referência rápida.**
