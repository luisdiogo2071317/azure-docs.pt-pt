...
ms.date: 12/08/2017
ms.author: jeedes
ms.openlocfilehash: ca393279da44ab06077ecbb46a93b8f55222c0fa
ms.sourcegitcommit: c851842d113a7078c378d78d94fea8ff5948c337
ms.translationtype: MT
ms.contentlocale: pt-PT
ms.lasthandoff: 06/18/2018
ms.locfileid: "35948032"
---
...
4. Na caixa de pesquisa, escreva **TOPdesk - segura**, selecione **TOPdesk - segura** partir do painel de resultados, em seguida, clique em **adicionar** botão para adicionar a aplicação.
    ...
    ![TOPdesk - seguro na lista de resultados](./media/topdesk-secure-tutorial/tutorial_topdesk-secure_addfromgallery.png)
...
3. No **TOPdesk - domínio seguro e URLs** secção, execute os seguintes passos:
    ...
    ![TOPdesk - domínio seguro e URLs único informações de início de sessão](./media/topdesk-secure-tutorial/tutorial_topdesk-secure_url.png)
...
4. No **certificado de assinatura de SAML** secção, clique em **XML de metadados** e, em seguida, guarde o ficheiro de metadados no seu computador.
    ...
    ![A hiperligação de transferência do certificado](./media/topdesk-secure-tutorial/tutorial_topdesk-secure_certificate.png) 

5. Clique em **guardar** botão.

    ![Configurar botão único início de sessão guardar](./media/topdesk-secure-tutorial/tutorial_general_400.png)
...
11. No **seguro** secção o **início de sessão SAML** configuração secção, execute os seguintes passos:
    ...
    ![Serviço de consumidor asserção](./media/topdesk-secure-tutorial/ic790856.png "asserção consumidor serviço")
...
2. Para apresentar a lista de utilizadores, aceda a **utilizadores e grupos**e, em seguida, clique em **todos os utilizadores**.
    ...
    !["Os utilizadores e grupos" e "Todos os utilizadores" ligações](./media/topdesk-secure-tutorial/create_aaduser_02.png)

3. Para abrir o **utilizador** caixa de diálogo, clique em **adicionar** na parte superior do **todos os utilizadores** caixa de diálogo.

    ![O botão de adição](./media/topdesk-secure-tutorial/create_aaduser_03.png)
...
3. No **operador New** caixa de diálogo, execute os seguintes passos:
    ...
    ![Operador New](./media/topdesk-secure-tutorial/ic790611.png "operador New")
