---
title: 'Tutorial: Integração do Azure Active Directory com Grovo | Documentos da Microsoft'
...
3. **[Criar um utilizador de teste Grovo](#create-a-grovo-test-user)**  - para ter um equivalente da Eduarda Almeida na Grovo que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **Grovo domínio e URLs** secção, execute os seguintes passos, se desejar configurar a aplicação no **IDP** iniciada pelo modo:
...
9. Sobre o **Grovo configuração** secção, clique em **configurar Grovo** para abrir **configurar início de sessão** janela. Cópia a **ID de entidade de SAML e SAML único início de sessão no URL do serviço** partir o **secção de referência rápida.**

    ![Configuração de Grovo](./media/grovo-tutorial/tutorial_grovo_configure.png) 

10. Numa janela do browser web diferente, início de sessão para Grovo como administrador.

11. Aceda a **administrador** > **integrações**.
 
    ![Configuração de Grovo](./media/grovo-tutorial/tutorial_grovo_admin.png) 

12. Clique em **CONFIGURADA** sob **SP iniciada SAML 2.0** secção.

    ![Configuração de Grovo](./media/grovo-tutorial/tutorial_grovo_setup.png)

13. Na **SP iniciada SAML 2.0** janela pop-up, execute os seguintes passos:
