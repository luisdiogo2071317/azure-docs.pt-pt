...
4. Na caixa de pesquisa, escreva **SumTotalCentral**, selecione **SumTotalCentral** no painel de resultados, em seguida, clique em **Add** botão para adicionar a aplicação.
...
3. **[Criar um utilizador de teste SumTotalCentral](#create-a-sumtotalcentral-test-user)**  - para ter um equivalente da Eduarda Almeida na SumTotalCentral que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **SumTotalCentral domínio e URLs** secção, execute os seguintes passos:
...
6. Para configurar o início de sessão único num **SumTotalCentral** lado, terá de enviar o transferido **XML de metadados** para [equipa de suporte de SumTotalCentral](http://www.sumtotalsystems.com/support/). Se definir esta definição para que a ligação de SAML SSO definidas corretamente em ambos os lados.
