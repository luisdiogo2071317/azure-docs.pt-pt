...
3. No **URLs de domínio do Zendesk e** secção, execute os seguintes passos:
    ...
    ![Domínio do Zendesk e os URLs únicos de informações de início de sessão](./media/zendesk-tutorial/tutorial_zendesk_url.png)
...
4. No **certificado de assinatura de SAML** secção, copie o **THUMBPRINT** valor do certificado.
    ...
    ![A hiperligação de transferência do certificado](./media/zendesk-tutorial/tutorial_zendesk_certificate.png)
...
5. Zendesk espera as asserções de SAML num formato específico. Existem não existem atributos SAML obrigatórios, mas, opcionalmente, pode adicionar um atributo de **atributos de utilizador** secção seguindo os passos abaixo: 
    ...
    ![Configurar addattb Single Sign-On](./media/zendesk-tutorial/tutorial_attribute_05.png)
...
6. Clique em **guardar** botão.
    ...
    ![Configurar botão único início de sessão guardar](./media/zendesk-tutorial/tutorial_general_400.png)
...
11. No **segurança** página, execute os seguintes passos: 
    ...
    ![De sessão único-](./media/zendesk-tutorial/ic773090.png "de sessão único-")
...
2. Para apresentar a lista de utilizadores, aceda a **utilizadores e grupos**e, em seguida, clique em **todos os utilizadores**.
    ...
    !["Os utilizadores e grupos" e "Todos os utilizadores" ligações](./media/zendesk-tutorial/create_aaduser_02.png)

3. Para abrir o **utilizador** caixa de diálogo, clique em **adicionar** na parte superior do **todos os utilizadores** caixa de diálogo.

    ![O botão de adição](./media/zendesk-tutorial/create_aaduser_03.png)
...
2. Na lista de aplicações, selecione **Zendesk**.
    ...
    ![A ligação do Zendesk na lista de aplicações](./media/zendesk-tutorial/tutorial_zendesk_app.png)
...
* [Configurar o aprovisionamento de utilizadores](zendesk-provisioning-tutorial.md)
