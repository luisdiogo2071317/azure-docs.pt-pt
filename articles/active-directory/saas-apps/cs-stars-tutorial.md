---
title: 'Tutorial: Integração do Active Directory do Azure com o CS estrelas | Documentos da Microsoft'
description: Saiba como configurar o início de sessão único entre o Azure Active Directory e o CS estrelas.
