...
3. **[Criar um utilizador de teste de planejamento de gama Predictix](#create-a-predictix-assortment-planning-test-user)**  - para ter um equivalente da Eduarda Almeida no Predictix variedade planejamento que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **Predictix variedade planejamento de domínio e URLs** secção, execute os seguintes passos:
...
6. No **Predictix variedade planejamento Configuration** secção, clique em **configurar o planejamento de gama Predictix** para abrir **configurar início de sessão** janela. Cópia a **URL de fim de sessão, o ID de entidade de SAML e o SAML único início de sessão no URL do serviço** partir o **secção de referência rápida.**
