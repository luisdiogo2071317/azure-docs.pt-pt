...
4. Na caixa de pesquisa, escreva **Predictix Assortment planeamento**, selecione **Predictix Assortment planeamento** partir do painel de resultados, em seguida, clique em **adicionar** botão para adicionar a aplicação.
    ...
    ![Planeamento de Assortment Predictix na lista de resultados](./media/predictix-assortment-planning-tutorial/tutorial_predictixassortmentplanning_addfromgallery.png)
...
3. No **Predictix Assortment planeamento de domínio e os URLs** secção, execute os seguintes passos:
    ...
    ![Predictix Assortment planeamento de domínio e os URLs únicos de informações de início de sessão](./media/predictix-assortment-planning-tutorial/tutorial_predictixassortmentplanning_url.png)
...
4. No **certificado de assinatura de SAML** secção, clique em **Certificate(Base64)** e, em seguida, guarde o ficheiro de certificado no seu computador.
    ...
    ![A hiperligação de transferência do certificado](./media/predictix-assortment-planning-tutorial/tutorial_predictixassortmentplanning_certificate.png) 

5. Clique em **guardar** botão.

    ![Configurar botão único início de sessão guardar](./media/predictix-assortment-planning-tutorial/tutorial_general_400.png)
...
6. No **Predictix Assortment planeamento configuração** secção, clique em **configurar planeamento de Assortment Predictix** para abrir **configurar início de sessão** janela. Copiar o **Sign-Out URL, o ID de entidade de SAML e o único início de sessão no URL do serviço SAML** do **secção de referência rápida.**
    ...
    ![Planear a configuração do Assortment Predictix](./media/predictix-assortment-planning-tutorial/tutorial_predictixassortmentplanning_configure.png) 
...
2. Para apresentar a lista de utilizadores, aceda a **utilizadores e grupos**e, em seguida, clique em **todos os utilizadores**.
    ...
    !["Os utilizadores e grupos" e "Todos os utilizadores" ligações](./media/predictix-assortment-planning-tutorial/create_aaduser_02.png)

3. Para abrir o **utilizador** caixa de diálogo, clique em **adicionar** na parte superior do **todos os utilizadores** caixa de diálogo.

    ![O botão de adição](./media/predictix-assortment-planning-tutorial/create_aaduser_03.png)
...
2. Na lista de aplicações, selecione **Predictix Assortment planeamento**.
    ...
    ![A ligação Predictix Assortment planeamento na lista de aplicações](./media/predictix-assortment-planning-tutorial/tutorial_predictixassortmentplanning_app.png)  
