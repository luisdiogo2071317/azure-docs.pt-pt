...
4. Na caixa de pesquisa, escreva **redes da Palo Alto - Admin IU**, selecione **redes da Palo Alto - Admin IU** na lista de resultados e, em seguida, selecione **adicionar**.
    ...
    ![Redes da Palo Alto - UI de administrador na lista de resultados](./media/paloaltoadmin-tutorial/tutorial_step4-add-from-the-gallery.png)
...
2. No **de sessão único-** janela, no **modo de início de sessão único** caixa, selecione **baseados em SAML início de sessão**.
    ...
    ![A janela "De sessão único"](./media/paloaltoadmin-tutorial/tutorial_paloaltoadmin_samlbase.png)

3. Em **da Palo Alto redes - administrador de domínio de IU e URLs**, efetue o seguinte procedimento:

    !["Redes da Palo Alto - administrador de domínio de IU e URLs" único informações de início de sessão](./media/paloaltoadmin-tutorial/tutorial_general_show_advanced_url.png)
...
5. Em **certificado de assinatura de SAML**, selecione **XML de metadados**e, em seguida, selecione **guardar**.
    ...
    ![O XML de metadados transferir ligação](./media/paloaltoadmin-tutorial/tutorial_paloaltoadmin_certificate.png) 

    ![O botão Guardar](./media/paloaltoadmin-tutorial/tutorial_general_400.png)
...
9. No **SAML identificar fornecedor de perfil de importação do servidor** janela, efetue o seguinte procedimento:
    ...
    ![A janela "SAML identificar fornecedor perfil importação do servidor"](./media/paloaltoadmin-tutorial/tutorial_paloaltoadmin_idp.png)
...
11. No **perfil de servidor de fornecedor de identidade de SAML** janela, efetue o seguinte procedimento:
    ...
    ![A janela "Perfil do servidor de fornecedor de identidade SAML"](./media/paloaltoadmin-tutorial/tutorial_paloaltoadmin_slo.png)
...
17. No **perfil autenticação** janela, efetue o seguinte procedimento: 
    ...
    ![A janela de "Autenticação perfil"](./media/paloaltoadmin-tutorial/tutorial_paloaltoadmin_authentication_profile.png)
    ...
    ![Botão Adicionar no separador Avançadas](./media/paloaltoadmin-tutorial/tutorial_paloaltoadmin_allowlist.png)
...
2. Para apresentar uma lista de utilizadores atuais, selecione **utilizadores e grupos** > **todos os utilizadores**.
    ...
    !["Os utilizadores e grupos" e "Todos os utilizadores" ligações](./media/paloaltoadmin-tutorial/create_aaduser_02.png)

3. Na parte superior do **todos os utilizadores** janela, selecione **adicionar**.

    ![O botão de adição](./media/paloaltoadmin-tutorial/create_aaduser_03.png)
...
2. No **aplicações** lista, selecione **redes da Palo Alto - Admin IU**.
    ...
    ![As redes da Palo Alto - ligação de IU de Admin](./media/paloaltoadmin-tutorial/tutorial_paloaltoadmin_app.png)  
...
* [Lista de tutoriais sobre a integração de aplicações SaaS no Azure Active Directory](tutorial-list.md)
