...
1. Na caixa de pesquisa, escreva **CylancePROTECT**, selecione **CylancePROTECT** no painel de resultados, em seguida, clique em **Add** botão para adicionar a aplicação.
...
1. **[Criar um utilizador de teste CylancePROTECT](#create-a-cylanceprotect-test-user)**  - para ter um equivalente da Eduarda Almeida na CylancePROTECT que está ligado à representação de utilizador do Azure AD.
...
1. Sobre o **CylancePROTECT domínio e URLs** secção, execute os seguintes passos:
...
1. Sobre o **CylancePROTECT configuração** secção, clique em **configurar CylancePROTECT** para abrir **configurar início de sessão** janela. Cópia a **URL de fim de sessão, o ID de entidade de SAML e o SAML único início de sessão no URL do serviço** partir o **secção de referência rápida.**
