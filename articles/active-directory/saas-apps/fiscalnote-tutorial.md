...
1. Na caixa de pesquisa, escreva **FiscalNote**, selecione **FiscalNote** no painel de resultados, em seguida, clique em **Add** botão para adicionar a aplicação.
...
1. **[Criar um utilizador de teste FiscalNote](#create-a-fiscalnote-test-user)**  - para ter um equivalente da Eduarda Almeida na FiscalNote que está ligado à representação de utilizador do Azure AD.
...
1. Sobre o **FiscalNote domínio e URLs** secção, execute os seguintes passos:
...
1. Sobre o **FiscalNote configuração** secção, clique em **configurar FiscalNote** para abrir **configurar início de sessão** janela. Cópia a **URL de fim de sessão, o ID de entidade de SAML e o SAML único início de sessão no URL do serviço** partir o **secção de referência rápida.**
...
1. Na lista de aplicações, selecione **FiscalNote**.
