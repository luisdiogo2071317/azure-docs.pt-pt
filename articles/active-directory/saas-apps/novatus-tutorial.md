---
title: 'Tutorial: Integração do Azure Active Directory com Novatus | Documentos da Microsoft'
...
5. No painel de resultados, selecione **Novatus**e, em seguida, clique em **Add** botão para adicionar a aplicação.
...
3. **[Criar um utilizador de teste Novatus](#creating-a-novatus-test-user)**  - para ter um equivalente da Eduarda Almeida na Novatus que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **Novatus domínio e URLs** secção, execute os seguintes passos:
...
6. Sobre o **Novatus configuração** secção, clique em **configurar Novatus** para abrir **configurar início de sessão** janela. Cópia a **URL de fim de sessão, o ID de entidade de SAML e o SAML único início de sessão no URL do serviço** partir o **secção de referência rápida.**

    ![Configurar o início de sessão único](./media/novatus-tutorial/tutorial_novatus_configure.png) 

7. Para obter SSO configurado para a sua aplicação, contacte o seu [equipa de suporte de Novatus](mailto:jvinci@novatusinc.com). Anexar o **transferido o certificado** ficheiro para o correio e partilha os **urls de metadados** (**URL de fim de sessão, o ID de entidade de SAML e o SAML único início de sessão no URL do serviço**) com Novatus equipe para configurar o SSO no seu lado.
