---
title: 'Tutorial: Integração do Azure Active Directory com o HPE SaaS | Documentos da Microsoft'
...
5. No painel de resultados, selecione **HPE SaaS**e, em seguida, clique em **Add** botão para adicionar a aplicação.
...
3. **[Criar um utilizador de teste de HPE SaaS](#creating-an-hpe-saas-test-user)**  - para ter um equivalente da Eduarda Almeida na HPE SaaS que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **HPE SaaS domínio e URLs** secção, execute os seguintes passos:
...
6. Para configurar o início de sessão único num **HPE SaaS** lado, terá de enviar o transferido **XML de metadados** para [equipa de suporte de HPE SaaS](https://saas.hpe.com/en-us/contact). Se definir esta definição para que a ligação de SAML SSO definidas corretamente em ambos os lados.
