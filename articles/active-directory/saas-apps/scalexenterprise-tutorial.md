...
Se pretender saber mais detalhes sobre a integração de aplicações SaaS com o Azure AD, consulte o artigo. O que é o acesso a aplicações e início de sessão único com [do Azure Active Directory](../manage-apps/what-is-single-sign-on.md).
...
Clique no mosaico ScaleX empresarial no painel de acesso, irá obter automaticamente com sessão iniciada para a aplicação de ScaleX Enterprise. Para mais informações sobre o painel de acesso, consulte [introdução ao painel de acesso](../active-directory-saas-access-panel-introduction.md).
