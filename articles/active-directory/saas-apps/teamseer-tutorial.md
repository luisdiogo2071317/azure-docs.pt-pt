...
1. Na caixa de pesquisa, escreva **TeamSeer**.

    ![Criar um utilizador de teste do Azure AD](./media/teamseer-tutorial/tutorial_teamseer_search.png)

1. No painel de resultados, selecione **TeamSeer**e, em seguida, clique em **Add** botão para adicionar a aplicação.
...
1. **[Criar um utilizador de teste TeamSeer](#creating-a-teamseer-test-user)**  - para ter um equivalente da Eduarda Almeida na TeamSeer que está ligado à representação de utilizador do Azure AD.
...
1. Sobre o **TeamSeer domínio e URLs** secção, execute os seguintes passos:
    ...
    > [!NOTE] 
    > O valor não é real. Atualize o valor com o URL de início de sessão real. Contacte [equipa de suporte de cliente TeamSeer](https://pages.theaccessgroup.com/solutions_business-suite_absence-management_contact.html) para obter o valor. 
...
1. Sobre o **TeamSeer configuração** secção, clique em **configurar TeamSeer** para abrir **configurar início de sessão** janela. Cópia a **SAML único início de sessão no URL do serviço** partir o **secção de referência rápida.**

    ![Configurar o início de sessão único](./media/teamseer-tutorial/tutorial_teamseer_configure.png)

1. Numa janela do browser web diferente, inicie sessão no site da sua empresa TeamSeer como administrador.
...
1. Na lista de aplicações, selecione **TeamSeer**.
