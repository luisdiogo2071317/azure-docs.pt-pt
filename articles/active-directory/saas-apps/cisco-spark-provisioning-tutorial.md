---
title: 'Tutorial: Configurar o Spark da Cisco para aprovisionamento automático de utilizadores no Azure Active Directory | Documentos da Microsoft'
...
ms.locfileid: "42055591"
---
# <a name="tutorial-configure-cisco-spark-for-automatic-user-provisioning"></a>Tutorial: Configurar o Spark da Cisco para aprovisionamento automático de utilizadores
...
12. Para configurar filtros de âmbito, consulte as seguintes instruções fornecidas a [tutorial de filtro de Scoping](../active-directory-saas-scoping-filters.md).
