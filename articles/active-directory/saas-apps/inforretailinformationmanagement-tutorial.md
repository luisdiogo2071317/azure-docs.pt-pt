...
ms.date: 07/25/2017
ms.author: jeedes
ms.openlocfilehash: 9636ed2c5586f906ed462bdce83fd4a428f2300c
ms.sourcegitcommit: c851842d113a7078c378d78d94fea8ff5948c337
ms.translationtype: MT
ms.contentlocale: pt-PT
ms.lasthandoff: 06/18/2018
ms.locfileid: "35954214"
---
...
4. Na caixa de pesquisa, escreva **Infor revenda – gestão de informações**, selecione **Infor revenda – gestão de informações** partir do painel de resultados, em seguida, clique em **adicionar** botão para adicionar a aplicação.
    ...
    ![Revenda de infor – gestão de informações na lista de resultados](./media/inforretailinformationmanagement-tutorial/tutorial_inforretailinformationmanagement_addfromgallery.png)
...
3. No **Infor revenda – domínio de gestão de informações e os URLs** secção, execute os seguintes passos, se pretender configurar a aplicação no modo de IDP iniciado:
    ...
    ![Revenda infor – domínio de gestão de informações e os URLs únicos de início de sessão informações IDP](./media/inforretailinformationmanagement-tutorial/tutorial_inforretailinformationmanagement_url.png)
...
4. Verifique **Mostrar avançadas definições de URL** e executar o passo seguinte, se pretender configurar a aplicação no **SP** iniciada modo:
    ...
    ![Revenda de infor – domínio de gestão de informações e os URLs único início de sessão informações SP](./media/inforretailinformationmanagement-tutorial/tutorial_inforretailinformationmanagement_url1.png)
...
5. No **certificado de assinatura de SAML** secção, clique em **XML de metadados** e, em seguida, guarde o ficheiro de metadados no seu computador.
    ...
    ![A hiperligação de transferência do certificado](./media/inforretailinformationmanagement-tutorial/tutorial_inforretailinformationmanagement_certificate.png) 

6. Clique em **guardar** botão.

    ![Configurar botão único início de sessão guardar](./media/inforretailinformationmanagement-tutorial/tutorial_general_400.png)
...
2. Para apresentar a lista de utilizadores, aceda a **utilizadores e grupos**e, em seguida, clique em **todos os utilizadores**.
    ...
    !["Os utilizadores e grupos" e "Todos os utilizadores" ligações](./media/inforretailinformationmanagement-tutorial/create_aaduser_02.png)

3. Para abrir o **utilizador** caixa de diálogo, clique em **adicionar** na parte superior do **todos os utilizadores** caixa de diálogo.

    ![O botão de adição](./media/inforretailinformationmanagement-tutorial/create_aaduser_03.png)
...
2. Na lista de aplicações, selecione **Infor revenda – gestão de informações**.
    ...
    ![Revenda de Infor – ligação de gestão de informações na lista de aplicações](./media/inforretailinformationmanagement-tutorial/tutorial_inforretailinformationmanagement_app.png)  
