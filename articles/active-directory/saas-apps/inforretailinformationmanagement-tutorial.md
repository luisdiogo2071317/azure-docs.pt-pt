...
3. **[Criar uma revenda Infor – o utilizador de teste de gerenciamento de informação](#create-an-infor-retail--information-management-test-user)**  - para ter um equivalente da Eduarda Almeida no varejo Infor – gerenciamento de informações que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **Infor revenda – URLs de domínio de gestão de informações e** secção, execute os seguintes passos, se desejar configurar a aplicação no modo de IDP iniciado:
