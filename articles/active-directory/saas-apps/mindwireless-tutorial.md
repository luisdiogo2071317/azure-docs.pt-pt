...
3. **[Criar um utilizador de teste mindWireless](#create-a-mindwireless-test-user)**  - para ter um equivalente da Eduarda Almeida na mindWireless que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **mindWireless domínio e URLs** secção, execute os seguintes passos:
...
9. Sobre o **mindWireless Configuration** secção, clique em **configurar mindWireless** para abrir **configurar início de sessão** janela. Cópia a **URL de fim de sessão, o ID de entidade de SAML e o SAML único início de sessão no URL do serviço** partir o **secção de referência rápida.**
