...
5. Sob o **credenciais de administrador** secção, de entrada a **segredo de Token** gerados por conta da sua LucidChart (pode encontrar o token na sua conta: **Da Equipe** > **integração de aplicações** > **SCIM**). 
