...
4. Definir o **modo de aprovisionamento** para **automática**.
    ...
    ![Aprovisionamento de LucidChart](./media/lucidchart-provisioning-tutorial/LucidChart1.png)
...
5. Sob o **credenciais de administrador** secção, introduza o **segredo Token** gerado pela conta do seu LucidChart (pode encontrar o token na sua conta: **equipa** > **integração de aplicações** > **SCIM**). 
    ...
    ![Aprovisionamento de LucidChart](./media/lucidchart-provisioning-tutorial/LucidChart2.png)
...
Esta operação inicia a sincronização inicial de todos os utilizadores e/ou grupos atribuídos a LucidChart na secção utilizadores e grupos. A sincronização inicial demora mais para efetuar a sincronizações subsequentes, o que ocorrer aproximadamente a cada 40 minutos, desde que o serviço está em execução. Pode utilizar o **detalhes de sincronização** secção para monitorizar o progresso e siga as ligações para os registos de atividade, que descrevem a todas as ações efetuadas pelo serviço de aprovisionamento de aprovisionamento.
