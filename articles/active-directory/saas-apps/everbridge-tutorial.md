...
- Um EverBridge início de sessão único na subscrição ativado
...
1. Na caixa de pesquisa, escreva **EverBridge**.

    ![Criar um utilizador de teste do Azure AD](./media/everbridge-tutorial/tutorial_everbridge_search.png)

1. No painel de resultados, selecione **EverBridge**e, em seguida, clique em **Add** botão para adicionar a aplicação.
...
EverBridge, atribua o valor do **nome de utilizador** no Azure AD como o valor do **Username** para estabelecer a relação de ligação.
...
1. **[Criar um utilizador de teste EverBridge](#creating-an-everbridge-test-user)**  - para ter um equivalente da Eduarda Almeida na EverBridge que está ligado à representação de utilizador do Azure AD.
...
1. Sobre o **EverBridge domínio e URLs** secção, execute os seguintes passos:

    ![Configurar o início de sessão único](./media/everbridge-tutorial/tutorial_everbridge_url.png)

    a. Na **identificador** caixa de texto, escreva um URL com o seguinte padrão: `https://sso.everbridge.net/<companyname>`

    b. Na **URL de resposta** caixa de texto, escreva um URL com o seguinte padrão: `https://manager.everbridge.net/saml/SSO/<companyname>/alias/defaultAlias`
...
1. Sobre o **EverBridge configuração** secção, clique em **configurar EverBridge** para abrir **configurar início de sessão** janela. Cópia a **SAML único início de sessão no URL do serviço** partir o **secção de referência rápida.**

    ![Configurar o início de sessão único](./media/everbridge-tutorial/tutorial_everbridge_configure.png) 

1. Para obter SSO configurado para a sua aplicação, terá de iniciar sessão com o seu inquilino Everbridge como administrador.

1. No menu na parte superior, clique nas **definições** separador e selecione **Single Sign-On** sob **segurança**.
    ...
    e. Na **URL de início de sessão do fornecedor de identidade** caixa de texto, cole o valor do URL de SSO SAML do Azure AD.
...
**Para atribuir a Eduarda Almeida a EverBridge, execute os seguintes passos:**

1. No portal do Azure, abra a vista de aplicativos e, em seguida, navegue para a vista de diretório e aceda a **aplicações empresariais** , em seguida, clique em **todos os aplicativos**.

    ![Atribuir utilizador][201] 

1. Na lista de aplicações, selecione **EverBridge**.
