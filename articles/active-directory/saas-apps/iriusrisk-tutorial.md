---
title: 'Tutorial: Integração do Azure Active Directory com IriusRisk | Documentos da Microsoft'
...
4. Na caixa de pesquisa, escreva **IriusRisk**, selecione **IriusRisk** no painel de resultados, em seguida, clique em **Add** botão para adicionar a aplicação.
...
3. **[Criar um utilizador de teste IriusRisk](#create-a-iriusrisk-test-user)**  - para ter um equivalente da Eduarda Almeida na IriusRisk que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **IriusRisk domínio e URLs** secção, execute os seguintes passos:
...
6. Para configurar o início de sessão único num **IriusRisk** lado, terá de enviar o transferido **XML de metadados** para [equipa de suporte de IriusRisk](mailto:info@continuumsecurity.net). Se definir esta definição para que a ligação de SAML SSO definidas corretamente em ambos os lados.
