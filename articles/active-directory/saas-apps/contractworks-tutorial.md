...
* Pode permitir que os utilizadores ser automaticamente sessão iniciada para ContractWorks (Single Sign-On) com as suas contas do Azure AD.
...
* ContractWorks único início de sessão na subscrição ativada

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, configure e teste do Azure AD início de sessão único num ambiente de teste.

* Suporta ContractWorks **SP** e **IDP** iniciada SSO
...
4. Na caixa de pesquisa, escreva **ContractWorks**, selecione **ContractWorks** no painel de resultados, em seguida, clique em **Add** botão para adicionar a aplicação.
     ...
     ![ContractWorks na lista de resultados](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurar e testar o Azure AD início de sessão único

Nesta secção, configure e teste do Azure AD início de sessão único com ContractWorks com base num utilizador de teste **Eduarda Almeida**.
Para o início de sessão único funcionar, uma relação de ligação entre um utilizador do Azure AD e o utilizador relacionado no ContractWorks deve ser estabelecido.
...
2. **[Configurar ContractWorks Single Sign-On](#configure-contractworks-single-sign-on)**  - para configurar as definições de início de sessão único no lado do aplicativo.
3. **[Criar um utilizador de teste do Azure AD](#create-an-azure-ad-test-user)**  - para testar o Azure AD início de sessão único com Eduarda Almeida.
4. **[Atribua o utilizador de teste do Azure AD](#assign-the-azure-ad-test-user)**  - para ativar a Eduarda Almeida utilizar o Azure AD início de sessão único.
5. **[Criar utilizador de teste ContractWorks](#create-contractworks-test-user)**  - para ter um equivalente da Eduarda Almeida na ContractWorks que está ligado à representação de utilizador do Azure AD.
...
1. Na [portal do Azure](https://portal.azure.com/), na **ContractWorks** página de integração de aplicações, selecione **início de sessão único**.
...
4. Sobre o **configuração básica de SAML** secção, se desejar configurar a aplicação no **IDP** iniciada pelo modo, executar o passo seguinte:
    ...
    ![ContractWorks domínio e URLs únicas início de sessão em informações](common/idp-identifier.png)
...
### <a name="configure-contractworks-single-sign-on"></a>Configurar ContractWorks Single Sign-On

Para configurar o início de sessão único num **ContractWorks** lado, terá de enviar o **Url de metadados de Federação de aplicação** para [equipa de suporte de ContractWorks](mailto:support@contractworks.com). Se definir esta definição para que a ligação de SAML SSO definidas corretamente em ambos os lados.
...
1. No portal do Azure, selecione **aplicações empresariais**, selecione **todos os aplicativos**, em seguida, selecione **ContractWorks**.

    ![Painel de aplicações empresariais](common/enterprise-applications.png)

2. Na lista de aplicações, selecione **ContractWorks**.

    ![A ligação de ContractWorks na lista de aplicações](common/all-applications.png)
...
Quando clica no mosaico ContractWorks no painel de acesso, deve ser automaticamente sessão iniciada no ContractWorks para o qual configura o SSO. Para obter mais informações sobre o painel de acesso, consulte [introdução ao painel de acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
