---
title: 'Tutorial: Integração do Azure Active Directory com o Software de gestão de privacidade OneTrust | Documentos da Microsoft'
...
ms.locfileid: "39042032"
---
# <a name="tutorial-azure-active-directory-integration-with-onetrust-privacy-management-software"></a>Tutorial: Integração do Azure Active Directory com o Software de gestão de privacidade OneTrust
...
4. Na caixa de pesquisa, escreva **Software de gestão de privacidade OneTrust**, selecione **OneTrust Software de gestão de privacidade** no painel de resultados, em seguida, clique em **Add** botão para adicionar o aplicação.
...
3. **[Criar um utilizador de teste de Software de gestão de privacidade OneTrust](#create-a-onetrust-privacy-management-software-test-user)**  - para ter um equivalente da Eduarda Almeida no Software de gestão de privacidade OneTrust que está ligada à representação de utilizador do Azure AD.
...
3. Na **OneTrust privacidade gestão Software domínio e URLs** secção, execute os seguintes passos, se desejar configurar a aplicação na **IDP** iniciada pelo modo:
...
2. Na lista de aplicações, selecione **Software de gestão de privacidade OneTrust**.
