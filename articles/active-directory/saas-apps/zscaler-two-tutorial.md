...
1. Na caixa de pesquisa, escreva **Zscaler dois**.

    ![Criar um utilizador de teste do Azure AD](./media/zscaler-two-tutorial/tutorial_zscalertwo_search.png)

1. No painel de resultados, selecione **Zscaler dois**e, em seguida, clique em **Add** botão para adicionar a aplicação.
...
1. **[Criar um utilizador de teste Zscaler dois](#creating-a-zscaler-two-test-user)**  - para ter um equivalente da Eduarda Almeida na Zscaler duas que está ligado à representação de utilizador do Azure AD.
...
1. Sobre o **domínio de dois Zscaler e URLs** secção, execute os seguintes passos:
...
1. Sobre o **Zscaler configuração de dois** secção, clique em **configurar dois Zscaler** para abrir **configurar início de sessão** janela. Cópia a **SAML único início de sessão no URL do serviço** partir o **secção de referência rápida.**

    ![Configurar o início de sessão único](./media/zscaler-two-tutorial/tutorial_zscalertwo_configure.png) 

1. Numa janela do browser web diferente, inicie sessão no site da sua empresa ZScaler dois como administrador.
...
1. Na lista de aplicações, selecione **Zscaler dois**.
