...
3. **[Criar um utilizador de teste TargetProcess](#create-a-targetprocess-test-user)**  - para ter um equivalente da Eduarda Almeida na TargetProcess que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **TargetProcess domínio e URLs** secção, execute os seguintes passos:
...
6. Sobre o **TargetProcess configuração** secção, clique em **configurar TargetProcess** para abrir **configurar início de sessão** janela. Cópia a **SAML único início de sessão no URL do serviço** partir o **secção de referência rápida.**

    ![Seção de configuração de TargetProcess](./media/target-process-tutorial/tutorial_target-process_configure.png) 

7. Início de sessão na sua aplicação TargetProcess como administrador.
...
10. Clique em **início de sessão único**.
   
    ![Clique em início de sessão único](./media/target-process-tutorial/tutorial_target_process_07.png) 

11. Caixa de diálogo de definições início de sessão único, execute os seguintes passos:
