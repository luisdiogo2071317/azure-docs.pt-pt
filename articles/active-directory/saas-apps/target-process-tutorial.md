...
3. No **TargetProcess domínio e os URLs** secção, execute os seguintes passos:
    ...
    ![Secção TargetProcess domínio e os URLs](./media/target-process-tutorial/tutorial_target-process_url.png)
...
4. No **certificado de assinatura de SAML** secção, clique em **certificado (Base64)** e, em seguida, guarde o ficheiro de certificado no seu computador.
    ...
    ![Secção de certificado de assinatura de SAML](./media/target-process-tutorial/tutorial_target-process_certificate.png) 
...
6. No **TargetProcess configuração** secção, clique em **configurar TargetProcess** para abrir **configurar início de sessão** janela. Copiar o **único início de sessão no URL do serviço SAML** do **secção de referência rápida.**
    ...
    ![Secção de configuração de TargetProcess](./media/target-process-tutorial/tutorial_target-process_configure.png) 
...
10. Clique em **de sessão único-**.
    ...
    ![Clique em Single Sign-On](./media/target-process-tutorial/tutorial_target_process_07.png) 
