...
4. Na caixa de pesquisa, escreva **competências Manager**, selecione **competências Manager** partir do painel de resultados, em seguida, clique em **adicionar** botão para adicionar a aplicação.
    ...
    ![Gestor de competências na lista de resultados](./media/skillsmanager-tutorial/tutorial_skillsmanager_addfromgallery.png)
...
3. No **URLs e de domínio do Gestor de competências** secção, execute os seguintes passos:
    ...
    ![Domínio do Gestor de competências e os URLs únicos de informações de início de sessão](./media/skillsmanager-tutorial/tutorial_skillsmanager_url.png)
...
4. No **certificado de assinatura de SAML** secção, clique em **Certificate(Base64)** e, em seguida, guarde o ficheiro de certificado no seu computador.
    ...
    ![A hiperligação de transferência do certificado](./media/skillsmanager-tutorial/tutorial_skillsmanager_certificate.png) 

5. Clique em **guardar** botão.

    ![Configurar botão único início de sessão guardar](./media/skillsmanager-tutorial/tutorial_general_400.png)
...
6. No **competências Gestor de configuração** secção, clique em **configurar Gestor de competências** para abrir **configurar início de sessão** janela. Copiar o **Sign-Out URL, o ID de entidade de SAML e o único início de sessão no URL do serviço SAML** do **secção de referência rápida.**
    ...
    ![Configuração do Gestor de competências](./media/skillsmanager-tutorial/tutorial_skillsmanager_configure.png) 
...
2. Para apresentar a lista de utilizadores, aceda a **utilizadores e grupos**e, em seguida, clique em **todos os utilizadores**.
    ...
    !["Os utilizadores e grupos" e "Todos os utilizadores" ligações](./media/skillsmanager-tutorial/create_aaduser_02.png)

3. Para abrir o **utilizador** caixa de diálogo, clique em **adicionar** na parte superior do **todos os utilizadores** caixa de diálogo.

    ![O botão de adição](./media/skillsmanager-tutorial/create_aaduser_03.png)
...
2. Na lista de aplicações, selecione **competências Manager**.
    ...
    ![A ligação do Gestor de competências na lista de aplicações](./media/skillsmanager-tutorial/tutorial_skillsmanager_app.png)  
