---
title: 'Tutorial: Integração do Active Directory do Azure com o Gestor de habilidades | Documentos da Microsoft'
...
1. Na caixa de pesquisa, escreva **Manager habilidades**, selecione **habilidades Manager** no painel de resultados, em seguida, clique em **Add** botão para adicionar a aplicação.
...
1. **[Criar um utilizador de teste do Gestor de habilidades](#create-a-skills-manager-test-user)**  - para ter um equivalente da Eduarda Almeida no Gestor de habilidades que está ligado à representação de utilizador do Azure AD.
...
1. Sobre o **URLs de domínio do Gestor de habilidades e** secção, execute os seguintes passos:
...
1. Na **configuração do Gestor de habilidades** secção, clique em **configurar Gestor de habilidades** para abrir **configurar início de sessão** janela. Cópia a **URL de fim de sessão, o ID de entidade de SAML e o SAML único início de sessão no URL do serviço** partir o **secção de referência rápida.**
...
1. Na lista de aplicações, selecione **habilidades Manager**.
