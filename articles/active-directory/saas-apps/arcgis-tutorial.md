...
4. **[Criar utilizador de teste ArcGIS Online](#create-arcgis-online-test-user)**  - para ter um equivalente da Eduarda Almeida ArcGIS online que está ligado à representação de utilizador do Azure AD.
