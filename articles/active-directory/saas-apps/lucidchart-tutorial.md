---
title: 'Tutorial: Integração do Azure Active Directory com Lucidchart | Documentos da Microsoft'
...
- Pode permitir que os utilizadores automaticamente obter com sessão iniciada para Lucidchart (Single Sign-On) com as suas contas do Azure AD
...
- Um Lucidchart logon único habilitado subscrição
...
1. Adicionando Lucidchart da Galeria
...
4. Na caixa de pesquisa, escreva **Lucidchart**.
    ...
    ![Criar um utilizador de teste do Azure AD](./media/lucidchart-tutorial/tutorial_lucidchart_search.png)

5. No painel de resultados, selecione **Lucidchart**e, em seguida, clique em **Add** botão para adicionar a aplicação.

    ![Criar um utilizador de teste do Azure AD](./media/lucidchart-tutorial/tutorial_lucidchart_addfromgallery.png)

##  <a name="configuring-and-testing-azure-ad-single-sign-on"></a>Configuração e teste do Azure AD início de sessão único
Nesta secção, configure e teste do Azure AD início de sessão único com Lucidchart com base num utilizador de teste chamado "Eduarda Almeida".

Para o início de sessão único funcione, o Azure AD precisa saber qual é o utilizador de contraparte no Lucidchart a um utilizador no Azure AD. Em outras palavras, uma relação de ligação entre um utilizador do Azure AD e o utilizador relacionado no Lucidchart deve ser estabelecido.

Lucidchart, atribua o valor do **nome de utilizador** no Azure AD como o valor do **Username** para estabelecer a relação de ligação.
...
3. **[Criar um utilizador de teste Lucidchart](#creating-a-lucidchart-test-user)**  - para ter um equivalente da Eduarda Almeida na Lucidchart que está ligado à representação de utilizador do Azure AD.
4. **[Atribuir o utilizador de teste do Azure AD](#assigning-the-azure-ad-test-user)**  - para ativar a Eduarda Almeida utilizar o Azure AD início de sessão único.
5. **[Teste de início de sessão único](#testing-single-sign-on)**  - para verificar se a configuração funciona.

### <a name="configuring-azure-ad-single-sign-on"></a>Configuração do Azure AD início de sessão único

Nesta secção, pode ativar o Azure AD início de sessão único no portal do Azure e configurar início de sessão único em seu aplicativo Lucidchart.

**Para configurar o Azure AD início de sessão único com Lucidchart, execute os seguintes passos:**

1. No portal do Azure, sobre o **Lucidchart** página de integração de aplicação, clique em **início de sessão único**.

    ![Configurar o início de sessão único][4]

2. Sobre o **início de sessão único** caixa de diálogo, selecione **modo** como **baseado em SAML logon** para ativar o início de sessão único.
 
    ![Configurar o início de sessão único](./media/lucidchart-tutorial/tutorial_lucidchart_samlbase.png)

3. Sobre o **Lucidchart domínio e URLs** secção, execute os seguintes passos:

    ![Configurar o início de sessão único](./media/lucidchart-tutorial/tutorial_lucidchart_url.png)
...
4. Sobre o **certificado de assinatura SAML** secção, clique em **XML de metadados** e, em seguida, guarde o ficheiro de metadados no seu computador.
    ...
    ![Configurar o início de sessão único](./media/lucidchart-tutorial/tutorial_lucidchart_certificate.png) 

5. Clique em **guardar** botão.

    ![Configurar o início de sessão único](./media/lucidchart-tutorial/tutorial_general_400.png)

6. Numa janela do browser web diferente, inicie sessão no site da sua empresa Lucidchart como um administrador.

7. No menu na parte superior, clique em **equipe**.
   
    ![Equipe](./media/lucidchart-tutorial/ic791190.png "equipe")

8. Clique em **aplicativos \> gerir SAML**.
   
    ![Gerir SAML](./media/lucidchart-tutorial/ic791191.png "gerir SAML")

9. Sobre o **definições de autenticação SAML** caixa de diálogo página, execute os seguintes passos:
...
1. Na **portal do Azure**, no painel de navegação esquerdo, clique em **Azure Active Directory** ícone.
    ...
    ![Criar um utilizador de teste do Azure AD](./media/lucidchart-tutorial/create_aaduser_01.png) 

2. Para apresentar a lista de utilizadores, aceda a **utilizadores e grupos** e clique em **todos os utilizadores**.
    
    ![Criar um utilizador de teste do Azure AD](./media/lucidchart-tutorial/create_aaduser_02.png) 

3. Para abrir o **usuário** caixa de diálogo, clique em **Add** na parte superior da caixa de diálogo.
 
    ![Criar um utilizador de teste do Azure AD](./media/lucidchart-tutorial/create_aaduser_03.png) 

4. Sobre o **utilizador** caixa de diálogo página, execute os seguintes passos:
 
    ![Criar um utilizador de teste do Azure AD](./media/lucidchart-tutorial/create_aaduser_04.png) 
...
**Para atribuir a Eduarda Almeida a Lucidchart, execute os seguintes passos:**
...
2. Na lista de aplicações, selecione **Lucidchart**.
    ...
    ![Configurar o início de sessão único](./media/lucidchart-tutorial/tutorial_lucidchart_app.png) 
...
Quando clica no mosaico Lucidchart no painel de acesso, deve obter automaticamente sessão iniciada em seu aplicativo Lucidchart.
