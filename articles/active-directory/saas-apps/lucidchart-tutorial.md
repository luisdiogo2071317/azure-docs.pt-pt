...
1. Na caixa de pesquisa, escreva **Lucidchart**.

    ![Criar um utilizador de teste do Azure AD](./media/lucidchart-tutorial/tutorial_lucidchart_search.png)

1. No painel de resultados, selecione **Lucidchart**e, em seguida, clique em **Add** botão para adicionar a aplicação.
...
1. **[Criar um utilizador de teste Lucidchart](#creating-a-lucidchart-test-user)**  - para ter um equivalente da Eduarda Almeida na Lucidchart que está ligado à representação de utilizador do Azure AD.
...
1. Sobre o **Lucidchart domínio e URLs** secção, execute os seguintes passos:
...
1. Clique em **aplicativos \> gerir SAML**.
   
    ![Gerir SAML](./media/lucidchart-tutorial/ic791191.png "gerir SAML")

1. Sobre o **definições de autenticação SAML** caixa de diálogo página, execute os seguintes passos:
