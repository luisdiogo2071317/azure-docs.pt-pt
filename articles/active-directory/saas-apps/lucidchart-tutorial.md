...
9. No **definições de autenticação SAML** diálogo página, execute os seguintes passos:
    ...
    ![Alterar o certificado](./media/lucidchart-tutorial/ic791193.png "alterar o certificado")
    ...
    ![Guardar as alterações](./media/lucidchart-tutorial/ic791195.png "guardar alterações")
