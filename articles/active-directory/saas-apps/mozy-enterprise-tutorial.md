---
title: 'Tutorial: Integração do Azure Active Directory com o Mozy Enterprise | Documentos da Microsoft'
...
5. No painel de resultados, selecione **Mozy Enterprise**e, em seguida, clique em **Add** botão para adicionar a aplicação.
...
3. **[Criar um utilizador de teste de Mozy Enterprise](#creating-a-mozy-enterprise-test-user)**  - para ter um equivalente da Eduarda Almeida na empresa Mozy que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **Mozy Enterprise domínio e URLs** secção, execute os seguintes passos:
...
6. Sobre o **Mozy Enterprise Configuration** secção, clique em **empresarial de Mozy configurar** para abrir **configurar início de sessão** janela. Cópia a **ID de entidade de SAML e SAML único início de sessão no URL do serviço** partir o **secção de referência rápida.**
...
8. Na **Configuration** secção, clique em **política de autenticação**.
   
   ![Política de autenticação](./media/mozy-enterprise-tutorial/ic777314.png "política de autenticação")

9. Sobre o **política de autenticação** secção, execute os seguintes passos:
