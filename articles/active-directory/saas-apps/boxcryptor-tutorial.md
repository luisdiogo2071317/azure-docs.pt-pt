---
title: 'Tutorial: Integração do Azure Active Directory com Boxcryptor | Documentos da Microsoft'
...
3. **[Criar um utilizador de teste Boxcryptor](#create-a-boxcryptor-test-user)**  - para ter um equivalente da Eduarda Almeida na Boxcryptor que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **Boxcryptor domínio e URLs** secção, execute os seguintes passos:
...
6. Sobre o **Boxcryptor configuração** secção, clique em **configurar Boxcryptor** para abrir **configurar início de sessão** janela. Cópia a **SAML único início de sessão no URL do serviço** e **ID de entidade de SAML** partir o **secção de referência rápida.**
