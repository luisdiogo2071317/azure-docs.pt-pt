...
4. **[Criar utilizador de teste Concur](#create-concur-test-user)**  - para ter um equivalente da Eduarda Almeida na Concur que está ligado à representação de utilizador do Azure AD.
