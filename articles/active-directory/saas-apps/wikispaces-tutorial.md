---
title: 'Tutorial: Integração do Active Directory do Azure com Wikispaces | Documentos da Microsoft'
...
1. Na caixa de pesquisa, escreva **Wikispaces**.

    ![Criar um utilizador de teste do Azure AD](./media/wikispaces-tutorial/tutorial_wikispaces_search.png)

1. No painel de resultados, selecione **Wikispaces**e, em seguida, clique em **Add** botão para adicionar a aplicação.
...
1. **[Criar um utilizador de teste Wikispaces](#creating-a-wikispaces-test-user)**  - para ter um equivalente da Eduarda Almeida na Wikispaces que está ligado à representação de utilizador do Azure AD.
...
1. Sobre o **Wikispaces domínio e URLs** secção, execute os seguintes passos:
...
1. Para configurar o início de sessão único num **Wikispaces** lado, terá de enviar o transferido **XML de metadados** para [equipa de suporte de Wikispaces](https://www.wikispaces.com/site/help). Receberá uma notificação quando a configuração foi concluída.
...
1. Clique nas **convidar pessoas**.
   
    ![Convidar pessoas](./media/wikispaces-tutorial/ic787194.png "convidar pessoas")

1. Na **convidar pessoas** secção, execute os seguintes passos:
...
1. Na lista de aplicações, selecione **Wikispaces**.
