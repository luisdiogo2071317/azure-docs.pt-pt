...
4. Na caixa de pesquisa, escreva **Bpm'online**, selecione **Bpm'online** no painel de resultados, em seguida, clique em **Add** botão para adicionar a aplicação.
...
3. **[Criar um utilizador de teste Bpm'online](#create-a-bpmonline-test-user)**  - para ter um equivalente da Eduarda Almeida na Bpm'online que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **Bpm'online domínio e URLs** secção, execute os seguintes passos, se desejar configurar a aplicação no **IDP** iniciada pelo modo:
...
7. Para configurar o início de sessão único num **Bpm'online** lado, terá de enviar o **Url de metadados de Federação de aplicação** para [equipa de suporte de Bpm'online](mailto:support@bpmonline.com). Se definir esta definição para que a ligação de SAML SSO definidas corretamente em ambos os lados.
