---
title: 'Tutorial: Integração do Azure Active Directory com eDigitalResearch | Documentos da Microsoft'
...
4. Na caixa de pesquisa, escreva **eDigitalResearch**, selecione **eDigitalResearch** no painel de resultados, em seguida, clique em **Add** botão para adicionar a aplicação.
...
3. **[Criar um utilizador de teste eDigitalResearch](#create-a-edigitalresearch-test-user)**  - para ter um equivalente da Eduarda Almeida na eDigitalResearch que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **eDigitalResearch domínio e URLs** secção, execute os seguintes passos:
    ...
    > [!NOTE] 
    > Estes valores não são reais. Atualize estes valores com o identificador real e o URL de resposta. Contacte [equipa de suporte de eDigitalResearch](http://www.maruedr.com/contact) obter esses valores.
 


4. Sobre o **certificado de assinatura SAML** secção, clique em **Base(64) certificado** e, em seguida, guarde o ficheiro de certificado no seu computador.
...
6. Sobre o **eDigitalResearch Configuration** secção, clique em **configurar eDigitalResearch** para abrir **configurar início de sessão** janela. Copiar o **URL de fim de sessão, o ID de entidade de SAML** partir o **secção de referência rápida.**
...
Trabalhar com o [equipa de suporte de eDigitalResearch](http://www.maruedr.com/contact) de pôr os utilizadores que criou.     
