...
3. **[Criar um utilizador de teste Expensify](#create-an-expensify-test-user)**  - para ter um equivalente da Eduarda Almeida na Expensify que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **Expensify domínio e URLs** secção, execute os seguintes passos:
