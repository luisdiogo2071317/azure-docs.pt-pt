...
5. No **certificado de assinatura de SAML** secção, clique em **Certificate(Base64)** e, em seguida, guarde o ficheiro de certificado no seu computador.
    ...
    ![A hiperligação de transferência do certificado](./media/druva-tutorial/tutorial_druva_certificate.png) 
...
12. Na caixa de diálogo Definições de início de sessão único, execute os seguintes passos:
    ...
    ![Single Sign-On definições](./media/druva-tutorial/ic795092.png "único as definições de início de sessão")
...
13. No **definições** página, clique em **gerar Token SSO**.
    ...
    ![Definições](./media/druva-tutorial/ic795093.png "definições")

14. No **único início de sessão no Token de autenticação** caixa de diálogo, execute os seguintes passos:

    ![Token SSO](./media/druva-tutorial/ic795094.png "SSO Token")
...
2. Para apresentar a lista de utilizadores, aceda a **utilizadores e grupos**e, em seguida, clique em **todos os utilizadores**.
    ...
    !["Os utilizadores e grupos" e "Todos os utilizadores" ligações](./media/druva-tutorial/create_aaduser_02.png)

3. Para abrir o **utilizador** caixa de diálogo, clique em **adicionar** na parte superior do **todos os utilizadores** caixa de diálogo.

    ![O botão de adição](./media/druva-tutorial/create_aaduser_03.png)
