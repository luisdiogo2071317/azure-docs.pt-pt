---
title: 'Tutorial: Integração do Active Directory do Azure com o Zscaler | Documentos da Microsoft'
...
4. Na caixa de pesquisa, escreva **Zscaler**, selecione **Zscaler** no painel de resultados, em seguida, clique em **Add** botão para adicionar a aplicação.
...
3. **[Criar um utilizador de teste do Zscaler](#creating-a-zscaler-test-user)**  - para ter um equivalente da Eduarda Almeida na Zscaler que está ligado à representação de utilizador do Azure AD.
...
4. Sobre o **configuração básica de SAML** secção, execute os seguintes passos:
    ...
    ![Zscaler domínio e URLs únicas início de sessão em informações](./media/zscaler-tutorial/tutorial_zscaler_url.png)

    Na **URL de início de sessão** caixa de texto, escreva um URL com o seguinte padrão: `https://<companyname>.zscaler.net`
...
7. No **certificado de assinatura SAML** página, além da **certificado de assinatura SAML** secção, clique em **transferir** para transferir **certificado (Base64)** e, em seguida, guarde o ficheiro de certificado no seu computador.
    ...
    ![O link de download de certificado](./media/zscaler-tutorial/tutorial_zscaler_certificate.png) 

8. Sobre o **configurar Zscaler** secção, copie o URL adequado, de acordo com seus requisitos.
    ...
    ![Configuração do Zscaler](common/configuresection.png)

9. Numa janela do browser web diferente, inicie sessão no site da sua empresa ZScaler como administrador.
...
11. Sobre o **SAML editar** janela, execute os seguintes passos: e clique em Guardar.  
    ...
    ![Gerir utilizadores e de autenticação](./media/zscaler-tutorial/ic800208.png "gerir utilizadores e de autenticação")
...
O objetivo desta secção é criar um usuário chamado Eduarda Almeida no Zscaler. Zscaler suporta o aprovisionamento de just-in-time, que está por predefinição, ativada. Não existe nenhum item de ação para nesta secção. Um novo utilizador é criado durante uma tentativa de aceder Zscaler se não existir ainda.
>[!Note]
>Se precisar de criar manualmente um utilizador, contacte [equipa de suporte do Zscaler](https://www.zscaler.com/company/contact).
