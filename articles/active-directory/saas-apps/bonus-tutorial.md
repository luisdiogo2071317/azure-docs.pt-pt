...
4. No **certificado de assinatura de SAML** secção, copie o **THUMBPRINT** valor do certificado.
    ...
    ![A hiperligação de transferência do certificado](./media/bonus-tutorial/tutorial_bonusly_certificate.png) 

5. Clique em **guardar** botão.

    ![Configurar botão único início de sessão guardar](./media/bonus-tutorial/tutorial_general_400.png)
...
8. Na barra de ferramentas na parte superior, clique em **definições**e, em seguida, selecione **integrações e aplicações**.
    ...
    ![Secção de redes Social bonusly](./media/bonus-tutorial/ic773686.png "Bonusly")
9. Em **Single Sign-On**, selecione **SAML**.

10. No **SAML** diálogo página, execute os seguintes passos:
   
    ![Página de caixa de diálogo de Saml bonusly](./media/bonus-tutorial/ic773687.png "Bonusly")
...
2. Para apresentar a lista de utilizadores, aceda a **utilizadores e grupos** e clique em **todos os utilizadores**.
    ...
    !["Os utilizadores e grupos" e "Todos os utilizadores" ligações](./media/bonus-tutorial/create_aaduser_02.png) 

3. Para abrir o **utilizador** caixa de diálogo, clique em **adicionar** na parte superior da caixa de diálogo.
 
    ![O botão de adição](./media/bonus-tutorial/create_aaduser_03.png) 
...
3. Clique em de **utilizadores e bonuses** separador.
    ...
    ![Os utilizadores e bonuses](./media/bonus-tutorial/ic781042.png "utilizadores e bonuses")
...
2. Na lista de aplicações, selecione **Bonusly**.
    ...
    ![O Bonusly ligação na lista de aplicações](./media/bonus-tutorial/tutorial_bonusly_app.png) 
