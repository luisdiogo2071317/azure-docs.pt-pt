---
title: 'Tutorial: Integração do Azure Active Directory com itslearning | Documentos da Microsoft'
...
5. No painel de resultados, selecione **itslearning**e, em seguida, clique em **Add** botão para adicionar a aplicação.
...
3. **[Criar um utilizador de teste itslearning](#creating-an-itslearning-test-user)**  - para ter um equivalente da Eduarda Almeida na itslearning que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **itslearning domínio e URLs** secção, execute os seguintes passos:
...
6. Para configurar o início de sessão único num **itslearning** lado, terá de enviar o transferido **XML de metadados** para [equipa de suporte de itslearning](mailto:support@itslearning.com). Se definir esta definição para que a ligação de SAML SSO definidas corretamente em ambos os lados.
