...
1. Na caixa de pesquisa, escreva **BlueJeans**.

    ![Criar um utilizador de teste do Azure AD](./media/bluejeans-tutorial/tutorial_bluejeans_search.png)

1. No painel de resultados, selecione **BlueJeans**e, em seguida, clique em **Add** botão para adicionar a aplicação.
...
1. **[Criar um utilizador de teste BlueJeans](#creating-a-bluejeans-test-user)**  - para ter um equivalente da Eduarda Almeida na BlueJeans que está ligado à representação de utilizador do Azure AD.
...
1. Sobre o **BlueJeans domínio e URLs** secção, execute os seguintes passos:
...
1. Sobre o **BlueJeans configuração** secção, clique em **configurar BlueJeans** para abrir **configurar início de sessão** janela. Cópia a **URL de fim de sessão, alterar o URL da palavra-passe e SAML único início de sessão no URL do serviço** partir o **secção de referência rápida.**
...
1. Aceda a **administrador \> definições de grupo \> segurança**.
...
1. Avançar com os seguintes passos:
...
1. Aceda a **administrador \> gerir utilizadores \> adicionar utilizador**.
...
1. Na lista de aplicações, selecione **BlueJeans**.
