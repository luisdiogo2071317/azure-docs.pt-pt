...
3. **[Criar um utilizador de teste TextMagic](#create-a-textmagic-test-user)**  - para ter um equivalente da Eduarda Almeida na TextMagic que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **TextMagic domínio e URLs** secção, execute os seguintes passos, se desejar configurar a aplicação no **IDP** iniciada pelo modo:
...
7. Sobre o **TextMagic configuração** secção, clique em **configurar TextMagic** para abrir **configurar início de sessão** janela. Cópia a **URL de fim de sessão, o ID de entidade de SAML e o SAML único início de sessão no URL do serviço** partir o **secção de referência rápida.**
...
10. Clique no SEPARADOR **"único início de sessão (SSO)"** e preencha os campos seguintes:  
