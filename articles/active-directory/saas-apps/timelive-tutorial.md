---
title: 'Tutorial: Integração do Azure Active Directory com TimeLive | Documentos da Microsoft'
...
3. **[Criar um utilizador de teste TimeLive](#create-a-timelive-test-user)**  - para ter um equivalente da Eduarda Almeida na TimeLive que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **TimeLive domínio e URLs** secção, execute os seguintes passos:
...
6. Sobre o **TimeLive configuração** secção, clique em **configurar TimeLive** para abrir **configurar início de sessão** janela. Cópia a **URL de fim de sessão e SAML único início de sessão no URL do serviço** partir o **secção de referência rápida.**
...
8. Selecione **preferências** sob **opções de administrador**.

    ![Configuração de TimeLive](./media/timelive-tutorial/configure1.png)

9. Na **preferência de aplicativo** secção, execute os seguintes passos:
