---
title: 'Tutorial: Integração do Active Directory do Azure com a plataforma de Capriza | Documentos da Microsoft'
...
1. Na caixa de pesquisa, escreva **Capriza plataforma**.

    ![Criar um utilizador de teste do Azure AD](./media/capriza-tutorial/tutorial_caprizaplatform_search.png)

1. No painel de resultados, selecione **plataforma Capriza**e, em seguida, clique em **Add** botão para adicionar a aplicação.
...
1. **[Criar um utilizador de teste de plataforma Capriza](#creating-a-capriza-platform-test-user)**  - para ter um equivalente da Eduarda Almeida na plataforma de Capriza que está ligado à representação de utilizador do Azure AD.
...
1. Sobre o **Capriza plataforma domínio e URLs** secção, execute os seguintes passos:
...
1. Na **configuração de plataforma Capriza** secção, clique em **configurar plataforma de Capriza** para abrir **configurar início de sessão** janela. Cópia a **URL de fim de sessão, o ID de entidade de SAML e o SAML único início de sessão no URL do serviço** partir o **secção de referência rápida.**
...
1. Na lista de aplicações, selecione **Capriza plataforma**.
