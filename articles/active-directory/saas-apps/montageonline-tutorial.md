---
title: 'Tutorial: Integração do Azure Active Directory com o Montage Online | Documentos da Microsoft'
...
ms.locfileid: "39046095"
---
# <a name="tutorial-azure-active-directory-integration-with-montage-online"></a>Tutorial: Integração do Azure Active Directory com o Montage Online
...
4. Na caixa de pesquisa, escreva **Montage Online**, selecione **Montage Online** no painel de resultados, em seguida, clique em **Add** botão para adicionar a aplicação.
...
3. **[Criar um utilizador de teste Online de Montage](#create-a-montage-online-test-user)**  - para ter um equivalente da Eduarda Almeida Montage online que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **Montage de domínio Online e URLs** secção, execute os seguintes passos:
...
6. Sobre o **Configuração Online de Montage** secção, clique em **configurar Montage Online** para abrir **configurar início de sessão** janela. Cópia a **URL de fim de sessão, o ID de entidade de SAML e o SAML único início de sessão no URL do serviço** partir o **secção de referência rápida.**
