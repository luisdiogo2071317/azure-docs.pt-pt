...
4. Na caixa de pesquisa, escreva **imagem FUNCIONA**, selecione **FUNCIONA de imagem** no painel de resultados, em seguida, clique em **Add** botão para adicionar a aplicação.
...
3. **[Criar um utilizador de teste de imagem FUNCIONA](#create-a-image-works-test-user)**  - para ter um equivalente da Eduarda Almeida na FUNCIONA de imagem que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **imagem FUNCIONA domínio e URLs** secção, execute os seguintes passos:
...
6. Na **configuração da imagem FUNCIONA** secção, clique em **configurar FUNCIONA de imagem** para abrir **configurar início de sessão** janela. Cópia a **URL de fim de sessão, o ID de entidade de SAML e o SAML único início de sessão no URL do serviço** partir o **secção de referência rápida.**
...
2. Na lista de aplicações, selecione **FUNCIONA de imagem**.
