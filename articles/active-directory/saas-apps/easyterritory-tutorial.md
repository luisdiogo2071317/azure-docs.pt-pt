---
title: 'Tutorial: Integração do Azure Active Directory com EasyTerritory | Documentos da Microsoft'
...
3. **[Criar um utilizador de teste EasyTerritory](#create-a-easyterritory-test-user)**  - para ter um equivalente da Eduarda Almeida na EasyTerritory que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **EasyTerritory domínio e URLs** secção, execute os seguintes passos, se desejar configurar a aplicação no modo de IDP iniciado:
...
7. Para configurar o início de sessão único num **EasyTerritory** lado, terá de enviar o transferido **XML de metadados** para [equipa de suporte de EasyTerritory](mailto:sales@easyterritory.com). Se definir esta definição para que a ligação de SAML SSO definidas corretamente em ambos os lados.
