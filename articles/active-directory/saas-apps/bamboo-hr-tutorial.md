...
ms.date: 01/18/2018
ms.author: jeedes
ms.openlocfilehash: 927af22b3f043db3222b39355187832e299f448e
...
2. No **de sessão único-** janela, no **modo** na lista pendente, selecione **baseados em SAML início de sessão**.
    ...
    ![Janela de início de sessão único](./media/bamboo-hr-tutorial/tutorial_bamboohr_samlbase.png)

3. Em **BambooHR domínio e os URLs**, efetue o seguinte procedimento:

    ![A secção BambooHR domínio e os URLs](./media/bamboo-hr-tutorial/tutorial_bamboohr_url.png)
...
4. Em **certificado de assinatura de SAML**, selecione **certificado (Base64)** e, em seguida, guarde o ficheiro de certificado no seu computador.
    ...
    ![A hiperligação de transferência do certificado](./media/bamboo-hr-tutorial/tutorial_bamboohr_certificate.png) 

5. Selecione **Guardar**.

    ![O botão Guardar](./media/bamboo-hr-tutorial/tutorial_general_400.png)
...
8. Na página inicial, efetue o seguinte:
    ...
    ![A página BambooHR Single Sign-On](./media/bamboo-hr-tutorial/ic796691.png "Single Sign-On")   
...
9. No **SAML Single Sign-On** painel, efetue o seguinte procedimento:
    ...
    ![Painel de SAML Single Sign-On](./media/bamboo-hr-tutorial/IC796692.png "SAML Single Sign-On")
...
2. Para apresentar a lista de utilizadores, aceda a **utilizadores e grupos**e, em seguida, selecione **todos os utilizadores**.
    ...
    !["Os utilizadores e grupos" e "Todos os utilizadores" ligações](./media/bamboo-hr-tutorial/create_aaduser_02.png)

3. Na parte superior do **todos os utilizadores** painel, selecione **adicionar**.

    ![O botão de adição](./media/bamboo-hr-tutorial/create_aaduser_03.png)
...
2. Na barra de ferramentas na parte superior, selecione **definições**.
    ...
    ![No botão definições](./media/bamboo-hr-tutorial/IC796694.png "definição")
...
2. No **aplicações empresariais** lista, selecione **BambooHR**.
    ...
    ![A ligação de BambooHR na lista de aplicações da empresa](./media/bamboo-hr-tutorial/tutorial_bamboohr_app.png)  
