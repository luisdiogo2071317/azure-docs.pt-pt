...
9. Clique em **utilizadores e de administração do sistema**.
    ...
    ![Utilizadores e de administração do sistema](./media/kintone-tutorial/ic785880.png "utilizadores e de administração do sistema")
...
3. Clique em **utilizadores e de administração do sistema**.
    ...
    ![Administração de sistema & utilizador](./media/kintone-tutorial/ic785880.png "administração System & utilizador")

4. Em **utilizador administração**, clique em **departamentos & utilizadores**.
   
    ![Departamento & utilizadores](./media/kintone-tutorial/ic785888.png "departamento & utilizadores")

5. Clique em **novo utilizador**.
   
    ![Os novos utilizadores](./media/kintone-tutorial/ic785889.png "novos utilizadores")

6. No **novo utilizador** secção, execute os seguintes passos:
   
    ![Os novos utilizadores](./media/kintone-tutorial/ic785890.png "novos utilizadores")
