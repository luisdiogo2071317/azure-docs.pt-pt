---
title: 'Tutorial: Integração do Active Directory do Azure com PatentSQUARE | Documentos da Microsoft'
...
ms.locfileid: "55167976"
---
# <a name="tutorial-azure-active-directory-integration-with-patentsquare"></a>Tutorial: Integração do Active Directory do Azure com PatentSQUARE
...
1. Na caixa de pesquisa, escreva **PatentSQUARE**, selecione **PatentSQUARE** no painel de resultados, em seguida, clique em **Add** botão para adicionar a aplicação.
...
1. **[Criar um utilizador de teste PatentSQUARE](#create-a-patentsquare-test-user)**  - para ter um equivalente da Eduarda Almeida na PatentSQUARE que está ligado à representação de utilizador do Azure AD.
...
1. Sobre o **PatentSQUARE domínio e URLs** secção, execute os seguintes passos:
...
1. Na lista de aplicações, selecione **PatentSQUARE**.
