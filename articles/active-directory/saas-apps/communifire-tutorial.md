...
1. Na caixa de pesquisa, escreva **Communifire**, selecione **Communifire** no painel de resultados, em seguida, clique em **Add** botão para adicionar a aplicação.
...
1. **[Criar um utilizador de teste Communifire](#create-a-communifire-test-user)**  - para ter um equivalente da Eduarda Almeida na Communifire que está ligado à representação de utilizador do Azure AD.
...
1. Sobre o **Communifire domínio e URLs** secção, execute os seguintes passos, se desejar configurar a aplicação no modo de IDP iniciado:
...
1. Na lista de aplicações, selecione **Communifire**.
