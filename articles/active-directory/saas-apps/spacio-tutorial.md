...
1. Na caixa de pesquisa, escreva **Spacio**, selecione **Spacio** no painel de resultados, em seguida, clique em **Add** botão para adicionar a aplicação.
...
1. **[Criar um utilizador de teste Spacio](#create-a-spacio-test-user)**  - para ter um equivalente da Eduarda Almeida na Spacio que está ligado à representação de utilizador do Azure AD.
...
1. Sobre o **Spacio domínio e URLs** secção, execute os seguintes passos:
...
1. Para configurar o início de sessão único num **Spacio** lado, terá de enviar o **Url de metadados de Federação de aplicação** para [equipa de suporte de Spacio](mailto:support@spac.io). Se definir esta definição para que a ligação de SAML SSO definidas corretamente em ambos os lados.
...
1. Na lista de aplicações, selecione **Spacio**.
