---
title: 'Tutorial: Integração do Azure Active Directory com BenefitHub | Documentos da Microsoft'
...
5. No painel de resultados, selecione **BenefitHub**e, em seguida, clique em **Add** botão para adicionar a aplicação.
...
3. **[Criar um utilizador de teste BenefitHub](#creating-a-benefithub-test-user)**  - para ter um equivalente da Eduarda Almeida na BenefitHub que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **BenefitHub domínio e URLs** secção, execute os seguintes passos:
...
8. Para configurar o início de sessão único num **BenefitHub** lado, terá de enviar o transferido **XML de metadados** para [equipa de suporte de BenefitHub](https://www.benefithub.com/Home/ContactUs). Se definir esta definição para que a ligação de SAML SSO definidas corretamente em ambos os lados.
