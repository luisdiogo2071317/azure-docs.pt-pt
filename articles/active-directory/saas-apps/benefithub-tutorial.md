...
* Pode permitir que os utilizadores ser automaticamente sessão iniciada para BenefitHub (Single Sign-On) com as suas contas do Azure AD.
...
* BenefitHub logon único habilitado subscrição

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, configure e teste do Azure AD início de sessão único num ambiente de teste.

* Suporta BenefitHub **IDP** iniciada SSO
...
4. Na caixa de pesquisa, escreva **BenefitHub**, selecione **BenefitHub** no painel de resultados, em seguida, clique em **Add** botão para adicionar a aplicação.

     ![BenefitHub na lista de resultados](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurar e testar o Azure AD início de sessão único

Nesta secção, configure e teste do Azure AD início de sessão único com BenefitHub com base num utilizador de teste **Eduarda Almeida**.
Para o início de sessão único funcionar, uma relação de ligação entre um utilizador do Azure AD e o utilizador relacionado no BenefitHub deve ser estabelecido.
...
2. **[Configurar BenefitHub Single Sign-On](#configure-benefithub-single-sign-on)**  - para configurar as definições de início de sessão único no lado do aplicativo.
3. **[Criar um utilizador de teste do Azure AD](#create-an-azure-ad-test-user)**  - para testar o Azure AD início de sessão único com Eduarda Almeida.
4. **[Atribua o utilizador de teste do Azure AD](#assign-the-azure-ad-test-user)**  - para ativar a Eduarda Almeida utilizar o Azure AD início de sessão único.
5. **[Criar utilizador de teste BenefitHub](#create-benefithub-test-user)**  - para ter um equivalente da Eduarda Almeida na BenefitHub que está ligado à representação de utilizador do Azure AD.
...
1. Na [portal do Azure](https://portal.azure.com/), na **BenefitHub** página de integração de aplicações, selecione **início de sessão único**.
...
4. Sobre o **definir a segurança de início de sessão único com o SAML** página, execute os seguintes passos:
    ...
    ![BenefitHub domínio e URLs únicas início de sessão em informações](common/idp-intiated.png)

    a. Na **identificador** texto, escreva o valor: `urn:benefithub:passport`

    b. Na **URL de resposta** texto, escreva o valor: `https://passport.benefithub.info/saml/post/ac`

5. Aplicação de BenefitHub espera que as asserções SAML num formato específico. Configure as seguintes declarações para esta aplicação. Pode gerir os valores destes atributos do **atributos de utilizador** secção na página de integração de aplicações. Sobre o **definido no início de sessão único com o SAML** página, clique em **editar** botão para abrir **atributos de utilizador** caixa de diálogo.
...
8. Sobre o **configurar BenefitHub** secção, copie os URLs apropriados de acordo com seus requisitos.
...
### <a name="configure-benefithub-single-sign-on"></a>Configurar BenefitHub Single Sign-On

Para configurar o início de sessão único num **BenefitHub** lado, terá de enviar o transferido **XML de metadados de Federação** e adequadas copiados URLs a partir do portal do Azure para [BenefitHub a equipa de suporte](https://www.benefithub.com/Home/ContactUs). Se definir esta definição para que a ligação de SAML SSO definidas corretamente em ambos os lados.
...
1. No portal do Azure, selecione **aplicações empresariais**, selecione **todos os aplicativos**, em seguida, selecione **BenefitHub**.

    ![Painel de aplicações empresariais](common/enterprise-applications.png)

2. Na lista de aplicações, selecione **BenefitHub**.

    ![A ligação de BenefitHub na lista de aplicações](common/all-applications.png)
...
### <a name="create-benefithub-test-user"></a>Criar utilizador de teste BenefitHub
...
Quando clica no mosaico BenefitHub no painel de acesso, deve ser automaticamente sessão iniciada no BenefitHub para o qual configura o SSO. Para obter mais informações sobre o painel de acesso, consulte [introdução ao painel de acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
