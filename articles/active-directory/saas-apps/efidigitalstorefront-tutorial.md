...
3. **[Criar um utilizador de teste de loja Digital de EFI](#create-a-efi-digital-storefront-test-user)**  - para ter um equivalente da Eduarda Almeida na loja Digital EFI e que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **EFI Digital Vitrine domínio e URLs** secção, execute os seguintes passos:
