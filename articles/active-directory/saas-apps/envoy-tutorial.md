...
3. No **Envoy domínio e os URLs** secção, execute os seguintes passos:
    ...
    ![Domínio de envoy e URLs único informações de início de sessão](./media/envoy-tutorial/tutorial_envoy_url.png)
...
4. No **certificado de assinatura de SAML** secção, copie o **THUMBPRINT** valor do certificado...
    ...
    ![A hiperligação de transferência do certificado](./media/envoy-tutorial/tutorial_envoy_certificate.png) 

5. Clique em **guardar** botão.

    ![Configurar botão único início de sessão guardar](./media/envoy-tutorial/tutorial_general_400.png)
...
6. No **Envoy configuração** secção, clique em **configurar Envoy** para abrir **configurar início de sessão** janela. Copiar o **único início de sessão no URL do serviço SAML** do **secção de referência rápida.**
    ...
    ![Configuração de envoy](./media/envoy-tutorial/tutorial_envoy_configure.png)
...
2. Para apresentar a lista de utilizadores, aceda a **utilizadores e grupos**e, em seguida, clique em **todos os utilizadores**.
    ...
    !["Os utilizadores e grupos" e "Todos os utilizadores" ligações](./media/envoy-tutorial/create_aaduser_02.png)

3. Para abrir o **utilizador** caixa de diálogo, clique em **adicionar** na parte superior do **todos os utilizadores** caixa de diálogo.

    ![O botão de adição](./media/envoy-tutorial/create_aaduser_03.png)
...
2. Na lista de aplicações, selecione **Envoy**.
    ...
    ![A ligação de Envoy na lista de aplicações](./media/envoy-tutorial/tutorial_envoy_app.png)  
