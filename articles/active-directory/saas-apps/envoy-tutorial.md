---
title: 'Tutorial: Integração do Active Directory do Azure com o Envoy | Documentos da Microsoft'
...
* Pode permitir que os utilizadores ser automaticamente sessão iniciada para o Envoy (Single Sign-On) com as suas contas do Azure AD.
...
* O Envoy logon único habilitado subscrição

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, configure e teste do Azure AD início de sessão único num ambiente de teste.

* O Envoy suporta **SP** iniciada SSO

* O Envoy suporta **Just In Time** aprovisionamento de utilizadores
...
4. Na caixa de pesquisa, escreva **o Envoy**, selecione **o Envoy** no painel de resultados, em seguida, clique em **Add** botão para adicionar a aplicação.

     ![Envoy na lista de resultados](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurar e testar o Azure AD início de sessão único

Nesta secção, configure e teste do Azure AD início de sessão único com o Envoy com base num utilizador de teste **Eduarda Almeida**.
Para o início de sessão único funcionar, uma relação de ligação entre um utilizador do Azure AD e o utilizador relacionado no Envoy deve ser estabelecido.
...
2. **[Configurar o Envoy Single Sign-On](#configure-envoy-single-sign-on)**  - para configurar as definições de início de sessão único no lado do aplicativo.
3. **[Criar um utilizador de teste do Azure AD](#create-an-azure-ad-test-user)**  - para testar o Azure AD início de sessão único com Eduarda Almeida.
4. **[Atribua o utilizador de teste do Azure AD](#assign-the-azure-ad-test-user)**  - para ativar a Eduarda Almeida utilizar o Azure AD início de sessão único.
5. **[Criar utilizador de teste o Envoy](#create-envoy-test-user)**  - para ter um equivalente da Eduarda Almeida no Envoy que está ligado à representação de utilizador do Azure AD.
...
1. Na [portal do Azure](https://portal.azure.com/), na **o Envoy** página de integração de aplicações, selecione **início de sessão único**.
...
4. Sobre o **configuração básica de SAML** secção, execute os seguintes passos:
    ...
    ![O Envoy domínio e URLs únicas início de sessão em informações](common/sp-signonurl.png)
    ...
    > [!NOTE]
    > O valor não é real. Atualize o valor com o URL de início de sessão real. Contacte [equipa de suporte de cliente o Envoy](https://envoy.com/contact/) para obter o valor. Também pode consultar os padrões mostrados a **configuração básica de SAML** secção no portal do Azure.
...
7. Sobre o **configurar o Envoy** secção, copie os URLs apropriados de acordo com seus requisitos.
...
### <a name="configure-envoy-single-sign-on"></a>Configurar o Envoy início de sessão único
...
5. Na **autenticação SAML** configuração secção, execute os seguintes passos:
    ...
    b. Colar **URL de início de sessão** valor, que copiou formam o portal do Azure para o **URL de HTTP de SAML de fornecedor de identidade** caixa de texto.
...
1. No portal do Azure, selecione **aplicações empresariais**, selecione **todos os aplicativos**, em seguida, selecione **o Envoy**.
...
### <a name="create-envoy-test-user"></a>Criar utilizador de teste o Envoy
...
Quando clica no mosaico o Envoy no painel de acesso, deve ser automaticamente sessão iniciada no Envoy para o qual configura o SSO. Para obter mais informações sobre o painel de acesso, consulte [introdução ao painel de acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
