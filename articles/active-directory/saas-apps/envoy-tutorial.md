...
3. **[Criar um utilizador de teste o Envoy](#create-an-envoy-test-user)**  - para ter um equivalente da Eduarda Almeida no Envoy que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **o Envoy domínio e URLs** secção, execute os seguintes passos:

    ![O Envoy domínio e URLs únicas início de sessão em informações](./media/envoy-tutorial/tutorial_envoy_url.png)

    Na **URL de início de sessão** caixa de texto, escreva um URL com o seguinte padrão: `https://<tenant-name>.Envoy.com`
...
6. Na **configuração o Envoy** secção, clique em **configurar o Envoy** para abrir **configurar início de sessão** janela. Cópia a **SAML único início de sessão no URL do serviço** partir o **secção de referência rápida.**

    ![O Envoy configuração](./media/envoy-tutorial/tutorial_envoy_configure.png)

7. Numa janela do browser web diferente, inicie sessão no site da sua empresa o Envoy como um administrador.
...
11. Na **autenticação SAML** configuração secção, execute os seguintes passos:
