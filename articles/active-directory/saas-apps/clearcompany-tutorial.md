---
title: 'Tutorial: Integração do Active Directory do Azure com ClearCompany | Documentos da Microsoft'
...
ms.locfileid: "56170325"
---
# <a name="tutorial-azure-active-directory-integration-with-clearcompany"></a>Tutorial: Integração do Active Directory do Azure com ClearCompany
...
* Pode permitir que os utilizadores ser automaticamente sessão iniciada para ClearCompany (Single Sign-On) com as suas contas do Azure AD.
...
* ClearCompany logon único habilitado subscrição

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, configure e teste do Azure AD início de sessão único num ambiente de teste.

* Suporta ClearCompany **SP e IDP** iniciada SSO
...
Nesta secção, configure e teste do Azure AD início de sessão único com ClearCompany com base num utilizador de teste **Eduarda Almeida**.
Para o início de sessão único funcionar, uma relação de ligação entre um utilizador do Azure AD e o utilizador relacionado no ClearCompany deve ser estabelecido.
...
2. **[Configurar ClearCompany Single Sign-On](#configure-clearcompany-single-sign-on)**  - para configurar as definições de início de sessão único no lado do aplicativo.
3. **[Criar um utilizador de teste do Azure AD](#create-an-azure-ad-test-user)**  - para testar o Azure AD início de sessão único com Eduarda Almeida.
4. **[Atribua o utilizador de teste do Azure AD](#assign-the-azure-ad-test-user)**  - para ativar a Eduarda Almeida utilizar o Azure AD início de sessão único.
5. **[Criar utilizador de teste ClearCompany](#create-clearcompany-test-user)**  - para ter um equivalente da Eduarda Almeida na ClearCompany que está ligado à representação de utilizador do Azure AD.
...
1. Na [portal do Azure](https://portal.azure.com/), na **ClearCompany** página de integração de aplicações, selecione **início de sessão único**.
...
4. Sobre o **configuração básica de SAML** secção, se desejar configurar a aplicação no **IDP** iniciada pelo modo, executar o passo seguinte:
    ...
    ![ClearCompany domínio e URLs únicas início de sessão em informações](common/idp-identifier.png)

    Na **identificador** caixa de texto, escreva um URL com o seguinte padrão:  `https://api.clearcompany.com`
...
5. Clique em **definir URLs adicionais** e executar o passo seguinte, se desejar configurar a aplicação na **SP** iniciada pelo modo:
    ...
    > [!NOTE]
    > O valor de URL de início de sessão não é real. Atualize o valor com o URL de início de sessão real. Contacte [equipa de suporte de cliente ClearCompany](https://www.clearcompany.com/support) para obter o valor. Também pode consultar os padrões mostrados a **configuração básica de SAML** secção no portal do Azure.
...
6. Sobre o **configurar ClearCompany** secção, copie os URLs apropriados de acordo com seus requisitos.
...
Para configurar o início de sessão único num **ClearCompany** lado, terá de enviar o transferido **certificado (Base64)** e adequadas copiados URLs a partir do portal do Azure para [ClearCompany a equipa de suporte ](https://www.clearcompany.com/support). Se definir esta definição para que a ligação de SAML SSO definidas corretamente em ambos os lados.
...
1. No portal do Azure, selecione **aplicações empresariais**, selecione **todos os aplicativos**, em seguida, selecione **ClearCompany**.

    ![Painel de aplicações empresariais](common/enterprise-applications.png)

2. Na lista de aplicações, selecione **ClearCompany**.

    ![A ligação de ClearCompany na lista de aplicações](common/all-applications.png)
...
Quando clica no mosaico ClearCompany no painel de acesso, deve ser automaticamente sessão iniciada no ClearCompany para o qual configura o SSO. Para obter mais informações sobre o painel de acesso, consulte [introdução ao painel de acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
