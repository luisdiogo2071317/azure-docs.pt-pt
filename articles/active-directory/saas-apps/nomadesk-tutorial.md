---
title: 'Tutorial: Integração do Azure Active Directory com Nomadesk | Documentos da Microsoft'
...
5. No painel de resultados, selecione **Nomadesk**e, em seguida, clique em **Add** botão para adicionar a aplicação.
...
3. **[Criar um utilizador de teste Nomadesk](#creating-a-nomadesk-test-user)**  - para ter um equivalente da Eduarda Almeida na Nomadesk que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **Nomadesk domínio e URLs** secção, execute os seguintes passos:
...
6. Sobre o **Nomadesk configuração** secção, clique em **configurar Nomadesk** para abrir **configurar início de sessão** janela. Cópia a **URL de fim de sessão, o ID de entidade de SAML e o SAML único início de sessão no URL do serviço** partir o **secção de referência rápida.**
