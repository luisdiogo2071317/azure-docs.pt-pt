...
4. Na caixa de pesquisa, escreva **redes da Palo Alto - Aperture**, selecione **redes da Palo Alto - Aperture** partir do painel de resultados, em seguida, clique em **adicionar** botão para adicionar a aplicação.
    ...
    ![Redes da Palo Alto - Aperture na lista de resultados](./media/paloaltonetworks-aperture-tutorial/tutorial_paloaltonetwork_addfromgallery.png)
...
3. No **da Palo Alto redes - domínio Aperture e URLs** secção, execute os seguintes passos, se pretender configurar a aplicação no **IDP** iniciada modo:
    ...
    ![Redes da Palo Alto - Aperture domínio e os URLs únicos de informações de início de sessão](./media/paloaltonetworks-aperture-tutorial/tutorial_paloaltonetwork_url.png)
...
4. Verifique **Mostrar avançadas definições de URL** e executar o passo seguinte, se pretender configurar a aplicação no **SP** iniciada modo:
    ...
    ![Redes da Palo Alto - Aperture domínio e os URLs únicos de informações de início de sessão](./media/paloaltonetworks-aperture-tutorial/tutorial_paloaltonetwork_url1.png)
...
5. No **certificado de assinatura de SAML** secção, clique em **certificado (Base64)** e, em seguida, guarde o ficheiro de certificado no seu computador.
    ...
    ![A hiperligação de transferência do certificado](./media/paloaltonetworks-aperture-tutorial/tutorial_paloaltonetwork_certificate.png) 

6. Clique em **guardar** botão.

    ![Configurar botão único início de sessão guardar](./media/paloaltonetworks-aperture-tutorial/tutorial_general_400.png)
...
7. No **redes da Palo Alto - configuração Aperture** secção, clique em **configurar redes da Palo Alto - Aperture** para abrir **configurar início de sessão** janela. Copiar o **ID de entidade de SAML e o único início de sessão no URL do serviço SAML** do **secção de referência rápida.**
    ...
    ![A ligação de configurar](./media/paloaltonetworks-aperture-tutorial/tutorial_paloaltonetwork_configure.png)
...
2. Para apresentar a lista de utilizadores, aceda a **utilizadores e grupos**e, em seguida, clique em **todos os utilizadores**.
    ...
    !["Os utilizadores e grupos" e "Todos os utilizadores" ligações](./media/paloaltonetworks-aperture-tutorial/create_aaduser_02.png)

3. Para abrir o **utilizador** caixa de diálogo, clique em **adicionar** na parte superior do **todos os utilizadores** caixa de diálogo.

    ![O botão de adição](./media/paloaltonetworks-aperture-tutorial/create_aaduser_03.png)
...
2. Na lista de aplicações, selecione **redes da Palo Alto - Aperture**.
    ...
    ![As redes da Palo Alto - ligação Aperture na lista de aplicações](./media/paloaltonetworks-aperture-tutorial/tutorial_paloaltonetwork_app.png)  
