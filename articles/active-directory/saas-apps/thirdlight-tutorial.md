...
5. No painel de resultados, selecione **ThirdLight**e, em seguida, clique em **Add** botão para adicionar a aplicação.
...
3. **[Criar um utilizador de teste ThirdLight](#creating-a-thirdlight-test-user)**  - para ter um equivalente da Eduarda Almeida na ThirdLight que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **ThirdLight domínio e URLs** secção, execute os seguintes passos:
...
7. Aceda a **Configuration \> administração do sistema**e, em seguida, clique em **SAML2**.
...
5. Introduza **o nome de utilizador, nome ou descrição, E-Mail, escolha uma configuração predefinida ou de novos membros do grupo** de uma conta do AAD válida que pretende aprovisionar.
