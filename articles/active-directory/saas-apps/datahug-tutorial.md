...
1. Na caixa de pesquisa, escreva **Datahug**.

    ![Criar um utilizador de teste do Azure AD](./media/datahug-tutorial/tutorial_datahug_search.png)

1. No painel de resultados, selecione **Datahug**e, em seguida, clique em **Add** botão para adicionar a aplicação.
...
1. **[Criar um utilizador de teste Datahug](#creating-a-datahug-test-user)**  - para ter um equivalente da Eduarda Almeida na Datahug que está ligado à representação de utilizador do Azure AD.
...
1. Sobre o **Datahug domínio e URLs** secção, se desejar configurar a aplicação no **IDP** iniciada pelo modo:
...
1.  Verifique **"Mostrar definições de assinatura de certificado avançadas"** e execute os seguintes passos:
...
1. Sobre o **Datahug configuração** secção, clique em **configurar Datahug** para abrir **configurar início de sessão** janela. Cópia a **ID de entidade de SAML** e **SAML único início de sessão no URL do serviço** partir o **secção de referência rápida.**
...
1. Paire o rato sobre o **ícone de roda dentada** no canto superior direito e clique **definições**
   
   ![Adicionar o funcionário](./media/datahug-tutorial/1.png)

1. Escolher **pessoas** e clique nas **adicionar usuários** separador

    ![Adicionar o funcionário](./media/datahug-tutorial/2.png)

1. Escreva a mensagem de e-mail da pessoa que pretende criar uma conta para e clique em **adicionar**.
...
1. Na lista de aplicações, selecione **Datahug**.

    ![Configurar o início de sessão único](./media/datahug-tutorial/tutorial_datahug_app.png) 
