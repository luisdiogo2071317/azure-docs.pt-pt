---
title: 'Tutorial: Integração do Azure Active Directory com Oneteam | Documentos da Microsoft'
...
5. No painel de resultados, selecione **Oneteam**e, em seguida, clique em **Add** botão para adicionar a aplicação.
...
3. **[Criar um utilizador de teste Oneteam](#creating-a-oneteam-test-user)**  - para ter um equivalente da Eduarda Almeida na Oneteam que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **Oneteam domínio e URLs** secção, se desejar configurar a aplicação no **IDP** iniciada pelo modo:
...
7. Para obter SSO configurado para a sua aplicação, pode fazer o pedido de suporte [equipa de suporte de Oneteam](https://support.one-team.com/hc/requests/new) e forneça o transferido **metadados**. 
