...
5. No painel de resultados, selecione **Kantega SSO para Bitbucket**e, em seguida, clique em **Add** botão para adicionar a aplicação.
...
3. **[Criar um SSO Kantega para o utilizador de teste de Bitbucket](#creating-a-kantega-sso-for-bitbucket-test-user)**  - para ter um equivalente da Eduarda Almeida na Kantega SSO para Bitbucket, ligado à representação de utilizador do Azure AD.
...
3. Na **IDP** iniciada modo, à **Kantega SSO para o domínio do Bitbucket e URLs** secção executar o passo seguinte:
...
8. Clique em dentada de definições e clique nas **encontrar novos suplementos**.

    ![Configurar o início de sessão único](./media/kantegassoforbitbucket-tutorial/addon1.png)

9. Pesquisa **Kantega SSO Bitbucket SAML & Kerberos** e clique em **instalar** botão para instalar o novo plug-in SAML.
...
20. Sobre o **contas de utilizador do Bitbucket** secção, execute os seguintes passos:
...
3. Sob **Administration** secção, clique em **utilizadores**.
...
5. Sobre o **criar utilizador** caixa de diálogo página, execute os seguintes passos:
