...
3. Para adicionar nova aplicação, clique em **adicionar** botão na parte superior de caixa de diálogo.

    ![Aplicações][3]

4. Na caixa de pesquisa, escreva **BC na Cloud**.

    ![Criar um utilizador de teste do Azure AD](./media/bcinthecloud-tutorial/tutorial_bcinthecloud_search.png)

5. No painel de resultados, selecione **BC na Cloud**e, em seguida, clique em **Add** botão para adicionar a aplicação.
...
3. **[Criar um BC do utilizador de teste na Cloud](#creating-a-bc-in-the-cloud-test-user)**  - para ter um equivalente da Eduarda Almeida na BC na Cloud que está ligada à representação de utilizador do Azure AD.
...
3. Sobre o **BC no domínio na Cloud e URLs** secção, execute os seguintes passos:
...
6. Para configurar o início de sessão único num **BC na Cloud** lado, terá de enviar o transferido **XML de metadados** para [BC na Cloud a equipa de suporte](https://www.bcinthecloud.com/supportcenter/).
