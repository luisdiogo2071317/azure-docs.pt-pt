...
4. Na caixa de pesquisa, escreva **New Relic**, selecione **New Relic** partir do painel de resultados, em seguida, clique em **adicionar** botão para adicionar a aplicação.
    ...
    ![New Relic na lista de resultados](./media/new-relic-tutorial/tutorial_new-relic_addfromgallery.png)
...
3. No **novo domínio Relic e URLs** secção, execute os seguintes passos:
    ...
    ![Novo domínio Relic e os URLs únicos de informações de início de sessão](./media/new-relic-tutorial/tutorial_new-relic_url.png)
...
4. No **certificado de assinatura de SAML** secção, clique em **certificado (Base64)** e, em seguida, guarde o ficheiro de certificado no seu computador.
    ...
    ![A hiperligação de transferência do certificado](./media/new-relic-tutorial/tutorial_new-relic_certificate.png) 

5. Clique em **guardar** botão.

    ![Configurar botão único início de sessão guardar](./media/new-relic-tutorial/tutorial_general_400.png)
...
9. Clique em de **segurança e autenticação** separador e, em seguida, clique em de **início de sessão único** separador.
    ...
    ![De sessão único-](./media/new-relic-tutorial/ic797037.png "Single Sign-On")
...
2. Para apresentar a lista de utilizadores, aceda a **utilizadores e grupos**e, em seguida, clique em **todos os utilizadores**.
    ...
    !["Os utilizadores e grupos" e "Todos os utilizadores" ligações](./media/new-relic-tutorial/create_aaduser_02.png)

3. Para abrir o **utilizador** caixa de diálogo, clique em **adicionar** na parte superior do **todos os utilizadores** caixa de diálogo.

    ![O botão de adição](./media/new-relic-tutorial/create_aaduser_03.png)
...
2. Na lista de aplicações, selecione **New Relic**.
    ...
    ![A ligação do New Relic na lista de aplicações](./media/new-relic-tutorial/tutorial_new-relic_app.png)  
