---
title: 'Tutorial: Integração do Azure Active Directory com Workpath | Documentos da Microsoft'
...
5. No painel de resultados, selecione **Workpath**e, em seguida, clique em **Add** botão para adicionar a aplicação.
...
3. **[Criar um utilizador de teste Workpath](#creating-a-workpath-test-user)**  - para ter um equivalente da Eduarda Almeida na Workpath que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **Workpath domínio e URLs** secção, se desejar configurar a aplicação na **IDP** modo iniciado execute os seguintes passos:
...
4. Verifique **Mostrar definições de URL avançadas**. Se desejar configurar a aplicação no **SP** iniciada pelo modo, execute os seguintes passos:
...
9. Sobre o **Workpath configuração** secção, clique em **configurar Workpath** para abrir **configurar início de sessão** janela. Cópia a **URL de fim de sessão, o ID de entidade de SAML e o SAML único início de sessão no URL do serviço** partir o **secção de referência rápida.**

    ![Configurar o início de sessão único](./media/workpath-tutorial/tutorial_workpath_configure.png) 

10. Para configurar o início de sessão único num **Workpath** lado, terá de enviar o transferido **XML de metadados**, **URL de fim de sessão, o ID de entidade de SAML e o SAML único início de sessão no URL do serviço** para [Equipa de suporte de Workpath](https://help.workpath.com). 
