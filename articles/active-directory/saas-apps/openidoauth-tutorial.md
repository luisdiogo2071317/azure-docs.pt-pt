...
1. Na [portal do Azure](https://portal.azure.com), no painel esquerdo, selecione **Azure Active Directory**. 
    ...
    ![Botão de Active Directory do Azure](./media/openidoauth-tutorial/tutorial_general_01.png)

2. Aceda a **aplicações empresariais** > **todas as aplicações**.

    ![Painel de aplicações empresariais](./media/openidoauth-tutorial/tutorial_general_02.png)

3. Selecione **nova aplicação** na parte superior da caixa de diálogo.

    ![Botão novo da aplicação](./media/openidoauth-tutorial/tutorial_general_03.png)
