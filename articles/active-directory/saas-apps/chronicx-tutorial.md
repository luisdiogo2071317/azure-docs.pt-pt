---
title: 'Tutorial: Integração do Azure Active Directory com ChronicX® | Documentos da Microsoft'
...
4. Na caixa de pesquisa, escreva **ChronicX®**, selecione **ChronicX®** no painel de resultados, em seguida, clique em **Add** botão para adicionar a aplicação.
...
3. **[Criar um utilizador de teste ChronicX®](#create-a-chronicx®-test-user)**  - para ter um equivalente da Eduarda Almeida na ChronicX® que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **ChronicX® domínio e URLs** secção, execute os seguintes passos:
...
6. Para configurar o início de sessão único num **ChronicX®** lado, terá de enviar o transferido **XML de metadados** para [equipa de suporte de ChronicX®](https://www.casebank.com/contact-us/). Se definir esta definição para que a ligação de SAML SSO definidas corretamente em ambos os lados.
