...
5. **[Criar utilizador de teste de caixa](#create-box-test-user)**  - para ter um equivalente da Eduarda Almeida na caixa que está ligada à representação de utilizador do Azure AD.
