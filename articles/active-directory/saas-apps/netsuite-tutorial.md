...
4. Na caixa de pesquisa, escreva **Netsuite**.
    ...
    ![Criar um utilizador de teste do Azure AD](./media/netsuite-tutorial/tutorial_netsuite_search.png)

5. No painel de resultados, selecione **Netsuite**e, em seguida, clique em **adicionar** botão para adicionar a aplicação.

    ![Criar um utilizador de teste do Azure AD](./media/netsuite-tutorial/tutorial_netsuite_addfromgallery.png)
...
11. No **configuração SAML** página, execute os seguintes passos:
    ...
    ![Configurar o início de sessão único](./media/netsuite-tutorial/ns-sso-setup.png)
...
* [Configurar o aprovisionamento de utilizadores](netsuite-provisioning-tutorial.md)
