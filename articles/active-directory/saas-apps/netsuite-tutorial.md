...
5. **[Criar utilizador de teste NetSuite](#create-netsuite-test-user)**  - para ter um equivalente da Eduarda Almeida na NetSuite que está ligado à representação de utilizador do Azure AD.
