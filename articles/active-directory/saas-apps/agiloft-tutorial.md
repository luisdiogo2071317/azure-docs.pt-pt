...
* Pode permitir que os utilizadores ser automaticamente sessão iniciada para Agiloft (Single Sign-On) com as suas contas do Azure AD.
...
* Agiloft logon único habilitado subscrição

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, configure e teste do Azure AD início de sessão único num ambiente de teste.

* Suporta Agiloft **SP e IDP** iniciada SSO
* Suporta Agiloft **Just In Time** aprovisionamento de utilizadores
...
Nesta secção, configure e teste do Azure AD início de sessão único com Agiloft com base num utilizador de teste **Eduarda Almeida**.
Para o início de sessão único funcionar, uma relação de ligação entre um utilizador do Azure AD e o utilizador relacionado no Agiloft deve ser estabelecido.
...
2. **[Configurar Agiloft Single Sign-On](#configure-agiloft-single-sign-on)**  - para configurar as definições de início de sessão único no lado do aplicativo.
3. **[Criar um utilizador de teste do Azure AD](#create-an-azure-ad-test-user)**  - para testar o Azure AD início de sessão único com Eduarda Almeida.
4. **[Atribua o utilizador de teste do Azure AD](#assign-the-azure-ad-test-user)**  - para ativar a Eduarda Almeida utilizar o Azure AD início de sessão único.
5. **[Criar utilizador de teste Agiloft](#create-agiloft-test-user)**  - para ter um equivalente da Eduarda Almeida na Agiloft que está ligado à representação de utilizador do Azure AD.
...
1. Na [portal do Azure](https://portal.azure.com/), na **Agiloft** página de integração de aplicações, selecione **início de sessão único**.
...
4. Sobre o **configuração básica de SAML** secção, se desejar configurar a aplicação no **IDP** iniciada pelo modo, execute os seguintes passos:
    ...
    ![Agiloft domínio e URLs únicas início de sessão em informações](common/idp-intiated.png)
...
5. Clique em **definir URLs adicionais** e executar o passo seguinte, se desejar configurar a aplicação na **SP** iniciada pelo modo:
    ...
    ![Agiloft domínio e URLs únicas início de sessão em informações](common/metadata-upload-additional-signon.png)
    ...
    > [!NOTE]
    > Estes valores não são reais. Atualize estes valores com o URL de identificador, o URL de resposta e início de sessão real. Contacte [equipa de suporte de cliente Agiloft](https://www.agiloft.com/support-login.htm) obter esses valores. Também pode consultar os padrões mostrados a **configuração básica de SAML** secção no portal do Azure.
...
7. Sobre o **configurar Agiloft** secção, copie os URLs apropriados de acordo com seus requisitos.
...
1. Numa janela do browser web diferente, inicie sessão no site da sua empresa Agiloft como administrador.

2. Clique em **programa de configuração** (no painel à esquerda) e, em seguida, selecione **acesso**.

    ![Agiloft Configuration](./media/agiloft-tutorial/setup1.png)

3. Clique no botão **configurar SAML 2.0 Single Sign-On**.

    ![Agiloft Configuration](./media/agiloft-tutorial/setup2.png)

4. É apresentada uma caixa de diálogo do assistente. Na caixa de diálogo, clique nas **detalhes do fornecedor de identidade** e preencha os campos seguintes:  

    ![Agiloft Configuration](./media/agiloft-tutorial/setup4.png)

    a. Na **Id de entidade do IdP / emissor** caixa de texto, cole o valor de **Azure Ad identificador**, que copiou do portal do Azure.
...
1. No portal do Azure, selecione **aplicações empresariais**, selecione **todos os aplicativos**, em seguida, selecione **Agiloft**.

    ![Painel de aplicações empresariais](common/enterprise-applications.png)

2. Na lista de aplicações, selecione **Agiloft**.

    ![A ligação de Agiloft na lista de aplicações](common/all-applications.png)
...
Nesta secção, um usuário chamado Eduarda Almeida é criado na Agiloft. Agiloft suporta o aprovisionamento de utilizadores de just-in-time, que está ativado por predefinição. Não existe nenhum item de ação para nesta secção. Se um utilizador já não existir no Agiloft, é criado um novo após a autenticação.

### <a name="test-single-sign-on"></a>Testar o início de sessão único

Nesta secção, vai testar a configuração do Azure AD única início de sessão com o painel de acesso.

Quando clica no mosaico Agiloft no painel de acesso, deve ser automaticamente sessão iniciada no Agiloft para o qual configura o SSO. Para obter mais informações sobre o painel de acesso, consulte [introdução ao painel de acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
