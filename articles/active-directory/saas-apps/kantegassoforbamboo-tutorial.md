...
5. No painel de resultados, selecione **Kantega SSO para Bamboo**e, em seguida, clique em **Add** botão para adicionar a aplicação.
...
3. **[Criar um SSO Kantega para o utilizador de teste Bamboo](#creating-a-kantega-sso-for-bamboo-test-user)**  - para ter um equivalente da Eduarda Almeida na Kantega SSO para Bamboo que está ligado à representação de utilizador do Azure AD.
...
3. Na **IDP** iniciada modo, à **Kantega SSO para Bamboo domínio e URLs** secção executar o passo seguinte:
...
7. Numa janela do browser web diferente, inicie sessão no seu servidor no local de Bamboo como administrador.
...
9. Na secção do separador de suplementos, clique em **encontrar novos suplementos**. Pesquisa **Kantega SSO para Bamboo (SAML e Kerberos)** e clique em **instalar** botão para instalar o novo plug-in SAML.
...
20. Sobre o **contas de utilizador Bamboo** secção, execute os seguintes passos:
