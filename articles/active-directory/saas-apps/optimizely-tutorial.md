...
1. Na caixa de pesquisa, escreva **Optimizely**.

    ![Criar um utilizador de teste do Azure AD](./media/optimizely-tutorial/tutorial_optimizely_search.png)

1. No painel de resultados, selecione **Optimizely**e, em seguida, clique em **Add** botão para adicionar a aplicação.
...
1. **[Criar um utilizador de teste Optimizely](#creating-an-optimizely-test-user)**  - para ter um equivalente da Eduarda Almeida na Optimizely que está ligado à representação de utilizador do Azure AD.
...
1. Sobre o **Optimizely domínio e URLs** secção, execute os seguintes passos:
...
1. Sobre o **Optimizely configuração** secção, clique em **configurar Optimizely** para abrir **configurar início de sessão** janela. Cópia a **SAML único início de sessão no URL do serviço** partir o **secção de referência rápida.**

    ![Configurar o início de sessão único](./media/optimizely-tutorial/tutorial_optimizely_configure.png) 

1. Para configurar o início de sessão único num **Optimizely** , contacte o seu Gestor de conta Optimizely e fornecerá o transferido **certificado (Base64)**, e **SAML único início de sessão no URL do serviço**. 

1. Em resposta ao seu correio eletrónico, Optimizely fornece o início de sessão no URL (SSO iniciado por SP) e os valores de identificador (ID de entidade do fornecedor de serviço).
...
1. Numa janela do browser diferente, início de sessão na sua aplicação Optimizely.

1. Clique em que o nome de conta no canto superior direito e, em seguida **definições de conta**.
   
    ![O Azure AD Single Sign-On](./media/optimizely-tutorial/tutorial_optimizely_09.png)

1. No separador de conta, a caixa de verificação **ativar o SSO** sob o início de sessão único no **descrição geral** secção.
...
1. Para adicionar o novo funcionário ao projeto, clique em **novo funcionário**.
   
    ![Criar um utilizador de teste do Azure AD](./media/optimizely-tutorial/create_aaduser_10.png)

1. Preencha o endereço de e-mail e atribuir-lhes uma função. Clique em **convidar**.

    ![Criar um utilizador de teste do Azure AD](./media/optimizely-tutorial/create_aaduser_11.png)

1. Eles recebem um convite por e-mail. Usando o endereço de e-mail, têm de iniciar sessão no Optimizely.
...
1. Na lista de aplicações, selecione **Optimizely**.
