---
title: 'Tutorial: Integração do Active Directory do Azure com Accredible | Documentos da Microsoft'
...
* Pode permitir que os utilizadores ser automaticamente sessão iniciada para Accredible (Single Sign-On) com as suas contas do Azure AD.
...
* Accredible logon único habilitado subscrição

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, configure e teste do Azure AD início de sessão único num ambiente de teste.

* Suporta Accredible **IDP** iniciada SSO
...
Nesta secção, configure e teste do Azure AD início de sessão único com Accredible com base num utilizador de teste **Eduarda Almeida**.
Para o início de sessão único funcionar, uma relação de ligação entre um utilizador do Azure AD e o utilizador relacionado no Accredible deve ser estabelecido.
...
2. **[Configurar Accredible Single Sign-On](#configure-accredible-single-sign-on)**  - para configurar as definições de início de sessão único no lado do aplicativo.
3. **[Criar um utilizador de teste do Azure AD](#create-an-azure-ad-test-user)**  - para testar o Azure AD início de sessão único com Eduarda Almeida.
4. **[Atribua o utilizador de teste do Azure AD](#assign-the-azure-ad-test-user)**  - para ativar a Eduarda Almeida utilizar o Azure AD início de sessão único.
5. **[Criar utilizador de teste Accredible](#create-accredible-test-user)**  - para ter um equivalente da Eduarda Almeida na Accredible que está ligado à representação de utilizador do Azure AD.
...
1. Na [portal do Azure](https://portal.azure.com/), na **Accredible** página de integração de aplicações, selecione **início de sessão único**.
...
4. Sobre o **definir a segurança de início de sessão único com o SAML** página, execute os seguintes passos:
    ...
    ![Accredible domínio e URLs únicas início de sessão em informações](common/idp-intiated.png)
...
6. Sobre o **configurar Accredible** secção, copie os URLs apropriados de acordo com seus requisitos.
...
Para configurar o início de sessão único num **Accredible** lado, terá de enviar o transferido **XML de metadados de Federação** e adequadas copiados URLs a partir do portal do Azure para [Accredible a equipa de suporte](mailto:support@accredible.com). Se definir esta definição para que a ligação de SAML SSO definidas corretamente em ambos os lados.
...
1. No portal do Azure, selecione **aplicações empresariais**, selecione **todos os aplicativos**, em seguida, selecione **Accredible**.

    ![Painel de aplicações empresariais](common/enterprise-applications.png)

2. Na lista de aplicações, selecione **Accredible**.

    ![A ligação de Accredible na lista de aplicações](common/all-applications.png)
...
Quando clica no mosaico Accredible no painel de acesso, deve ser automaticamente sessão iniciada no Accredible para o qual configura o SSO. Para obter mais informações sobre o painel de acesso, consulte [introdução ao painel de acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
