...
5. No painel de resultados, selecione **Chromeriver**e, em seguida, clique em **Add** botão para adicionar a aplicação.
...
3. **[Criar um utilizador de teste Chromeriver](#creating-a-chromeriver-test-user)**  - para ter um equivalente da Eduarda Almeida na Chromeriver que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **Chromeriver domínio e URLs** secção, execute os seguintes passos:
...
6. Para configurar o início de sessão único num **Chromeriver** lado, terá de enviar o transferido **XML de metadados** para [equipa de suporte de Chromeriver](https://www.chromeriver.com/services/support). Receberá uma notificação quando SSO foi ativado para a sua subscrição.
