...
ms.date: 05/04/2018
ms.author: jeedes
ms.openlocfilehash: b99a6350cf78b00cd2761aeaf16482a7611728f8
ms.sourcegitcommit: c851842d113a7078c378d78d94fea8ff5948c337
ms.translationtype: MT
ms.contentlocale: pt-PT
ms.lasthandoff: 06/18/2018
ms.locfileid: "35947628"
---
...
4. Na caixa de pesquisa, escreva **Workday**, selecione **Workday** partir do painel de resultados, em seguida, clique em **adicionar** botão para adicionar a aplicação.
    ...
    ![Workday na lista de resultados](./media/workday-tutorial/tutorial_workday_addfromgallery.png)
...
3. No **URLs e de domínio do Workday** secção, execute os seguintes passos:
    ...
    ![Domínios e URLs do workday único informações de início de sessão](./media/workday-tutorial/tutorial_workday_url.png)
...
4. Verifique **Mostrar avançadas definições de URL** e executar o passo seguinte:
    ...
    ![Domínios e URLs do workday único informações de início de sessão](./media/workday-tutorial/tutorial_workday_url1.png)
...
5. No **certificado de assinatura de SAML** secção, clique em **certificado (Base64)** e, em seguida, guarde o ficheiro de certificado no seu computador.
    ...
    ![A hiperligação de transferência do certificado](./media/workday-tutorial/tutorial_workday_certificate.png) 

6. Clique em **guardar** botão.

    ![Configurar botão único início de sessão guardar](./media/workday-tutorial/tutorial_general_400.png)
...
9. No **caixa pesquisa** pesquisa com o nome **Editar configuração de inquilino – segurança** na parte superior esquerda do lado da home page.
    ...
    ![Editar segurança inquilino](./media/workday-tutorial/IC782925.png "Editar segurança do inquilino")

10. No **os URLs de redirecionamento** secção, execute os seguintes passos:
   
    ![Os URLs de redirecionamento](./media/workday-tutorial/IC7829581.png "os URLs de redirecionamento")
    ...
    >-Se o nome de domínio do URL de inquilino do Workday começa com impl por exemplo: *https://impl.workday.com/\<tenant\>/login-saml2.htmld*), o **ambiente** tem de ser definido para implementação.  
...
11. No **configuração SAML** secção, execute os seguintes passos:
    ...
    ![A configuração SAML](./media/workday-tutorial/IC782926.png "configuração SAML")
...
13. No **chave pública de vista x509** secção, execute os seguintes passos: 
    ...
    ![Chave pública de vista x509](./media/workday-tutorial/IC782930.png "chave pública de vista x509") 
...
14. Execute os seguintes passos: 
    ...
    ![Configuração de SSO](./media/workday-tutorial/WorkdaySSOConfiguratio.png "configuração SSO")
...
2. Para apresentar a lista de utilizadores, aceda a **utilizadores e grupos**e, em seguida, clique em **todos os utilizadores**.
    ...
    !["Os utilizadores e grupos" e "Todos os utilizadores" ligações](./media/workday-tutorial/create_aaduser_02.png)

3. Para abrir o **utilizador** caixa de diálogo, clique em **adicionar** na parte superior do **todos os utilizadores** caixa de diálogo.

    ![O botão de adição](./media/workday-tutorial/create_aaduser_03.png)
...
2. Na lista de aplicações, selecione **Workday**.
    ...
    ![A ligação do Workday na lista de aplicações](./media/workday-tutorial/tutorial_workday_app.png)  
