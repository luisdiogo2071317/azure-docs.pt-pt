...
4. Na caixa de pesquisa, escreva **Lifesize Cloud**.

    ![Criar um utilizador de teste do Azure AD](./media/lifesize-cloud-tutorial/tutorial_lifesize-cloud_search.png)

5. No painel de resultados, selecione **Lifesize Cloud**e, em seguida, clique em **Add** botão para adicionar a aplicação.
...
3. **[Criar um utilizador de teste da Lifesize Cloud](#creating-a-lifesize-cloud-test-user)**  - para ter um equivalente da Eduarda Almeida na Cloud de Lifesize que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **Lifesize Cloud domínio e URLs** secção, execute os seguintes passos:
...
4. Verifique **Mostrar definições de URL avançadas**, executar o passo seguinte:    
...
6. Na **configuração de Cloud Lifesize** secção, clique em **configurar a Cloud de Lifesize** para abrir **configurar início de sessão** janela. Cópia a **ID de entidade de SAML e SAML único início de sessão no URL do serviço** partir o **secção de referência rápida.**

    ![Configurar o início de sessão único](./media/lifesize-cloud-tutorial/tutorial_lifesize-cloud_configure.png) 

7. Para obter SSO configurado para a sua aplicação, início de sessão na aplicação Lifesize Cloud com privilégios de administrador.

8. No canto superior direito clique no seu nome e, em seguida, clique nas **definições avançadas**.
   
    ![Configurar o início de sessão único](./media/lifesize-cloud-tutorial/tutorial_lifesizecloud_06.png)

9. Nas definições de avanço agora, clique no **SSO configuração** ligação. Isso abrirá a página de configuração de SSO para a sua instância.
   
    ![Configurar o início de sessão único](./media/lifesize-cloud-tutorial/tutorial_lifesizecloud_07.png)

10. Agora, configure os seguintes valores na configuração do SSO da interface do Usuário.    
...
12. Ativar o SSO, verificando no **ativar o SSO** botão.

13. Agora, clique no **atualização** botão, para que todas as definições são guardadas. Isso irá gerar o valor de RelayState. Copie o valor de RelayState, que é gerado na caixa de texto, cole-a no **estado de reencaminhamento** caixa de texto em **Lifesize Cloud domínio e URLs** secção. 
