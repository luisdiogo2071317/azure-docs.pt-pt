---
title: 'Tutorial: Integração do Azure Active Directory com Mixpanel | Documentos da Microsoft'
...
ms.locfileid: "39046523"
---
# <a name="tutorial-azure-active-directory-integration-with-mixpanel"></a>Tutorial: Integração do Azure Active Directory com o Mixpanel
...
5. No painel de resultados, selecione **Mixpanel**e, em seguida, clique em **Add** botão para adicionar a aplicação.
...
3. **[Criar um utilizador de teste Mixpanel](#creating-a-mixpanel-test-user)**  - para ter um equivalente da Eduarda Almeida no Mixpanel que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **Mixpanel domínio e URLs** secção, execute os seguintes passos:
...
6. Sobre o **Mixpanel configuração** secção, clique em **configurar Mixpanel** para abrir **configurar início de sessão** janela. Cópia a **SAML único início de sessão no URL do serviço** partir o **secção de referência rápida.**

    ![Configurar o início de sessão único](./media/mixpanel-tutorial/tutorial_mixpanel_configure.png) 

7. Numa janela do browser diferente, início de sessão na sua aplicação Mixpanel como administrador.

8. Na parte inferior da página, clique em pequena **engrenagem** ícone no canto esquerdo. 
   
    ![Mixpanel Single Sign-On](./media/mixpanel-tutorial/tutorial_mixpanel_06.png) 

9. Clique nas **segurança de acesso** separador e, em seguida, clique em **alterar as definições de**.
   
    ![Definições de Mixpanel](./media/mixpanel-tutorial/tutorial_mixpanel_08.png) 

10. Sobre o **alterar o certificado** página de diálogo, clique em **Escolher ficheiro** para carregar o certificado transferido e, em seguida, clique em **seguinte**.
   
    ![Definições de Mixpanel](./media/mixpanel-tutorial/tutorial_mixpanel_09.png) 

11.  Na caixa de texto de URL de autenticação sobre a **alterar o URL de autenticação** caixa de diálogo página, cole o valor de **SAML único início de sessão no URL do serviço** que copiou do portal do Azure e, em seguida, clique em **PRÓXIMA**.
...
2. Na parte inferior da página, clique no pequeno botão de engrenagem no canto esquerdo para abrir o **definições** janela.

3. Clique nas **equipe** separador.

4. Na **membro da Equipe** caixa de texto, escreva o endereço de e-mail da Eduarda no Azure.
