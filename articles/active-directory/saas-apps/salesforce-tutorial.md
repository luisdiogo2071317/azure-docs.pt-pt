...
4. **[Criar utilizador de teste do Salesforce](#create-salesforce-test-user)**  - para ter um equivalente da Eduarda Almeida no Salesforce, que está ligado à representação de utilizador do Azure AD.
