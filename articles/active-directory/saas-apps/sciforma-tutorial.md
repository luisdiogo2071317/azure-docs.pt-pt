...
5. No painel de resultados, selecione **Sciforma**e, em seguida, clique em **Add** botão para adicionar a aplicação.
...
3. **[Criar um utilizador de teste Sciforma](#creating-a-sciforma-test-user)**  - para ter um equivalente da Eduarda Almeida na Sciforma que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **Sciforma domínio e URLs** secção, execute os seguintes passos:
    ...
    > [!NOTE] 
    > Estes valores não são reais. Atualize estes valores com o URL de início de sessão e o identificador real. Contacte [equipa de suporte de cliente Sciforma](http://www.sciforma.com/company/contact_us) obter esses valores. 
...
6. Para configurar o início de sessão único num **Sciforma** lado, terá de enviar o transferido **XML de metadados** para [equipa de suporte de Sciforma](http://www.sciforma.com/company/contact_us).
