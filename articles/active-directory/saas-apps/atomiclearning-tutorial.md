---
title: 'Tutorial: Integração do Azure Active Directory com aprendizagem Atômica | Documentos da Microsoft'
...
ms.locfileid: "39053952"
---
# <a name="tutorial-azure-active-directory-integration-with-atomic-learning"></a>Tutorial: Integração do Azure Active Directory com aprendizagem atómico
...
4. Na caixa de pesquisa, escreva **Learning Atômica**.

    ![Criar um utilizador de teste do Azure AD](./media/atomiclearning-tutorial/tutorial_atomiclearning_search.png)

5. No painel de resultados, selecione **Learning Atômica**e, em seguida, clique em **Add** botão para adicionar a aplicação.
...
3. **[Criar um utilizador de teste de aprendizagem Atômica](#creating-an-atomic-learning-test-user)**  - para ter um equivalente da Eduarda Almeida na aprendizagem Atômicas que está ligada à representação de utilizador do Azure AD.
...
3. Sobre o **Atômica de aprendizagem de domínio e URLs** secção, execute os seguintes passos:
...
6. Para configurar o início de sessão único num **Learning Atômica** lado, terá de enviar o transferido **XML de metadados** para [equipa de suporte de aprendizagem Atômica](mailto:cs@atomiclearning.com). Se definir esta definição para que a ligação de SAML SSO definidas corretamente em ambos os lados.
...
2. Na lista de aplicações, selecione **Learning Atômica**.
