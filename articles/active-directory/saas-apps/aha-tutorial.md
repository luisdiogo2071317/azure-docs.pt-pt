...
9. Clique em **segurança e o início de sessão único**.
    ...
    ![Segurança e o início de sessão único](./media/aha-tutorial/IC798952.png "segurança e o início de sessão único")

10. No **Single Sign-On** secção, como **fornecedor de identidade**, selecione **SAML2.0**.
   
    ![Segurança e o início de sessão único](./media/aha-tutorial/IC798953.png "segurança e o início de sessão único")

11. No **Single Sign-On** configuração página, execute os seguintes passos:
    
    ![De sessão único-](./media/aha-tutorial/IC798954.png "Single Sign-On")
