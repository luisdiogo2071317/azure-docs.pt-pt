...
5. No painel de resultados, selecione **myPolicies**e, em seguida, clique em **Add** botão para adicionar a aplicação.
...
3. **[Criar um utilizador de teste myPolicies](#creating-a-mypolicies-test-user)**  - para ter um equivalente da Eduarda Almeida na myPolicies que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **myPolicies domínio e URLs** secção, execute os seguintes passos:
...
8. Sobre o **myPolicies Configuration** secção, clique em **configurar myPolicies** para abrir **configurar início de sessão** janela. Cópia a **SAML único início de sessão no URL do serviço** partir o **secção de referência rápida.**

    ![Configurar o início de sessão único](./media/mypolicies-tutorial/tutorial_mypolicies_configure.png) 

9. Para configurar o início de sessão único num **myPolicies** lado, terá de enviar o transferido **Certificate(Base64)** e **SAML único início de sessão no URL do serviço** para [ equipa de suporte de myPolicies](mailto:support@mypolicies.com). 
