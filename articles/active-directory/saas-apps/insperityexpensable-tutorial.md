---
title: 'Tutorial: Integração do Azure Active Directory com Insperity ExpensAble | Documentos da Microsoft'
...
5. No painel de resultados, selecione **Insperity ExpensAble**e, em seguida, clique em **Add** botão para adicionar a aplicação.
...
3. **[Criar um utilizador de teste Insperity ExpensAble](#creating-an-insperity-expensable-test-user)**  - para ter um equivalente da Eduarda Almeida na Insperity ExpensAble que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **domínio de ExpensAble Insperity e URLs** secção, execute os seguintes passos:
...
6. Na **Insperity de configuração ExpensAble** secção, clique em **configurar Insperity ExpensAble** para abrir **configurar início de sessão** janela. Cópia a **ID de entidade de SAML e SAML único início de sessão no URL do serviço** partir o **secção de referência rápida.**
