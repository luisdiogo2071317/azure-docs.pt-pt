---
title: 'Tutorial: Integração do Azure Active Directory com Clever | Documentos da Microsoft'
...
3. **[Criar um utilizador de teste inteligente](#create-a-clever-test-user)**  - para ter um equivalente da Eduarda Almeida na Clever que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **inteligente de domínio e URLs** secção, execute os seguintes passos:
...
5. A aplicação inteligente espera que as asserções SAML num formato específico, o que requer a adição de mapeamentos de atributos personalizados para sua **atributos de Token SAML** configuração.
...
8. Numa janela do browser web diferente, inicie sessão no site da sua empresa inteligente como administrador.
...
10. Sobre o **instantânea de início de sessão** página, execute os seguintes passos:
