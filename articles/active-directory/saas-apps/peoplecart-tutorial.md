---
title: 'Tutorial: Integração do Azure Active Directory com Peoplecart | Documentos da Microsoft'
...
4. Na caixa de pesquisa, escreva **Peoplecart**, selecione **Peoplecart** no painel de resultados, em seguida, clique em **Add** botão para adicionar a aplicação.
...
3. **[Criar um utilizador de teste Peoplecart](#create-a-peoplecart-test-user)**  - para ter um equivalente da Eduarda Almeida na Peoplecart que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **Peoplecart domínio e URLs** secção, execute os seguintes passos:
...
6. Sobre o **Peoplecart configuração** secção, clique em **configurar Peoplecart** para abrir **configurar início de sessão** janela. Cópia a **SAML único início de sessão no URL do serviço** partir o **secção de referência rápida.**
