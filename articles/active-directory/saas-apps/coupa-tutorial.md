...
3. **[Criar um utilizador de teste Coupa](#create-a-coupa-test-user)**  - para ter um equivalente da Eduarda Almeida na Coupa que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **Coupa domínio e URLs** secção, execute os seguintes passos:
...
6. Inicie sessão site da sua empresa Coupa como um administrador.

7. Aceda a **programa de configuração \> controlo de segurança**.

   ![Controlos de segurança](./media/coupa-tutorial/ic791900.png "controlos de segurança")

8. Na **inicie sessão com credenciais de Coupa** secção, execute os seguintes passos:
