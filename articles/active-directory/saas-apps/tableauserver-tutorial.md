...
1. Na caixa de pesquisa, escreva **Tableau Server**.

    ![Criar um utilizador de teste do Azure AD](./media/tableauserver-tutorial/tutorial_tableauserver_search.png)

1. No painel de resultados, selecione **o servidor da Tableau**e, em seguida, clique em **Add** botão para adicionar a aplicação.
...
1. **[Criar um utilizador de teste do servidor da Tableau](#creating-a-tableau-server-test-user)**  - para ter um equivalente da Eduarda Almeida no servidor da Tableau que está ligado à representação de utilizador do Azure AD.
...
1. Sobre o **Tableau Server domínio e URLs** secção, execute os seguintes passos:
