---
title: 'Tutorial: Integração do Azure Active Directory com Wingspan eTMF | Documentos da Microsoft'
...
5. No painel de resultados, selecione **Wingspan eTMF**e, em seguida, clique em **Add** botão para adicionar a aplicação.
...
3. **[Criar um utilizador de teste de eTMF Wingspan](#creating-a-wingspan-etmf-test-user)**  - para ter um equivalente da Eduarda Almeida na eTMF Wingspan que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **Wingspan eTMF domínio e URLs** secção, execute os seguintes passos:
...
6. Para configurar o início de sessão único num **Wingspan eTMF** lado, terá de enviar o transferido **XML de metadados** para [suporte de eTMF Wingspan](http://www.wingspan.com/contact-us/). Eles configurar isto para que a ligação de SAML SSO definidas corretamente em ambos os lados.
