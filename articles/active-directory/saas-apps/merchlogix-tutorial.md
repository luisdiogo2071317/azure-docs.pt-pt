---
title: 'Tutorial: Integração do Azure Active Directory com Merchlogix | Documentos da Microsoft'
...
4. Na caixa de pesquisa, escreva **Merchlogix**, selecione **Merchlogix** no painel de resultados, em seguida, clique em **Add** botão para adicionar a aplicação.
...
3. **[Criar um utilizador de teste Merchlogix](#create-a-merchlogix-test-user)**  - para ter um equivalente da Eduarda Almeida na Merchlogix que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **Merchlogix domínio e URLs** secção, execute os seguintes passos:
    ...
    > [!NOTE]
    > Estes valores não são reais. Atualize estes valores com o URL de início de sessão e o identificador real. Contacte [equipa de suporte de Merchlogix](http://www.merchlogix.com/contact/) obter esses valores.
...
6. Sobre o **Merchlogix configuração** secção, clique em **configurar Merchlogix** para abrir **configurar início de sessão** janela. Cópia a **URL de fim de sessão, o ID de entidade de SAML** e **SAML único início de sessão no URL do serviço** do **secção de referência rápida.**

    ![Configuração de Merchlogix](./media/merchlogix-tutorial/tutorial_merchlogix_configure.png) 

7. Para configurar o início de sessão único num **Merchlogix** lado, terá de enviar o transferido **certificado (Base64)**, **URL de fim de sessão, o ID de entidade de SAML e o SAML único início de sessão no URL do serviço**para [a equipa de suporte Merchlogix](http://www.merchlogix.com/contact/). Se definir esta definição para que a ligação de SAML SSO definidas corretamente em ambos os lados.
...
Nesta secção, vai criar um usuário chamado Eduarda Almeida no Merchlogix. Trabalhar com [equipa de suporte de Merchlogix](http://www.merchlogix.com/contact/) para adicionar os utilizadores na plataforma Merchlogix.
