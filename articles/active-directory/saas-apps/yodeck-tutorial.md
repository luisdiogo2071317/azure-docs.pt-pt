---
title: 'Tutorial: Integração do Azure Active Directory com Yodeck | Documentos da Microsoft'
...
3. **[Criar um utilizador de teste Yodeck](#create-a-yodeck-test-user)**  - para ter um equivalente da Eduarda Almeida na Yodeck que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **Yodeck domínio e URLs** secção, execute os seguintes passos, se desejar configurar a aplicação no **IDP** iniciada pelo modo:
...
8. Clique em **definições de utilizador** opção formulário canto superior direito da página e selecione **definições de conta**.
