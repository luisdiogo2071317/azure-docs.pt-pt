...
3. No **MobileIron domínio e os URLs** secção, execute os seguintes passos, se pretender configurar a aplicação no **IDP** iniciada modo:
    ...
    ![Domínio MobileIron e os URLs únicos de informações de início de sessão](./media/mobileiron-tutorial/tutorial_mobileiron_url.png)
...
4. Verifique **Mostrar avançadas definições de URL** e executar o passo seguinte, se pretender configurar a aplicação no **SP** iniciada modo:
    ...
    ![Domínio MobileIron e URLs-início de sessão único](./media/mobileiron-tutorial/tutorial_mobileiron_url1.png)
...
5. No **certificado de assinatura de SAML** secção, clique em **XML de metadados** e, em seguida, guarde o ficheiro de metadados no seu computador.
    ...
    ![A hiperligação de transferência do certificado](./media/mobileiron-tutorial/tutorial_mobileiron_certificate.png) 

6. Clique em **guardar** botão.

    ![Configurar botão único início de sessão guardar](./media/mobileiron-tutorial/tutorial_general_400.png)
...
8. Aceda a **Admin** > **identidade**.
   ...
   * Selecione **AAD** opção o **informações sobre o programa de configuração do Cloud IDP** campo.
    ...
    ![Configurar o botão de administração de início de sessão único](./media/mobileiron-tutorial/tutorial_mobileiron_admin.png)
...
9. Copie os valores de **chave** e **anfitrião** e cole-os para concluir os URLs no **MobileIron domínio e os URLs** secção no portal do Azure.
    ...
    ![Configurar o botão de administração de início de sessão único](./media/mobileiron-tutorial/key.png)
...
10. No **ficheiro de metadados de exportação do AAD e importação para o campo de nuvem MobileIron** clique **Escolher ficheiro** para carregar os metadados transferido a partir do portal do Azure. Clique em **feito** uma vez carregado.
    ...
    ![Configurar o início de sessão único do botão de metadados do administrador](./media/mobileiron-tutorial/tutorial_mobileiron_adminmetadata.png)
...
2. Para apresentar a lista de utilizadores, aceda a **utilizadores e grupos**e, em seguida, clique em **todos os utilizadores**.
    ...
    !["Os utilizadores e grupos" e "Todos os utilizadores" ligações](./media/mobileiron-tutorial/create_aaduser_02.png)

3. Para abrir o **utilizador** caixa de diálogo, clique em **adicionar** na parte superior do **todos os utilizadores** caixa de diálogo.

    ![O botão de adição](./media/mobileiron-tutorial/create_aaduser_03.png)
