...
4. Na caixa de pesquisa, escreva **Insignia SAML SSO**, selecione **Insignia SAML SSO** no painel de resultados, em seguida, clique em **Add** botão para adicionar a aplicação.
...
3. **[Criar um utilizador de teste Insignia SAML SSO](#create-an-insignia-saml-sso-test-user)**  - para ter um equivalente da Eduarda Almeida na Insignia SAML SSO que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **Insignia SAML SSO domínio e URLs** secção, execute os seguintes passos:
...
6. Sobre o **Insignia SAML SSO Configuration** secção, clique em **configurar Insignia SAML SSO** para abrir **configurar início de sessão** janela. Cópia a **URL de fim de sessão e SAML único início de sessão no URL do serviço** partir o **secção de referência rápida.**
