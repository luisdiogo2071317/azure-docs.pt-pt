---
title: 'Tutorial: Integração do Azure Active Directory com Nomadic | Documentos da Microsoft'
...
4. Na caixa de pesquisa, escreva **Nomadic**, selecione **Nomadic** no painel de resultados, em seguida, clique em **Add** botão para adicionar a aplicação.
...
3. **[Criar um utilizador de teste Nômades](#create-a-nomadic-test-user)**  - para ter um equivalente da Eduarda Almeida na Nomadic que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **Nômades domínio e URLs** secção, execute os seguintes passos:
...
6.  Para obter SSO configurado para a sua aplicação, contacte [equipa de suporte Nômades](mailto:help@nomadic.fm) e forneça-los com o transferido **metadados**.
