...
3. **Criar um utilizador de teste HubSpot** - para ter um equivalente da Eduarda Almeida na HubSpot que está ligado à representação de utilizador do Azure AD.
