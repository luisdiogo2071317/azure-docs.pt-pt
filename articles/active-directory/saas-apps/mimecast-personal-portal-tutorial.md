...
3. **[Criar um utilizador de teste do Portal de pessoal de Mimecast](#create-a-mimecast-personal-portal-test-user)**  - para ter um equivalente da Eduarda Almeida no Portal de pessoal de Mimecast que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **Mimecast pessoais Portal domínio e URLs** secção, execute os seguintes passos:
    ...
    > [!NOTE] 
    > O valor do identificador não é real. Atualize o valor com o identificador real. Contacte [equipa de suporte de cliente de Portal pessoal Mimecast](http://www.mimecast.com/customer-success/technical-support/) para obter o valor. 
...
6. Sobre o **Mimecast pessoal a configuração do Portal** secção, clique em **Portal pessoal de Mimecast configurar** para abrir **configurar início de sessão** janela. Cópia a **URL de fim de sessão, o ID de entidade de SAML e o SAML único início de sessão no URL do serviço** partir o **secção de referência rápida.**
...
7. Numa janela do browser web diferente, inicie sessão no seu Portal pessoal Mimecast como um administrador.

8. Aceda a **serviços \> aplicativos**.
...
2. Na lista de aplicações, selecione **Portal de pessoal de Mimecast**.
