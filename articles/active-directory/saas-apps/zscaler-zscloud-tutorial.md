...
1. Na caixa de pesquisa, escreva **Zscaler ZSCloud**.

    ![Criar um utilizador de teste do Azure AD](./media/zscaler-zscloud-tutorial/tutorial_zscalerzscloud_search.png)

1. No painel de resultados, selecione **Zscaler ZSCloud**e, em seguida, clique em **Add** botão para adicionar a aplicação.
...
1. **[Criar um utilizador de teste do Zscaler ZSCloud](#creating-a-zscaler-zscloud-test-user)**  - para ter um equivalente da Eduarda Almeida na Zscaler ZSCloud que está ligado à representação de utilizador do Azure AD.
...
1. Sobre o **Zscaler ZSCloud domínio e URLs** secção, execute os seguintes passos:
...
1. Na **Zscaler ZSCloud Configuration** secção, clique em **configurar o Zscaler ZSCloud** para abrir **configurar início de sessão** janela. Cópia a **SAML único início de sessão no URL do serviço** partir o **secção de referência rápida.**

    ![Configurar o início de sessão único](./media/zscaler-zscloud-tutorial/tutorial_zscalerzscloud_configure.png) 

1. Numa janela do browser web diferente, inicie sessão no site da sua empresa ZScaler ZSCloud como administrador.
...
1. Na lista de aplicações, selecione **Zscaler ZSCloud**.
