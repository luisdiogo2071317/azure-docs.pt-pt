...
6. Sobre o **fidelidade NetBenefits configuração** secção, clique em **configurar NetBenefits de fidelidade** para abrir **configurar início de sessão** janela. Cópia a **ID de entidade de SAML e SAML único início de sessão no URL do serviço** partir o **secção de referência rápida.**
