...
8. Aceda a **Comunidade definições**.
    ...
    ![Definições de Comunidade](./media/ideascale-tutorial/ic790847.png "definições de Comunidade")

9. Aceda a **segurança \> único Signon definições**.
   
    ![Único Signon definições](./media/ideascale-tutorial/ic790848.png "único Signon definições")

10. Como **Signon único tipo**, selecione **SAML 2.0**.
   
    ![Único tipo Signon](./media/ideascale-tutorial/ic790849.png "único tipo Signon")

11. No **único Signon definições** caixa de diálogo, execute os seguintes passos:
   
    ![Único Signon definições](./media/ideascale-tutorial/ic790850.png "único Signon definições")
