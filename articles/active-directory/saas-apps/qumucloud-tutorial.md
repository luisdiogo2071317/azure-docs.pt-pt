---
title: 'Tutorial: Integração do Azure Active Directory com nuvem Qumu | Documentos da Microsoft'
...
ms.locfileid: "39051637"
---
# <a name="tutorial-azure-active-directory-integration-with-qumu-cloud"></a>Tutorial: Integração do Azure Active Directory com nuvem Qumu
...
4. Na caixa de pesquisa, escreva **Qumu Cloud**, selecione **Qumu Cloud** no painel de resultados, em seguida, clique em **Add** botão para adicionar a aplicação.
...
3. **[Criar um utilizador de teste da Qumu Cloud](#create-a-qumu-cloud-test-user)**  - para ter um equivalente da Eduarda Almeida na Cloud de Qumu que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **Qumu Cloud domínio e URLs** secção, execute os seguintes passos, se desejar configurar a aplicação no **IDP** iniciada pelo modo:
...
4. Aplicação na Cloud de Qumu espera que as asserções SAML num formato específico. Configure as seguintes declarações para esta aplicação. Pode gerir os valores destes atributos da "**atributos de utilizador**" secção na página de integração de aplicações. Captura de ecrã seguinte mostra um exemplo disso.
...
7. Para configurar o início de sessão único num **Qumu Cloud** lado, terá de enviar o transferido **XML de metadados** para [equipa de suporte de Qumu Cloud](mailto:support@qumu.com). Se definir esta definição para que a ligação de SAML SSO definidas corretamente em ambos os lados.
