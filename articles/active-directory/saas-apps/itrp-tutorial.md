...
8. No painel de navegação esquerdo, selecione **Single Sign-On**.
    ...
    ![De sessão único-](./media/itrp-tutorial/ic775571.png "Single Sign-On")

9. Na secção de configuração Single Sign-On, execute os seguintes passos:
   
    ![De sessão único-](./media/itrp-tutorial/ic775572.png "Single Sign-On")
    
    ![De sessão único-](./media/itrp-tutorial/ic775573.png "Single Sign-On")   
...
2. Na barra de ferramentas na parte superior, clique em **registos**.
    ...
    ![Administração](./media/itrp-tutorial/ic775575.png "Admin")
...
4. Clique em **Adicionar nova pessoa** ("+").
    ...
    ![Administração](./media/itrp-tutorial/ic775576.png "Admin")

5. Na caixa de diálogo Adicionar nova pessoa, execute os seguintes passos:
   
    ![Utilizador](./media/itrp-tutorial/ic775577.png "utilizador") 
