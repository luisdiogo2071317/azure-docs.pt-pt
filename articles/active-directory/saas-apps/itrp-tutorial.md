---
title: 'Tutorial: Integração do Azure Active Directory com ITRP | Documentos da Microsoft'
...
5. No painel de resultados, selecione **ITRP**e, em seguida, clique em **Add** botão para adicionar a aplicação.
...
3. **[Utilizador de teste de criação de um ITRP](#creating-an-itrp-test-user)**  - para ter um equivalente da Eduarda Almeida na ITRP que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **ITRP domínio e URLs** secção, execute os seguintes passos:
...
6. Sobre o **ITRP configuração** secção, clique em **configurar ITRP** para abrir **configurar início de sessão** janela. Copiar o **SAML único início de sessão no URL do serviço e o URL de fim de sessão** partir o **secção de referência rápida.**
...
9. Na secção de configuração início de sessão único, execute os seguintes passos:
