...
9. No **associação** separador, clique em **definições de início de sessão**.
    ...
    ![Iniciar sessão nas definições](./media/igloo-software-tutorial/ic783968.png "iniciar sessão nas definições")

10. Na secção de configuração de SAML, clique em **configurar a autenticação SAML**.
   
    ![Configuração de SAML](./media/igloo-software-tutorial/ic783969.png "configuração SAML")
...
13. Execute os seguintes passos para concluir a configuração:
    ...
    ![Criação de utilizador no início de sessão](./media/igloo-software-tutorial/IC783972.png "criação de utilizador no início de sessão") 
