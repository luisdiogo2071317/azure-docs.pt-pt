...
*   JIRA também suporta 6.0 e 7.8. Para obter mais detalhes, clique em [JIRA SAML SSO pela Microsoft](jiramicrosoft-tutorial.md)
...
3. **[Criar um JIRA SAML SSO por utilizador de teste da Microsoft (V5.2)](#create-a-jira-saml-sso-by-microsoft-v52-test-user)**  - para ter um equivalente da Eduarda Almeida no JIRA SAML SSO pela Microsoft (V5.2) que está ligado à representação de utilizador do Azure AD.
...
2. Sobre o **início de sessão único** caixa de diálogo, selecione **modo** como **baseado em SAML logon** para ativar o início de sessão único.
    ...
    ![Caixa de diálogo de início de sessão único](./media/jira52microsoft-tutorial/tutorial_singlesign-onforjira5.2_samlbase.png)

3. Sobre o **JIRA SAML SSO pelo Microsoft Domain e URLs** secção, execute os seguintes passos:

    ![JIRA SAML SSO pelo Microsoft Domain e URLs únicas início de sessão em informações](./media/jira52microsoft-tutorial/tutorial_singlesign-onforjira5.2_url.png)
...
4. Sobre o **certificado de assinatura SAML** secção, clique no botão de cópia para copiar **Url de metadados de Federação de aplicação** e cole-o no bloco de notas.
    ...
    ![Configurar o início de sessão único](./media/jira52microsoft-tutorial/tutorial_metadataurl.png)

5. Clique em **guardar** botão.

    ![Configurar o início de sessão único](./media/jira52microsoft-tutorial/tutorial_general_400.png)
...
1. No portal do Azure, no painel esquerdo, clique nas **do Azure Active Directory** botão.
    ...
    ![O botão do Azure Active Directory](./media/jira52microsoft-tutorial/create_aaduser_01.png)

2. Para apresentar a lista de utilizadores, aceda a **utilizadores e grupos**e, em seguida, clique em **todos os utilizadores**.

    !["Os utilizadores e grupos" e os links de "Todos os utilizadores"](./media/jira52microsoft-tutorial/create_aaduser_02.png)

3. Para abrir o **usuário** caixa de diálogo, clique em **Add** na parte superior a **todos os utilizadores** caixa de diálogo.

    ![Botão Adicionar](./media/jira52microsoft-tutorial/create_aaduser_03.png)

4. Na **utilizador** diálogo caixa, execute os seguintes passos:

    ![A caixa de diálogo de utilizador](./media/jira52microsoft-tutorial/create_aaduser_04.png)
...
### <a name="create-a-jira-saml-sso-by-microsoft-v52-test-user"></a>Criar um JIRA SAML SSO por utilizador de teste da Microsoft (V5.2)
...
**Para atribuir a Eduarda Almeida a JIRA SAML SSO pela Microsoft (V5.2), execute os seguintes passos:**
...
2. Na lista de aplicações, selecione **JIRA SAML SSO pela Microsoft (V5.2)**.
    ...
    ![O JIRA SAML SSO pela Microsoft (V5.2) de ligação na lista de aplicações](./media/jira52microsoft-tutorial/tutorial_singlesign-onforjira5.2_app.png)
