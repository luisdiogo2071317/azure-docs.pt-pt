...
4. Na caixa de pesquisa, escreva **Wizergos produtividade Software**, selecione **Wizergos produtividade Software** partir do painel de resultados, em seguida, clique em **adicionar** botão para adicionar a aplicação.
    ...
    ![Software de produtividade Wizergos na lista de resultados](./media/wizergosproductivitysoftware-tutorial/tutorial_wizergosproductivitysoftware_addfromgallery.png)
...
3. No **Wizergos produtividade Software domínio e os URLs** secção, execute os seguintes passos:
    ...
    ![Wizergos produtividade Software domínio e os URLs únicos de informações de início de sessão](./media/wizergosproductivitysoftware-tutorial/tutorial_wizergosproductivitysoftware_url.png)
...
4. No **certificado de assinatura de SAML** secção, clique em **certificado** e, em seguida, guarde o ficheiro de certificado no seu computador.
    ...
    ![A hiperligação de transferência do certificado](./media/wizergosproductivitysoftware-tutorial/tutorial_wizergosproductivitysoftware_certificate.png) 

5. Clique em **guardar** botão.

    ![Configurar botão único início de sessão guardar](./media/wizergosproductivitysoftware-tutorial/tutorial_general_400.png)
...
6. No **Wizergos produtividade Software configuração** secção, clique em **configurar Wizergos produtividade Software** para abrir **configurar início de sessão** janela. Copiar o **Sign-Out URL, o ID de entidade de SAML e o único início de sessão no URL do serviço SAML** do **secção de referência rápida.**
    ...
    ![Configuração do Software Wizergos produtividade](./media/wizergosproductivitysoftware-tutorial/tutorial_wizergosproductivitysoftware_configure.png) 
...
8. No hamburger menu, selecione **Admin**.
    ...
    ![Configurar lado único início de sessão na aplicação](./media/wizergosproductivitysoftware-tutorial/tutorial_wizergosproductivitysoftware_000.png)

9. Na página de administrador no menu esquerdo selecione **autenticação** e clique em **do Azure AD**.

    ![Configurar lado único início de sessão na aplicação](./media/wizergosproductivitysoftware-tutorial/tutorial_wizergosproductivitysoftware_002.png)

10. Execute os seguintes passos no **autenticação** secção.

    ![Configurar lado único início de sessão na aplicação](./media/wizergosproductivitysoftware-tutorial/tutorial_wizergosproductivitysoftware_003.png)
...
2. Para apresentar a lista de utilizadores, aceda a **utilizadores e grupos**e, em seguida, clique em **todos os utilizadores**.
    ...
    !["Os utilizadores e grupos" e "Todos os utilizadores" ligações](./media/wizergosproductivitysoftware-tutorial/create_aaduser_02.png)

3. Para abrir o **utilizador** caixa de diálogo, clique em **adicionar** na parte superior do **todos os utilizadores** caixa de diálogo.

    ![O botão de adição](./media/wizergosproductivitysoftware-tutorial/create_aaduser_03.png)
...
2. Na lista de aplicações, selecione **Wizergos produtividade Software**.
    ...
    ![A ligação ao Software de produtividade Wizergos na lista de aplicações](./media/wizergosproductivitysoftware-tutorial/tutorial_wizergosproductivitysoftware_app.png)  
