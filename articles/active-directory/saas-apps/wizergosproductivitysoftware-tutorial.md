---
title: 'Tutorial: Integração do Active Directory do Azure com o Software de produtividade Wizergos | Documentos da Microsoft'
...
ms.locfileid: "54826578"
---
# <a name="tutorial-azure-active-directory-integration-with-wizergos-productivity-software"></a>Tutorial: Integração do Active Directory do Azure com o Software de produtividade Wizergos
...
1. Sobre o **Wizergos produtividade Software domínio e URLs** secção, execute os seguintes passos:
    ...
    Na **identificador** caixa de texto, escreva o URL: `https://www.wizergos.net`
