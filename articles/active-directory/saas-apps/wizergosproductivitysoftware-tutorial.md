...
4. Na caixa de pesquisa, escreva **Software de produtividade Wizergos**, selecione **Software de produtividade Wizergos** no painel de resultados, em seguida, clique em **Add** botão para adicionar a aplicação.
...
3. **[Criar um utilizador de teste de Software de produtividade Wizergos](#create-a-wizergos-productivity-software-test-user)**  - para ter um equivalente da Eduarda Almeida em Software de produtividade de Wizergos que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **Wizergos produtividade Software domínio e URLs** secção, execute os seguintes passos:
...
7. Numa janela do browser web diferente, início de sessão no seu inquilino de Software de produtividade Wizergos como administrador.

8. A partir do menu de opções, selecione **administrador**.
...
9. Na página de administração no menu do lado esquerdo, selecione **autenticação** e clique em **do Azure AD**.
...
2. Na lista de aplicações, selecione **Software de produtividade Wizergos**.
