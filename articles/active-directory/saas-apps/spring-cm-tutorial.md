---
title: 'Tutorial: Integração do Azure Active Directory com SpringCM | Documentos da Microsoft'
...
5. No painel de resultados, selecione **SpringCM**e, em seguida, clique em **Add** botão para adicionar a aplicação.
...
3. **[Criar um utilizador de teste SpringCM](#creating-a-springcm-test-user)**  - para ter um equivalente da Eduarda Almeida na SpringCM que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **SpringCM domínio e URLs** secção, execute os seguintes passos:
...
6. Sobre o **SpringCM configuração** secção, clique em **configurar SpringCM** para abrir **configurar início de sessão** janela. Cópia a **ID de entidade de SAML e SAML único início de sessão no URL do serviço** partir o **secção de referência rápida.**
...
8. No menu na parte superior, clique em **Ir para**, clique em **preferências**e, em seguida, no **preferências de conta** secção, clique em **SAML SSO**.
...
2. Clique em **GOTO**e, em seguida, clique em **livro de endereços**.
...
6. Escreva o nome próprio, apelido e endereço de e-mail de uma conta de utilizador válido do Azure Active Directory que pretende aprovisionar em caixas de texto relacionadas.
