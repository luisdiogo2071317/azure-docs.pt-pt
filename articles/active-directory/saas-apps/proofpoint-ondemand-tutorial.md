...
3. No **Proofpoint no domínio a pedido e URLs** secção, execute os seguintes passos:
    ...
    ![Proofpoint no domínio a pedido e URLs único início de sessão informações](./media/proofpoint-ondemand-tutorial/tutorial_proofpointondemand_url.png)
...
5. No **certificado de assinatura de SAML** secção, clique em **Certificate(Base64)** e, em seguida, guarde o ficheiro de certificado no seu computador.
    ...
    ![A hiperligação de transferência do certificado](./media/proofpoint-ondemand-tutorial/tutorial_proofpointondemand_certificate.png) 

6. Clique em **guardar** botão.

    ![Configurar botão único início de sessão guardar](./media/proofpoint-ondemand-tutorial/tutorial_general_400.png)
...
2. Para apresentar a lista de utilizadores, aceda a **utilizadores e grupos**e, em seguida, clique em **todos os utilizadores**.
    ...
    !["Os utilizadores e grupos" e "Todos os utilizadores" ligações](./media/proofpoint-ondemand-tutorial/create_aaduser_02.png)

3. Para abrir o **utilizador** caixa de diálogo, clique em **adicionar** na parte superior do **todos os utilizadores** caixa de diálogo.

    ![O botão de adição](./media/proofpoint-ondemand-tutorial/create_aaduser_03.png)
