...
3. **[Criar um Proofpoint no utilizador de teste a pedido](#create-a-proofpoint-on-demand-test-user)**  - para ter um equivalente da Eduarda Almeida na Proofpoint sob demanda e que está ligada à representação de utilizador do Azure AD.
...
3. Sobre o **Proofpoint no domínio a pedido e URLs** secção, execute os seguintes passos:
...
7. Na **Proofpoint na configuração de pedido** secção, clique em **configurar Proofpoint a pedido** para abrir **configurar início de sessão** janela. Cópia a **URL de fim de sessão, o ID de entidade de SAML e o SAML único início de sessão no URL do serviço** partir o **secção de referência rápida.**
