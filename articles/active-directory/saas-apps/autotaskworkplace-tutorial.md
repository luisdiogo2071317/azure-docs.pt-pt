...
3. **[Criar um utilizador de teste de área de trabalho Autotask](#create-an-autotask-workplace-test-user)**  - para ter um equivalente da Eduarda Almeida na área de trabalho de Autotask que está ligado à representação de utilizador do Azure AD.
...
3. Se desejar configurar a aplicação no **IDP** iniciadas pelo modo, execute os seguintes passos no **Autotask à área de trabalho domínio e URLs** secção:
...
4. Se desejar configurar a aplicação no **SP** modo iniciado, verificação **Mostrar definições de URL avançadas** e execute os seguintes passos:
...
7. Numa janela do browser web diferente, inicie sessão à área de trabalho Online com as credenciais de administrador.
...
8. Aceda a **Configuration** > **Single Sign-On** e execute os seguintes passos:
