---
title: 'Tutorial: Integração do Azure Active Directory com Zwayam | Documentos da Microsoft'
...
4. Na caixa de pesquisa, escreva **Zwayam**, selecione **Zwayam** no painel de resultados, em seguida, clique em **Add** botão para adicionar a aplicação.
...
3. **[Criar um utilizador de teste Zwayam](#create-a-zwayam-test-user)**  - para ter um equivalente da Eduarda Almeida na Zwayam que está ligado à representação de utilizador do Azure AD.
...
3. Sobre o **Zwayam domínio e URLs** secção, execute os seguintes passos:
...
6. Sobre o **Zwayam configuração** secção, clique em **configurar Zwayam** para abrir **configurar início de sessão** janela. Cópia a **ID de entidade de SAML** da **seção de referência rápida** e cole o **ID de entidade de SAML** valor no **URL de início de sessão** o decaixadetexto **Zwayam domínio e URLs** secção.

    ![Configuração de Zwayam](./media/zwayam-tutorial/tutorial_Zwayam_configure.png) 

7. Para configurar o início de sessão único num **Zwayam** lado, terá de enviar o transferido **XML de metadados** para [equipa de suporte de Zwayam](mailto:opendoors@zwayam.com). Se definir esta definição para que a ligação de SAML SSO definidas corretamente em ambos os lados.
