...
2. O dispositivo é o Azure AD associado ou Azure AD híbrido associou. Para obter mais informações, consulte [como obter um dispositivo sob o controlo do Azure AD](device-management-introduction.md).
3. Certifique-se de que **Roaming de estado empresarial** está ativada para o inquilino no Azure AD, tal como descrito na [para ativar o Roaming de estado empresarial](active-directory-windows-enterprise-state-roaming-enable.md). Pode ativar o roaming para todos os utilizadores ou para um grupo selecionado de utilizadores.
4. Já tem de ser atribuída ao utilizador uma licença do Azure Active Directory Premium.  
25. O dispositivo tem de ser reiniciado e o utilizador tem de iniciar sessão novamente para aceder às funcionalidades de Roaming de estado empresarial.
...
2. Certifique-se de que a sincronização funciona em várias máquinas, fazendo algumas alterações no computador original, como mover a barra de tarefas para o lado direito ou superior do ecrã. Assista a alteração se propaguem para a segunda máquina dentro de cinco minutos. 
