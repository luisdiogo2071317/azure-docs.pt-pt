---
title: Configurar a gestão de grupos self-service no Azure AD | Documentos da Microsoft
...
Dois cenários de serviços de gestão de grupos self-service: 
