---
title: Configurar a verificação de dois passos - do Azure AD | Microsoft Docs
...
* Configurar [palavras-passe de aplicação](../../../../multi-factor-authentication/end-user/multi-factor-authentication-end-user-app-passwords.md) nativo para aplicações de dispositivo que não suportam a verificação de dois passos.
* Veja o [aplicação Microsoft Authenticator](../../../../multi-factor-authentication/end-user/microsoft-authenticator-app-how-to.md) para fast, autenticação segura, mesmo quando não tiver o serviço de célula.
