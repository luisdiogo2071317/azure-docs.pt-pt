---
title: Aplicação Microsoft Authenticator para telemóveis - do Azure AD | Microsoft Docs
...
4. No scanner, selecione **introduzir manualmente o código**.
    ...
    ![Ecrã de análise de um código QR](./media/microsoft-authenticator-app-how-to/scan2.png)
5. Introduza o código e o URL nas caixas adequadas na aplicação, em seguida, selecione **concluir**.

    ![Ecrã para introduzir o código e o URL](./media/microsoft-authenticator-app-how-to/manual.png)
...
![Verificação da configuração de Touch ID](./media/microsoft-authenticator-app-how-to/touchid1.png)
