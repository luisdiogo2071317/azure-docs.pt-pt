...
3. Selecione **verificação adicional de segurança**.
   ![Selecione verificação adicional de segurança - captura de ecrã](./media/multi-factor-authentication-end-user-app-passwords/myapps1.png)
...
- Experimentar o [aplicação Microsoft Authenticator](../../../../multi-factor-authentication/end-user/microsoft-authenticator-app-how-to.md) para verificar os inícios de sessão com as notificações de aplicação, em vez de textos ou chamadas a receber.
