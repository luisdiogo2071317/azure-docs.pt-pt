...
1. Ative o telefone início de sessão para a sua conta.
  ...
  - Se não tiver a aplicação Microsoft Authenticator ainda, instalar e adicionar a sua conta Microsoft pessoal, de acordo com os passos no [página Microsoft Authenticator](../../../../multi-factor-authentication/end-user/microsoft-authenticator-app-how-to.md). São ativadas automaticamente contas recentemente adicionadas, pelo que está pronto para continuar.
...
Se tiver dúvidas sobre a aplicação em geral, observe o [perguntas frequentes do autenticador Microsoft](../../../../multi-factor-authentication/end-user/microsoft-authenticator-app-faq.md)
