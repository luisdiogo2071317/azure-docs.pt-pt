...
[LoginScreen]: ./media/tutorial-sspr-windows/logon-reset-password.png "Ligação de Repor palavra-passe no ecrã de início de sessão do Windows 10"
