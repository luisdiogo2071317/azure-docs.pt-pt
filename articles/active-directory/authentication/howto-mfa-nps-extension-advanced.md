...
Para resolver problemas relacionados com os IDs de início de sessão alternativo, utilize os passos recomendados para [alternativa erros de ID de início de sessão](howto-mfa-nps-extension-errors.md#alternate-login-id-errors).
