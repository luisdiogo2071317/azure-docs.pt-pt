...
1. Utilize as instruções no [transferir o servidor do Azure multi-factor Authentication](howto-mfaserver-deploy.md#download-the-mfa-server) para obter a versão mais recente do servidor MFA do Azure.
...
- Obter exemplos de [avançadas cenários com multi-factor Authentication do Azure e VPNs de terceiros](howto-mfaserver-nps-vpn.md)
