...
* Se o utilizador acede o URL personalizado:
    * Transferindo o *whr* parâmetro para a palavra-passe de reposição de página, tal como "https://login.microsoftonline.com/?whr=contoso.com"
...
[Contact]: ./media/concept-sspr-customization/sspr-contact-admin.png "Contacte o administrador para obter ajuda a repor o seu exemplo de e-mail palavras-passe"
