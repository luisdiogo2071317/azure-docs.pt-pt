...
- [Aumentar a sua infraestrutura de autenticação existente com a extensão NPS para o multi-factor Authentication do Azure](howto-mfa-nps-extension.md)
