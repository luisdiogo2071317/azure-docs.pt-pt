...
- Se gostaria de um plano de implementação passo a passo com as políticas recomendadas, consulte o [plano de implementação de acesso condicional](http://aka.ms/conditionalaccessdeploymentplan)
