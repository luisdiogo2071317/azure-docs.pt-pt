...
Para obter mais informações sobre como implementar estas soluções, consulte [conceder B2B utilizadores no Azure AD acedem às suas aplicações no local](active-directory-b2b-hybrid-cloud-to-on-premises.md).
...
Para detalhes de implementação, consulte [as contas de parceiro localmente geridos de concessão de aceder a recursos de nuvem através de colaboração B2B do Azure AD](active-directory-b2b-hybrid-on-premises-to-cloud.md).
...
- [Conceder acesso a contas de parceiro gerido localmente a recursos de nuvem através de colaboração B2B do Azure AD](active-directory-b2b-hybrid-on-premises-to-cloud.md)
