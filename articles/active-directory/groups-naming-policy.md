...
3. Siga os passos em [cmdlets do Azure Active Directory para configurar definições de grupo](users-groups-roles/groups-settings-cmdlets.md) para criar definições de grupo para este inquilino.
...
Para obter mais informações, consulte o artigo [cmdlets do Azure Active Directory para configurar definições de grupo](users-groups-roles/groups-settings-cmdlets.md).
...
* [Política de expiração para grupos do Office 365](users-groups-roles/groups-lifecycle.md)
...
* [Gerir regras dinâmicas para os utilizadores num grupo](users-groups-roles/groups-dynamic-membership.md)
