...
- Para obter uma lista completa de todas as atividades de auditoria, veja [Referência da atividade de auditoria do Azure AD](active-directory-reporting-activity-audit-reference.md)
