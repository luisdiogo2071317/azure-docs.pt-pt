...
Depois de ativar a MSI um recurso do Azure, tal como um [VM do Azure](msi-qs-configure-portal-windows-vm.md) ou [Azure VMSS](msi-qs-configure-portal-windows-vmss.md):
...
- Para ativar o MSI numa máquina virtual do Azure, consulte [configurar um Azure VM geridos serviço de identidade (MSI) no portal do Azure](msi-qs-configure-portal-windows-vm.md).
