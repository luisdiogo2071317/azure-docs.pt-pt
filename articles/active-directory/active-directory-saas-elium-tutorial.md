...
4. Verifique **Mostrar avançadas definições de URL** e executar o passo seguinte, se pretender configurar a aplicação no **SP** iniciada modo:
    ...
    > [!NOTE] 
    > Estes valores não estiverem reais. Irá obter estes valores no **ficheiro de metadados SP** transferível em `https://<platform-domain>/login/saml2/metadata`, que é explicado posteriormente neste tutorial.
