...
- [Melhores práticas para acesso condicional no Azure Active Directory](conditional-access/best-practices.md) para obter orientações sobre como implementar o acesso condicional na sua organização.

- [Exigir a MFA para aplicações específicas com acesso condicional do Azure Active Directory](conditional-access/app-based-mfa.md) para se familiarizar com a interface de utilizador no portal do Azure.
...
- Se quiser saber como configurar uma política de acesso condicional, consulte [GRequire MFA para aplicações específicas com acesso condicional do Azure Active Directory](conditional-access/app-based-mfa.md).
