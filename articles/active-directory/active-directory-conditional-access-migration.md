...
- [Melhores práticas para acesso condicional no Azure Active Directory](active-directory-conditional-access-best-practices.md) para obter orientações sobre como implementar o acesso condicional na sua organização.
