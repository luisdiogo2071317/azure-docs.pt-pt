...
**Programa predefinido** sempre está presente. Se estiver num administrador global ou função de administrador de conta de utilizador, pode criar programas adicionais. Por exemplo, pode optar por ter um programa para cada iniciativa de compatibilidade ou o objetivo de negócio.
