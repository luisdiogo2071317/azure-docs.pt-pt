...
![função de administrador global](./media/add-guest-to-role/global-admin-role.png)

## <a name="limited-administrator-role"></a>Função de administrador limitado

![função de administrador limitado](./media/add-guest-to-role/limited-admin-role.png)
