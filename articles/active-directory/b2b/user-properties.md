...
- Estado 4: Duplamente, na Azure do organização de anfitrião AD com UserType = convidado e as credenciais que gere a organização de anfitrião.
  ...
  ![Apresentar iniciais do inviter](media/user-properties/redemption-diagram.png)
...
![Antes de oferta resgate](media/user-properties/before-redemption.png)

### <a name="after-invitation-redemption"></a>Depois de resgate convite

![Depois de oferta resgate](media/user-properties/after-redemption.png)
...
![Remova as limitações de utilizador convidado](media/user-properties/remove-guest-limitations.png)
