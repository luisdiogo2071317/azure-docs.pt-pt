...
Sim. Para obter mais informações sobre como utilizar a funcionalidade de carregamento do ficheiro. csv, consulte [este exemplo do PowerShell](code-samples.md).

### <a name="how-can-i-customize-my-invitation-emails"></a>Como personalizar o meu mensagens de e-mail de convite?
Pode personalizar quase tudo sobre o processo de inviter utilizando o [B2B convite APIs](customize-invitation-api.md).
...
Com certeza. Para obter mais informações, consulte [adicionar utilizadores de convidado para uma função](add-guest-to-role.md).
...
1. Modificar o **todos os utilizadores** para que contém apenas os membros de grupo.
  ![modificar a captura de ecrã de grupo](media/faq/modify-all-users-group.png)
...
Sim. Para obter mais informações, consulte [acesso condicional para os utilizadores de colaboração do B2B](conditional-access.md).
...
Para obter informações sobre o que licenças as necessidades da organização para utilizar o Azure AD B2B, consulte [colaboração do Azure Active Directory B2B licenciamento orientações](licensing-guidance.md).
