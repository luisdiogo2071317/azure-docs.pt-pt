...
- Pode permitir que os utilizadores automaticamente obter com sessão iniciada para Vodeclic (Single Sign-On) com as respetivas contas do Azure AD.
...
- Um Vodeclic início de sessão único subscrição ativado
...
## <a name="adding-vodeclic-from-the-gallery"></a>Adicionar Vodeclic a partir da Galeria
...
4. Na caixa de pesquisa, escreva **Vodeclic**, selecione **Vodeclic** partir do painel de resultados, em seguida, clique em **adicionar** botão para adicionar a aplicação.
...
Para início de sessão trabalhar, do Azure AD tem de saber o que o utilizador homólogo no Vodeclic é um utilizador no Azure AD. Por outras palavras, uma relação de ligação entre um utilizador do Azure AD e o utilizador relacionado no Vodeclic tem de ser estabelecida.

No Vodeclic, atribua o valor do **nome de utilizador** no Azure AD como o valor a **Username** para estabelecer a relação de ligação.

Para configurar e testar o Azure AD-início de sessão único com Vodeclic, tem de concluir os blocos modulares seguintes:

1. **[Configurar o Azure AD Single Sign-On](#configure-azure-ad-single-sign-on)**  - para permitir aos utilizadores utilizar esta funcionalidade.
2. **[Criar um utilizador de teste do Azure AD](#create-an-azure-ad-test-user)**  - para testar o Azure AD-início de sessão único com Britta Simon.
3. **[Criar um utilizador de teste Vodeclic](#create-a-vodeclic-test-user)**  - para ter um homólogo de Britta Simon Vodeclic que está ligada a representação do Azure AD do utilizador.
...
1. No portal do Azure, no **Vodeclic** página de integração de aplicações, clique em **de sessão único-**.
...
3. No **Vodeclic domínio e os URLs** secção, execute os seguintes passos, se pretender configurar a aplicação no modo de IDP iniciado:
    ...
    a. No **identificador** caixa de texto, escreva um URL a utilizar o padrão do seguinte:`https://<companyname>.lms.vodeclic.net/auth/saml`

    b. No **URL de resposta** caixa de texto, escreva um URL a utilizar o padrão do seguinte:`https://<companyname>.lms.vodeclic.net/auth/saml/callback`
...
4. Verifique **Mostrar avançadas definições de URL** e executar o passo seguinte, se pretender configurar a aplicação no **SP** iniciada modo:
    ...
    No **URL de início de sessão** caixa de texto, escreva um URL a utilizar o padrão do seguinte:`https://<companyname>.lms.vodeclic.net/auth/saml`
     
    > [!NOTE] 
    > Estes valores não estiverem reais. Atualize estes valores com o identificador de real, a URL de resposta e o URL de início de sessão. Contacte [equipa de suporte de cliente Vodeclic](mailto:hotline@vodeclic.com) para obter estes valores.
...
7. Para configurar o início de sessão único em **Vodeclic** lado, terá de enviar o transferido **XML de metadados** para [equipa de suporte de Vodeclic](mailto:hotline@vodeclic.com). Se definir esta definição para que a ligação de SAML SSO corretamente em ambos os lados.
...
Nesta secção, vai criar um utilizador chamado Britta Simon Vodeclic. Trabalhar com [equipa de suporte de Vodeclic](mailto:hotline@vodeclic.com) para adicionar os utilizadores na plataforma Vodeclic. Os utilizadores tem de ser criados e ativados antes de utilizar o início de sessão único.

> [!NOTE]
> De acordo com o requisito da aplicação poderá ter de obter na lista de permissões de máquina e para que precisar de partilhar o seu endereço IP público para o [equipa de suporte de Vodeclic](mailto:hotline@vodeclic.com).
...
**Para atribuir Britta Simon a Vodeclic, execute os seguintes passos:**
...
Quando clica no mosaico Vodeclic no painel de acesso, deve obter automaticamente com sessão iniciada para a aplicação de Vodeclic.
