...
- Um [conector do Proxy de aplicação](application-proxy-enable.md) instalado. 
...
Para mais informações sobre o Proxy de aplicações do Azure AD, consulte [como fornecer acesso remoto seguro a aplicações no local](application-proxy.md).
