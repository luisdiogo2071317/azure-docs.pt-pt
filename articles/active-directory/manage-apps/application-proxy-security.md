...
Para obter mais informações sobre conectores, consulte [conetores da Proxy da aplicação Azure compreender AD](application-proxy-connectors.md).
...
* [O conector no local](application-proxy-connectors.md): um componente no local, o conector escuta pedidos de ligações de serviço e identificadores de Proxy de aplicações do Azure AD para as aplicações internas. 
