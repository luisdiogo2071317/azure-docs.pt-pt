...
![Acesso negado página utilizadores inquilinos não permitido](./media/tenant-restrictions/end-user-denied.png)
...
![Utilizar o portal do Azure para ver as tentativas de início de sessão restritas](./media/tenant-restrictions/portal-report.png)
