...
description: Como resolver problemas com a aplicação da galeria do Azure AD configurada para a palavra-passe início de sessão único
documentationcenter: ''
author: barbkess
manager: mtillman
ms.assetid: ''
