...
6. Para procurar uma aplicação, em **Adicionar a partir da galeria**, introduza o nome da aplicação que quer adicionar. Selecione a aplicação nos resultados e clique em **Adicionar**. O exemplo seguinte mostra o formulário **Adicionar aplicação** que aparece depois de se pesquisar por GitHub.com.
...
Neste início rápido, aprendeu a adicionar uma aplicação da galeria ao seu inquilino do Azure AD. Também aprendeu a editar as propriedades da aplicação. 
