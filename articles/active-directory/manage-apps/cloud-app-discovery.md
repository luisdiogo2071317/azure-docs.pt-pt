...
1. [Configurar relatórios de instantâneo](cloud-app-discovery-create-snapshot-reports.md) para verificar o formato do registo Certifique-se os seus registos fornecem informações utilizáveis ao Cloud App Discovery. Pode também fornecem ad-hoc visibilidade sobre os registos de tráfego que carregar manualmente de firewalls e servidores proxy.
...
3. Se os registos não são atualmente suportados, [configurar um analisador de registo personalizado](https://docs.microsoft.com/cloud-app-security/custom-log-parser) para que o Cloud App Discovery poder analisá-las.
...
2.  Formato de registo corresponde ao formato padrão esperado. Isto é verificado ao tempo de carregamento. Para otimizar o formato de registo uour, consulte [criar relatórios de Cloud App Discovery do instantâneo](cloud-app-discovery-create-snapshot-reports.md).
...
* [Criar relatórios de instantâneos](cloud-app-discovery-create-snapshot-reports.md)
