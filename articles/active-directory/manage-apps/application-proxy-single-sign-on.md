...
Para obter informações sobre como configurar a autenticação integrada do Windows, consulte [delegação restrita de Kerberos para o início de sessão único com o Proxy da aplicação](application-proxy-configure-single-sign-on-with-kcd.md).
