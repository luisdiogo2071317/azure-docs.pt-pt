...
1. Navegue para o canal de equipas para adicionar esta aplicação e selecione onde pretende **+** para adicionar um separador.
   ...
   ![Selecionar adicionar um separador](./media/application-proxy-integrate-with-teams/add-tab.png)
...
3. Atribua o separador um nome e defina o URL para o URL externo de Proxy de aplicações. 
   ...
   ![Configurar URL e o nome do separador](./media/application-proxy-integrate-with-teams/tab-name-url.png)
...
- Saiba como [publicar sites do SharePoint no local](application-proxy-integrate-with-sharepoint-server.md) com o Proxy da aplicação.
- Configurar as suas aplicações a utilizar [domínios personalizados](application-proxy-configure-custom-domain.md) para as respetivas URL externo. 
