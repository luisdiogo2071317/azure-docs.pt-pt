...
-   Implementação do Proxy de aplicações do Azure AD por [introdução ao Proxy de aplicações](application-proxy-enable.md) e acesso geral para aplicativos não KCD funcionar conforme esperado.
