...
![Conceção da implementação](./media/how-to-connect-fed-azure-adfs/deployment.png)
...
![Criar a rede virtual](./media/how-to-connect-fed-azure-adfs/deploynetwork1.png)
...
![Subrede](./media/how-to-connect-fed-azure-adfs/deploynetwork2.png)
...
![Criar o NSG](./media/how-to-connect-fed-azure-adfs/creatensg1.png)
...
![Inicializar o NSG](./media/how-to-connect-fed-azure-adfs/nsgint1.png)
...
![Configurar o NGS](./media/how-to-connect-fed-azure-adfs/nsgconfigure1.png)
...
![Sub-redes após associar o NSG](./media/how-to-connect-fed-azure-adfs/nsgconfigure2.png)
...
![Máquinas Virtuais implementadas](./media/how-to-connect-fed-azure-adfs/virtualmachinesdeployed_noadfs.png)
...
![Procurar o balanceador de carga](./media/how-to-connect-fed-azure-adfs/browseloadbalancer.png)
...
![Balanceadores de carga depois do ILB](./media/how-to-connect-fed-azure-adfs/ilbdeployment2.png)
...
![Configurar o conjunto de back-ends do ILB](./media/how-to-connect-fed-azure-adfs/ilbdeployment3.png)
...
![Configurar a sonda do ILB](./media/how-to-connect-fed-azure-adfs/ilbdeployment4.png)
...
![Configurar as regras de balanceamento do ILB](./media/how-to-connect-fed-azure-adfs/ilbdeployment5.png)
...
![Balanceador de carga com acesso à Internet](./media/how-to-connect-fed-azure-adfs/elbdeployment1.png)
...
![Configurar o balanceador de carga com acesso à Internet](./media/how-to-connect-fed-azure-adfs/elbdeployment3.png) 

![Configurar o balanceador de carga com acesso à Internet (DNS)](./media/how-to-connect-fed-azure-adfs/elbdeployment4.png)
...
![Configurar o conjunto de back-ends do Balanceador de Carga com Acesso à Internet](./media/how-to-connect-fed-azure-adfs/elbdeployment5.png)
...
![Configurar a sonda do Balanceador de Carga com Acesso à Internet](./media/how-to-connect-fed-azure-adfs/elbdeployment6.png)
...
![Configurar as regras de balanceamento do Balanceador de Carga com Acesso à Internet](./media/how-to-connect-fed-azure-adfs/elbdeployment7.png)
...
![Página de início de sessão de teste](./media/how-to-connect-fed-azure-adfs/test1.png)

Após o início de sessão com êxito, é-lhe apresentada uma mensagem de êxito, conforme mostrado abaixo:

![Teste bem-sucedido](./media/how-to-connect-fed-azure-adfs/test2.png)
...
* [Ligações para o AD FS e o Proxy de Aplicações Web](https://aka.ms/ADFSLinks) 

## <a name="next-steps"></a>Passos seguintes
* [Integrar as identidades no local ao Azure Active Directory](whatis-hybrid-identity.md)
* [Configurar e gerir o AD FS com o Azure AD Connect](how-to-connect-fed-whatis.md)
