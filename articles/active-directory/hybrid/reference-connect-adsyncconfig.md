---
title: 'Do Azure AD Connect: Referência do PowerShell ADSyncConfig | Documentos da Microsoft'
...
ms.locfileid: "50634543"
---
# <a name="azure-ad-connect--adsyncconfig-powershell-reference"></a>Do Azure AD Connect: Referência do PowerShell ADSyncConfig
...
Get-ADSyncObjectsWithInheritanceDisabled - SearchBase UO = AzureAD, DC = Contoso, DC = com - ObjectClass ' *'
...
## <a name="set-adsyncbasicreadpermissions"></a>Conjunto ADSyncBasicReadPermissions
...
## <a name="set-adsyncexchangehybridpermissions"></a>Conjunto ADSyncExchangeHybridPermissions
...
## <a name="set-adsyncexchangemailpublicfolderpermissions"></a>Conjunto ADSyncExchangeMailPublicFolderPermissions
...
## <a name="set-adsyncmsdsconsistencyguidpermissions"></a>Conjunto ADSyncMsDsConsistencyGuidPermissions
...
## <a name="set-adsyncpasswordhashsyncpermissions"></a>Conjunto ADSyncPasswordHashSyncPermissions
...
## <a name="set-adsyncpasswordwritebackpermissions"></a>Conjunto ADSyncPasswordWritebackPermissions
...
## <a name="set-adsyncrestrictedpermissions"></a>Conjunto ADSyncRestrictedPermissions
...
## <a name="set-adsyncunifiedgroupwritebackpermissions"></a>Conjunto ADSyncUnifiedGroupWritebackPermissions
...
1.
Genérica leitura/escrita, Delete, Eliminar árvore e subordinados Create\Delete para todos os tipos de objeto e Subobjetos
...
### <a name="description"></a>DESCRIÇÃO
Esta função retuns todas as permissões do AD atualmente definido para um determinado objeto AD fornecido no parâmetro - ADobjectDN.
