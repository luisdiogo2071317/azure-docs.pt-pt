...
1. **Atualizar o Azure AD Connect**: Siga esta [artigo](how-to-upgrade-previous-version.md) e atualize para a versão mais recente do Azure AD Connect.
