...
### <a name="permissions-summary"></a>Resumidas de permissões 
...
|Tipo |Nome |Access |Aplica-se A|
|-----|-----|-----|-----| 
|Permitir|Conta do conector do AD DS|Propriedade de leitura/escrita|MS-DS-consistência-Guid|Objetos de utilizador de subordinados|
...
|Permitir |Conta do conector do AD DS |Um objeto de eliminação/eliminação e todos os filhos de |Este objeto e todos os objetos descendentes|
