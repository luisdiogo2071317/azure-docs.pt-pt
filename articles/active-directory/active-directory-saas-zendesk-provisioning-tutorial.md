...
6. O **segredo Token** para sua Zendesk conta está localizada numa **Admin > API > definições**. 
    ...
    ![Aprovisionamento do Zendesk](./media/active-directory-saas-zendesk-provisioning-tutorial/ZenDesk4.png) ![Zendesk aprovisionamento](./media/active-directory-saas-zendesk-provisioning-tutorial/ZenDesk2.png)
