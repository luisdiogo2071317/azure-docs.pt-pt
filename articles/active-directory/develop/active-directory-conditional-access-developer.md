...
Azure Active Directory (Azure AD) oferece várias formas de proteger a sua aplicação e proteger um serviço. Uma destas funcionalidades exclusivo é o acesso condicional. Acesso condicional permite que os programadores e os clientes empresariais para proteger serviços em diversos formas incluindo:
