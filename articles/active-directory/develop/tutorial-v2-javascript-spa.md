---
title: O Azure AD v2.0 JavaScript de aplicação de página única (SPA) interativo do programa de configuração | Documentos da Microsoft
description: Como os aplicativos SPA do JavaScript podem chamar uma API que precisam de tokens de acesso ao ponto final de v2.0 do Azure Active Directory
