---
title: O Azure AD v2 JS SPA interativo do programa de configuração | Documentos da Microsoft
description: Como os aplicativos SPA do JavaScript podem chamar uma API que precisam de tokens de acesso ao ponto final do Azure Active Directory v2
