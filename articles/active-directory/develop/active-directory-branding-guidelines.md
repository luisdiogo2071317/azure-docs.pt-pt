...
| ------------------------------------ | ---------- | ---------- |
| Logótipo da Microsoft  | ![Logótipo da Microsoft PNG](./media/active-directory-branding-guidelines/MS-SymbolLockup_MSSymbol_19.png) | ![Logótipo da Microsoft SVG](./media/active-directory-branding-guidelines/MS-SymbolLockup_MSSymbol_19.svg) |
...
![Redlines Sign in with Microsoft](./media/active-directory-branding-guidelines/Sign-in-with-Microsoft-redlines.png)
...
| Recurso                                | Formato PNG | Formato SVG |
| ------------------------------------ | ---------- | ---------- |
| Inicie sessão com a Microsoft (tema escuro)  | ![Inicie sessão no tema escuro do botão PNG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_dark.png) | ![Inicie sessão com o tema no escuro Microsoft botão SVG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_dark.svg) |
| Inicie sessão com a Microsoft (tema claro) | ![Inicie sessão no tema claro do botão PNG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_light.png) | ![Inicie sessão com o tema claro de botão Microsoft SVG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_light.svg) |
| Iniciar sessão (tema escuro)                 | ![Iniciar sessão, em Resumo, tema escuro do botão PNG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_dark_short.png) | ![Iniciar sessão, em Resumo, tema escuro do botão SVG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_dark_short.svg) |
| Iniciar sessão (tema claro)                | ![Iniciar sessão, em Resumo, tema claro do botão PNG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_light_short.png) | ![Iniciar sessão, em Resumo, tema claro do botão SVG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_light_short.svg) |
