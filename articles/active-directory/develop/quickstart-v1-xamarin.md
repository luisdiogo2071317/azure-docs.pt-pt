...
ms.locfileid: "39506459"
---
# <a name="azure-ad-xamarin-getting-started"></a>O Azure AD Xamarin, introdução
...
Agora pode passar para cenários de identidade adicionais. Por exemplo, experimente [proteger uma API Web do .NET com o Azure AD](active-directory-devquickstarts-webapi-dotnet.md).
