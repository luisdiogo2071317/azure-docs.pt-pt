...
Agora pode passar para cenários de identidade adicionais. Por exemplo, experimente [proteger uma API Web do .NET com o Azure AD](quickstart-v1-dotnet-webapi.md).
