...
* Para obter mais informações sobre a relação entre objetos de Principal de serviço e aplicações de uma aplicação, consulte [aplicativos e objetos de principal de serviço no Azure AD][AAD-APP-OBJECTS].
* Consulte a [Glossário do programador do Azure AD] [ AAD-DEVELOPER-GLOSSARY] para definições de alguns dos conceitos básicos do Azure Active Directory (AD) para desenvolvedores.
