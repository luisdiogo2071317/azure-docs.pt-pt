...
|--------------|------------------------------------|----------------|
| MSA          | N/d – pedidos de suporte do RPS são utilizados em vez disso | Suporte a chegar |
