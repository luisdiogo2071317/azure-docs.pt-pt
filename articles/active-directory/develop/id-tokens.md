...
|`unique_name` |  Cadeia | Fornece um valor de legível humano que identifica o assunto do token. Este valor não é garantido de ser exclusivo dentro de um inquilino e deve ser utilizado apenas para fins de exibição. Apenas são emitidas em v1.0 `id_tokens`. |
