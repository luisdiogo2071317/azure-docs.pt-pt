...
> [!IMPORTANT]
> Os clientes públicos que utilizam o [concessão implícita OAuth 2.0](v1-oauth2-implicit-grant-flow.md) não é possível utilizar o fluxo OBO. Estes clientes tem de passar seu token de acesso a um cliente confidencial da camada intermediária para executar fluxos OBO. Para mais informações sobre os quais os clientes possam executar chamadas OBO, veja [limitações de cliente](#client-limitations).
