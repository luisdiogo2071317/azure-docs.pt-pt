...
| scope                 | obrigatório    | Uma lista separada por espaço de [âmbitos](active-directory-v2-scopes.md) que pretende que o utilizador para autorizar.           |
...
> [!TIP]
> Experimente executar este pedido no Postman! (Não se esqueça de substituir a `code`) [ ![executar no Postman](./media/active-directory-v2-protocols-oauth-code/runInPostman.png)](https://app.getpostman.com/run-collection/8f5715ec514865a07e6a)
> 
> 
...
> [!TIP]
> Execute este pedido no Postman! (Substitua a `Authorization` cabeçalho primeiro) [ ![executar no Postman](./media/active-directory-v2-protocols-oauth-code/runInPostman.png)](https://app.getpostman.com/run-collection/8f5715ec514865a07e6a)
> 
> 
...
> [!TIP]
> Experimente executar este pedido no Postman! (Não se esqueça de substituir a `refresh_token`) [ ![executar no Postman](./media/active-directory-v2-protocols-oauth-code/runInPostman.png)](https://app.getpostman.com/run-collection/8f5715ec514865a07e6a)
> 
> 
