...
Esta opção permite-lhe alterar o método de início de sessão do utilizador e de sincronização de hash de palavra-passe, autenticação pass-through ou de Federação. Não é possível alterar a **não configurar**.
