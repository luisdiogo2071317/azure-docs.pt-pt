...
* **O Azure AD Connect**: Certifique-se de que a versão do Azure AD Connect é 1.1.553.0 ou superior. Usará a tarefa **certificado de FS SSL atualização AD**.
...
![Selecione os servidores para atualizar](./media/active-directory-aadconnectfed-ssl-update/selectservers.png)
...
- [Gestão de serviços de Federação de diretório Active Directory e a personalização com o Azure AD Connect](active-directory-aadconnect-federation-management.md)
