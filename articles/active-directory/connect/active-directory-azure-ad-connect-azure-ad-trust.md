...
![Azure AD Connect mensagem de que mostra de página sobre a cópia de segurança de confiança do Azure AD existente](media/active-directory-azure-ad-connect-azure-ad-trust/backup2.png)
...
![Um sanpshot do exemplo de cópia de segurança de confiança do Azure AD](media/active-directory-azure-ad-connect-azure-ad-trust/backup.png)
...
* [Gerir e personalizar os serviços de Federação do Active Directory com o Azure AD Connect](active-directory-aadconnect-federation-management.md)