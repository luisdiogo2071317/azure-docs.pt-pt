...
Para entender os detalhes do modelo de configuração, leia [aprovisionamento declarativo da compreensão](active-directory-aadconnectsync-understanding-declarative-provisioning.md).
...
![Com a descrição do cenário de imagens](./media/active-directory-aadconnectsync-understanding-default-configuration/scenario.png)
...
Uma regra de sincronização tem quatro seções de configuração: descrição, controlo de âmbito do filtro, regras de associação e transformações.

#### <a name="description"></a>Descrição
A primeira secção fornece informações básicas, como um nome e descrição.

![Descrição do separador editor de regras em sincronia ](./media/active-directory-aadconnectsync-understanding-default-configuration/syncruledescription.png)
...
![Separador de âmbito no editor de regra de sincronização ](./media/active-directory-aadconnectsync-understanding-default-configuration/syncrulescopingfilter.png)
...
![Separador de âmbito no editor de regra de sincronização ](./media/active-directory-aadconnectsync-understanding-default-configuration/syncrulescopingfilterout.png)
...
![Junte-se a guia regras no editor de regra de sincronização ](./media/active-directory-aadconnectsync-understanding-default-configuration/syncrulejoinrules.png)
...
![Transformações de separador editor de regras em sincronia ](./media/active-directory-aadconnectsync-understanding-default-configuration/syncruletransformations.png)
...
Ver [Noções básicas sobre expressões de aprovisionamento declarativas](active-directory-aadconnectsync-understanding-declarative-provisioning-expressions.md) para obter mais informações sobre a linguagem de expressão para fluxos de atributos.
...
* Continue a ler como a configuração de out-of-box funciona no [entender utilizadores e contactos](active-directory-aadconnectsync-understanding-users-and-contacts.md)
* Veja como fazer uma alteração prática com o aprovisionamento declarativo [como fazer uma alteração à configuração padrão](active-directory-aadconnectsync-change-the-configuration.md).
