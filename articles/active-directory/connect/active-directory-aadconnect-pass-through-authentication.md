...
- *Experiência de utilizador excelente*
  ...
  - Os utilizadores podem concluir [gestão de palavra-passe self-service](../authentication/active-directory-passwords-overview.md) tarefas na nuvem.
...
- Integrado com baseado na nuvem [gestão de palavra-passe self-service](../authentication/active-directory-passwords-overview.md), incluindo a repetição de escrita de palavras-passe para no local do Active Directory e a proteção de palavra-passe por banning palavras-passe utilizadas frequentemente.
