...
- [Propriedades de um utilizador de colaboração do Azure Active Directory B2B](../../active-directory/b2b/user-properties.md#key-properties-of-the-azure-ad-b2b-collaboration-user)
