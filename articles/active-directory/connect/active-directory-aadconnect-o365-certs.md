...
> [!NOTE]
> Se precisar de suportar vários domínios de nível superior, como contoso.com e fabrikam.com, tem de utilizar o **SupportMultipleDomain** mudar com qualquer cmdlet. Para obter mais informações, consulte [suporte para múltiplos domínios de nível superior](active-directory-aadconnect-multiple-domains.md).
>
