...
Para transferir e obter mais informações sobre a aplicação Microsoft Authenticator, veja [começar com a aplicação Microsoft Authenticator](user-help-auth-app-download-install.md).
