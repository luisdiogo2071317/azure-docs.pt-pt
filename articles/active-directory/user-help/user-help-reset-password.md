...
1. Na **introduzir palavra-passe** ecrã, selecione **Esqueci-me da minha palavra-passe**.
...
Se o administrador estiver ativada a funcionalidade, verá um link para **Repor palavra-passe** no seu ecrã início de sessão no Windows 7, Windows 8, Windows 8.1 ou Windows 10.

1. Selecione o **Repor palavra-passe** processo de reposição da ligação para iniciar a palavra-passe sem ter de utilizar a experiência baseada na web normal.

2. Confirme o seu ID de utilizador e selecione **seguinte**.

3. Selecione e confirme um método de contacto para verificação. Se necessário, escolha uma segunda opção de verificação que é diferente da sua anterior, preenchendo as informações necessárias.

4. Sobre o **criar uma nova palavra-passe** página, escreva e confirme a palavra-passe nova e, em seguida, selecione **próxima**.

    Palavras-passe seguras têm, normalmente, 8 e 16 carateres, incluindo carateres em maiúsculas e minúsculas, pelo menos um número e, pelo menos, um caráter especial.

5. Depois de obter a mensagem a indicar que a palavra-passe foi reposta, poderá selecionar **concluir**.
