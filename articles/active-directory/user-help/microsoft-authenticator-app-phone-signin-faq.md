...
ms.locfileid: "39060118"
---
# <a name="sign-in-with-your-phone-not-your-password"></a>Inicie sessão com o seu telemóvel, não a palavra-passe

A aplicação Microsoft Authenticator ajuda-o a proteger as suas contas ao realizar a verificação de dois passos depois de introduzir a palavra-passe. Mas sabia que ele pode substituir a palavra-passe para a sua conta Microsoft pessoal totalmente?
...
3. A maioria das páginas onde normalmente deve introduzir a palavra-passe de conta do Microsoft têm uma ligação que diz **em alternativa, utilize uma aplicação**. Selecione esta ligação para iniciar sessão com o seu telemóvel.

4. A Microsoft envia uma notificação para o seu telefone. Aprove a notificação para iniciar sessão na sua conta.   
