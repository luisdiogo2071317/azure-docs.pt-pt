...
- Depois de transferir e instalar a aplicação, tem de adicionar as suas várias contas. Para obter mais informações, consulte [adicionar as suas contas](microsoft-authenticator-app-add-accounts-overview.md).
