---
title: Como iniciar sessão utilizando as duas etapas a verificação ou a segurança informações - Azure Active Directory | Documentos da Microsoft
...
1. Inicie sessão na sua conta escolar ou profissional com o seu nome de utilizador e palavra-passe.
...
- Editar as informações de segurança para adicionar ou alterar seus métodos de verificação no [gerir as suas informações de segurança](security-info-manage-settings.md) artigo. 
