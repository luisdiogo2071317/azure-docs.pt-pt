---
title: "Tutorial: Configurar DocuSign para aprovisionamento de utilizadores automática no Azure Active Directory | Microsoft Docs"
...
4. Definir o **modo de aprovisionamento** para **automática**. 
    ...
    ![a aprovisionar](./media/active-directory-saas-docusign-provisioning-tutorial/provisioning.png)
