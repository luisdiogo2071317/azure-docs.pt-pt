---
title: Planos de implementação do Azure Active Directory | Microsoft Docs
description: Disponibiliza orientações completas para implementar as capacidades do Azure Active Directory
