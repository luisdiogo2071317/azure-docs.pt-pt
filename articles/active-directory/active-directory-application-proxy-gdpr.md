...
Para obter uma descrição geral do proxy de aplicações do Azure AD, consulte [como fornecer acesso remoto seguro a aplicações no local](manage-apps/application-proxy.md).
