...
[Sincronização do Azure AD Connect: compreender a aprovisionamento declarativo](active-directory-aadconnectsync-understanding-declarative-provisioning.md)
