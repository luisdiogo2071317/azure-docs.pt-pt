...
- Para obter uma descrição geral do acesso condicional, consulte [que é o acesso condicional no Azure Active Directory?](active-directory-conditional-access-azure-portal.md)
