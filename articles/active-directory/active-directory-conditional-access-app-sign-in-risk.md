...
![Criar política](./media/active-directory-conditional-access-app-sign-in-risk/1000.png)
...
O cenário neste início rápido utiliza um início de sessão num browser de Tor para gerar um detetado **inícios de sessão de endereços IP anónimos** evento de risco. O nível de risco deste evento de risco é médio.   
...
3. Na **do Azure Active Directory** página, além do **gerir** secção, clique em **acesso condicional**.
    ...
    ![Acesso condicional](./media/active-directory-conditional-access-app-sign-in-risk/03.png)
 
4. Sobre o **acesso condicional** página, na barra de ferramentas na parte superior, clique em **Add**.

    ![Nome](./media/active-directory-conditional-access-app-sign-in-risk/108.png)

5. No **New** na página a **nome** caixa de texto, tipo **bloquear o acesso de nível de risco médio**.

    ![Nome](./media/active-directory-conditional-access-app-sign-in-risk/104.png)

6. Na **atribuição** secção, clique em **utilizadores e grupos**.

    ![Utilizadores e grupos](./media/active-directory-conditional-access-app-sign-in-risk/06.png)

7. Sobre o **utilizadores e grupos** página:

    ![Acesso condicional](./media/active-directory-conditional-access-app-sign-in-risk/107.png)
...
8. Clique em **aplicações na Cloud**.
    ...
    ![Aplicações na cloud](./media/active-directory-conditional-access-app-sign-in-risk/08.png)

9. Sobre o **aplicações na Cloud** página:

    ![Acesso condicional](./media/active-directory-conditional-access-app-sign-in-risk/109.png)
...
10. Na **controlos de acesso** secção, clique em **concessão**.
    ...
    ![Controlos de acesso](./media/active-directory-conditional-access-app-sign-in-risk/10.png)

11. Sobre o **concessão** página:

    ![Acesso condicional](./media/active-directory-conditional-access-app-sign-in-risk/105.png)
...
12. Na **ativar política** secção, clique em **no**.
    ...
    ![Activar política](./media/active-directory-conditional-access-app-sign-in-risk/18.png)
...
![Utilizador](./media/active-directory-conditional-access-app-sign-in-risk/117.png)
...
2. Clique em **usuário**, selecione **Alan Charon** no **utilizadores** página e, em seguida, clique em **selecione**.
    ...
    ![Utilizador](./media/active-directory-conditional-access-app-sign-in-risk/116.png)

3. Como **início de sessão de risco**, selecione **médio**.

    ![Utilizador](./media/active-directory-conditional-access-app-sign-in-risk/119.png)
...
> [Exigir a termos de utilização para ser aceite](./active-directory-conditional-access-tou.md)
