...
O Azure Active Directory Identity Protection analisa a configuração e detecta vulnerabilidades que podem ter um impacto sobre as identidades dos utilizadores. Para obter mais detalhes, consulte [vulnerabilidades detetadas pelo Azure Active Directory Identity Protection](identity-protection/vulnerabilities.md).
...
Pode vincular suas atividades de investigação para o [notificações](identity-protection/notifications.md) Azure Active Directory Protection envia por e-mail.
...
![Política de início de sessão de risco](./media/active-directory-identityprotection/1014.png "política de risco de início de sessão")
...
* Defina os utilizadores e grupos que a política aplica-se a:
    ...
    ![Política de início de sessão de risco](./media/active-directory-identityprotection/1015.png "política de risco de início de sessão")
* Defina o risco de início de sessão ao nível limiar (baixa, média ou alta) que aciona a política:

    ![Política de início de sessão de risco](./media/active-directory-identityprotection/1016.png "política de risco de início de sessão")
* Defina os controlos a serem impostas quando a política aciona:  

    ![Política de início de sessão de risco](./media/active-directory-identityprotection/1017.png "política de risco de início de sessão")
* Alterne o estado da política:

    ![Registo na MFA](./media/active-directory-identityprotection/403.png "registo na MFA")
* Rever e avaliar o impacto de uma alteração antes de ativar ele:

    ![Política de início de sessão de risco](./media/active-directory-identityprotection/1018.png "política de risco de início de sessão")
...
* [Recuperação de início de sessão arriscada](identity-protection/flows.md#risky-sign-in-recovery)
* [Risco início de sessão bloqueado](identity-protection/flows.md#risky-sign-in-blocked)  
* [Experiências de início de sessão com o Azure AD Identity Protection](identity-protection/flows.md)  
...
![Riscos de usuário](./media/active-directory-identityprotection/1031.png "riscos de utilizador")
...
1. Sobre o **do Azure AD Identity Protection** painel, em **investigar**, clique em **eventos de risco**.
    ...
    ![Reposição de palavra-passe manual](./media/active-directory-identityprotection/1002.png "de reposição de palavra-passe Manual")
2. Na **eventos de risco** , clique num risco.

    ![Reposição de palavra-passe manual](./media/active-directory-identityprotection/1003.png "de reposição de palavra-passe Manual")
3. No painel de risco, com o botão direito um utilizador.

    ![Reposição de palavra-passe manual](./media/active-directory-identityprotection/1004.png "de reposição de palavra-passe Manual")
...
1. Sobre o **do Azure AD Identity Protection** painel, clique em **utilizadores sinalizados para risco**.
    ...
    ![Reposição de palavra-passe manual](./media/active-directory-identityprotection/1006.png "de reposição de palavra-passe Manual")
2. Na lista de utilizadores, selecione um utilizador com eventos de risco de pelo menos um.

    ![Reposição de palavra-passe manual](./media/active-directory-identityprotection/1007.png "de reposição de palavra-passe Manual")
3. No painel do utilizador, clique em **Repor palavra-passe**.

    ![Reposição de palavra-passe manual](./media/active-directory-identityprotection/1008.png "de reposição de palavra-passe Manual")
...
![Política de risco do utilizador](./media/active-directory-identityprotection/1009.png "política de risco do utilizador")
...
* Defina os utilizadores e grupos que a política aplica-se a:
    ...
    ![Política de risco do utilizador](./media/active-directory-identityprotection/1010.png "política de risco do utilizador")
* Defina o utilizador risco nível limiar (baixa, média ou alta) que aciona a política:

    ![Política de risco do utilizador](./media/active-directory-identityprotection/1011.png "política de risco do utilizador")
* Defina os controlos a serem impostas quando a política aciona:

    ![Política de risco do utilizador](./media/active-directory-identityprotection/1012.png "política de risco do utilizador")
* Alterne o estado da política:

    ![Política de risco do utilizador](./media/active-directory-identityprotection/403.png "registo na MFA")
* Rever e avaliar o impacto de uma alteração antes de ativar ele:

    ![Política de risco do utilizador](./media/active-directory-identityprotection/1013.png "política de risco do utilizador")
...
* [Comprometido de fluxo de recuperação de conta](identity-protection/flows.md#compromised-account-recovery).  
* [Comprometido fluxo conta bloqueada](identity-protection/flows.md#compromised-account-blocked).  
...
![Política de risco do utilizador](./media/active-directory-identityprotection/1019.png "política de risco do utilizador")
...
* [Fluxo de registo de autenticação multifator](identity-protection/flows.md#multi-factor-authentication-registration).  
* [Experiências de início de sessão com o Azure AD Identity Protection](identity-protection/flows.md).  
...
* [Vulnerabilidades detetadas pelo Azure Active Directory Identity Protection](identity-protection/vulnerabilities.md)

* [Eventos de risco do Azure Active Directory](active-directory-identity-protection-risk-events.md)

* [Notificações do Azure Active Directory Identity Protection](identity-protection/notifications.md)

* [Playbook do Azure Active Directory Identity Protection](identity-protection/playbook.md)

* [Glossário do Azure Active Directory Identity Protection](identity-protection/glossary.md)

* [Experiências de início de sessão com o Azure AD Identity Protection](identity-protection/flows.md)

* [O Azure Active Directory Identity Protection - como desbloquear utilizadores](identity-protection/howto-unblock-user.md)
