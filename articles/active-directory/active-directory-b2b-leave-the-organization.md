...
3. Junto a **organizações**, selecione o ícone de definições (engrenagem).
   ...
   ![Captura de ecrã que mostra as definições de utilizador no painel de acesso](media/active-directory-b2b-leave-the-organization/UserSettings.png) 

3. Em **organizações**, localizar a organização que pretende sair e selecione **deixar a organização**.

   ![Captura de ecrã com a opção de organização deixe na interface de utilizador](media/active-directory-b2b-leave-the-organization/LeaveOrg.png)
...
- Para uma descrição geral do Azure AD B2B, consulte [o que é a colaboração B2B do Azure AD?](active-directory-b2b-what-is-azure-ad-b2b.md)
