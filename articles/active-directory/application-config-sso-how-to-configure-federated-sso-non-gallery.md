...
Segue-se uma descrição dos passos necessários para configurar federado-início de sessão único com SAML 2.0 para uma aplicação (por exemplo, personalizada) não Galeria de alto nível.
