...
Para ativar a identidade gerida atribuído ao sistema durante a criação de uma VM, no **gerenciamento** separador a **identidade** secção, mude **identidade de serviço gerida** para  **No**.  
