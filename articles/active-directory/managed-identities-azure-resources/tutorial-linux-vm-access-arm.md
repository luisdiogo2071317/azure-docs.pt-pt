...
3. Na janela de terminal, através do cURL, envie um pedido às identidades geridas locais para que o ponto final dos recursos do Azure obtenha um token de acesso ao Azure Resource Manager.  
