---
title: Descrição geral do Estado do Azure | Microsoft Docs
description: Uma vista global para o estado de funcionamento dos serviços do Azure.
...
A página de estado do Azure obtém atualizada em tempo real, como o estado de funcionamento de alteração de serviços do Azure. Se deixar a página de estado do Azure aberto, pode controlar a frequência com que a página é atualizada com novos dados. Na parte superior, pode ver a hora da última página foi atualizada.
...
* Saiba como obter uma vista mais granular sobre o estado de funcionamento dos seus recursos Azure específicos com [estado de funcionamento do recurso](./resource-health-overview.md).
