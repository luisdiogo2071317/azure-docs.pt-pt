...
| Ponto de verificação    |Procure **VPN do Azure** no [sites de ponto de verificação](https://supportcenter.checkpoint.com/supportcenter/portal) |
|Juniper |Procure **VPN do Azure** no [Juniper site]( http://www.juniper.net/search/public/)|
