...
2. **As ferramentas deve utilizar para análise de dados?**
   ...
   * [Análise de rotações](https://www.microsoft.com/sql-server/machinelearningserver)
   * [RStudio](http://www.rstudio.com)
   * [Ferramentas do Python para Visual Studio](http://aka.ms/ptvsdocs)
