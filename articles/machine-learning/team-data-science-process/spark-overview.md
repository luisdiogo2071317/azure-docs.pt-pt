---
title: Descrição geral da ciência de dados com o Spark no HDInsight do Azure | Documentos da Microsoft
...
1. tem de ter uma subscrição do Azure. Se ainda não tiver uma, veja [avaliação gratuita do Azure obter](https://azure.microsoft.com/documentation/videos/get-azure-free-trial-for-testing-hadoop-in-hdinsight/).

2. terá de um cluster do Spark 1.6 para concluir estas instruções. Para criar um, veja as instruções fornecidas [começar a utilizar: criar o Apache Spark no Azure HDInsight](../../hdinsight/spark/apache-spark-jupyter-spark-sql.md). O tipo de cluster e a versão é especificada a partir da **selecionar o tipo de Cluster** menu. 
...
> [!TIP]
> Faça duplo clique nos links de no seu browser e selecione **copiar ligação** para obter o URL de conteúdo não processados do github. Pode colar este URL na caixa de diálogo a de Explorador de ficheiros Jupyter carregar.
> 
> 
...
**Exploração de dados e modelação com o Spark:** explorar o conjunto de dados e criar, classificação e avaliar os modelos de machine learning ao trabalhar com o [criar modelos de classificação e regressão binários para dados com o Spark MLlib Kit de ferramentas](spark-data-exploration-modeling.md) tópico.

**Consumo de modelo:** para saber como classificar modelos de classificação e regressão criados neste tópico, consulte o artigo [pontuação e avaliar modelos de aprendizagem automática criados com o Spark](spark-model-consumption.md).
