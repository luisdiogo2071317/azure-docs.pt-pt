...
- Aplicação do Azure Machine Learning Workbench instalada, conforme descrito em [Início Rápido: Instalar e iniciar os serviços do Azure Machine Learning](quickstart-installation.md). 
...
Uma das execuções tem um AUC melhor, pelo que é este que vai ser utilizado quando criar um serviço Web de classificação para implementação em produção. Para tal, tem primeiro de promover os artefactos para um elemento.
