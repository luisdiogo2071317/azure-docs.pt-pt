...
>[!NOTE]
> Embora tenha criado a conta de gestão de modelos, o seu ambiente ainda não está configurado para implementar serviços Web. Saiba como configurar o [ambiente de implementação](deployment-setup-configuration.md).
