...
Depois de recarregar o Visual Studio, a extensão é ativada. [Saiba mais sobre como encontrar extensões](hhttps://docs.microsoft.com/en-us/visualstudio/ide/finding-and-using-visual-studio-extensions).
