...
ms.locfileid: "47220873"
---
# <a name="tutorial-train-a-classification-model-with-automated-machine-learning-in-azure-machine-learning"></a>Tutorial: Preparar um modelo de classificação com aprendizagem automática automatizada no Azure Machine Learning

Neste tutorial, vai aprender a gerar um modelo de machine learning com aprendizagem automática automatizada (ML automatizado).  O Azure Machine Learning pode executar o pré-processamento de dados, a seleção de algoritmos e a seleção de hiperparâmetros de forma automatizada. O modelo final pode ser depois implementado seguindo o fluxo de trabalho no tutorial [Implementar um modelo](tutorial-deploy-models-with-aml.md).

[ ![diagrama de fluxo](./media/tutorial-auto-train-models/flow2.png) ](./media/tutorial-auto-train-models/flow2.png#lightbox)
...
Para sua comodidade, este tutorial está disponível como bloco de notas do Jupyter. Utilize um destes métodos para executar o bloco de notas `tutorials/03.auto-train-models.ipynb`:
...
|**exit_score**|0,995|Valor *duplo* que indica o destino para *primary_metric*. Assim que o destino for ultrapassado, a execução termina|
...
Saiba mais sobre [como configurar as definições para preparação automática]() ou [como utilizar a preparação automática num recurso remoto](how-to-auto-train-remote.md).  
