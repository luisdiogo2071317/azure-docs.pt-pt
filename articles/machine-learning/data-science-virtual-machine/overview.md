...
| **Ferramenta**                                                           | **Windows Edition** | **Edição do Linux** |
| :------------------------------------------------------------------ |:-------------------:|:------------------:|
...
| &nbsp;&nbsp;&nbsp;&nbsp;* [Visual Studio 2017 (edição Community)](https://www.visualstudio.com/community/) > com o plug-in do Git, o Azure HDInsight (Hadoop), o Data Lake, ferramentas de dados do SQL Server, [Node.js](https://github.com/Microsoft/nodejstools), [Python](http://aka.ms/ptvs), e [R ferramentas Visual Studio (RTVS)](http://microsoft.github.io/RTVS-docs/) | S | N |
...
| &nbsp;&nbsp;&nbsp;&nbsp;* [Controlador FUSE de blob](https://github.com/Azure/azure-storage-fuse) | N | S |
...
| **Com base em GPU avançada, ferramentas de aprendizagem** |Edição do Windows Server 2016  | S |
...
| &nbsp;&nbsp;&nbsp;&nbsp;* [Servidor MXNet modelo](https://github.com/awslabs/mxnet-model-server) | N | S |
| &nbsp;&nbsp;&nbsp;&nbsp;* [Servir TensorFlow](https://www.tensorflow.org/serving/) | N | S |
...
* Criar uma instância da edição de Linux DSVM pretendida, acedendo a 
  ...
  * [CentOS com base em DSVM](http://aka.ms/dsvm/centos)
