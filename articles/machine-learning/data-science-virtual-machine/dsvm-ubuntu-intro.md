...
Keras é uma rede neural alto nível API em Python, que é capaz de executar na parte superior do TensorFlow, Microsoft Cognitive Toolkit ou Theano. Está disponível nos ambientes de Python de raiz e py35. 
