...
- [Azure Machine Learning Workbench](../service/overview-what-is-azure-ml.md)
    - Siga o [instalar e criar o guia de introdução](../service/quickstart-installation.md) para instalar o Workbench do Azure Machine Learning e criar a experimentação e contas de gestão de modelo.
