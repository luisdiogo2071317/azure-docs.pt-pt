...
Criar uma conta de experimentação do Machine Learning e instalar a aplicação do Azure Machine Learning Workbench. Para obter mais informações, consulte [instalar e criar o guia de introdução](../service/quickstart-installation.md).
