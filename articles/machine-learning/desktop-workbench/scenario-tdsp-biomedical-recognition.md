...
* Azure Machine Learning Workbench. Ver [guia de instalação](quickstart-installation.md). Atualmente, o Azure Machine Learning Workbench pode ser instalado nos seguintes sistemas operativos apenas: 
