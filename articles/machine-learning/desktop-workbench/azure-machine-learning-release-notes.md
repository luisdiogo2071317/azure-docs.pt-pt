...
ms.locfileid: "35647819"
---
# <a name="whats-new-in-azure-machine-learning"></a>Novidades do Azure Machine Learning

Neste artigo, saiba mais sobre as novas versões do [do Azure Machine Learning](../service/overview-what-is-azure-ml.md). 
...
+ Criar e implementar elevada precisão de aprendizagem automática e modelos de aprendizagem profunda com rapidamente [personalizado pacotes do Azure Machine Learning](../service/reference-python-package-overview.md) para os seguintes domínios:
...
**Número de versão**: 0.1.1801.24353 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;([encontrar a versão](../service/known-issues-and-troubleshooting-guide.md#find-the-workbench-build-number))
...
**Número de versão**: 0.1.1712.18263 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;([encontrar a versão](../service/known-issues-and-troubleshooting-guide.md#find-the-workbench-build-number))
...
**Número de versão**: 0.1.1711.15323 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;([encontrar a versão](../service/known-issues-and-troubleshooting-guide.md#find-the-workbench-build-number))
...
**Número de versão**: 0.1.1711.15263 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;([encontrar a versão](../service/known-issues-and-troubleshooting-guide.md#find-the-workbench-build-number))
...
- [Suporte para SQL Server e o Azure SQL DB como uma origem de dados](data-prep-appendix2-supported-data-sources.md#types) 
...
**Número de versão**: 0.1.1710.31013 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;([encontrar a versão](../service/known-issues-and-troubleshooting-guide.md#find-the-workbench-build-number))
...
#### <a name="sample-projects"></a>Projetos de exemplo
- [_Classificar íris_ ](./tutorial-classifying-iris-part-1.md) projeto de exemplo:
...
- [_Advanced preparação de dados com dados de partilha de bicicletas_ ](./tutorial-bikeshare-dataprep.md) projeto de exemplo "Lidar com valor de erro" passo fixado.
...
- [_Otimização de hiper-parâmetros distribuída_ ](./scenario-distributed-tuning-of-hyperparameters.md) projeto de exemplo`docker.runconfig` formato atualizado de JSON para YAML.
- Novo projeto de exemplo [ _classificação de imagens com o CNTK_](./scenario-image-classification-using-cntk.md).
