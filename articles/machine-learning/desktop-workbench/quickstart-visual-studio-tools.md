...
Depois de recarregar o Visual Studio, a extensão é ativada. [Saiba mais sobre como encontrar extensões](https://docs.microsoft.com/visualstudio/ide/finding-and-using-visual-studio-extensions).
