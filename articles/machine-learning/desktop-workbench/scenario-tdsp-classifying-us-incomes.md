...
4. Certifique-se de que tem instalado corretamente Azure Machine Learning, o [guia de instalação de início rápido](../service/quickstart-installation.md).
