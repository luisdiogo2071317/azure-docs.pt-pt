...
1. Na janela da CLI, inicie sessão no Azure. [Obter mais informações sobre o comando az login](https://docs.microsoft.com/en-us/cli/azure/authenticate-azure-cli?view=azure-cli-latest).
