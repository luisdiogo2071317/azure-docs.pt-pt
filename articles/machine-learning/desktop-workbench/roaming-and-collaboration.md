...
1. Instale o Machine Learning aplicação Workbench. Certifique-se de que tem acesso a uma conta do Azure Machine Learning experimentação. Para obter mais informações, consulte o [guia de instalação](../service/quickstart-installation.md).
