...
* Certifique-se de que tem instalado corretamente [Azure Machine Learning Workbench](../service/overview-what-is-azure-ml.md) seguindo o [instalar e criar o guia de introdução](../service/quickstart-installation.md).
