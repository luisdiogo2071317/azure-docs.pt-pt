...
>[!Note]
>**Este artigo foi preterido.** Suporte para versões anteriores deste serviço irá terminar a forma incremental. [Ver a linha cronológica de suporte](../service/overview-what-happened-to-workbench.md#timeline). Leitura a [mais recente artigo](../service/how-to-export-delete-data.md) sobre esse tópico.
