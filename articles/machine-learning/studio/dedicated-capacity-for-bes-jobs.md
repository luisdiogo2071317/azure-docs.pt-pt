---
title: Capacidade dedicada para o machine learning de lote de tarefas do serviço de execução - Azure Machine Learning Studio | Documentos da Microsoft
description: Descrição geral dos serviços do Azure Batch para trabalhos de Machine Learning.
