...
---
# <a name="retrain-a-new-resource-manager-based-web-service-using-powershell"></a>Voltar a preparar um novo serviço web baseado no Resource Manager com o Powershell
