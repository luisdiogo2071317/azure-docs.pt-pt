---
title: Criar módulos personalizados do R no Azure Machine Learning | Documentos da Microsoft
description: Guia de introdução para a criação de módulos R personalizados no Azure Machine Learning.
