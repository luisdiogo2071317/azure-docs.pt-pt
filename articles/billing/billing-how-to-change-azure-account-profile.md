---
title: Alterar as informações de perfil de conta do Azure | Documentos da Microsoft
description: Descreve como alterar o perfil da sua conta do Azure e responde a perguntas comuns, como por que não é possível alterar o país no Centro de contas do Azure
services: ''
documentationcenter: ''
author: genlin
manager: alherz
...
O endereço de e-mail no perfil de administrador de conta é utilizado pela Microsoft para notificá-lo sobre atualizações importantes relacionados com faturação sobre a subscrição. Recomendamos que especifica um endereço de correio eletrónico de contacto que verificar regularmente.

## <a name="how-to-change-your-profile-information"></a>Como alterar as informações do perfil

1. Inicie sessão no [Centro de Contas do Azure](https://account.azure.com/Profile).
1. Selecione o botão **Editar detalhes** e, em seguida, atualize as informações do **Perfil**.
