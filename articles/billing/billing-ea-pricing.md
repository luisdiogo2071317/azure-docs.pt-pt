---
title: Veja os preços do Azure para a sua empresa | Documentos da Microsoft
description: Saiba como ver e transferir a preços ou estimar os custos com os preços do Enterprise Agreement.
services: ''
documentationcenter: ''
author: adpick
manager: dougeby
...
ms.locfileid: "54904238"
---
# <a name="view-your-organizations-azure-enterprise-agreement-pricing"></a>Veja os preços de contrato Enterprise do Azure da sua organização 

Os clientes do Azure com um contrato Enterprise (EA) podem ver e transferir EA preços a partir do portal do Azure. Também pode usar EA da sua organização, os preços de estimar os custos ao utilizar a Calculadora de preços do Azure.
...
## <a name="estimate-costs-with-ea-pricing"></a>Estimar os custos com preços de EA
...
- [Compreender a sua fatura para clientes do Azure com um contrato Enterprise](billing-understand-your-bill-ea.md)
