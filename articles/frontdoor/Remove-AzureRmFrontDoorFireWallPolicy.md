...
ms.locfileid: "47047922"
---
# Remove-AzureRmFrontDoorFireWallPolicy
Remover política do WAF
...
## DESCRIÇÃO
O **Remove-AzureRmFrontDoor** cmdlet Remove uma política de WAF na subscrição atual
...
Remova a política de WAF chamada $name no $resourceGroup.
...
Remova todas as políticas de WAF $resourceGroup.
...
### -InputObject
O objeto de política de WAF para eliminar.
...
### -Nome
O nome da política de WAF para eliminar.
...
### -ResourceGroupName
O grupo de recursos a que pertence a política de WAF.
...
### -ResourceId
Id de recurso da política de WAF para eliminar
