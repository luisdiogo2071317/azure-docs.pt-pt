...
ms.locfileid: "47047826"
---
# Novo AzureRmFrontDoorFrontendEndpointObject

Criar um objeto de PSFrontendEndpoint para criação de porta de entrada
...
### -CertificateType
o tipo de certificado utilizado para ligações seguras para um frontendEndpoint
...
### -Nome do anfitrião
O nome de anfitrião do frontendEndpoint.
Tem de ser um nome de domínio.
...
### -Nome
Nome do ponto final de front-end.
...
### -Tipodeprotocolo
O protocolo de extensão TLS que é utilizado para entrega segura
...
### -SecretName
O nome do segredo do Key Vault, que representa o total certificado PFX
...
### -SecretVersion
A versão do segredo do Key Vault, que representa o total certificado PFX
...
Se é permitido a afinidade de sessão neste anfitrião.
Valor predefinido está desativado
...
O valor de TTL para utilizar em segundos para a afinidade de sessão, se aplicável. Valor predefinido é 0
...
### -WebApplicationFirewallPolicyLink
O id de recurso da política de Firewall de aplicações Web para cada anfitrião (se aplicável)
