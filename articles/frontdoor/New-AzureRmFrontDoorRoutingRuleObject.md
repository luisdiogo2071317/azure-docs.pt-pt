...
ms.locfileid: "47047898"
---
# Novo AzureRmFrontDoorRoutingRuleObject
Criar um PSRoutingRuleObject para a criação de porta de entrada
...
### Exemplo 1: Criar um PSRoutingRuleObject para a criação de porta de entrada
```powershell
...
### -AcceptedProtocol
Esquemas de protocolo a corresponder para esta regra.
Valor predefinido é Https, Http
...
### -BackendPoolName
Id de recurso do BackendPool que esta regra encaminha para
...
### -CustomForwardingPath
Caminho personalizado utilizado para reescrever os caminhos de recurso correspondidos por esta regra.
Deixe em branco para utilizar o caminho de entrada.
...
### -DynamicCompression
Se pretende ativar a compressão dinâmica de conteúdo em cache quando a colocação em cache está ativada.
Valor predefinido está ativado
...
### -EnableCaching
Se pretende ativar a colocação em cache para esta rota. Valor predefinido é false
...
### -EnabledState
Se pretende ativar a utilização desta regra.
Valor predefinido está ativado
...
### -ForwardingProtocol
O protocolo esta regra irá utilizar quando a reencaminhar o tráfego para o valor predefinido de back-ends é MatchRequest.
...
Os nomes dos pontos finais de front-end associados a esta regra
...
### -PatternToMatch
Os padrões de rota da regra, não pode ter qualquer *, possivelmente, exceto após o último / no final do caminho. Valor predefinido é / *
...
O tratamento de consulta de URL de termos quando que formam a chave de cache.
Valor predefinido é StripAll
