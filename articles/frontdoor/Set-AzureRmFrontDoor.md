...
ms.locfileid: "47048239"
---
# Conjunto AzureRmFrontDoor
Atualizar um balanceador de carga de porta de entrada
...
## DESCRIÇÃO
O **Set-AzureRmFrontDoor** cmdlet atualiza um balanceador de carga de porta de entrada. Se não forem fornecidos parâmetros de entrada, serão utilizados antigos parâmetros de desde o início existente.

## EXEMPLOS

### Exemplo 1: Atualize uma porta de entrada existente com FrontDoorName e ResourceGroupName.
```powershell
...
### Exemplo 2: Atualize uma porta de entrada existente com o objeto de PSFrontDoor.
```powershell
...
### Exemplo 3: atualizar uma existente porta de entrada com ResourceId
```powershell
...
### -BackendPool
Backendpools disponíveis para a regra de encaminhamento.
...
### -EnabledState
Estado operacional do porta de entrada do Balanceador de carga.
...
### -FrontendEndpoint
Pontos finais front-end disponíveis para a regra de encaminhamento.
...
### -HealthProbeSetting
Definições de sonda de estado de funcionamento associadas a esta instância de porta de entrada.
...
### -InputObject
O objeto de porta de entrada para atualizar.
...
As definições associadas esta instância de porta de entrada de balanceamento de carga.
...
### -Nome
O nome do desde início para atualizar.
...
### -ResourceGroupName
O grupo de recursos a que pertence a porta de entrada.
...
### -ResourceId
Id de recurso de desde o início para atualizar
...
### -RoutingRule
Regras de encaminhamento associadas a este FrontDoor
...
### -Etiqueta
As etiquetas de associar o FrontDoor.
