---
title: O Azure Time Series Insights adicionar um hub de eventos - adicionar dos Hubs de eventos origem do evento para o Azure Time Series Insights | Documentos da Microsoft
