...
3. Selecione **+ grupo de consumidores** para adicionar um novo grupo de consumidor. 

4. Sobre o **grupos de consumidores** , indique um novo exclusivo **nome**.  Utilize este nome de mesmo ao criar uma nova origem de evento no ambiente do Time Series Insights.
...
9. Se tiver selecionado o **definições do Hub de eventos de fornecer manualmente** opção, a tabela seguinte explica cada propriedade necessária:
...
10. Adicione o nome de grupo consumidor dedicado TSI adicionado ao seu hub de eventos.
