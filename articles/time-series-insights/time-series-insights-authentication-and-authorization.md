---
title: Autenticação do Azure Time Series Insights - como autenticar e autorizar pela API no Azure Time Series Insights | Documentos da Microsoft
