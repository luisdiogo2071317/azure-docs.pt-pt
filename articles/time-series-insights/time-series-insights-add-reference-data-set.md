---
title: Como adicionar um conjunto de dados de referência para o seu ambiente do Azure Time Series Insights
...
7. Fornece os dados, através de um dos dois métodos:
   ...
   Por exemplo, cole os dados CSV: ![dados colados CSV](media/add-reference-data-set/csv_data_pasted.png)
