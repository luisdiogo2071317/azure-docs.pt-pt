---
title: Melhores práticas para formatação JSON em consultas do Azure Time Series Insights.
description: Saiba como melhorar sua eficiência de consulta do Time Series Insights.
