...
* Se utilizar o r Studio para a área de trabalho como seu IDE, também instalar a partir do Microsoft R Client [ http://aka.ms/rclient/ ](http://aka.ms/rclient/). 
