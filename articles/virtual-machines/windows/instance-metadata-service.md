...
Serviço de metadados de instância do Azure é um ponto final REST acessíveis a todas as VMs de IaaS criados através da [do Azure Resource Manager](https://docs.microsoft.com/rest/api/resources/).
