...
2. No menu à esquerda, selecione **todos os recursos**. Pode ordenar os recursos por **tipo** encontrar facilmente as imagens.
...
Crie a sub-rede. Este exemplo cria uma sub-rede designada **mySubnet** com o prefixo de endereço de **10.0.0.0/24**.  
...
Criar a rede virtual. Este exemplo cria uma rede virtual denominada **myVnet** com o prefixo de endereço de **10.0.0.0/16**.  
...
Crie um endereço IP público. Este exemplo cria um endereço IP público com o nome **myPip**. 
...
Criar o NIC. Este exemplo cria um NIC com o nome **myNic**. 
...
Crie variáveis para o nome da VM e o nome de computador. Neste exemplo define o nome da VM como **myVM** e o nome do computador como **myComputer**.
...
Defina o tamanho da máquina virtual. Este exemplo cria **Standard_DS1_v2** tamanho de VM. Consulte o [tamanhos de VM](https://azure.microsoft.com/documentation/articles/virtual-machines-windows-sizes/) documentação para obter mais informações.

```azurepowershell-interactive
$vmSize = "Standard_DS1_v2"
```

Adicione o nome da VM e o tamanho para a configuração de VM.
