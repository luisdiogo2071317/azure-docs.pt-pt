---
title: Executar scripts uma VM do Windows Azure
...
O [extensão de Script personalizado](../extensions/custom-script-windows.md) é principalmente utilizado para a instalação de software e configuração de implementação do post.
