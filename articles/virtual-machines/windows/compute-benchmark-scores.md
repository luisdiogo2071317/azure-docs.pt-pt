---
title: Calcular as pontuações de benchmark para VMs do Windows Azure | Microsoft Docs
description: Compare pontuações de benchmark de computação SPECint para VMs do Azure com o Windows Server.
