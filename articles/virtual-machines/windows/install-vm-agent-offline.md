...
2.  Anexar o disco do SO como um disco de dados para outra VM (conhecido como um _resolução de problemas de_ VM). Para obter mais informações, consulte [anexar um disco de dados a uma VM do Windows no portal do Azure](attach-managed-disk-portal.md).
...
- [Extensões de máquina virtual e funcionalidades para Windows](extensions-features.md)
