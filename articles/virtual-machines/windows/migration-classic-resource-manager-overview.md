---
title: Migrar recursos clássicos para Azure Resource Manager - descrição geral | Documentos da Microsoft
description: Este artigo explica a migração suportada por plataforma de recursos da implementação clássica para Azure Resource Manager
...
* [Gateway de VPN clássico para migração do Gestor de recursos](https://docs.microsoft.com/en-us/azure/vpn-gateway/vpn-gateway-classic-resource-manager-migration)
