...
## [Extensões de VMs](agents-and-extensions-classic.md)
## [Disponibilidade](configure-availability-classic.md)
## [FAQ](faq-classic.md)

# Introdução
## [Criar uma VM de Linux](createportal-classic.md)

# Procedimento
## Computação
### [Criar uma VM personalizada](create-custom-classic.md)
### [Capturar uma VM](capture-image-classic.md)
### [Utilizar o Ambiente de Trabalho Remoto com uma VM do Linux](remote-desktop-classic.md)
...
### [Repor palavras-passe ou chaves do Linux, corrigir SSH e verificar discos](reset-access-classic.md)
...
## Executar aplicações
### [Aplicação Web Ruby on Rails](ruby-rails-web-app.md)
...
#### [Gerir um cluster com nós do Linux](hpcpack-cluster.md)
