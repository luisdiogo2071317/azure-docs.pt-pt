...
Passo 2. Execute **extensão de vm do azure definir vm_name LinuxDiagnostic Microsoft.OSTCExtensions 2.\* – o caminho de configuração privada PrivateConfig.json**.
