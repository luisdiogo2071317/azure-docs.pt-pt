---
title: Resolver erros de eliminação de recursos de armazenamento numa implementação do Azure Resource Manager em VMs do Linux | Microsoft Docs
