...
description: Neste tutorial, irá aprender a utilizar a CLI 2.0 do Azure para proteger uma máquina virtual com Linux que executa o servidor Web NGINX com certificados SSL armazenados no Azure Key Vault.
