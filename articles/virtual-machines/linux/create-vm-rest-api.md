...
Para obter mais informações sobre as APIs de REST do Azure ou outras ferramentas de gestão, como a CLI 2.0 do Azure ou do Azure PowerShell, consulte o seguinte:
