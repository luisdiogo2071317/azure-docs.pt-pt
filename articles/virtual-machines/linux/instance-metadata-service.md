...
Também pode aproveitar [zonas de disponibilidade](../../availability-zones/az-overview.md) para as instâncias tomar essas decisões. Pode consultar estes dados diretamente através do serviço de metadados de instância.
