...
Agora, crie uma VM com [az vm criar](/cli/azure/vm#az_vm_create) e especifique o ficheiro de nuvem init com `--custom-data cloud_init_swapfile.txt` da seguinte forma:
