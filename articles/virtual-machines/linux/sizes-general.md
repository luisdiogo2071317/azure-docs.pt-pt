---
title: Tamanhos de VM Linux do Azure - fins gerais | Microsoft Docs
description: Lista os tamanhos de objetivo geral diferentes disponíveis para computadores virtuais Linux no Azure. Apresenta informações sobre o número de vCPUs, discos de dados e NICs, bem como armazenamento débito e a rede de largura de banda para tamanhos de nesta série.
