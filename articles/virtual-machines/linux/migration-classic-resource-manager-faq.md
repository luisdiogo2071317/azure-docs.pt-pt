---
title: Perguntas mais frequentes sobre clássico para migração do Azure Resource Manager | Microsoft Docs
description: Perguntas mais frequentes sobre clássico para migração do Gestor de recursos do Azure
