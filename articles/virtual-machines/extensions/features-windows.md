...
O `Set-AzureRmVMExtension` comando pode ser utilizado para iniciar qualquer extensão de VM. Para obter mais informações, consulte a [Set-AzureRmVMExtension referência](https://msdn.microsoft.com/library/mt603745.aspx).
