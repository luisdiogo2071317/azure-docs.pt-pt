---
title: Extensão DSC do Azure para Linux | Documentos da Microsoft
...
A extensão DSC Linux oferece suporte a todos os [do extensão suportada SO](https://azurewiki.cloudapp.netVMAgentExtension/extensionSupportedOSs) , exceto:
