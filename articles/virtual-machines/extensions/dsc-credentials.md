...
- Obter um [introdução ao processador de extensão de DSC do Azure](dsc-overview.md).
- Examine o [modelo Azure Resource Manager para a extensão de DSC](dsc-template.md).
