...
> [!IMPORTANT]
> Para obter informações sobre a versão mais antiga e 2.3, consulte [neste documento](../linux/classic/diagnostic-extension-v2.md).
...
Pode ativar esta extensão utilizando os cmdlets do Azure PowerShell, scripts da CLI do Azure ou modelos de implementação do Azure. Para obter mais informações, consulte [extensões funcionalidades](features-linux.md).
...
* Saiba como [criar um conjunto de dimensionamento de máquina virtual](../linux/tutorial-create-vmss.md) utilizar métricas para controlar o dimensionamento automático.
