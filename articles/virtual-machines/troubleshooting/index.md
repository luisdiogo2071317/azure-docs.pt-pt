---
layout: LandingPage
description: Aprenda a criar resoluções de problemas de implementação de máquina virtual.
...
- Falhas de alocação
    ...
    - [ Falhas de atribuição para implementações clássicas  ](allocation-failure-classic.md)
...
- [Reinícios inesperados de VMs com VHDs ligadas  ](unexpected-reboots-attached-vhds.md)
