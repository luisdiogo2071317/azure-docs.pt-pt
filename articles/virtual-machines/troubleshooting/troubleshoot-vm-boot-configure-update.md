...
Este artigo ajuda-o a resolver o problema quando está bloqueada a Máquina Virtual (VM) sobre o "introdução Windows pronto. Não desativar o seu computador." estágio durante o arranque.
