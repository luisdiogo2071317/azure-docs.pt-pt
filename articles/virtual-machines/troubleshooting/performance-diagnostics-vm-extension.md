...
O `Set-AzVMExtension` comando pode ser utilizado para implementar a extensão de VM de diagnóstico de desempenho do Azure para uma máquina virtual existente.
