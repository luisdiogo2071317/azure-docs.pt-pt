...
Este script copia um disco gerido para uma subscrição idêntica ou diferente na mesma região. Tem de ser um Administrador Global de inquilinos do AAD de ambos os subscrição para executar este script.
