...
- Utilize Premium SSDs em HDDs padrão. Para saber mais sobre os tipos de disco disponível, consulte nosso artigo [selecione um tipo de disco](../../windows/disks-types.md)
