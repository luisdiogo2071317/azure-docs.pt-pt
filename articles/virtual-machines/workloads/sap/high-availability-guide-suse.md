...
* [SUSE SAP HA melhor prática guias] [ suse-ha-guide] os guias contém informações de todas as necessárias para configurar Netweaver HA e replicação do sistema de SAP HANA no local. . Utilize que esta orienta como uma linha de base geral. Fornecem informações detalhadas muito mais.
