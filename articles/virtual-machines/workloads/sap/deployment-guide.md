...
[dbms-guide-2.1]:dbms-guide.md#c7abf1f0-c927-4a7c-9c1d-c7b5b3b7212f (A colocação em cache para VMs e VHDs)
...
[dbms-guide-3]:dbms-guide.md#871dfc27-e509-4222-9370-ab1de77021c3 (Elevada disponibilidade e recuperação após desastre com as VMs do Azure)
...
[dbms-guide-5.6]:dbms-guide.md#1b353e38-21b3-4310-aeb6-a77e7c8e81c8 (Utilizar uma imagem de servidor de SQL do Azure Marketplace)
[dbms-guide-5.8]:dbms-guide.md#9053f720-6f3b-4483-904d-15dc54141e30 (Geral SQL Server para SAP no resumo do Azure)
...
[dbms-guide-8.4.3]:dbms-guide.md#77cd2fbb-307e-4cbf-a65f-745553f72d2c (Considerações de desempenho para cópia de segurança e restauro)
...
[deployment-guide-3.1.2]:deployment-guide.md#3688666f-281f-425b-a312-a77e7db2dfab (Implementar uma VM utilizando uma imagem personalizada)
[deployment-guide-3.2]:deployment-guide.md#db477013-9060-4602-9ad4-b0316f8bb281 (Cenário 1: Implementar uma VM do Azure Marketplace para SAP)
...
[deployment-guide-3.4]:deployment-guide.md#a9a60133-a763-4de8-8986-ac0fa33aa8c1 (Cenário 3: Mover uma VM no local através de um VHD de Azure não generalizado com SAP)
...
[deployment-guide-4.1]:deployment-guide.md#604bcec2-8b6e-48d2-a944-61b0f5dee2f7 (Cmdlets de implementação do Azure PowerShell)
[deployment-guide-4.2]:deployment-guide.md#7ccf6c3e-97ae-4a7a-9c75-e82c37beb18e (Transferir e importar os cmdlets do PowerShell SAP relevantes)
[deployment-guide-4.3]:deployment-guide.md#31d9ecd6-b136-4c73-b61e-da4a29bbc9cc (Associar uma VM a um domínio no local - apenas o Windows)
...
[deployment-guide-5.2]:deployment-guide.md#e2d592ff-b4ea-4a53-a91a-e5521edb6cd1 (Verificação de estado de funcionamento para a infraestrutura de monitorização do Azure)
...
[deployment-guide-troubleshooting-chapter]:deployment-guide.md#564adb4f-5c95-4041-9616-6635e83a810b (Verificações e a resolução de problemas para configurar a monitorização ponto a ponto)
...
[planning-guide]:planning-guide.md (Azure máquinas virtuais de planeamento e implementação de SAP)
[planning-guide-1.2]:planning-guide.md#e55d1e22-c2c8-460b-9897-64622a34fdff (Recursos)
[planning-guide-11]:planning-guide.md#7cf991a1-badd-40a9-944e-7baae842a058 (Elevada disponibilidade e recuperação após desastre para NetWeaver SAP em execução em Azure Virtual Machines)
...
[planning-guide-11.5]:planning-guide.md#4e165b58-74ca-474f-a7f4-5e695a93204f (Utilizar o início automático para instâncias SAP)
[planning-guide-2.1]:planning-guide.md#1625df66-4cc6-4d60-9202-de8a0b77f803 (Apenas na nuvem - implementações de Máquina Virtual no Azure sem dependências na rede de cliente no local)
[planning-guide-2.2]:planning-guide.md#f5b3b18c-302c-4bd8-9ab2-c388f1ab3d10 (Totalmente integrado em vários locais - implementação do único ou vários SAP VMs no Azure com a rede no local)
...
[planning-guide-5.1.1]:planning-guide.md#4d175f1b-7353-4137-9d2f-817683c26e53 (Mover uma VM no local para o Azure com um disco não generalizado)
...
[planning-guide-5.2.1]:planning-guide.md#1b287330-944b-495d-9ea7-94b83aff73ef (Preparação para mover uma VM no local para o Azure com um disco não generalizado)
[planning-guide-5.2.2]:planning-guide.md#57f32b1c-0cba-4e57-ab6e-c39fe22b6ec3 (Preparação para implementar uma VM com uma imagem específica do cliente para SAP)
[planning-guide-5.2]:planning-guide.md#6ffb9f41-a292-40bf-9e70-8204448559e7 (Preparar as VMs com SAP para o Azure)
...
[planning-guide-5.5.1]:planning-guide.md#4efec401-91e0-40c0-8e64-f2dceadff646 (Estrutura do VM/VHD para as implementações de SAP)
[planning-guide-5.5.3]:planning-guide.md#17e0d543-7e8c-4160-a7da-dd7117a1ad9d (Definição automount para discos ligados)
[planning-guide-7.1]:planning-guide.md#3e9c3690-da67-421a-bc3f-12c520d99a30 (VM única com SAP NetWeaver demonstração/formação cenário)
[planning-guide-7]:planning-guide.md#96a77628-a05e-475d-9df3-fb82217e8f14 (Conceitos de implementação apenas de nuvem de instâncias SAP)
[planning-guide-9.1]:planning-guide.md#6f0a47f3-a289-4090-a053-2521618a28c3 (Azure solução de monitorização para SAP)
...
[planning-guide-microsoft-azure-networking]:planning-guide.md#61678387-8868-435d-9f8c-450b2424f5bd (Funcionamento em rede do Microsoft Azure)
...
[virtual-machines-linux-cli-deploy-templates]:../../linux/cli-deploy-templates.md (Implementar e gerir máquinas virtuais utilizando modelos Azure Resource Manager e a CLI do Azure)
