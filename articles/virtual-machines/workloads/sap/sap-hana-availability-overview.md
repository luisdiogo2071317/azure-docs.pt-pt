...
- Saiba mais sobre [disponibilidade de SAP HANA dentro de uma região do Azure](https://docs.microsoft.com/en-us/azure/virtual-machines/workloads/sap/sap-hana-availability-one-region).
- Saiba mais sobre [disponibilidade de SAP HANA em regiões do Azure](https://docs.microsoft.com/en-us/azure/virtual-machines/workloads/sap/sap-hana-availability-across-regions). 
