...
Utilize o comando [kubectl apply][kubectl-apply] para executar a aplicação. Este comando analisa o ficheiro de manifesto e cria os objetos de Kubernetes definidos.
