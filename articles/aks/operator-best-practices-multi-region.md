...
* Encaminhar o tráfego entre vários clusters com o Gestor de tráfego do Azure
* Utilizar a georreplicação para os registos de imagem de contentor
