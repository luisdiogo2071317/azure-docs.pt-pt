---
title: Instalar pacotes num bloco de notas do Jupyter no Azure | Documentos da Microsoft
description: Como instalar o Python, R, e F# pacotes de dentro de um bloco de notas.
