...
Filtros de IP do seu IoT Hub podem ser recuperados e definidos através de [do Azure PowerShell](https://docs.microsoft.com/powershell/azure/overview?view=azps-1.2.0). 
