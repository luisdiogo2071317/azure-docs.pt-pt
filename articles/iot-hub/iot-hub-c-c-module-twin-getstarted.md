...
* Uma conta ativa do Azure. (Se não tiver uma conta, pode criar uma [conta gratuita do Azure](http://azure.microsoft.com/pricing/free-trial/) em apenas alguns minutos.)
* Um Hub IoT.
