...
1. Numa janela de terminal, navegue para a pasta raiz do projeto Node.js de exemplo. Em seguida, navegue para a pasta **Quickstarts\simulated-device-2**.
...
1. Noutra janela de terminal, navegue para a pasta raiz do projeto Node.js de exemplo. Em seguida, navegue para a pasta **Quickstarts\back-end-application**.
...
> [Tutorial: encaminhar telemetria para pontos finais diferentes para processamento](iot-hub-node-node-process-d2c.md)