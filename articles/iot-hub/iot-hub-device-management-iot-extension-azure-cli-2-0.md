...
Um do duplo comunicadas propriedades é $metadata. $lastUpdated que mostra a última vez que a aplicação de dispositivo atualizar o conjunto de propriedade comunicados.
