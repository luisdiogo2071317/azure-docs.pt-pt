...
* Uma versão completa do trabalho do [introdução ao IoT Hub](iot-hub-java-java-getstarted.md) ou [mensagens de dispositivo para a nuvem do IoT Hub do processo](tutorial-routing.md) tutorial.
