...
Utilizar a funcionalidade de AC X.509 requer que tenha uma conta do IoT Hub.  [Saiba como criar uma instância do IoT Hub](iot-hub-csharp-csharp-getstarted.md) se ainda não tiver uma.
