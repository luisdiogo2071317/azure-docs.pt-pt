...
**TriggerFWUpdate**, que liga ao seu IoT hub com a identidade de dispositivo que criou anteriormente, recebe um método direto firmwareUpdate, é executada através de um processo com múltiplos estado para simular a atualização de firmware, incluindo: a aguardar que a transferência de imagem Transferir a nova imagem e, finalmente, aplicar a imagem.
