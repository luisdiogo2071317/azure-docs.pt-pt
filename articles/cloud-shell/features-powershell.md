...
|**Categoria**    |**Nome**                                 |
|----------------|-----------------------------------------|
|Ferramentas do Azure     |[Azure PowerShell (5.2.0)](https://docs.microsoft.com/powershell/azure/overview)<br> [CLI do Azure (2.0.26)](https://docs.microsoft.com/cli/azure/overview)|
