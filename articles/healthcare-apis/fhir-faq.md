...
**Os dados por trás do FHIR&reg; APIs armazenados no Azure?** Sim, os dados são armazenados em bases de dados geridas no Azure. A API do Azure para FHIR não fornece acesso direto ao armazenamento de dados subjacente.
