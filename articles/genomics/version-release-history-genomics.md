...
O cliente atual do Python é versão 0.7.4. Foi lançada de 2018 5 de Março e utiliza GATK 3.3. 
...
Versão 0.7.4 inclui suporte para tokens SAS em vez de chaves de conta na aceitar o `config.txt` entrada. Para obter mais informações, consulte [início rápido de tokens SAS de entrada](quickstart-input-sas.md). 

### <a name="version-073"></a>Versão 0.7.3
Versão 0.7.3 inclui pequenas correções de erros

### <a name="version-072"></a>Versão 0.7.2
Versão 0.7.2 é a versão inicial. Foi lançada 1 de Novembro de 2017 e utiliza GATK 3.3.