...
9. Para o terceiro e último passo, especifica um **Grupo de Ações**, que garante que as mesmas ações são feitas sempre que um alerta é acionado e pode ser utilizado para cada regra que definir.  Configure um novo grupo de ações com as seguintes informações:  
   ...
   e. No painel **E-mail/SMS/Push/Voz**, ative **E-mail** e indique um endereço de e-mail SMTP válido para entregar a mensagem. f. Clique em **OK** para guardar as alterações.<br><br> ![Criar novo grupo de ações](./media/log-analytics-tutorial-response/action-group-properties-01.png)<br>
