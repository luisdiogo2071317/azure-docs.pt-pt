...
> [!NOTE]
> Agora tem sido expandidos totalmente alertas no portal do Azure. Regras de alerta existentes podem ser visualizadas no portal do OMS, mas só podem ser geridos no portal do Azure.
