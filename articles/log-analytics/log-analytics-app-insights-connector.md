...
3. Sob **Selecione uma subscrição**, selecione uma subscrição que tem os recursos do Application Insights e, em **nome da aplicação**, selecione uma ou mais aplicações.
4. Clique em **Guardar**.
