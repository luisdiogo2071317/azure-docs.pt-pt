...
![Símbolo de verificar o estado de funcionamento do AD](./media/log-analytics-ad-assessment/ad-assessment-symbol.png)
...
![imagem do mosaico de verificação de estado de funcionamento do AD](./media/log-analytics-ad-assessment/ad-healthcheck-summary-tile.png)

![imagem do dashboard de verificação de estado de funcionamento do AD](./media/log-analytics-ad-assessment/ad-healthcheck-dashboard-01.png)
...
2. Utilize a seguinte consulta para recomendações de lista que tenham falhado para computadores no seu ambiente.
    ...
    ```
    Eis uma captura de ecrã que mostra a consulta de pesquisa de registos:<br><br> ![recomendações com falhas](./media/log-analytics-ad-assessment/ad-failed-recommendations.png)
