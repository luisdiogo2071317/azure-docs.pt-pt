...
* Crie [alertas](../monitoring-and-diagnostics/monitoring-overview-unified-alerts.md) no Log Analytics para gerar notificações e a resolução de problemas.
