...
* Adicionar a solução de monitorização de VMware para sua assinatura usando o processo descrito em [adicionar uma solução de gestão](log-analytics-add-solutions.md#add-a-management-solution).
