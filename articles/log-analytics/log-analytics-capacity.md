...
![Mosaico de capacidade e desempenho](./media/log-analytics-capacity/capacity-tile.png)
...
![Painel de anfitriões do dashboard](./media/log-analytics-capacity/dashboard-hosts.png)

![Painel de máquinas virtuais de dashboard](./media/log-analytics-capacity/dashboard-vms.png)
