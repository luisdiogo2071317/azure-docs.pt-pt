...
Configurar os registos do IIS no Log Analytics a partir do [menu de dados nas definições do Log Analytics](log-analytics-data-sources.md#configuring-data-sources).  É necessária nenhuma configuração que selecionar **ficheiros de registo IIS de formato W3C</a&gt recolher**.
