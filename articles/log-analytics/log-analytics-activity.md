...
![Símbolo de registos de atividades do Azure](./media/log-analytics-activity/activity-log-analytics.png)
...
![Mosaico de registos de atividades do Azure](./media/log-analytics-activity/azure-activity-logs-tile.png)
...
![Dashboard de registos de atividades do Azure](./media/log-analytics-activity/activity-log-dash.png)
