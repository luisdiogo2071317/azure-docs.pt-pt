...
O portal do Azure é executado excelente em moderna PCs, Macs e tablets. Se precisar de gerir os recursos do Azure a partir de um dispositivo móvel, experimente a aplicação móvel do Azure que está disponível no iPhone e Android. Para obter mais informações, consulte [aplicação móvel do Azure](https://azure.microsoft.com/features/azure-portal/mobile-app/).
