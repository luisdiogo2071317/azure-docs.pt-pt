...
* Ao trocar rotas através do BGP (da indústria padrão protocolo de encaminhamento dinâmico), quando é utilizado o ExpressRoute, se bloquear o acesso à Internet

Neste artigo, irá aprender a ativar o acesso ao Azure Data Lake Store a partir de VMs do Azure, que foram restritos para aceder aos recursos através de um dos três métodos listados anteriormente.
