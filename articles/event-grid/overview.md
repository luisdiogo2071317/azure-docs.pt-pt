...
O Azure Event Grid fornece várias funcionalidades que melhorar ainda mais a sem servidor, automatização de operações e trabalho de integração: 
