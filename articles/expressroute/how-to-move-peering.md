...
Pode ver uma lista de todos os circuitos ExpressRoute e peerings no portal do Azure. Para obter mais informações, consulte [os detalhes do peering vista Microsoft](expressroute-howto-routing-portal-resource-manager.md#getmsft).
