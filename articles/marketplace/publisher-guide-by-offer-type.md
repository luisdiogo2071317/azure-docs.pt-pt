...
A oferta é o objeto de publicação que irá criar, publicar e gerir o [Cloud Partner Portal](https://cloudpartner.azure.com). O *tipo de oferta* define a estrutura de oferta, que inclui os metadados, artefactos e outros conteúdos utilizado para apresentar a oferta no marketplace.
...
| [**Serviços de consultoria**](https://docs.microsoft.com/azure/marketplace/consulting-services) | Serviços de consultoria no Azure Marketplace ajudam a ligar-se os clientes com os serviços para suportar e expandir a sua utilização do Azure. |
| [**Ofertas de AppSource**](https://docs.microsoft.com/azure/marketplace/appsource-offer-publishing-guide) | A loja de AppSource inclui ofertas que criam no ou expandem Dynamics 365, Office 365, Power BI e Power Apps. |
