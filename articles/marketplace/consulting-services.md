---
title: O Azure Marketplace e AppSource serviços de consultoria
...
A listagem de ofertas de serviços de parceiros de integrador de sistema (SI) da Microsoft – o objetivo a ser oferecer serviços de consultoria de qualidade para permitir aos clientes ligar-se com os serviços de especialistas que precisam de consultoria de suporte do Azure Marketplace e AppSource. Ajudando os clientes a avaliar, avaliar e implantar as soluções certas e implementação que ajudará com seus objetivos de negócios e objetivos.  

Estas ofertas de serviços de consultoria são específicas do cliente compromissos. Os publicadores têm a opção para determinar o tipo de listagem e com o escopo fixo e o período de tempo, com preços fixos ou gratuito, e ter uma agenda definida com os resultados finais para o cliente. Oportunidades potenciais recebidas através de uma notificação no sistema CRM do parceiro e têm como objetivo responder aos clientes dentro de 48 horas. 
...
Parceiros devem ter uma **competência silver ou gold** na área de relevante para o seu serviço. 

**As competências elegíveis estão listadas na seguinte tabela para o Azure Marketplace:**
...
**As competências elegíveis estão listadas na seguinte tabela para o AppSource:**
