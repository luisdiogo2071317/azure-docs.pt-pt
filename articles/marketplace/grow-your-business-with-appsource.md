...
## <a name="how-to-grow-your-business-with-appsource"></a>Como expandir seu negócio com o AppSource  
...
Sua listagem no AppSource pode ser a sua primeira interação com um cliente potencial. Como qualquer sua primeira impressão, que pretende torná-la forte e algo seu público-alvo deseja dar seguimento. Parceiro com a sua equipa de marketing para garantir que o conteúdo de mensagens e suporte na sua listagem diferenciados e ajuda a sua oferta se destacam. 

Aqui estão algumas coisas básicas que pode fazer para fornecer a sua primeira impressão excelente. 

![Sua primeira impressão](./media/marketplace-appsource/appsourcefirstimpression.png)

A secção seguinte descreve as diferentes etapas necessárias para submeter a sua listagem do marketplace. Leia-lo cuidadosamente pois inclui melhores práticas que podem ajudar a sua aplicação se destacam e melhorar as classificações de motor de pesquisa. 

As tabelas a seguir detalham a cada etapa do preenchimento de sua listagem de oferta.

**Identidade de oferta**  
...
|:---------------------------------------- |:----------------------------------------------------- |
| **Nome da oferta** | O resumo de oferta é apresentada na página de pesquisa da oferta na Galeria de aplicações e de home page do AppSource. Inclua as palavras a procurar no seu resumo de oferta para ajudar a melhorar a classificação da sua aplicação nos resultados do motor de pesquisa. |
| **Descrição da oferta** | **Forneça uma descrição de boa oferta**<br />Descreva claramente a proposta de valor da sua oferta nas frases alguns primeiro da sua descrição. Tenha em atenção que as frases de alguns primeiro poderão ser apresentadas nos resultados do motor de pesquisa.<br />Não confie em recursos e funcionalidades para vender seu produto. Em vez disso, concentre-se no valor que fornecer. Utilize o vocabulário específicos da indústria ou com base em benefício redação tanto quanto possível.<br />Componentes principais de sua proposta de valor devem incluir informações sobre:<ul> <li>O que é o produto</li>  <li>Que obtém do mesmo mais</li> <li>Quais necessidade ou problema resolve.</li> </ul>Diga aos seus clientes como seu negócio ou a rotina de trabalho pode ser diferente quando utilizarem a sua solução.<br />Incorpore as palavras a procurar e variações de palavra-chave em sua descrição da oferta para ajudar a melhorar a classificação da sua oferta nos resultados do motor de pesquisa.<br />Fornece a descrição de oferta usando simple HTML.<br />Eis um exemplo de uma oferta simple página da lista (conforme mostrado na listagem de exemplo acima), que fornece um resumo de oferta, seguido por uma lista de capacidades principais. O número máximo de carateres é 3.000.<br />*HTML de exemplo*<br />Informações da organização para do Dynamics 365 (online) fornece as métricas importantes de adoção e utilização da sua organização do Dynamics 365 e ferramentas para ajudá-lo se antecipar aos problemas de desempenho e suporte. <ul> <li>**Personalize dashboards**<br />Configure o seu dashboard para fornecer uma experiência de usuário e instantâneos dos seus dados importantes.<ul> <li>**Monitorizar a adoção e utilizar**<br />Identificar os seus utilizadores mais ativos, o número de solicitações de página, entidades mais utilizados, os fluxos de trabalho e muito mais.</li> </ul></li> </ul>Versão mínima de plataforma suportada: `8.1.1` |

**Vitrine detalhes - detalhes de listagem**  

| Definições de vitrine | Melhores práticas | 
|:--- |:--- |
| **Setores (máx. 2)** | Selecione até dois setores se a sua oferta aborda os requisitos específicos da indústria. Certifique-se chamar esses recursos específicos da indústria na descrição da oferta. |
| **Categorias (máx. 3)** | Selecione até três categorias que se ajustam melhor na sua oferta. Escolha cuidadosamente essas categorias, como os utilizadores a utilizar as categorias para procurar as aplicações relevantes. Certifique-se a destacar como sua oferta suporta as necessidades de categorias específicas na descrição da oferta. |
| **Produtos a que sua aplicação funciona com (máx. 3)** | Lista de outros produtos e tecnologias que utiliza a sua solução. Por exemplo, o Hub IOT do Azure, Azure Machine Learning, etc. |
| **Palavras a procurar (máx. 3)** | As palavras a procurar ajudam os utilizadores empresariais a encontrar a sua oferta, ao pesquisar no AppSource, ou através de mecanismos de pesquisa. Palavras-chave de pesquisa de identidade a 3 principais para a sua oferta, incorporar as palavras-chave de pesquisa em sua descrição de resumo, oferta e listar as palavras-chave de pesquisa aqui. |

**Vitrine detalhes - artefactos de Marketing**  

| Definições de vitrine | Melhores práticas | 
|:--- |:--- |
| **Logótipo da oferta (formato. png, 48 x 48)** | O logótipo deve ser criado e otimizado para um digital médio.<br />Carregue o logótipo no formato PNG para a página de pesquisa da sua oferta. |
