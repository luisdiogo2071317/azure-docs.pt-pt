...
>[!Note]
>Para obter informações gerais sobre o Portal de parceiros da Cloud, pode verificar o [saber documentação](https://docs.microsoft.com/azure/marketplace/cloud-partner-portal-orig/cloud-partner-portal-getting-started-with-the-cloud-partner-portal)
