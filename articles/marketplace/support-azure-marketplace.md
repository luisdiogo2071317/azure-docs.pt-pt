---
title: Suporte para o Azure Marketplace e AppSource | Azure
...
Além disso, pode obter muitas das suas perguntas respondidas no [canal do Marketplace do Fórum da Comunidade de C + IA](https://www.microsoftpartnercommunity.com/t5/Marketplace/bd-p/2222).  
...
| Canal de suporte | Descrição | Disponibilidade |  
|:--- |:--- |:--- |  
| E-mail: [cosell@microsoft.com](mailto:cosell@microsoft.com) | Suporte para processos de inclusão e questões relacionadas com o programa de venda conjunta. | Com base no fuso horário do Pacífico. |  
