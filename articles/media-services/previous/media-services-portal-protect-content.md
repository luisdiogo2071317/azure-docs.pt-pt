...
Os Media Services suportam várias formas de autenticar utilizadores que efetuam pedidos de chave ou de licença. Tem de configurar a política de autorização da chave de conteúdo. O cliente, em seguida, tem de cumprir a política antes da chave/licença podem ser fornecida ao mesmo. A política de autorização da chave de conteúdo pode ter uma ou mais restrições de autorização, quer sejam restrições abertas ou de token.
