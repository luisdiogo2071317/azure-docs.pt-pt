...
## <a name="a-idconfigurewirecastrtmp-aconfigure-the-telestream-wirecast-encoder"></a>< um id = "configure_wirecast_rtmp" /a > Configure o codificador Telestream Wirecast
