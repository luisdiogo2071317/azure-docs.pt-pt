...
description: Este tópico compara as capacidades de codificação do **codificador de multimédia Standard** e **o fluxo de trabalho do suporte de dados codificador Premium**.
