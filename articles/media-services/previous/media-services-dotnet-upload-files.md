...
ms.locfileid: "55984227"
---
# <a name="upload-files-into-a-media-services-account-using-net-legacy"></a>Carregar ficheiros para uma conta de serviços de multimédia com .NET (Legado)
