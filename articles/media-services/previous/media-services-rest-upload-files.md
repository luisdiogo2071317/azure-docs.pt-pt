...
ms.locfileid: "55981235"
---
# <a name="upload-files-into-a-media-services-account-using-rest-legacy"></a>Carregar ficheiros para uma conta de serviços de multimédia com REST (Legado)
