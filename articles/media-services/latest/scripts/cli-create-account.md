---
title: Exemplo do Script da CLI do Azure – Criar uma conta dos Serviços de Multimédia do Azure | Microsoft Docs
...
Este script cria uma conta dos Serviços de Multimédia do Azure.
...
| **az ams account create** | Criar uma conta dos Serviços de Multimédia. |
| **az ams account sp create** | Cria um principal de serviço com palavra-passe e configura o acesso a uma conta dos Serviços de Multimédia do Azure. |
