...
Para criar o seu processo de carregamento, veja as [Melhores práticas de carregamento de dados para o Azure SQL Data Warehouse](guidance-for-loading-data.md).  
