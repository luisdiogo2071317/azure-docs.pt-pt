...
<sub>origem: [Relatório de analista investigação da Gigaom: Armazém de dados no parâmetro de comparação de Cloud](https://gigaom.com/report/data-warehouse-in-the-cloud-benchmark/)</sub>
