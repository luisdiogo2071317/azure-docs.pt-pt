...
Para obter mais informações, consulte [blog de padrões de carregamento](http://blogs.msdn.microsoft.com/sqlcat/2017/05/17/azure-sql-data-warehouse-loading-patterns-and-strategies/). 
