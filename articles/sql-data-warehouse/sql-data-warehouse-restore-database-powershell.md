...
> [!NOTE]
> Pode efetuar um restauro de georreplicação para o Optimized para a camada de desempenho de computação! Para tal, especifique um Optimized para computação ServiceObjectiveName como um parâmetro opcional. 
>
> 
