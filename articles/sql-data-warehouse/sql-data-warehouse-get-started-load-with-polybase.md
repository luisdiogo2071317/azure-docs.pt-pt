...
Veja também [Getting Started with the AzCopy Command-Line Utility (Introdução ao Utilitário de Linha de Comandos AzCopy)][Getting Started with the AzCopy Command-Line Utility].
