...
| ![Sentry um][5] |**Sentry de armazém de dados**<br>Com o dados inteligente movimento dashboard e o evento de calendário, sempre sabe exatamente o que está a afetar a sua carga de trabalho. Concebido para lhe fornecer visibilidade de suas consultas e as tarefas em execução para carregar, cópia de segurança, ou de restauro dos dados, nunca se preocupar sobre a tirar o máximo partido dos seus recursos do Azure. |[Marketplace][sql_sentry_marketplace]<br>[Web site][sql_sentry_website]<br>[Imprensa][sql_sentry_press]<br>[Twitter][sql_sentry_twitter]<br>[YouTube][sql_sentry_youtube] | |
