...
> [!NOTE]
> Este artigo reflete o preterido **experiência de métricas clássicas**. Anotações só estão atualmente disponíveis na experiência do clássica e no  **[livros](app-insights-usage-workbooks.md)**. Para saber mais sobre o currrent experiência de métricas, consulte [este artigo](../azure-monitor/platform/metrics-charts.md).
