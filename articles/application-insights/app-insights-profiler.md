...
Profiler trabalha atualmente para aplicações ASP.NET e ASP.NET Core em execução no App Service do Azure. Basic camada de serviço ou superior é obrigatório para utilizar o Profiler. Ativar Profiler no Linux atualmente só é possível por meio [esse método](app-insights-profiler-aspnetcore-linux.md).
