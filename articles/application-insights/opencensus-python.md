...
O Application Insights agora suporta distribuídas de aplicativos do Python através da integração com o rastreamento [OpenCensus](https://opencensus.io) e a nova [reencaminhador local](./opencensus-local-forwarder.md). Este artigo irá guiá-lo passo a passo pelo processo de configuração OpenCensus para Python e obter os seus dados de rastreio para o Application Insights.
