...
![Captura de ecrã de navegação para pastas de trabalho](./media/app-insights-usage-workbooks/001-workbooks.png)
...
![Captura de ecrã da Galeria de livro](./media/app-insights-usage-workbooks/002-workbook-gallery.png)

Vamos começar com o **modelo predefinido**, que se encontra sob o cabeçalho **guia de introdução**.

![Captura de ecrã da Galeria de livro](./media/app-insights-usage-workbooks/003-default-template.png)
...
![Controles de edição de secção de pastas de trabalho do Application Insights](./media/app-insights-usage-workbooks/editing-controls-new.png)
...
![Secção de consulta em pastas de trabalho](./media/app-insights-usage-workbooks/analytics-section-new.png)
...
Cada secção tem suas próprias definições avançadas, que são acessíveis através do ícone de definições ![controles de edição de secção de pastas de trabalho do Application Insights](./media/app-insights-usage-workbooks/005-settings.png) localizado à direita do **adicionar parâmetros** botão.

![Controles de edição de secção de pastas de trabalho do Application Insights](./media/app-insights-usage-workbooks/0006-settings-expanded.png)
...
![Controles de edição de secção de pastas de trabalho do Application Insights](./media/app-insights-usage-workbooks/003-active-users.png)
...
![Controles de edição de secção de pastas de trabalho do Application Insights](./media/app-insights-usage-workbooks/004-active-users-trend.png)
...
![Controles de edição de secção de pastas de trabalho do Application Insights](./media/app-insights-usage-workbooks/007-settings-export.png)
...
![Controles de edição de secção de pastas de trabalho do Application Insights](./media/app-insights-usage-workbooks/008-metrics-grid.png)
...
![Controles de edição de secção de pastas de trabalho do Application Insights](./media/app-insights-usage-workbooks/009-time-range.png)

Isso iniciará o item de menu Edit Parameter:

![Controles de edição de secção de pastas de trabalho do Application Insights](./media/app-insights-usage-workbooks/010-time-range-edit.png)
...
![Controles de edição de secção de pastas de trabalho do Application Insights](./media/app-insights-usage-workbooks/011-data-table.png)
...
![Lista pendente do país](./media/app-insights-usage-workbooks/012-country-dropdown.png)
...
![Lista pendente do país](./media/app-insights-usage-workbooks/013-resource-picker.png)
