...
> [!NOTE]
> Instruções que faça referência a **applicationinsights. config** só são aplicáveis às aplicações que estiver a filtrar .NET Standard e não se aplicam às aplicações de .NET Core. 
