...
- Configurar o controlo para dependência personalizadas [.NET](app-insights-asp-net-dependencies.md).
- Configurar o controlo para dependência personalizadas [Java](app-insights-java-agent.md).
