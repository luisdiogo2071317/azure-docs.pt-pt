...
![Botão de controle de captura de ecrã de acesso no portal do Azure](./media/app-insights-resources-roles-access-control/0001-access-control.png)

Selecione **adicionar**

![Menu de controle de captura de ecrã de acesso com o botão Adicionar realçado a vermelho](./media/app-insights-resources-roles-access-control/0002-add.png)
...
![Lista de funções de utilizador de controle de captura de ecrã de acesso](./media/app-insights-resources-roles-access-control/0003-user-roles.png)
