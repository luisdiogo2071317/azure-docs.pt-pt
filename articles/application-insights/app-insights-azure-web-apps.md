...
* [Monitorizar as métricas de estado de funcionamento de serviço](../monitoring/monitoring-data-collection.md) para se certificar de que o serviço está disponível e a responder.
