...
![Menu de contexto do projeto para aplicações do Windows Universal](./media/app-insights-release-notes-vsix/UniversalContextMenu.png)
...
![Carregar a caixa de diálogo para aplicações do Windows Universal](./media/app-insights-release-notes-vsix/UniversalUploadDialog.png)
...
![Menu de contexto do projeto para aplicativos Windows Forms](./media/app-insights-release-notes-vsix/WinFormContextMenu.png)

Esta ação abre o diálogo de carregamento do HockeyApp, que é semelhante de num aplicativo do Windows Universal.

![Carregar a caixa de diálogo para aplicativos Windows Forms](./media/app-insights-release-notes-vsix/WinFormsUploadDialog.png)
...
![Notificações de registos](./media/app-insights-release-notes-vsix/LoggingToast.png)
...
![Retroceder](./media/app-insights-release-notes-vsix/GoBAck.png)
