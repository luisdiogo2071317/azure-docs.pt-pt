...
Para adicionar capacidades de rastreio distribuído para uma aplicação com OpenCensus, primeiro [instalar e configurar o reencaminhador de Local do Application Insights](./opencensus-local-forwarder.md). A partir daí, configure OpenCensus para encaminhar dados de rastreio distribuído por meio do reencaminhador de Local. Ambos [Python](./opencensus-python.md) e [vá](./opencensus-go.md) são suportados.
